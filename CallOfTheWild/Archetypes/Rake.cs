...
namespace CallOfTheWild.Archetypes
{
    public class Rake
    {
        ...
        public static BlueprintFeature rakes_smile;
        public static BlueprintFeature[] bravados_blade = new BlueprintFeature[5];
        ...
        public static void create()
        {
            ...
            {
                Helpers.LevelEntry(1, bravados_blade[0]),
            ...
            rogue_class.Progression.UIGroups = rogue_class.Progression.UIGroups.AddToArray(
                Helpers.CreateUIGroup(bravados_blade)
            );
        ...
        {
            rakes_smile = Helpers.CreateFeature(
                "RakesSmileFeature",
                "Rake’s Smile",
        ...
        static void createBravadosBlade()
        {
            var demoralize =
                library
                    .Get<BlueprintAbility>("5f3126d4120b2b244a95cb2ec23d69fb")
                    .GetComponent<AbilityEffectRunAction>()
                    .Actions.Actions[0] as Demoralize;
            for (int i = 0; i < 5; i++)
            {
                var buff_sneak = Helpers.CreateBuff(
                    $"BravadosBladeReduceSneak{i}Buff",
                    "",
                    "",
                    "",
                    null,
                ...
                var action_on_hit = Helpers.CreateActionList(
                ...
                var buff = Helpers.CreateBuff(
                    ...
                    Common.createAddInitiatorAttackWithWeaponTrigger(
                        Helpers.CreateActionList(Common.createContextActionRemoveBuff(buff_sneak)),
                        false,
                ...
                toggle.Group =
                    ActivatableAbilityGroupExtension.BravadosBlade.ToActivatableAbilityGroup();
