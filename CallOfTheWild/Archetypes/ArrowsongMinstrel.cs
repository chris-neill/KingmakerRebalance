...
namespace CallOfTheWild.Archetypes
{
    public class ArrowsongMinstrel
    {
        ...
        public static BlueprintBuff precise_minstrel_no_cover_buff;

        public static BlueprintFeature precise_minstrel;
        public static BlueprintFeature arrowsong_strike;
        public static BlueprintFeatureSelection arcane_achery_selection;
        public static BlueprintFeature arcane_achery;
        public static BlueprintFeature weapon_proficiency;

        public static BlueprintFeature ray_spell_combat;

        static LibraryScriptableObject library => Main.library;

        internal static void create()
        {
            var bard_class = ResourcesLibrary.TryGetBlueprint<BlueprintCharacterClass>(
                "772c83a25e2268e448e841dcd548235f"
            );
            createSpellbook();
            ...
            archetype.RemoveFeatures = new LevelEntry[]
            {
                Helpers.LevelEntry(
                    1,
                    library.Get<BlueprintFeature>("fa3d3b2211a51994785d85e753f612d3")
                ), //bard proficiencies
                ...
                Helpers.LevelEntry(
                    6,
                    library.Get<BlueprintFeature>("ddaec3a5845bc7d4191792529b687d65")
                ), //fascinate
                Helpers.LevelEntry(
                    7,
                    library.Get<BlueprintFeature>("6d3fcfab6d935754c918eb0e004b5ef7")
                ), //inspire competence
                Helpers.LevelEntry(
                    8,
                    library.Get<BlueprintFeature>("1d48ab2bded57a74dad8af3da07d313a")
                ), //dirge of doom
                Helpers.LevelEntry(
                    11,
                    library.Get<BlueprintFeature>("6d3fcfab6d935754c918eb0e004b5ef7")
                ...
                Helpers.LevelEntry(
                    12,
                    library.Get<BlueprintFeature>("546698146e02d1e4ea00581a3ea7fe58")
                ), //soothing performance
                Helpers.LevelEntry(
                    14,
                    library.Get<BlueprintFeature>("cfd8940869a304f4aa9077415f93febe")
                ), //frightening tune
                Helpers.LevelEntry(
                    15,
                    library.Get<BlueprintFeature>("6d3fcfab6d935754c918eb0e004b5ef7")
            ...
            {
                Helpers.LevelEntry(1, weapon_proficiency),
            ...
            bard_class.Progression.UIDeterminatorsGroup =
                bard_class.Progression.UIDeterminatorsGroup.AddToArray(weapon_proficiency);
            bard_class.Progression.UIGroups = bard_class.Progression.UIGroups.AddToArray(
            ...
            var starting_items = library
                .Get<BlueprintArchetype>("44388c01eb4a29d4d90a25cc0574320d")
                .StartingItems; //from eldritch archer
            //replace scroll of snowball with cure light wounds
            archetype.StartingItems = starting_items
                .RemoveFromArray(
                    library.Get<BlueprintItemEquipmentUsable>("66fc961f9c39ae94fb87a79adc87212e")
                )
                .AddToArray(
                    library.Get<BlueprintItemEquipmentUsable>("cd635d5720937b044a354dba17abad8d")
                );
        ...
        static void addToPrestigeClasses()
        {
            ...
            var selections_to_fix = new BlueprintFeatureSelection[]
            {
            ...
            foreach (var s in selections_to_fix)
            {
                ...
                {
                    if (
                        f.GetComponents<PrerequisiteClassSpellLevel>()
                            .Where(c => c.CharacterClass == bard_class)
                            .Count() > 0
                    )
                    {
            ...
            Common.addReplaceSpellbook(
                Common.EldritchKnightSpellbookSelection,
                spellbook,
                "EldritchKnightArrowsongMinstrel",
            ...
            Common.addReplaceSpellbook(
                Common.ArcaneTricksterSelection,
                spellbook,
                "ArcaneTricksterArrowsongMinstrel",
            ...
            Common.addReplaceSpellbook(
                Common.MysticTheurgeArcaneSpellbookSelection,
                spellbook,
                "MysticTheurgeArrowosngMinstrel",
                Common.createPrerequisiteClassSpellLevel(bard_class, 2),
                Common.createPrerequisiteArchetypeLevel(bard_class, archetype, 1)
            );
            ...
            Common.addReplaceSpellbook(
                Common.DragonDiscipleSpellbookSelection,
                spellbook,
                "DragonDiscipleArrowosngMinstrel",
        ...
        {
            weapon_proficiency = library.CopyAndAdd<BlueprintFeature>(
                "fa3d3b2211a51994785d85e753f612d3",
                "ArrowsongMinstrelProficiencies",
                ""
            );
            weapon_proficiency.ReplaceComponent<AddProficiencies>(a =>
            ...
            weapon_proficiency.SetNameDescriptionIcon(
                "Arrowsong Minstrel Proficiencies",
                "An Arrowsong minstrel is proficient with longbows, but not the longsword and rapier.",
                library.Get<BlueprintAbility>("3e9d1119d43d07c4c8ba9ebfd1671952").Icon
            ); //gravity bow
        }
        ...
        static void createArcaneArchery()
        {
            ...
            arcane_achery = Helpers.CreateFeature(
                "ArrowsongMinstrelArcaneArcheryFeature",
                "Arcane Archery",
            ...
            var magus = library.Get<BlueprintCharacterClass>("45a4607686d96a1498891b3286121780");
            arcane_achery_selection = Helpers.CreateFeatureSelection(
                "ArrowsongMinstrelArcaneArcherySelectionFeature",
                arcane_achery.Name,
        ...
        static void createArrowSongStrike()
        {
            ...
            var add_magus_part = Helpers.Create<NewMechanics.ActivateUnitPartMagus>(a =>
                a.magus_class = bard_class
            );
            ...
            var spellstrike = library.CopyAndAdd<BlueprintActivatableAbility>(
                "e958891ef90f7e142a941c06c811181e",
                "ArrowsongMinstrelSpellstrike",
                ""
            );
            spellstrike.SetName("Arrowsong Strike");
            spellstrike.SetDescription(
                "At 6th level, an Arrowsong minstrel can use spellstrike (as per the magus class feature) to cast a single-target ranged touch attack spell and deliver it through a ranged weapon attack."
            );
            ...
            var add_spell_combat18 = library
                .Get<BlueprintFeature>("2464ba53317c7fc4d88f383fac2b45f9")
                .GetComponent<AddMagusMechanicPart>()
                .CreateCopy(); //spell combat
            ...
            ray_spell_combat = Helpers.CreateFeature(
                "RaySpellCombatFeature",
                "Arrowsong Strike II",
            ...
            spellcombat_penalty_buff.AddComponent(
                Helpers.Create<NewMechanics.BuffExtraAttackIfHasFact>(b =>
                {
                    b.num_attacks = -1;
                    b.fact = ray_spell_combat;
                })
            );
            var apply_spell_combat = Common.createContextActionApplyBuff(
                spell_combat_buff,
            ...
            spellstrike.Buff.AddComponent(
                Helpers.CreateAddFactContextActions(
                    Helpers.CreateConditional(
                        Common.createContextConditionHasFact(ray_spell_combat),
                        apply_spell_combat
                    )
                )
            );
        ...
        static void createPreciseMinstrel()
        {
            ...
            precise_minstrel = Helpers.CreateFeature(
                "PreciseMinstrelFeature",
                "Precise Minstrel",
        ...
        static void createSpellbook()
        {
            ...
            var wizard_class = ResourcesLibrary.TryGetBlueprint<BlueprintCharacterClass>(
            ...
            spellbook.Name = Helpers.CreateString(
                "ArrowsongMinstrelSpellbook.Name",
                "Arrowsong Minstrel"
            );
            spellbook.SpellsPerDay = Common.increaseNumSpellsCast(
                "ArrowsongMinstrellSpellPerDay",
                "",
                bard_class.Spellbook.SpellsPerDay,
                -1
            );
        ...
        public class MagusController_HandleUnitRunCommand_Patch
        {
            ...
            )
            {
                ...
                var check_magus_spell_list = codes.FindIndex(x =>
                    x.opcode == System.Reflection.Emit.OpCodes.Callvirt
                    && x.operand.ToString().Contains("IsSpellFromMagusSpellList")
                );

                codes[check_magus_spell_list] = new Harmony12.CodeInstruction(
        ...
        public class MagusController_CreateCastCommand_Patch
        {
            ...
            )
            {
                ...
                codes[check_magus_spell_list] = new Harmony12.CodeInstruction(
                    System.Reflection.Emit.OpCodes.Call,
                    new Func<UnitPartMagus, AbilityData, bool>(
                        MagusController_HandleUnitRunCommand_Patch.canUseSpellForSpellCombat
                    ).Method
                );
