...
namespace CallOfTheWild.Archetypes
{
    public class Ninja
    {
        ...
        public static BlueprintFeature ninja_proficiencies;
        public static BlueprintFeature ki_pool;
        public static BlueprintAbility ninja_ki_extra_attack_ability;
        public static BlueprintAbilityResource ki_resource;
        public static BlueprintFeature no_trace;
        public static BlueprintFeature light_steps;
        public static BlueprintFeature dispatchment;

        public static BlueprintFeatureSelection ninja_trick;

        //base tricks
        static public BlueprintFeature acceleration_of_form; //
        public static BlueprintFeature chocking_bomb; //
        public static BlueprintFeature herbal_compound;
        public static BlueprintFeature kamikaze;

        //static public BlueprintFeature pressure_points; ~ similar to cripling strike
        static public BlueprintFeature smoke_bomb; //
        public static BlueprintFeatureSelection style_master; //
        public static BlueprintFeature unarmed_combat_training; //
        public static BlueprintFeature shadow_clone; //
        public static BlueprintFeature vanishing_trick; //

        //+all rogue talents
        //master tricks
        static public BlueprintFeature unarmed_combat_mastery;
        public static BlueprintFeature blinding_bomb; //
        public static BlueprintFeature invisible_blade; //
        public static BlueprintFeature see_the_unseen; //
        public static BlueprintFeature flurry_of_darts;
        ...
        {
            var rogue_class = ResourcesLibrary.TryGetBlueprint<BlueprintCharacterClass>(
        ...
        public static void create()
        {
            ...
            var rogue_proficiencies = library.Get<BlueprintFeature>(
            ...
            var rogue_talent = library.Get<BlueprintFeatureSelection>(
                "c074a5d615200494b8f2a9c845799d93"
            );
            var finesse_training_selection = library.Get<BlueprintFeature>(
                "b78d146cea711a84598f0acef69462ea"
            );
            var danger_sense = library.Get<BlueprintFeature>("0bcbe9e450b0e7b428f08f66c53c5136");
            var debilitating_injury = library.Get<BlueprintFeature>(
                "def114eb566dfca448e998969bf51586"
            );
            ...
            var advanced_talents = library.Get<BlueprintFeature>(
                "a33b99f95322d6741af83e9381b2391c"
            );
            ...
            {
                Helpers.LevelEntry(1, rogue_proficiencies, trapfinding),
            ...
            {
                Helpers.LevelEntry(1, ninja_proficiencies),
            ...
            rogue_class.Progression.UIDeterminatorsGroup =
                rogue_class.Progression.UIDeterminatorsGroup.AddToArray(ninja_proficiencies);
        ...
        {
            style_strikes = library.CopyAndAdd<BlueprintFeatureSelection>(
                "7bc6a93f6e48eff49be5b0cde83c9450",
                "NinjaStyleStrikes",
                ""
            );
            style_strikes.Features = new BlueprintFeature[0];
            style_strikes.SetDescription(
            ...
            foreach (var ss in old_fetures)
            {
                ...
                var buff = library.CopyAndAdd(
                    toggle.Buff,
                    "Ninja" + toggle.Buff.name,
                    Helpers.MergeIds(toggle.AssetGuid, "879a3c116afe43c3b25448abbaa9941b")
                );

                buff.MaybeReplaceComponent<NewMechanics.DoubleDamageDiceOnAttack>(d =>
                    d.WeaponType = null
                );
                buff.MaybeReplaceComponent<AddInitiatorAttackWithWeaponTrigger>(a =>
                    a.WeaponType = null
                );
                ...
                var ability = library.CopyAndAdd(
                    ninja_ki_extra_attack_ability,
                    "Ninja" + toggle.name,
                    Helpers.MergeIds(toggle.AssetGuid, "12469cb6b01548888069e45b6dc5bd37")
                );
                ...
                var feature = library.CopyAndAdd(
                    ss,
                    "Ninja" + ss.name,
                    Helpers.MergeIds(toggle.AssetGuid, "5497acccb4834d4eb39144a972c9125b")
                );
                ...
                ability.SetNameDescriptionIcon(
                    ninja_ki_extra_attack_ability.Name + " (" + toggle.Name + ")",
            ...
            var wrapper = Common.createVariantWrapper(
                "NinjaStyleStrikesAbilityBase",
                "",
                abilities.ToArray()
            );
            wrapper.SetNameDescriptionIcon(
                ninja_ki_extra_attack_ability.Name + " (" + style_strikes.Name + ")",
                ninja_ki_extra_attack_ability.Description
                    + "\n"
                    + style_strikes.Name
                    + ": "
                    + style_strikes.Description,
                ninja_ki_extra_attack_ability.Icon
            );

            style_strikes.ComponentsArray = new BlueprintComponent[]
            {
        ...
        {
            dispatchment = Helpers.CreateFeature(
                "DispatchmentFeature",
                "Dispatchment",
        ...
        {
            ninja_proficiencies = library.CopyAndAdd<BlueprintFeature>(
                "33e2a7e4ad9daa54eaf808e1483bb43c",
                "NinjaProficiencies",
                ""
            );
            ninja_proficiencies.ReplaceComponent<AddProficiencies>(a =>
                a.WeaponProficiencies = new WeaponCategory[]
                {
                    WeaponCategory.Kama,
            ...
            ninja_proficiencies.AddComponent(
                Helpers.CreateAddFact(
                    library.Get<BlueprintFeature>("9c37279588fd9e34e9c4cb234857492c")
                )
            ); //duelling sword proficiency
            ninja_proficiencies.SetNameDescription(
                "Ninja Proficiencies",
        ...
        {
            no_trace = Helpers.CreateFeature(
                "NoTraceNinjaFeature",
                "No Trace",
        ...
        static void createKiPool()
        {
            ...
            ki_resource.SetIncreasedByLevelStartPlusDivStep(
                0,
                0,
                0,
                2,
            ...
            var ki_extra_attack = library.CopyAndAdd<BlueprintAbility>(
                "ca948bb4ce1a2014fbf4d8d44b553074",
                "NinjaKiExtraAttackAbility",
                ""
            );
            ki_extra_attack.SetDescription(
                "By spending 1 point from his ki pool as a swift action, a ninja can make one additional attack at his highest attack bonus when making a full attack. This bonus attack stacks with haste and similar effects."
            );
            ki_extra_attack.ReplaceComponent<AbilityResourceLogic>(a =>
                a.RequiredResource = ki_resource
            );

            var ki_speed_buff = library.CopyAndAdd<BlueprintBuff>(
                "9ea4ec3dc30cd7940a372a4d699032e7",
                "NinjaKiSpeedBoostBuff",
                ""
            );
            ki_speed_buff.ReplaceComponent<BuffMovementSpeed>(b => b.Value = 20);
            var ki_speed_burst = library.CopyAndAdd<BlueprintAbility>(
                "8c98b8f3ac90fa245afe14116e48c7da",
                "NinjaKiSpeedBoostAbility",
                ""
            );

            var new_actions = Common.changeAction<ContextActionApplyBuff>(
                ki_speed_burst.GetComponent<AbilityEffectRunAction>().Actions.Actions,
                c =>
                {
            ...
            ki_speed_burst.ReplaceComponent<AbilityEffectRunAction>(
                Helpers.CreateRunActions(new_actions)
            );
            ki_speed_burst.ReplaceComponent<AbilityResourceLogic>(a =>
                a.RequiredResource = ki_resource
            );
            ki_speed_burst.SetNameDescription(
                "Ki Speed Burst",
        ...
        static void createLightSteps()
        {
            var ability = library.CopyAndAdd<BlueprintAbility>(
                "336a841704b7e2341b51f89fc9491f54",
                "NinjaLightSteps",
                ""
            );
        ...
        {
            ninja_trick = library.CopyAndAdd<BlueprintFeatureSelection>(
                "c074a5d615200494b8f2a9c845799d93",
                "NinjaTrickSelection",
                ""
            );
            ninja_trick.SetNameDescriptionIcon(
                "Ninja Tricks",
            ...
            var improved_unarmed_strike = library.Get<BlueprintFeature>(
                "7812ad3672a4b9a4fb894ea402095167"
            );
            ninja_trick.AllFeatures = ninja_trick.AllFeatures.AddToArray(
                improved_unarmed_strike,
                RogueTalents.assasinate
            );
        ...
        static void createFlurryOfDarts()
        {
            var buff = Helpers.CreateBuff(
                ...
                {
                    b.categories = new WeaponCategory[] { WeaponCategory.Dart };
                    b.num_attacks = 2;
                    b.attack_bonus = -2;
                })
            );
            ...
            var ability = Helpers.CreateAbility(
                ...
                Helpers.Create<AbilityCasterMainWeaponCheck>(a =>
                    a.Category = new WeaponCategory[] { WeaponCategory.Dart }
                )
            );
            ability.setMiscAbilityParametersSelfOnly();

            flurry_of_darts = Common.AbilityToFeature(ability, false);
            flurry_of_darts.AddComponent(
                Helpers.Create<HoldingItemsMechanics.ConsiderWeaponCategoriesAsLightWeapon>(c =>
                    c.categories = new WeaponCategory[] { WeaponCategory.Dart }
                )
            );
        }
        ...
        {
            style_master = library.CopyAndAdd(
                Warpriest.sacred_fist_syle_feat_selection,
                "NinjaStyleMasterFeatureSelection",
                ""
            );
            style_master.SetNameDescription(
                "Style Master",
        ...
        {
            var smoke_bomb_ability = library.CopyAndAdd(
                NewSpells.obscuring_mist,
                "NinjaSmokeBombAbility",
                ""
            );
            ...
            smoke_bomb_ability.Animation = Kingmaker
                .Visual
                .Animation
                .Kingmaker
                .Actions
                ...
                .CastAnimationStyle
                .Thrown;
            smoke_bomb_ability.AnimationStyle = Kingmaker
                .View
                .Animation
                .CastAnimationStyle
                .CastActionThrown;
            smoke_bomb_ability.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(
                    Common.changeAction<ContextActionSpawnAreaEffect>(
                        a.Actions.Actions,
                        s =>
                        {
                            s.AreaEffect = NewSpells.obscuring_mist_area;
            ...
            smoke_bomb_ability.AddComponent(
            ...
            smoke_bomb_ability.SetNameDescription(
                "Smoke Bomb",
            ...
            var chocking_bomb_ability = library.CopyAndAdd(
                smoke_bomb_ability,
                "NinjaNausetingBombAbility",
                ""
            );
            var chocking_bomb_area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                NewSpells.obscuring_mist_area,
                "ChockingBombArea",
                ""
            );
            ...
            var apply_buff_saved = Helpers.CreateConditional(
                Common.createContextConditionHasFact(staggered_buff),
                null,
            ...
            chocking_bomb_area.Fx = library
                .Get<BlueprintAbilityAreaEffect>("aa2e0a0fe89693f4e9205fd52c5ba3e5")
                .Fx; //stinking cloud
            chocking_bomb_ability.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(
                    Common.changeAction<ContextActionSpawnAreaEffect>(
                        a.Actions.Actions,
                        s =>
                        {
                            s.AreaEffect = chocking_bomb_area;
                            s.DurationValue = Helpers.CreateContextDuration(
                                1,
                                DurationRate.Minutes
                            );
            ...
            chocking_bomb_ability.SetNameDescriptionIcon(
                "Chocking Bomb",
            ...
            var blinding_bomb_ability = library.CopyAndAdd(
                smoke_bomb_ability,
                "NinjaBlindingBombAbility",
                ""
            );
            var blinding_bomb_area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                NewSpells.obscuring_mist_area,
                "BlindingBombArea",
                ""
            );
            var blind_buff = library.Get<BlueprintBuff>("187f88d96a0ef464280706b63635f2af");
            var apply_buff2 = Helpers.CreateConditionalSaved(
                null,
                Common.createContextActionApplyBuff(
                    blind_buff,
                    Helpers.CreateContextDuration(0, DurationRate.Rounds, DiceType.D4, 1),
            ...
            var apply_buff_saved2 = Helpers.CreateConditional(
                Common.createContextConditionHasFact(blind_buff),
                null,
                Common.createContextActionSavingThrow(
                    SavingThrowType.Fortitude,
                    Helpers.CreateActionList(apply_buff2)
                )
            );
            var blinding_bomb_action =
                Helpers.Create<NewMechanics.AbilityAreaEffectRunActionWithFirstRound>(a =>
                {
            ...
            blinding_bomb_area.Fx = library
                .Get<BlueprintAbilityAreaEffect>("aa2e0a0fe89693f4e9205fd52c5ba3e5")
                .Fx; //stinking cloud
            blinding_bomb_ability.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(
                    Common.changeAction<ContextActionSpawnAreaEffect>(
                        a.Actions.Actions,
                        s =>
                        {
                            s.AreaEffect = blinding_bomb_area;
                            s.DurationValue = Helpers.CreateContextDuration(
                                1,
                                DurationRate.Minutes
                            );
            ...
            blinding_bomb_ability.SetNameDescriptionIcon(
                "Blinding Bomb",
            ...
            blinding_bomb.AddComponents(
                Helpers.PrerequisiteFeature(smoke_bomb),
                Helpers.PrerequisiteFeature(chocking_bomb)
            );
        }
        ...
        static void createAccelerationOfForm()
        {
            ...
            var apply_displacement = Common.createContextActionApplyBuff(
                displacement_buff,
            ...
            var apply_haste = Common.createContextActionApplyBuff(
                haste_buff,
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilityRankType.Default),
                    DurationRate.Rounds
            ...
            var ability = Helpers.CreateAbility(
                "NinjaAccelerationOfFormAbility",
        ...
        static void createShadowClone()
        {
            ...
            var ability = Common.convertToSuperNatural(
                mirror_image,
                "NinjaShadowClone",
                getRogueArray(),
                StatType.Charisma,
            ...
            shadow_clone = Helpers.CreateFeature(
                "NinjaShadowCloneFeature",
                "Shadow Clone",
        ...
        static void createVanishingTrickAndInvisibleBlade()
        {
            ...
            var improved_invisibility_buff = library.Get<BlueprintBuff>(
                "e6b35473a237a6045969253beb09777c"
            );

            invisible_blade = Helpers.CreateFeature(
                "NinjaInvisibleBladeFeature",
                "Invisible Blade",
            ...
            var apply_invisibility_improved = Common.createContextActionApplyBuff(
            ...
            var action = Helpers.CreateConditional(
                Common.createContextConditionHasFact(invisible_blade),
                apply_invisibility_improved,
                apply_invisibility
            );

            var ability = Helpers.CreateAbility(
                "NinjaVanishingTrickAbility",
                "Vanishing Trick",
        ...
        static void createSeeTheUnseen()
        {
            ...
            see_the_unseen.SetDescription(
                "A ninja with this trick learns how to see that which cannot be seen. As a swift action, the ninja can cast see invisibility, using her level as the caster level. Each use of this ability uses up 1 ki point."
            );
        }
        ...
        static void createHerbalCompound()
        {
            ...
            var ability = Helpers.CreateAbility(
                ...
                Common.createAbilitySpawnFx(
                    "2afcad44a5112d54ebfc8248df7e6525",
        ...
        static void createKamikaze()
        {
            ...
            var vicious = library.Get<BlueprintWeaponEnchantment>(
                "a1455a289da208144981e4b1ef92cc56"
            );
            var buff = Helpers.CreateBuff(
                "NinjaKamikazeBuff",
                "Kamikaze",
        ...
        static void createUnarmedCombatMastery()
        {
            ...
            var fake_monk_class = library.CopyAndAdd<BlueprintCharacterClass>(
                "e8f21e5b58e0569468e420ebea456124",
                "FakeNinjjaMonkClassForUnarmedCombatMastery",
                ""
            );
            ClassToProgression.addClassToFeat(
                fake_monk_class,
                new BlueprintArchetype[] { },
                ClassToProgression.DomainSpellsType.NoSpells,
                fist1d6,
                monk
            );
            ...
            unarmed_combat_mastery = Helpers.CreateFeature(
                "NinjaUnarmedCombatMastery",
            ...
            unarmed_combat_mastery.AddComponents(
                Helpers.PrerequisiteFeature(improved_unarmed_strike),
                Helpers.Create<FakeClassLevelMechanics.AddFakeClassLevel>(a =>
                {
                    a.fake_class = fake_monk_class;
                    a.value = Helpers.CreateContextValue(AbilityRankType.DamageDiceAlternative);
                }),
                Helpers.CreateContextRankConfig(
                    ContextRankBaseValueType.ClassLevel,
                    classes: getRogueArray(),
