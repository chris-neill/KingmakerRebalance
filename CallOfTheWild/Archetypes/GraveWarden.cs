...
namespace CallOfTheWild.Archetypes
{
    public class GraveWarden
    {
        ...
        public static BlueprintFeature holy_water_sprinkler;
        public static BlueprintFeature death_ward;
        public static BlueprintFeature dustbringer;
        ...
        internal static void create()
        {
            ...
            {
                Helpers.LevelEntry(2, slayer_talent2),
            ...
            {
                Helpers.LevelEntry(2, holy_water_sprinkler),
                Helpers.LevelEntry(7, death_ward),
                Helpers.LevelEntry(10, dustbringer),
            };

            slayer_class.Progression.UIGroups = slayer_class.Progression.UIGroups.AddToArray(
                Helpers.CreateUIGroup(holy_water_sprinkler, death_ward, dustbringer)
            );
        ...
        static void createDustBringer()
        {
            ...
            var assasinate_buff = Helpers.CreateBuff(
                ...
                "At 10th level, a grave warden can slay a studied undead opponent. This functions as the assassinate slayer talent, except it requires a successful Will saving throw instead of a successful Fortitude save, affects only undead, and destroys the target instead of killing it. If the target succeeds at its saving throw, it becomes immune to that grave warden’s dustbringer ability for 24 hours.\n"
                    + "Assassinate: "
                    + RogueTalents.assasinate.Description,
                "",
                icon,
                null
            );
            ...
            var assasinate_cooldown = Helpers.CreateBuff(
                "GraveWardenDustbringerCooldownBuff",
            ...
            dustbringer = Helpers.CreateFeature(
                "GraveWardenDustbringerFeature",
                ability.Name,
                ability.Description,
                "",
                ability.Icon,
        ...
        static void createHolyWaterSprinkerAndDeathWard()
        {
            var enchantment = Common.createWeaponEnchantment(
                ...
                0,
                null,
                Common.createWeaponDamageAgainstFact(
            ...
            var death_ward_ability = Common.convertToSpellLike(
