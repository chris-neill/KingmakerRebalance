...
namespace CallOfTheWild.Archetypes
{
    public class DrillSergeant
    {
        ...
        public static BlueprintFeatureSelection tactician;
        public static BlueprintFeatureSelection greater_tactician;
        public static BlueprintFeatureSelection master_tactician;
        public static BlueprintFeature weapon_trainer;

        static HashSet<BlueprintFeature> processed_teamwork_feats = new HashSet<BlueprintFeature>();

        static BlueprintCharacterClass fighter_class =
        ...
        public static void create()
        {
            ...
            var weapon_training_extra = library.Get<BlueprintFeature>(
                "b8cecf4e5e464ad41b79d5b42b76b399"
            );

            archetype.RemoveFeatures = new LevelEntry[]
            {
                Helpers.LevelEntry(2, bravery),
        ...
        static void createTactician()
        {
            ...
            buff.SetIcon(Helpers.GetIcon("6e423d7de48eef74b999ebc8a62df8b8"));

            var resource = Helpers.CreateAbilityResource(
                "DrillSergeantTacticianResource",
                "",
                "",
                "",
                null
            );
            resource.SetIncreasedByLevelStartPlusDivStep(
                1,
                5,
                1,
                5,
                ...
                0,
                0.0f,
                new BlueprintCharacterClass[] { fighter_class }
            );
            var ability = library.CopyAndAdd<BlueprintAbility>(
                "f1c8ec6179505714083ed9bd47599268",
                "DrillSergeantTactician",
                ""
            );
            ...
            ability.SetIcon(buff.Icon);

            ability.ReplaceComponent<ContextRankConfig>(c =>
                Helpers.SetField(c, "m_Class", new BlueprintCharacterClass[] { fighter_class })
            );
            ability.ReplaceComponent<AbilityResourceLogic>(a => a.RequiredResource = resource);

            tactician = Helpers.CreateFeatureSelection(
                "DrillSergeantTacticianFeatureSelection",
                ability.Name,
                ability.Description,
                "",
                ability.Icon,
            ...
            {
                var add_comp = tf.GetComponent<AddFeatureIfHasFact>()
                    .CreateCopy(a => a.CheckedFact = tactician);
                tf.AddComponent(add_comp);
            }

            tactician.AllFeatures = library
                .Get<BlueprintFeatureSelection>("d87e2f6a9278ac04caeb0f93eff95fcb")
                .AllFeatures;

            var comp = library
                .Get<BlueprintFeature>("4ca47c023f1c158428bd55deb44c735f")
                .GetComponent<AutoMetamagic>()
                .CreateCopy(a => a.Abilities = new BlueprintAbility[] { ability }.ToList());
            greater_tactician = Helpers.CreateFeatureSelection(
                "DrillSergeantGreaterTacticianFeatureSelection",
                "Greater Tactician",
            ...
            master_tactician = Helpers.CreateFeatureSelection(
                "DrillSergeantMasterTacticianFeatureSelection",
                "Master Tactician",
        ...
        static void createWeaponTrainer()
        {
            ...
            weapon_trainer = Helpers.CreateFeature(
                "WeaponTrainerFeature",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
                FeatureGroup.None,
                Common.createAuraEffectFeatureComponentCustom(
                    buff,
                    30.Feet(),
