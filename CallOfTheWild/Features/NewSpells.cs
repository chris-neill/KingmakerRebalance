...
namespace CallOfTheWild
{
    ...
    {
        public static BlueprintFeature immunity_to_wind;
        public static BlueprintBuff ranged_attacks_forbidden_buff;
        public static LibraryScriptableObject library => Main.library;
        public static BlueprintAbility shillelagh;
        public static BlueprintAbility flame_blade;
        public static BlueprintAbility flame_blade_electric;
        public static BlueprintAbility virtuoso_performance;
        public static BlueprintAbility deadly_juggernaut;
        public static BlueprintBuff deadly_juggernaut_buff;
        public static BlueprintAbility invisibility_purge;
        public static BlueprintAbility sanctuary;
        public static BlueprintBuff sanctuary_buff;

        public static BlueprintAbility command;
        public static BlueprintAbility command_greater;
        public static BlueprintAbility fire_shield;
        public static Dictionary<DamageEnergyType, BlueprintBuff> fire_shield_buffs =
            new Dictionary<DamageEnergyType, BlueprintBuff>();
        public static Dictionary<DamageEnergyType, BlueprintAbility> fire_shield_variants =
            new Dictionary<DamageEnergyType, BlueprintAbility>();

        public static BlueprintAbility strong_jaw;
        public static BlueprintAbility contingency;
        public static BlueprintAbility produce_flame;
        public static BlueprintAbility flurry_of_snowballs;
        public static BlueprintAbility ice_slick;
        public static BlueprintAbility vine_strike;
        public static BlueprintAbility sheet_lightning;
        public static BlueprintAbility poison_breath;

        public static BlueprintAbility countless_eyes;
        public static BlueprintAbility righteous_vigor;
        public static BlueprintAbility force_sword;
        public static BlueprintAbility blood_armor;
        public static BlueprintAbility flame_arrow;
        public static BlueprintAbility keen_edge;

        public static BlueprintAbility savage_maw;
        public static BlueprintAbility blood_mist;
        public static BlueprintAbility winter_grasp;

        public static BlueprintAbility frost_bite;
        public static BlueprintWeaponType touch_slam_cold;
        public static BlueprintAbility chill_touch;
        public static BlueprintWeaponType touch_slam_negative;

        public static BlueprintAbility earth_tremor;
        public static BlueprintAbility bone_fists;
        public static BlueprintAbility explosion_of_rot;

        public static BlueprintAbility aura_of_doom;
        public static BlueprintBuff aura_of_doom_effect_buff;
        public static BlueprintAbility archons_trumpet;

        public static BlueprintAbility burning_entanglement;
        public static BlueprintAbility bow_spirit;
        public static BlueprintAbility ray_of_exhaustion;

        public static BlueprintAbility obscuring_mist;
        public static BlueprintAbilityAreaEffect obscuring_mist_area;
        public static BlueprintAbility burst_of_radiance;

        public static BlueprintAbility river_of_wind;
        public static BlueprintAbility winds_of_vengeance;

        public static BlueprintAbility blistering_invective;
        public static BlueprintAbility flashfire;
        public static BlueprintAbility stricken_heart;
        public static BlueprintAbility rigor_mortis;

        public static BlueprintAbility ice_body;

        public static BlueprintAbility fire_seeds;

        public static BlueprintAbility suffocation,
            mass_suffocation;
        public static BlueprintBuff suffocation_buff;
        public static BlueprintBuff fast_suffocation_buff;
        public static BlueprintAbility fluid_form;

        public static BlueprintAbility hold_person_mass;
        public static BlueprintAbility irresistible_dance;
        public static BlueprintAbility particulate_form;
        public static BlueprintAbility curse_major;
        public static BlueprintAbility hold_monster_mass;

        public static BlueprintAbility freezing_sphere;

        public static BlueprintAbility howling_agony;
        public static BlueprintAbility spite;
        public static BlueprintAbility forceful_strike;

        public static BlueprintAbility ghoul_touch;
        public static BlueprintAbility fleshworm_infestation;
        public static BlueprintAbility rebuke;

        public static BlueprintAbility bladed_dash;
        public static BlueprintAbility bladed_dash_greater;
        public static BlueprintAbility dimension_door_free;
        public static BlueprintBuff bladed_dash_buff;

        public static BlueprintAbility fiery_runes;

        public static BlueprintAbility lend_judgement;
        public static BlueprintAbility lend_judgement_greater;
        public static BlueprintAbility flames_of_the_faithful;

        public static BlueprintAbility magic_weapon;
        public static BlueprintAbility magic_weapon_greater;

        public static BlueprintAbility dazzling_blade;
        public static BlueprintAbility dazzling_blade_mass;

        public static BlueprintAbility accursed_glare;
        public static BlueprintAbility solid_fog;
        public static BlueprintAbilityAreaEffect solid_fog_area;
        public static BlueprintAbility thirsting_entanglement;

        public static BlueprintAbility resinous_skin;
        public static BlueprintAbility delayed_consumption;

        public static BlueprintAbility long_arm;
        public static BlueprintAbility blade_lash;
        public static BlueprintAbility stunning_barrier_greater;
        public static BlueprintAbility tidal_surge;

        public static BlueprintAbility path_of_glory;
        public static BlueprintAbility path_of_glory_greater;

        public static BlueprintAbility meteor_swarm;

        public static BlueprintAbility fly;
        public static BlueprintAbility fly_mass;
        public static BlueprintBuff fly_buff;
        public static BlueprintAbility air_walk;
        public static BlueprintAbility air_walk_communal;
        public static BlueprintAbility overland_flight;
        public static BlueprintAbility wind_walk;

        public static BlueprintAbility hypnotic_pattern;

        public static BlueprintAbility wall_of_nausea;
        public static BlueprintAbility wall_of_blindness;
        public static BlueprintAbility wall_of_fire;
        public static BlueprintAbility wall_of_fire_fire_domain;
        public static BlueprintAbility incendiary_cloud;
        public static BlueprintAbility scouring_winds;
        public static BlueprintAbility aggressive_thundercloud;
        static BlueprintBuff thunder_cloud_fx_buff;
        public static BlueprintAbility aggressive_thundercloud_greater;

        public static BlueprintAbility threefold_aspect;
        public static BlueprintAbility sands_of_time;

        public static BlueprintAbility temporal_stasis;
        public static BlueprintAbility time_stop;

        public static BlueprintAbility sleet_storm;
        public static BlueprintAbility control_undead;
        public static BlueprintAbility halt_undead;

        public static BlueprintAbility touch_of_blood_letting;
        public static BlueprintAbility bloody_claws;

        public static BlueprintAbility[] mind_thrust = new BlueprintAbility[6];
        public static BlueprintAbility[] thought_shield = new BlueprintAbility[3];
        public static BlueprintAbility[] mental_barrier = new BlueprintAbility[5];
        public static BlueprintAbility intellect_fortress;

        public static BlueprintAbility consecrate;
        public static BlueprintAbilityAreaEffect consecrate_area;
        public static BlueprintAbility desecrate;
        public static BlueprintAbilityAreaEffect desecrate_area;
        public static BlueprintAbility animate_dead_lesser;
        public static BlueprintUnit animate_dead_skeleton;

        public static BlueprintAbility barrow_haze;
        public static BlueprintAbility screech;
        public static BlueprintAbility fickle_winds;

        public static BlueprintAbility fiery_shiriken;

        public static BlueprintAbility burst_of_adrenaline;
        public static BlueprintAbility burst_of_insight;
        public static BlueprintAbility synapse_overload;
        public static BlueprintAbility burst_of_force;

        public static BlueprintAbility[] psychic_crush = new BlueprintAbility[5];

        public static BlueprintAbility pain_strike,
            pain_strike_mass;
        public static BlueprintAbility inflict_pain,
            inflict_pain_mass;
        public static BlueprintAbility synesthesia,
            synesthesia_mass;
        public static BlueprintAbility iron_body;
        public static BlueprintAbility orb_of_the_void;
        public static BlueprintAbility psychic_surgery;
        public static BlueprintAbility akashic_form;
        public static BlueprintAbility divide_mind;
        public static BlueprintAbility telekinetic_storm;

        public static BlueprintBuff nauseted_non_poison;

        public static BlueprintAbility synaptic_pulse;
        public static BlueprintAbility synaptic_pulse_greater;
        public static BlueprintAbility babble;
        public static BlueprintAbility song_of_discord_greater;
        public static BlueprintAbility silence;
        public static BlueprintBuff silence_buff;

        public static BlueprintAbility shadow_enchantment;
        public static BlueprintAbility shadow_enchantment_greater;
        public static BlueprintAbility shadow_conjuration;
        public static BlueprintAbility shadow_conjuration_greater;
        public static BlueprintAbility shades;
        public static BlueprintAbility wrathful_weapon;
        public static BlueprintAbility blade_tutor;

        public static BlueprintAbility channel_vigor;
        public static BlueprintAbility control_construct;

        public static BlueprintAbility telekinetic_strikes;
        public static BlueprintAbility debilitating_portent;

        public static BlueprintAbility daze_mass;

        public static BlueprintAbility invigorate;
        public static BlueprintAbility invigorate_mass;
        public static BlueprintAbility cloak_of_winds;
        public static BlueprintAbility spirit_bound_blade;
        public static BlueprintAbility phantom_limbs;
        public static BlueprintAbility ghostbane_dirge;
        public static BlueprintAbility ghostbane_dirge_mass;
        public static BlueprintAbility arcane_concordance;

        public static BlueprintAbility shadow_claws;
        public static BlueprintAbility second_wind;
        public static BlueprintAbility wracking_ray;
        public static BlueprintAbility smite_abomination;

        public static BlueprintAbility corrosive_consumption;
        public static BlueprintAbility warding_weapon;
        public static BlueprintAbility globe_of_invulnerability;
        public static BlueprintAbility globe_of_invulnerability_lesser;
        public static BlueprintAbility locate_weakness;

        public static BlueprintAbility weapon_of_awe;
        public static BlueprintAbility allied_cloak;

        public static BlueprintAbility implosion;
        public static BlueprintAbility haunting_mists;
        public static BlueprintAbility eruptive_postules;
        public static BlueprintAbility scourge_of_horsemen;

        public static BlueprintAbility miracle;

        public static BlueprintAbility arcane_eye;
        public static BlueprintAbility emblem_of_greed;
        public static BlueprintAbility battlemind_link;
        public static BlueprintAbility litany_of_truth;

        public static BlueprintAbility ball_lightning;
        public static BlueprintBuff flaming_sphere_fx_buff;
        public static BlueprintAbility flaming_sphere;
        public static BlueprintAbility flaming_sphere_greater;

        public static BlueprintAbility condensed_ether;
        ...
        static void createCondensedEther()
        {
            ...
            var area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                "fe5102d734382b74586f56980086e5e8",
                "CondensedEtherArea",
                ""
            ); //mind fog
            ...
            var buff = Helpers.CreateBuff(
                ...
                icon,
                null,
                Helpers.Create<AddConcealment>(a =>
                {
                    a.Descriptor = ConcealmentDescriptor.Fog;
                    a.Concealment = Concealment.Partial;
                    a.CheckDistance = false;
                }),
                Helpers.Create<AddConcealment>(a =>
                {
                    a.CheckDistance = true;
                    a.DistanceGreater = 5.Feet();
                    a.Descriptor = ConcealmentDescriptor.Fog;
                ...
                Helpers.Create<NewMechanics.WeaponAttackAutoMiss>(w =>
                    w.attack_types = new AttackType[] { AttackType.Ranged }
                ),
                Helpers.Create<NewMechanics.OutgoingWeaponAttackAutoMiss>(w =>
                    w.attack_types = new AttackType[] { AttackType.Ranged }
                ),
            ...
            condensed_ether = library.CopyAndAdd<BlueprintAbility>(
                "68a9e6d7256f1354289a39003a46d826",
                "CondensedEthereAbility",
                ""
            );
            condensed_ether.SpellResistance = false;
            condensed_ether.ReplaceComponent<SpellComponent>(s =>
                s.School = SpellSchool.Transmutation
            );
            condensed_ether.RemoveComponents<SpellListComponent>();
            condensed_ether.RemoveComponents<SpellDescriptorComponent>();
            condensed_ether.ReplaceComponent<AbilityAoERadius>(a =>
                Helpers.SetField(a, "m_Radius", 20.Feet())
            );
            condensed_ether.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(
                    Common.changeAction<ContextActionSpawnAreaEffect>(
                        a.Actions.Actions,
                        s =>
                        {
                            s.AreaEffect = area;
                            s.DurationValue = Helpers.CreateContextDuration(
                                s.DurationValue.BonusValue,
            ...
            condensed_ether.AvailableMetamagic =
                Metamagic.Heighten | Metamagic.Quicken | Metamagic.Reach | Metamagic.Extend;
        ...
        static void createFlamingSphere()
        {
            ...
            flaming_sphere_fx_buff = library.CopyAndAdd<BlueprintBuff>(
                "18fa83a7b9990114792664df8dfc6b92",
                "FlamingSphereFxBuff",
                ""
            ); //fire theme base buff
            ...
            var dmg = Helpers.CreateActionDealDamage(
                DamageEnergyType.Fire,
                Helpers.CreateContextDiceValue(BalanceFixes.getDamageDie(DiceType.D6), 3)
            );

            flaming_sphere = createFlamingSphereLikeSpell(
                "FlamingSphere",
                "Flaming Sphere",
        ...
        static void createFlamingSphereGreater()
        {
            ...
            var dmg = Helpers.CreateActionDealDamage(
                DamageEnergyType.Fire,
                Helpers.CreateContextDiceValue(BalanceFixes.getDamageDie(DiceType.D6), 6)
            );

            var burning_buff = library.Get<BlueprintBuff>("e92ecaa76b5db674fa5b0aaff5b21bc9");
            var apply_burn = Common.createContextActionApplyBuff(
                burning_buff,
            ...
            flaming_sphere_greater = createFlamingSphereLikeSpell(
                "FlamingSphereGreater",
        ...
        static void createBallLightning()
        {
            ...
            var fx_buff = library.CopyAndAdd<BlueprintBuff>(
                "bedf9d0d6be45bb4eb197b83e2ad38ee",
                "BallLightningFxBuff",
                ""
            );
            fx_buff.ComponentsArray = new BlueprintComponent[0];
            fx_buff.SetBuffFlags(BuffFlags.HiddenInUi);
            ball_lightning = createFlamingSphereLikeSpell(
                "BallLightning",
                "Ball Lightning",
                ...
                Helpers.CreateConditionsCheckerOr(
                    Helpers.Create<NewMechanics.ContextConditionTargetHasMetalArmor>()
                ),
                4
            );
        ...
        static void createLitanyOfTruth()
        {
            ...
            var apply_buff = Helpers.CreateConditionalSaved(
                null,
                Common.createContextActionApplyBuff(buff, Helpers.CreateContextDuration(1))
            );
            litany_of_truth = Helpers.CreateAbility(
                "LitanyOfTruthAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
                ...
                Helpers.CreateSpellDescriptor(
                    (SpellDescriptor)
                        AdditionalSpellDescriptors.ExtraSpellDescriptor.LanguageDependent
                ),
            ...
            litany_of_truth.AvailableMetamagic =
                Metamagic.Heighten
                | Metamagic.Reach
                | (Metamagic)MetamagicFeats.MetamagicExtender.Persistent
                | (Metamagic)MetamagicFeats.MetamagicExtender.Piercing;
        }
        ...
        static void createBattlemindLink()
        {
            ...
            var description =
                "You fuse your thoughts with an ally’s, allowing the two of you to fight in tandem, perfectly coordinated. You and the ally each receive a +2 bonus on your initiative rolls. This has three effects.\n"
            ...
            {
                melee_buffs[i] = Helpers.CreateBuff(
                    prefixes[i] + "BattlemindLinkMeleeAttackTargetBuff",
                ...
                ranged_buffs[i] = Helpers.CreateBuff(
                    prefixes[i] + "BattlemindLinkRangedAttackTargetBuff",
                ...
                spell_buffs[i] = Helpers.CreateBuff(
                    prefixes[i] + "BattlemindLinkSpellTargetBuff",
            ...
            for (int i = 0; i < prefixes.Length; i++)
            {
                var apply_melee = Helpers.CreateConditional(
                ...
                var apply_ranged = Helpers.CreateConditional(
                    Helpers.Create<ContextConditionIsEnemy>(),
                    Common.createContextActionApplyBuff(
                        ranged_buffs[i],
                        Helpers.CreateContextDuration(1),
                ...
                var apply_spell = Helpers.CreateConditional(
                    Helpers.Create<ContextConditionIsEnemy>(),
                    Common.createContextActionApplyBuff(
                        spell_buffs[i],
                        Helpers.CreateContextDuration(1),
                ...
                base_buffs[i] = Helpers.CreateBuff(
                    prefixes[i] + "BattlemindLinkBuff",
                    ...
                    Helpers.Create<NewMechanics.AttackBonusAgainstFactsOwner>(a =>
                    {
                        ...
                        a.CheckedFacts = new Kingmaker.Blueprints.Facts.BlueprintUnitFact[]
                        {
                            melee_buffs[1 - i],
                        };
                        a.Bonus = 2;
            ...
            var caster_actions = actions.AddToArray(
                Common.createContextActionApplyBuff(
                    base_buffs[0],
                    Helpers.CreateContextDuration(
            ...
            var target_actions = actions.AddToArray(
                Common.createContextActionApplyBuff(
                    base_buffs[1],
                    Helpers.CreateContextDuration(
                        Helpers.CreateContextValue(AbilityRankType.Default),
            ...
            battlemind_link = Helpers.CreateAbility(
                "BattlemindlinkAbility",
                "Battlemind Link",
                description,
                "",
                icon,
                ...
                Helpers.CreateRunActions(
                    new GameAction[]
                    {
                        Common.createContextActionOnContextCaster(caster_actions),
                    }.AddToArray(target_actions)
                ),
                Helpers.CreateSpellComponent(SpellSchool.Divination),
                Helpers.CreateContextRankConfig(),
                Common.createAbilitySpawnFx(
            ...
            battlemind_link.AvailableMetamagic =
                Metamagic.Heighten | Metamagic.Quicken | Metamagic.Extend | Metamagic.Reach;
        }
        ...
        static void createEmblemOfGreed()
        {
            ...
            var weapon = library.CopyAndAdd<BlueprintItemWeapon>(
                "f83415c0e7ea1994d8a7f3dec8f5a861",
                "EmblemOfGreedWeaponWeapon",
                ""
            ); //glaive
            Helpers.SetField(
                weapon,
                "m_DisplayNameText",
                Helpers.CreateString("EmblemOfGreedName", "Emblem of Greed")
            );
            ...
            var buff = Helpers.CreateBuff(
                ...
                {
                    r.weapon = weapon;
                    r.target_value = Helpers.CreateContextValue(
                        AbilityRankType.DamageDiceAlternative
                    );
                }),
                Helpers.Create<NewMechanics.EnchantmentMechanics.CreateWeapon>(c =>
                    c.weapon = weapon
                ),
                Common.createBuffContextEnchantPrimaryHandWeapon(
                    Helpers.CreateContextValue(AbilityRankType.DamageBonus),
                    false,
                    false,
                    new BlueprintWeaponType[] { },
                    plus_enchants
                ),
                Common.createBuffContextEnchantPrimaryHandWeapon(
                    1,
                    ...
                    false,
                    new BlueprintWeaponType[] { },
                    new BlueprintWeaponEnchantment[] { extra_enchants[0] }
                ),
                Common.createBuffContextEnchantPrimaryHandWeapon(
                    ...
                    false,
                    new BlueprintWeaponType[] { },
                    new BlueprintWeaponEnchantment[] { null, extra_enchants[2] }
                ),
                Common.createBuffContextEnchantPrimaryHandWeapon(
                    Helpers.CreateContextValue(AbilityRankType.DamageDice),
                    false,
                    false,
                    new BlueprintWeaponType[] { },
                    new BlueprintWeaponEnchantment[] { null, null, extra_enchants[1] }
                ),
                Helpers.CreateContextRankConfig(
            ...
            emblem_of_greed = library.CopyAndAdd<BlueprintAbility>(
                shillelagh.AssetGuid,
                "EmblemOfGreedAbility",
                ""
            );
            ...
            emblem_of_greed.ActionType = Kingmaker
                .UnitLogic
                .Commands
                .Base
                .UnitCommand
            ...
            emblem_of_greed.ReplaceComponent<NewMechanics.AbilitTargetMainWeaponCheck>(
                Helpers.Create<NewMechanics.AbilityTargetPrimaryHandFree>(a => a.for_2h_item = true)
            );

            var apply_buff = Common.createContextActionApplyBuff(
                buff,
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilityRankType.Default),
                    DurationRate.Minutes
            ...
            emblem_of_greed.ReplaceComponent<AbilityEffectRunAction>(
                Helpers.CreateRunActions(apply_buff)
            );
            emblem_of_greed.AvailableMetamagic =
                Metamagic.Heighten | Metamagic.Quicken | Metamagic.Extend;
        ...
        {
            var unit = library.CopyAndAdd<BlueprintUnit>(
                "827b90e60645fe641b29098ed1f70219",
                "ArcaneEyeUnit",
                ""
            );
            unit.ComponentsArray = new BlueprintComponent[]
            {
                unit.GetComponent<AddClassLevels>().CreateCopy(a => a.Levels = 1), //abberation levels
                // unit.GetComponent<Experience>().CreateCopy(a => a.CR = 1000) //to prevent identification
            };
            var buff = library.CopyAndAdd<BlueprintBuff>(
                "e6b35473a237a6045969253beb09777c",
                "ArcaneEyeBuff",
                "4741d7726ebf43d9a2d55130b5d173d3"
            );
            buff.AddComponent(
                Helpers.CreateAddStatBonus(
            ...
            buff.AddComponent(
                Helpers.CreateAddFactContextActions(
                    activated: Helpers.Create<ContextActionHideInPlainSight>(),
                    newRound: Helpers.Create<ContextActionHideInPlainSight>()
                )
            );
            buff.AddComponents(
                Common.createAddCondition(Kingmaker.UnitLogic.UnitCondition.CanNotAttack),
                Common.createAddCondition(Kingmaker.UnitLogic.UnitCondition.CantAct),
                Common.createAddCondition(
                    Kingmaker.UnitLogic.UnitCondition.ImmuneToAttackOfOpportunity
                ),
                Helpers.Create<AooMechanics.DoNotProvokeAoo>(),
                Helpers.Create<AooMechanics.DoesNotEngage>()
            );
            var invisibility_feature = Helpers.CreateFeature(
                "ArcaneEyeFeature",
                "Arcane Eye",
                "",
                "",
            ...
            unit.Faction = library.Get<BlueprintFaction>( /*"72f240260881111468db610b6c37c099"*/
                "1b08d9ed04518ec46a9b3e4e23cb5105"
            ); //player
            unit.Speed = 30.Feet();
            unit.AddFacts = new Kingmaker.Blueprints.Facts.BlueprintUnitFact[]
            {
                invisibility_feature,
                FixFlying.airborne,
            };
            unit.SetUnitName("Arcane Eye");
            unit.Alignment = Alignment.TrueNeutral;
            unit.Brain = library.Get<Kingmaker.Controllers.Brain.Blueprints.BlueprintBrain>(
                "cf986dd7ba9d4ec46ad8a3a0406d02ae"
            );
            unit.Strength = 10;
            unit.Dexterity = 10;
            ...
            unit.Wisdom = 10;
            unit.Charisma = 10;
            var dominate_buff = library.CopyAndAdd<BlueprintBuff>(
                "c0f4e1c24c9cd334ca988ed1bd9d201f",
                "DominateArcaneEyeBuff",
                ""
            );
            dominate_buff.RemoveComponents<AddFactContextActions>();
            dominate_buff.RemoveComponents<SpellDescriptorComponent>();
            dominate_buff.ReplaceComponent<ChangeFaction>(c =>
                Helpers.SetField(c, "m_AllowDirectControl", true)
            );
            ...
            var arcane_eye_pool = library.CopyAndAdd<BlueprintSummonPool>(
            ...
            var spawn_monster = Helpers.Create<ContextActionSpawnMonster>(c =>
            {
                ...
                c.AfterSpawn = Helpers.CreateActionList(
                    Common.createContextActionApplyBuff(
                        summon_buff,
                        Helpers.CreateContextDuration(),
                        is_permanent: true,
            ...
            arcane_eye = Helpers.CreateAbility(
                "ArcaneEyeAbility",
                "Arcane Eye",
            ...
            arcane_eye.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Heighten | Metamagic.Quicken;
            ...
            type.Description = Helpers.CreateString(
                "ArcaneEyeType.Description",
                arcane_eye.Description
            );
        ...
        static void createScourgeOfHorsemen()
        {
            ...
            {
                var action = Helpers.CreateConditionalSaved(
                    i == 0
                        ? null
                        : Helpers.CreateActionEnergyDrain(
                            Helpers.CreateContextDiceValue(DiceType.Zero, 0, (i + 1) / 2),
                            Helpers.CreateContextDuration(1, DurationRate.Days),
                            Kingmaker.RuleSystem.Rules.EnergyDrainType.Temporary,
                            isAoE: true
                        ),
                    Helpers.CreateActionEnergyDrain(
                        Helpers.CreateContextDiceValue(DiceType.Zero, 0, i + 1),
                        Helpers.CreateContextDuration(1, DurationRate.Days),
                        Kingmaker.RuleSystem.Rules.EnergyDrainType.Temporary,
                        isAoE: true
                    )
            ...
            scourge_of_horsemen = Helpers.CreateAbility(
                "ScourgeOfHorsemenAbility",
                ...
                Helpers.CreateRunActions(
                    ...
                    dmg,
                    Common.createContextActionRandomize(energy_drains)
                ),
                ...
                Helpers.CreateContextRankConfig(
                    max: 20,
                    feature: MetamagicFeats.intensified_metamagic
                ),
                Helpers.CreateAbilityTargetsAround(
                    30.Feet(),
                    TargetType.Any,
                    spreadSpeed: 14.Feet()
                ),
                Common.createAbilitySpawnFxDestroyOnCast(
                    "c483c82262bbae74a8a89d8e9fc97d81",
            ...
            scourge_of_horsemen.AvailableMetamagic =
                ...
                | Metamagic.Heighten
                | (Metamagic)MetamagicFeats.MetamagicExtender.Persistent
                | (Metamagic)MetamagicFeats.MetamagicExtender.Dazing
                | (Metamagic)MetamagicFeats.MetamagicExtender.Rime
                | (Metamagic)MetamagicFeats.MetamagicExtender.Elemental
                | (Metamagic)MetamagicFeats.MetamagicExtender.Selective
                | (Metamagic)MetamagicFeats.MetamagicExtender.Piercing
                | (Metamagic)MetamagicFeats.MetamagicExtender.IntensifiedGeneral;
        ...
        static void createEruptivePostules()
        {
            ...
            var dmg = Helpers.CreateActionDealDamage(
                DamageEnergyType.Acid,
                Helpers.CreateContextDiceValue(DiceType.D6, 1, 0)
            );
            var apply_sickened = Common.createContextActionApplyBuff(
                sickened,
                Helpers.CreateContextDuration(),
                false,
                false,
            ...
            var apply_nauseted = Common.createContextActionApplyBuff(
                nauseted,
                Helpers.CreateContextDuration(),
                false,
                false,
            ...
            var on_hit = Helpers.CreateActionList(
                dmg,
                Helpers.CreateActionSavingThrow(
                    SavingThrowType.Fortitude,
                    Helpers.CreateConditionalSaved(null, apply_sickened)
                )
            );
            var on_crit = Helpers.CreateActionList(
                dmg,
                Helpers.CreateConditionalSaved(null, apply_nauseted)
            );

            var buff = Helpers.CreateBuff(
                "EruptivePostulesBuff",
                "Eruptive Postules",
                ...
                Common.createAddTargetAttackWithWeaponTrigger(
                    null,
                    on_hit,
            ...
            eruptive_postules = Helpers.CreateAbility(
                "EruptivePostulesAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
            ...
            eruptive_postules.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Extend
                | Metamagic.Maximize
                | Metamagic.Heighten
                ...
                | (Metamagic)MetamagicFeats.MetamagicExtender.Rime
                | (Metamagic)MetamagicFeats.MetamagicExtender.Elemental
                | (Metamagic)MetamagicFeats.MetamagicExtender.ImprovedSpellSharing;
        ...
        {
            var shaken_haunting_mist = library.CopyAndAdd<BlueprintBuff>(
                "25ec6cb6ab1845c48a95f9c20b034220",
                "ShakenHauntingMistsBuff",
                ""
            );
            var area = library.CopyAndAdd(obscuring_mist_area, "HauntingMistsArea", "");

            var effect = Helpers.CreateActionSavingThrow(
                ...
                Helpers.CreateConditionalSaved(
                    ...
                    new GameAction[]
                    {
                        Helpers.CreateActionDealDamage(
                            StatType.Wisdom,
                            Helpers.CreateContextDiceValue(DiceType.D2, 1, 0)
                        ),
                        Common.createContextActionApplyBuff(
                            shaken_haunting_mist,
                            Helpers.CreateContextDuration(),
                            is_permanent: true,
                            dispellable: false
                        ),
            ...
            area.AddComponent(
                Helpers.CreateAreaEffectRunAction(
                    unitEnter: effect,
                    unitExit: Common.createContextActionRemoveBuffFromCaster(shaken_haunting_mist)
                )
            );
            area.AddComponent(
                Helpers.CreateSpellDescriptor(
                    SpellDescriptor.MindAffecting | SpellDescriptor.Fear | SpellDescriptor.Shaken
                )
            );

            haunting_mists = library.CopyAndAdd<BlueprintAbility>(
                "68a9e6d7256f1354289a39003a46d826",
                "HauntingMistsAbility",
                ""
            );
            haunting_mists.SpellResistance = false;
            haunting_mists.RemoveComponents<SpellListComponent>();
            haunting_mists.ReplaceComponent<SpellDescriptorComponent>(s =>
                s.Descriptor = area.GetComponent<SpellDescriptorComponent>().Descriptor
            );
            haunting_mists.ReplaceComponent<AbilityAoERadius>(a =>
                Helpers.SetField(a, "m_Radius", 20.Feet())
            );
            haunting_mists.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(
                    Common.changeAction<ContextActionSpawnAreaEffect>(
                        a.Actions.Actions,
                        s =>
            ...
            haunting_mists.SetNameDescriptionIcon(
                "Haunting Mists",
            ...
            haunting_mists.AvailableMetamagic =
                Metamagic.Heighten
                | Metamagic.Quicken
                | Metamagic.Reach
                | Metamagic.Extend
            ...
            haunting_mists.LocalizedSavingThrow = Helpers.CreateString(
                "HauntingMists.SavingThrow",
                "Will partial"
            );
        ...
        static void createImplosion()
        {
            ...
            var cooldown_buff = Helpers.CreateBuff(
                "ImplosionCooldownBuff",
                "Implosion: Cooldown",
                "",
                "",
                null,
            ...
            var apply_cooldown = Common.createContextActionApplyBuff(
                cooldown_buff,
                Helpers.CreateContextDuration(),
                is_permanent: true,
                dispellable: false
            ...
            var watcher_buff = Helpers.CreateBuff(
                "ImplosionWatcherBuff",
                "",
                "",
                "",
                null,
            ...
            var pronlong_watcher_buff = Common.createContextActionApplyBuffToCaster(
                watcher_buff,
                Helpers.CreateContextDuration(),
                duration_seconds: 6,
                dispellable: false
            ...
            var dmg = Helpers.CreateActionDealDirectDamage(
                Helpers.CreateContextDiceValue(
                    DiceType.Zero,
                    0,
                    Helpers.CreateContextValue(AbilityRankType.DamageBonus)
            ...
            var implosion_ability = Helpers.CreateAbility(
                "ImplosionAbility",
                "Implosion",
                ...
                Helpers.CreateRunActions(
                    ...
                    Helpers.CreateActionSavingThrow(
                        SavingThrowType.Fortitude,
                        Helpers.CreateConditionalSaved(null, dmg)
                    )
                ),
                Helpers.CreateContextRankConfig(
                    ContextRankBaseValueType.CasterLevel,
                ...
                Common.createAbilityTargetHasFact(
                    inverted: true,
                    library.Get<BlueprintFeature>("dd3d0c7f4f57f304cbdbb68170b1b775")
                ), //subtype air
                Common.createAbilityDeliverProjectile(
                    AbilityProjectileType.Simple,
                    library.Get<BlueprintProjectile>("e093b08cd4cafe946962b339faf2310a"),
                    0.Feet(),
                    5.Feet()
                ),
                Common.createAbilityExecuteActionOnCast(
                    Helpers.CreateActionList(pronlong_watcher_buff)
                )
            );
            implosion_ability.AvailableMetamagic =
                Metamagic.Reach
                | (Metamagic)MetamagicFeats.MetamagicExtender.Dazing
                | (Metamagic)MetamagicFeats.MetamagicExtender.Piercing
                | (Metamagic)MetamagicFeats.MetamagicExtender.Persistent;
            ...
            var buff = Helpers.CreateBuff(
                ...
                null,
                Helpers.CreateAddFactContextActions(
                    activated: Common.createContextActionApplyBuffToCaster(
                        watcher_buff,
                        Helpers.CreateContextDuration(),
                        duration_seconds: 6,
                        dispellable: false,
                    ...
                    deactivated: Helpers.Create<BuffMechanics.RemoveStoredBuffs>(r =>
                        r.buff = cooldown_buff
                    )
                ),
                Helpers.Create<ReplaceAbilityParamsWithContext>(r => r.Ability = implosion_ability),
                Helpers.CreateAddFact(implosion_ability)
            );
            watcher_buff.AddComponent(
                Helpers.CreateAddFactContextActions(
                    deactivated: Common.createContextActionRemoveBuff(buff)
                )
            );

            implosion = Helpers.CreateAbility(
                "ImplosionSpellAbility",
                "Implosion",
                "This spell causes a destructive resonance in a corporeal creature’s body. Each round you concentrate (including the first), you can cause one creature to collapse in on itself, inflicting 10 points of damage per caster level. If you break concentration, the spell immediately ends, though any implosions that have already happened remain in effect. You can target a particular creature only once with each casting of the spell. Implosion has no effect on creatures in gaseous form or on incorporeal creatures.",
                "",
                icon,
                ...
                Helpers.fortNegates,
                Helpers.CreateRunActions(
                    Helpers.Create<ContextActionCastSpell>(c => c.Spell = implosion_ability)
                ),
                Helpers.CreateContextRankConfig(
                    ContextRankBaseValueType.CasterLevel,
                    type: AbilityRankType.DamageBonus
                ...
                Common.createAbilityExecuteActionOnCast(
                    Helpers.CreateActionList(
                        Common.createContextActionOnContextCaster(
                            Common.createContextActionRemoveBuff(watcher_buff),
            ...
            implosion.AvailableMetamagic =
                implosion_ability.AvailableMetamagic
                | Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Quicken
                | (Metamagic)MetamagicFeats.MetamagicExtender.RollSpellResistanceTwice;
            ...
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("269ff0bf4596f5248864bc2653a2f0e0"),
                implosion,
                9
            ); //instead of tsunami for destruction domain
        }

        static void createMiracle()
        {
            var blacklist_guids = Helpers.readStringsfromFile(
                UnityModManager.modsPath + @"/CallOfTheWild/WishBlackLists/miracle_black_list.txt",
                ' '
            );
            miracle = createWish(
                "Miracle",
        ...
        static void createAlliedCloak()
        {
            ...
            allied_cloak = Helpers.CreateAbility(
                "AlliedCloakAbility",
                buff.Name,
                buff.Description,
                "",
                ...
                "",
                Helpers.CreateRunActions(
                    Common.createContextActionApplySpellBuff(
                        buff,
                        Helpers.CreateContextDuration(
                            Helpers.CreateContextValue(AbilityRankType.Default)
                        )
                ...
                Common.createAbilitySpawnFx(
                    "c4d861e816edd6f4eab73c55a18fdadd",
                    anchor: AbilitySpawnFxAnchor.SelectedTarget
                )
            );
            allied_cloak.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Heighten | Metamagic.Quicken;
        ...
        static void createWeaponOfAwe()
        {
            ...
            var enchant = Common.createWeaponEnchantment(
                "WeaponOfAweEnchantment",
                "Weapon of Awe",
                ...
                5,
                null,
                Helpers.Create<NewMechanics.EnchantmentMechanics.WeaponDamageBonus>(c =>
                    c.damage = 2
                ),
                Common.createAddInitiatorAttackRollTrigger2(
                    Helpers.CreateActionList(
            ...
            var ability1 = library.CopyAndAdd<BlueprintAbility>(
                "831e942864e924846a30d2e0678e438b",
                "WeaponOfAwePrimaryHandAbility",
                ""
            );
            ...
            var action_old = (
                ability1.GetComponent<AbilityEffectRunAction>().Actions.Actions[0]
                as ContextActionEnchantWornItem
            );

            var action = Common.createItemEnchantmentAction(
                enchant.name + "PrimaryHandWeaponOfAweBuff",
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilityRankType.Default),
                    DurationRate.Minutes
                ),
            ...
            ability1.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(action)
            );
            ...
            var action2 = Common.createItemEnchantmentAction(
                enchant.name + "SecondaryHandWeaponOfAweBuff",
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilityRankType.Default),
                    DurationRate.Minutes
                ),
            ...
            ability2.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(action2)
            );
            ability2.AddComponent(
                Helpers.Create<NewMechanics.AbilitTargetManufacturedWeapon>(a =>
                {
                    a.off_hand = true;
                    a.works_on_summoned = true;
                })
            );
            ability1.AddComponent(
                Helpers.Create<NewMechanics.AbilitTargetManufacturedWeapon>(a =>
                    a.works_on_summoned = true
                )
            );

            weapon_of_awe = Common.createVariantWrapper(
                "WeaponOfAweAbility",
                "",
                ability1,
                ability2
        ...
        static void createLocateWeakness()
        {
            ...
            locate_weakness = Helpers.CreateAbility(
                "LocateWeaknessAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
            ...
            locate_weakness.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Quicken | Metamagic.Heighten;
        ...
        {
            var buff_lesser = Helpers.CreateBuff(
                "GlobeOfInvulnerabilityLesserBuff",
                ...
                null,
                Helpers.Create<InvulnerabilityMechanics.ImmunityUpToSpellLevel>(i =>
                    i.max_spell_level = 3
                )
            );
            var buff = Helpers.CreateBuff(
                "GlobeOfInvulnerabilityBuff",
            ...
            {
                var area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                    "7ced0efa297bd5142ab749f6e33b112b",
                    buffs[i].name + "Area",
                    ""
                );
                ...
                abilities[i] = Helpers.CreateAbility(
                    buffs[i].name + "Ability",
                    buffs[i].Name,
                    buffs[i].Description,
                    "",
                    buffs[i].Icon,
                    ...
                    "",
                    Helpers.CreateRunActions(
                        Common.createContextActionSpawnAreaEffect(
                            area,
                            Helpers.CreateContextDuration(
                                Helpers.CreateContextValue(AbilityRankType.Default)
                            )
                ...
                abilities[i].AvailableMetamagic =
                    Metamagic.Extend | Metamagic.Quicken | Metamagic.Heighten;
            }
        ...
        static void createWardingWeapon()
        {
            ...
            warding_weapon = Helpers.CreateAbility(
                "WardingWeaponAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
            ...
            warding_weapon.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Quicken | Metamagic.Heighten;
        ...
        static void createCorrosiveConsumption()
        {
            ...
            var dmg1 = Helpers.CreateActionDealDamage(
                DamageEnergyType.Acid,
                Helpers.CreateContextDiceValue(
                    DiceType.Zero,
                    0,
            ...
            var dmg2 = Helpers.CreateActionDealDamage(
                DamageEnergyType.Acid,
                Helpers.CreateContextDiceValue(
                    BalanceFixes.getDamageDie(DiceType.D4),
                    Helpers.CreateContextValue(AbilityRankType.Default),
                    0
                )
            );
            var dmg3 = Helpers.CreateActionDealDamage(
                DamageEnergyType.Acid,
                Helpers.CreateContextDiceValue(
                    BalanceFixes.getDamageDie(DiceType.D6),
                    Helpers.CreateContextValue(AbilityRankType.Default),
            ...
            var buff = Helpers.CreateBuff(
                ...
                Helpers.CreateAddFactContextActions(
                    ...
                    newRound: Helpers.CreateConditional(
                        Common.createBuffConditionCheckRoundNumber(2),
                        dmg2,
                        Helpers.CreateConditional(
                            Common.createBuffConditionCheckRoundNumber(3),
                            dmg3
                        )
                    )
                ),
            ...
            var ability = Helpers.CreateAbility(
                ...
                Common.createAbilitySpawnFx(
                    "524f5d0fecac019469b9e58ce1b8402d",
                    anchor: AbilitySpawnFxAnchor.SelectedTarget
                )
            );
        ...
        {
            smite_abomination = library.CopyAndAdd<BlueprintAbility>(
                "7bb9eb2042e67bf489ccd1374423cdec",
                "SmiteAbominationAbility",
                ""
            );

            smite_abomination.SetName("Smite Abomination");
            smite_abomination.SetDescription(
            ...
            smite_abomination.LocalizedDuration = Helpers.CreateString(
                "SmiteAbomination.Duration",
                Helpers.roundsPerLevelDuration
            );
            ...
            var wis_cha_property = NewMechanics.HighestStatPropertyGetter.createProperty(
                "SmiteAbominationWisChaUnitProperty",
                "",
                StatType.Wisdom,
                StatType.Charisma
            );
            smite_abomination.AddComponent(
                Helpers.CreateContextRankConfig(
                    ContextRankBaseValueType.CustomProperty,
                    type: AbilityRankType.StatBonus,
                    customProperty: wis_cha_property
                )
            );
            smite_abomination.AddComponent(
                Helpers.CreateContextRankConfig(type: AbilityRankType.DamageBonus, max: 20)
            );
            smite_abomination.AddComponent(Helpers.CreateSpellComponent(SpellSchool.Evocation));

            var smite_action =
                smite_abomination.GetComponent<Kingmaker.UnitLogic.Abilities.Components.AbilityEffectRunAction>();

            var old_conditional =
                (Kingmaker.Designers.EventConditionActionSystem.Actions.Conditional)
                    smite_action.Actions.Actions[0];
            var conditions = new Condition[]
            {
                Common.createContextConditionHasFact(Common.undead),
                old_conditional.ConditionsChecker.Conditions[1],
            };

            var smite_buff = ((ContextActionApplyBuff)old_conditional.IfTrue.Actions[0]).Buff;
            var apply_smite_buff = Common.createContextActionApplyBuff(
                smite_buff,
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilityRankType.DamageBonus)
                ),
            ...
            var new_smite_action = Helpers.CreateConditional(
                conditions,
                new GameAction[] { apply_smite_buff },
                null
            );
            smite_abomination.ReplaceComponent(
                smite_action,
                Helpers.CreateRunActions(new_smite_action)
            );
            ...
            smite_abomination.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Heighten | Metamagic.Quicken | Metamagic.Reach;
        }

        static void createWrackingRay()
        {
            wracking_ray = library.CopyAndAdd<BlueprintAbility>(
                "450af0402422b0b4980d9c2175869612",
                "WrackingRayAbility",
                ""
            ); //ray of enfeeblement
            ...
            wracking_ray.LocalizedSavingThrow = Helpers.CreateString(
                "WrackingRay.Savingthrow",
                "Fortitude half"
            );
            wracking_ray.SetNameDescription(
                "Wracking Ray",
            ...
            wracking_ray.AvailableMetamagic =
                wracking_ray.AvailableMetamagic
                | (Metamagic)MetamagicFeats.MetamagicExtender.Persistent
                | (Metamagic)MetamagicFeats.MetamagicExtender.Piercing
                | (Metamagic)MetamagicFeats.MetamagicExtender.IntensifiedGeneral;
            ...
            var dice = Helpers.CreateContextDiceValue(
                DiceType.Zero,
                0,
                Helpers.CreateContextValue(AbilitySharedValue.Damage)
            );
            var str_damage = Helpers.CreateActionDealDamage(
                StatType.Strength,
                dice,
                halfIfSaved: true
            );
            var dex_damage = Helpers.CreateActionDealDamage(
                StatType.Dexterity,
                dice,
                halfIfSaved: true
            );
            wracking_ray.AddComponents(
                Helpers.CreateRunActions(SavingThrowType.Fortitude, str_damage, dex_damage),
        ...
        {
            second_wind = Helpers.CreateAbility(
                "SecondWindAbility",
                "Second Wind",
                ...
                "",
                Helpers.CreateRunActions(
                    Common.createContextActionHealTarget(
                        Helpers.CreateContextDiceValue(
                            BalanceFixes.getDamageDie(DiceType.D8),
                            2,
                            Helpers.CreateContextValue(AbilityRankType.Default)
                        )
                    )
                ...
                Helpers.CreateSpellDescriptor(
                    SpellDescriptor.Cure
                        ...
                        | (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.Air
                )
            );
            second_wind.setMiscAbilityParametersSelfOnly();
            second_wind.AvailableMetamagic =
                Metamagic.Empower | Metamagic.Maximize | Metamagic.Heighten;
        ...
        static void createShadowClaws()
        {
            ...
            var effect = Helpers.CreateActionDealDamage(
                StatType.Strength,
                Helpers.CreateContextDiceValue(DiceType.Zero, 0, 1)
            );
            var saved_effect = Helpers.CreateActionSavingThrow(
                SavingThrowType.Fortitude,
            ...
            var buff = Helpers.CreateBuff(
                ...
                Common.createAddInitiatorAttackWithWeaponTriggerWithCategory(
                    Helpers.CreateActionList(saved_effect),
                    weapon_category: WeaponCategory.Claw
                ),
                Helpers.CreateSpellDescriptor(
                    (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.Shadow
                )
            );

            shadow_claws = Helpers.CreateAbility(
                "ShadowClawsAbility",
                buff.Name,
                buff.Description,
                "",
                ...
                Common.createAbilitySpawnFx(
                    "790eb82d267bf0749943fba92b7953c2",
                    anchor: AbilitySpawnFxAnchor.SelectedTarget
                )
            );
            shadow_claws.setMiscAbilityParametersSelfOnly();
            shadow_claws.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Quicken
                | (Metamagic)MetamagicFeats.MetamagicExtender.Persistent;
        ...
        static void createArcaneConcordance()
        {
            var buff = Helpers.CreateBuff(
                ...
                null,
                Helpers.Create<SpellManipulationMechanics.IncreaseSpellTypeDC>(i =>
                {
                    i.apply_to_arcane = true;
                    i.bonus = 1;
                }),
                Helpers.Create<NewMechanics.MetamagicMechanics.MetamagicOnSpellType>(m =>
                {
                    m.Metamagic = Metamagic.Extend;
                    m.apply_to_arcane = true;
                    m.amount = 0;
                })
            );

            var aura_buff = Common.createBuffAreaEffect(
                buff,
                13.Feet(),
            ...
            aura_buff.GetComponent<AddAreaEffect>().AreaEffect.Fx = Common.createPrefabLink(
                "cda35ba5c34a61b499f5858eabcedec7"
            ); //abjuration aoe

            arcane_concordance = Helpers.CreateAbility(
            ...
            arcane_concordance.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Quicken | Metamagic.Heighten;
        ...
        static void createGhostbaneDirge()
        {
            ...
            var apply_buff = Helpers.CreateActionSavingThrow(
                SavingThrowType.Will,
                Helpers.CreateConditionalSaved(
                    null,
                    Common.createContextActionApplyBuff(
            ...
            ghostbane_dirge = Helpers.CreateAbility(
                "GhostbaneDirgeAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
            ...
            ghostbane_dirge.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Quicken
                | Metamagic.Reach
            ...
            ghostbane_dirge_mass = Helpers.CreateAbility(
                "GhostbaneDirgeMassAbility",
                "Ghostbane Dirge, Mass",
                "This spell functions as ghostbane dirge, except that it affects multiple targets.\n"
                    + ghostbane_dirge.Name
                    + ": "
                    + ghostbane_dirge.Description,
                "",
                buff.Icon,
                AbilityType.Spell,
                UnitCommand.CommandType.Standard,
                ...
                Helpers.CreateRunActions(
                    Helpers.CreateConditional(
                        Common.createContextConditionHasFact(Common.incorporeal),
                        apply_buff
                    )
                ),
                Helpers.CreateContextRankConfig(),
            ...
            ghostbane_dirge_mass.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Quicken
                | Metamagic.Reach
        ...
        static void createPhantomLimbs()
        {
            ...
            phantom_limbs = Helpers.CreateAbility(
                "PhantomLimbsAbility",
                buff.Name,
                buff.Description,
                "",
            ...
            phantom_limbs.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Heighten | Metamagic.Quicken | Metamagic.Reach;
        ...
        static void createSpiritBoundBlade()
        {
            ...
            var ghost_touch = library.Get<BlueprintWeaponEnchantment>(
            ...
            var spell_description =
                "You focus emotional energy and weave it into a shroud of hardened ectoplasm around the weapon you touch, infusing it with a ghostly glow and great power. The weapon becomes a ghost touch weapon, and gains one of the following additional enchantments: vicious, keen, cruel, menacing or heartseeker.";

            for (int i = 0; i < enchants.Length; i++)
            {
                var ability1 = library.CopyAndAdd<BlueprintAbility>(
                    "831e942864e924846a30d2e0678e438b",
                    enchants[i].name + "SpiritBoundBladeAbility",
                    ""
                );
                ...
                var action = Common.createItemEnchantmentsAction(
                    enchants[i].name + "PrimaryHandSpiritBoundBladeBuff",
                ...
                var ability2 = library.CopyAndAdd(
                    ability1,
                    enchants[i].name + "SpiritBoundBladeSecondaryHandAbility",
                    ""
                );
                ability2.SetName(spell_name + ": " + enchants[i].Name + " (Off-Hand)");
                var action2 = Common.createItemEnchantmentsAction(
                    enchants[i].name + "SecondaryHandSpiritBoundBladeBuff",
                    action_old.DurationValue,
                    new BlueprintWeaponEnchantment[] { enchants[i], ghost_touch },
                    true,
                    off_hand: true
            ...
            {
                a.ReplaceComponent<AbilityEffectRunAction>(ab =>
                    ab.Actions.Actions = new GameAction[]
                    {
                        Helpers.Create<NewMechanics.ContextActionRemoveBuffs>(c =>
                            c.Buffs = buffs_off_hand.ToArray()
                        ),
                    }.AddToArray(ab.Actions.Actions)
                );
            }
            foreach (var a in abilities_primary_hand)
            {
                a.ReplaceComponent<AbilityEffectRunAction>(ab =>
                    ...
                    {
                        Helpers.Create<NewMechanics.ContextActionRemoveBuffs>(c =>
                            c.Buffs = buffs_primary_hand.ToArray()
                        ),
                    }.AddToArray(ab.Actions.Actions)
                );
            }

            spirit_bound_blade = Common.createVariantWrapper(
                "SpiritBoundBladeAbility",
                "",
                abilities.ToArray()
            );
            spirit_bound_blade.SetNameDescriptionIcon(
                spell_name,
                spell_description,
                enchant_icons[0]
            );
        ...
        static void createCloakOfWinds()
        {
            ...
            cloak_of_winds = Helpers.CreateAbility(
                "CloakOfWindsAbility",
                "Cloak of Winds",
                ...
                Helpers.CreateContextRankConfig(),
                Common.createAbilitySpawnFx(
                    "c30bef03751b7e844bc22646fb6927c4",
                    anchor: AbilitySpawnFxAnchor.SelectedTarget
                ),
                Helpers.CreateSpellComponent(SpellSchool.Abjuration),
                Helpers.CreateSpellDescriptor(
            ...
            cloak_of_winds.AvailableMetamagic =
                Metamagic.Heighten | Metamagic.Quicken | Metamagic.Reach | Metamagic.Extend;
        ...
        static void createInvigorateAndInvigorateMass()
        {
            ...
            var buff = Helpers.CreateBuff(
                ...
                Helpers.Create<BuffMechanics.SuppressBuffsCorrect>(s =>
                {
                    s.Buffs = new BlueprintBuff[] { fatigued, exhaused };
                })
            );

            invigorate = Helpers.CreateAbility(
                "InvigorateAbility",
                "Invigorate",
            ...
            invigorate.AvailableMetamagic =
                Metamagic.Heighten | Metamagic.Quicken | Metamagic.Reach | Metamagic.Extend;

            invigorate_mass = Helpers.CreateAbility(
                "InvigorateMass Ability",
                "Invigorate, Mass",
                "This spell work as invigorate, except it affects multiple creatures.\n"
                    + invigorate.Name
                    + ": "
                    + invigorate.Description,
                "",
                Helpers.GetIcon("4ebaf39efb8ffb64baf92784808dc49c"), //destruciton judgment
                AbilityType.Spell,
                UnitCommand.CommandType.Standard,
            ...
            invigorate_mass.AvailableMetamagic =
                Metamagic.Heighten | Metamagic.Quicken | Metamagic.Extend;
        ...
        {
            var serpentine_arcana = library.Get<BlueprintFeature>(
                "02707231be1d3a74ba7e38a426c8df37"
            );
            ...
            var effect = Helpers.CreateConditional(
                Common.createContextConditionHasFacts(
                    false,
                    Common.aberration,
                    Common.construct,
                    Common.dragon,
                ...
                Helpers.CreateConditional(
                    new Condition[]
                    {
                        Common.createContextConditionHasFacts(
                            false,
                            Common.animal,
                            Common.monstrous_humanoid,
                            Common.magical_beast,
                            Common.vermin
                        ),
            ...
            daze_mass = Helpers.CreateAbility(
                "DazeMassAbility",
                "Daze, Mass",
        ...
        static void createDebilitatingPortent()
        {
            var buff = Helpers.CreateBuff(
                ...
                null,
                Helpers.CreateSpellDescriptor(
                    SpellDescriptor.MindAffecting | SpellDescriptor.Compulsion
                ),
                Helpers.Create<NewMechanics.SaveOrReduceDamage>(s =>
                {
                    s.save_type = SavingThrowType.Will;
                    s.use_caster_level_and_stat = true;
                })
            );

            debilitating_portent = Helpers.CreateAbility(
                "DebilitatingPortentAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
            ...
            debilitating_portent.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Quicken
                | Metamagic.Reach
        ...
        static void createTelekinticStrikes()
        {
            var dmg = Helpers.CreateActionDealDamage(
                ...
                Helpers.CreateContextDiceValue(DiceType.D4, 1)
            );
            dmg.DamageType.Type = DamageType.Force;
            var on_attack = Common.createAddInitiatorAttackWithWeaponTrigger(
                Helpers.CreateActionList(dmg),
                wait_for_attack_to_resolve: true
            );
            on_attack.AllNaturalAndUnarmed = true;
            var buff = Helpers.CreateBuff(
                "TelekinticStrikesBuff",
                "Telekinetic Strikes",
            ...
            telekinetic_strikes = Helpers.CreateAbility(
                "TelekineticStrikesAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
                ...
                Common.createAbilitySpawnFx(
                    "52d413df527f9fa4a8cf5391fd593edd",
                    anchor: AbilitySpawnFxAnchor.SelectedTarget
                ),
                Helpers.CreateSpellComponent(SpellSchool.Evocation),
                Helpers.CreateSpellDescriptor(SpellDescriptor.Force),
            ...
            telekinetic_strikes.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Empower
                | Metamagic.Maximize
                | Metamagic.Quicken
                | Metamagic.Heighten
                | Metamagic.Reach
                | (Metamagic)MetamagicFeats.MetamagicExtender.Toppling;
        ...
        {
            var dominate_person_buff = library.Get<BlueprintBuff>(
                "c0f4e1c24c9cd334ca988ed1bd9d201f"
            );
            var buff = Helpers.CreateBuff(
                "ControlConstructBuff",
                "",
                "",
                "",
                null,
                ...
                Helpers.CreateAddFactContextActions(
                    newRound: Helpers.Create<SkillMechanics.ContextActionCasterSkillCheck>(c =>
                    {
            ...
            control_construct = Helpers.CreateAbility(
                "ControlConstructAbility",
                "Control Construct",
            ...
            control_construct.AvailableMetamagic =
                Metamagic.Heighten | Metamagic.Extend | Metamagic.Quicken | Metamagic.Reach;
        ...
        static void createChannelVigor()
        {
            ...
            var mind_buff = Helpers.CreateBuff(
                "ChannelVigorMindBuff",
                "",
                "",
                "",
                null,
                ...
                Common.createAttackTypeAttackBonus(
                    4,
                    AttackTypeAttackBonus.WeaponRangeType.Ranged,
                    ModifierDescriptor.Competence
                )
            );
            var spirit_buff = Helpers.CreateBuff(
                "ChannelVigorSpiritBuff",
                "",
                "",
                "",
                null,
            ...
            var torso_buff = Helpers.CreateBuff(
                "ChannelVigorTorsoBuff",
                "",
                "",
                "",
                null,
            ...
            foreach (var kv in name_buff_map)
            {
                var ability = Helpers.CreateAbility(
                    ...
                    Helpers.CreateRunActions(
                        Helpers.Create<NewMechanics.ContextActionRemoveBuffs>(c =>
                            c.Buffs = name_buff_map.Values.ToArray()
                        ),
                        Common.createContextActionApplyBuff(
                            kv.Value,
                            Helpers.CreateContextDuration(
                ...
                ability.AvailableMetamagic =
                    Metamagic.Quicken | Metamagic.Heighten | Metamagic.Extend;
                ability.setMiscAbilityParametersSelfOnly();
                abilities.Add(ability);
            }

            channel_vigor = Common.createVariantWrapper(
                "ChannelVigorBaseAbility",
                "",
                abilities.ToArray()
            );
        ...
        static void createBladeTutor()
        {
            var buff = Helpers.CreateBuff(
                ...
                null,
                Helpers.Create<BladeTutor.BladeTutor>(b =>
                    b.value = Helpers.CreateContextValue(AbilityRankType.StatBonus)
                ),
                Helpers.CreateContextRankConfig(
                    ContextRankBaseValueType.CasterLevel,
            ...
            blade_tutor = Helpers.CreateAbility(
                "BladeTutorAbility",
                buff.Name,
                buff.Description,
                "",
                ...
                Helpers.CreateSpellComponent(SpellSchool.Conjuration),
                Common.createAbilitySpawnFx(
                    "930c1a4aa129b8344a40c8c401d99a04",
                    anchor: AbilitySpawnFxAnchor.SelectedTarget,
                    position_anchor: AbilitySpawnFxAnchor.None,
                    orientation_anchor: AbilitySpawnFxAnchor.None
                )
            );
            blade_tutor.setMiscAbilityParametersSelfOnly(
                Kingmaker
                    .Visual
                    .Animation
                    .Kingmaker
            ...
            blade_tutor.AvailableMetamagic =
                Metamagic.Heighten | Metamagic.Extend | Metamagic.Quicken;
        ...
        static void fixPhantasmalSpells()
        {
            ...
            var phantasmal_putrefaction = library.Get<BlueprintAbility>(
                "1f2e6019ece86d64baa5effa15e81ecc"
            );
            var phantasmal_killer = library.Get<BlueprintAbility>(
                "6717dbaef00c0eb4897a1c908a75dfe5"
            );
        ...
        static void createWrathfulWeapon()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                var ability1 = library.CopyAndAdd<BlueprintAbility>(
                    "831e942864e924846a30d2e0678e438b",
                    enchants[i].name + "WrathfulWeaponAbility",
                    ""
                );
                ...
                var action = Common.createItemEnchantmentAction(
                    enchants[i].name + "PrimaryHandWrathfulWeaponBuff",
                    action_old.DurationValue,
                    enchants[i],
                    true,
                    off_hand: false
                ...
                var ability2 = library.CopyAndAdd(
                    ability1,
                    enchants[i].name + "WrathfulWeaponSecondaryHandAbility",
                    ""
                );
                ability2.SetName(spell_name + ": " + enchants[i].Name + " (Off-Hand)");
                var action2 = Common.createItemEnchantmentAction(
                    enchants[i].name + "SecondaryHandWrathfulWeaponBuff",
                    action_old.DurationValue,
                    enchants[i],
                    true,
                    off_hand: true
            ...
            wrathful_weapon = Common.createVariantWrapper(
                "WrathfulWeaponAbility",
                "",
                abilities.ToArray()
            );
        ...
        {
            shadow_enchantment = Helpers.CreateAbility(
                "ShadowEnchantment",
                "Shadow Enchantment",
            ...
            shadow_enchantment_greater = Helpers.CreateAbility(
        ...
        {
            shadow_conjuration = Helpers.CreateAbility(
                "ShadowConjuration",
                "Shadow Conjuration",
            ...
            shadow_conjuration_greater = Helpers.CreateAbility(
            ...
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("1e1b4128290b11a41ba55280ede90d7d"),
                shadow_conjuration,
                4
            ); //instead of enervation for darkness domain
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("1e1b4128290b11a41ba55280ede90d7d"),
                shades,
                9
            ); //instead of polar midnight for darkness domain
        }

        public static void addShadowSpells(
            BlueprintAbility base_ability,
            int reality,
            params BlueprintAbility[] spells
        )
        {
            base_ability.AddComponent(
                Helpers.CreateSpellDescriptor(
                    (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.Shadow
                )
            );

            var shadow_spell_component = Helpers.Create<ShadowSpells.ShadowSpell>(s =>
                s.spell_reality = reality
            );
            ...
            {
                var shadow_s = library.CopyAndAdd<BlueprintAbility>(
                    s,
                    base_ability.name + s.name,
                    Helpers.MergeIds(base_ability.AssetGuid, s.AssetGuid)
                );
                ...
                Common.addSpellDescriptor(
                    shadow_s,
                    (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.Shadow,
                    false
                );
                shadow_s.AddComponent(shadow_spell_component);
                shadow_s.SetNameDescription(
                    base_ability.Name + " (" + s.Name + ")",
                ...
                if (shadow_touch != null)
                {
                    ...
                    var shadow_sticky_touch = library.CopyAndAdd<BlueprintAbility>(
                        touch_s,
                        base_ability.name + touch_s.name,
                        Helpers.MergeIds(base_ability.AssetGuid, touch_s.AssetGuid)
                    );
                    shadow_sticky_touch.RemoveComponents<SpellListComponent>();
                    shadow_sticky_touch.RemoveComponents<SpellComponent>();
                    shadow_sticky_touch.AddComponent(
                        Helpers.CreateSpellComponent(SpellSchool.Illusion)
                    );
                    ...
                    shadow_s.ReplaceComponent<AbilityEffectStickyTouch>(a =>
                        a.TouchDeliveryAbility = shadow_sticky_touch
                    );
                }
                ability_variants.Variants = ability_variants.Variants.AddToArray(shadow_s);
                base_ability.AvailableMetamagic =
                    base_ability.AvailableMetamagic | shadow_s.AvailableMetamagic;
        ...
        static void addShadowSpells(
            BlueprintAbility base_ability,
            int reality,
            BlueprintSpellList[] spell_lists,
            int max_level,
            SpellSchool school,
            params BlueprintAbility[] except_spells
        )
        {
            ...
            foreach (var sl in spell_lists)
            {
                ...
                {
                    extracted_spells = extracted_spells.AddToArray(
                        sl.GetSpells(i).Where(a => a.School == school)
                    );
                }
            }
        ...
        public static void fixShadowSpells()
        {
            var shadow_evocation = library.Get<BlueprintAbility>(
                "237427308e48c3341b3d532b9d3a001f"
            );
            shadow_evocation.SetDescription(
            ...
            {
                shadow_evocation.Variants[i].ComponentsArray = base_spells[i]
                    .ComponentsArray.ToArray();
                ...
                if (shadow_evocation.Variants[i].GetComponent<SpellDescriptorComponent>() == null)
                {
                    shadow_evocation
                        ...
                        .AddComponent(
                            Helpers.CreateSpellDescriptor(
                                (SpellDescriptor)
                                    AdditionalSpellDescriptors.ExtraSpellDescriptor.Shadow
                            )
                        );
                }
                else
                {
                    shadow_evocation
                        .Variants[i]
                        .ReplaceComponent<SpellDescriptorComponent>(sd =>
                            sd.Descriptor =
                                sd.Descriptor
                                | (SpellDescriptor)
                                    AdditionalSpellDescriptors.ExtraSpellDescriptor.Shadow
                ...
                shadow_evocation
                    .Variants[i]
                    .AddComponent(
                        Helpers.Create<ShadowSpells.ShadowSpell>(s => s.spell_reality = 20)
                    );
            }
            ...
            addShadowSpells(
                shadow_evocation,
                20,
                new BlueprintSpellList[] { Helpers.wizardSpellList },
                4,
                SpellSchool.Evocation,
                base_spells.AddToArray(SpiritualWeapons.twilight_knife)
            );

            var shadow_evocation_greater = library.Get<BlueprintAbility>(
                "3c4a2d4181482e84d9cd752ef8edc3b6"
            );
            shadow_evocation_greater.SetDescription(
                "This spell functions like shadow evocation, except that it enables you to create a partially real, illusory version of any evocation spell of 7th level or lower. If recognized as a greater shadow evocation, a damaging spell deals only three-fifths (60%) damage.\nShadow Evocation: You tap energy from the Plane of Shadow to cast a quasi-real, illusory version of any evocation spell of 4th level or lower. Spells that deal damage have normal effects unless an affected creature succeeds at a Will save. Each disbelieving creature takes only one-fifth damage from the attack. Regardless of the result of the save to disbelieve, an affected creature is also allowed any save (or spell resistance) that the spell being simulated allows, but the save DC is set according to shadow evocation's level (5th) rather than the spell's normal level."
            );
            ...
            {
                shadow_evocation_greater.Variants[i].ComponentsArray = base_spells[i]
                    .ComponentsArray.ToArray();
                shadow_evocation_greater.Variants[i].RemoveComponents<SpellListComponent>();
                if (
                    shadow_evocation_greater.Variants[i].GetComponent<SpellDescriptorComponent>()
                    == null
                )
                {
            ...
            addShadowSpells(
                ...
                {
                    Helpers.wizardSpellList,
                    Psychic.psychic_class.Spellbook.SpellList,
                },
                2,
        ...
        {
            silence_buff = Helpers.CreateBuff(
                "SilenceBuff",
                "Silence",
                ...
                Common.createSpellImmunityToSpellDescriptor(
                ...
                Helpers.Create<BuffMechanics.SuppressBuffsCorrect>(s =>
                {
                    s.Descriptor = SpellDescriptor.Sonic;
                }),
                Helpers.Create<BuffMechanics.SuppressBuffsCorrect>(s =>
                    s.Buffs = new BlueprintBuff[]
                    {
                        library.Get<BlueprintBuff>("cbfd2f5279f5946439fe82570fd61df2"),
                    }
                ) //echolocation
            );
            silence_buff.Stacking = StackingType.Stack;
            var area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                "7f57a1fabe15a3e4f96d1e12f838a476",
                "SilenceAreaEffect",
                ""
            );
            area.Size = 20.Feet();
            ...
            {
                Helpers.CreateAreaEffectRunAction(
                    unitEnter: Helpers.CreateActionSavingThrow(
                        SavingThrowType.Will,
                        Helpers.CreateConditionalSaved(
                            null,
                            Common.createContextActionApplyBuff(
                    ...
                    unitExit: Helpers.CreateConditional(
                        Common.createContextConditionHasBuffFromCaster(silence_buff),
                        Common.createContextActionRemoveBuffFromCaster(silence_buff)
                    )
                ),
            };

            silence = Helpers.CreateAbility(
                "SilenceAbility",
                silence_buff.Name,
            ...
            var soothing_performance = library.Get<BlueprintAbility>(
                "9b7fa6cadc0349449829873c63cc5b0b"
            );
        ...
        {
            var buff = library.CopyAndAdd<BlueprintBuff>(
                "2e1646c2449c88a4188e58043455a43a",
                "SongOfDiscordGreaterBuff",
                ""
            );
            ...
            song_of_discord_greater = library.CopyAndAdd<BlueprintAbility>(
                "d38aaf487e29c3d43a3bffa4a4a55f8f",
                "SongOfDiscordGreaterAbility",
                ""
            );
            ...
            song_of_discord_greater.SetNameDescription(
            ...
            song_of_discord_greater.AddComponent(
                Helpers.CreateRunActions(
                    SavingThrowType.Will,
                    Helpers.CreateConditionalSaved(
                        Common.createContextActionApplyBuff(
        ...
        static void createBabble()
        {
            ...
            silence_buff.AddComponent(
                Helpers.Create<BuffMechanics.SuppressBuffsCorrect>(s =>
                    s.Buffs = new BlueprintBuff[] { fascinated }
                )
            );
            var immune_to_fascinate = library.Get<BlueprintBuff>(
                "a50373fa77d30d34c8c6efb198b36921"
            );

            var apply_fascinate_immune = Common.createContextActionApplyBuff(
                immune_to_fascinate,
                Helpers.CreateContextDuration(1, DurationRate.Days),
                dispellable: false
            );
            var apply_fascinate = Common.createContextActionApplyBuff(
                fascinated,
                Helpers.CreateContextDuration(),
                dispellable: false,
                is_permanent: true
            ...
            var fascinate_area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                "a4fc1c0798359974e99e1d790935501d",
                "BabbleFascinateArea",
                ""
            );
            ...
            {
                Helpers.CreateAreaEffectRunAction(
                    unitEnter: new GameAction[]
                    {
                        Helpers.CreateConditional(
                            Common.createContextConditionHasFact(immune_to_fascinate),
                            null,
                            Helpers.CreateActionSavingThrow(
                                SavingThrowType.Will,
                                Helpers.CreateConditionalSaved(
                                    apply_fascinate_immune,
                                    apply_fascinate
                                )
                            )
                        ),
                    },
                    unitExit: new GameAction[]
                    {
                        Common.createContextActionRemoveBuffFromCaster(fascinated),
            ...
            var buff = library.CopyAndAdd<BlueprintBuff>(
                "555930f121b364a4e82670b433028728",
                "BabbleBuff",
                ""
            );
            buff.ComponentsArray = new BlueprintComponent[]
            ...
            silence_buff.AddComponent(
                Helpers.Create<BuffMechanics.SuppressBuffsCorrect>(s =>
                    s.Buffs = new BlueprintBuff[] { buff }
                )
            );

            babble = Helpers.CreateAbility(
                "BabbleAbility",
                "Babble",
        ...
        static void createSynapticPulse()
        {
            ...
            var sickened = library.Get<BlueprintBuff>("4e42460798665fd4cb9173ffa7ada323");
            var stun1 = Helpers.CreateConditionalSaved(
                null,
                Common.createContextActionApplyBuff(
                    stunned,
                    Helpers.CreateContextDuration(1),
            ...
            var sickened1 = Common.createContextActionApplyBuff(
                sickened,
                Helpers.CreateContextDuration(1),
                is_from_spell: true
            );
            var stun1d4 = Helpers.CreateConditionalSaved(
                sickened1,
                Common.createContextActionApplyBuff(
                    stunned,
                    Helpers.CreateContextDuration(0, diceType: DiceType.D4, diceCount: 1),
                    is_from_spell: true
                )
            );
            synaptic_pulse = Helpers.CreateAbility(
                "SynapticPulseAbility",
                "Synaptic Pulse",
                ...
                Common.createAbilitySpawnFxDestroyOnCast(
                    "9012980c54f45ee428aa717c69446820",
            ...
            synaptic_pulse.AvailableMetamagic =
                Metamagic.Quicken
                | Metamagic.Extend
                | Metamagic.Heighten
                | (Metamagic)MetamagicFeats.MetamagicExtender.Persistent
            ...
            synaptic_pulse_greater = Helpers.CreateAbility(
                "SynapticPulseGreaterAbility",
        ...
        static void createAkashicForm()
        {
            ...
            var buff_resurrect = Helpers.CreateBuff(
                "AkashicFormHealBuff",
            ...
            buff.AddComponent(
                Common.createDeathActions(
                    Helpers.CreateActionList(
                        Common.createContextActionApplyBuff(
                            buff_resurrect,
                            Helpers.CreateContextDuration(0),
                            is_child: true,
                            dispellable: false
                        )
                    )
            ...
            akashic_form = Helpers.CreateAbility(
                "AkashicFormAbility",
                buff.Name,
                buff.Description,
                "",
                ...
                Helpers.CreateSpellComponent(SpellSchool.Necromancy),
                Common.createAbilitySpawnFx(
                    "e93261ee4c3ea474e923f6a645a3384f",
                    anchor: AbilitySpawnFxAnchor.ClickedTarget,
                    position_anchor: AbilitySpawnFxAnchor.None,
                    orientation_anchor: AbilitySpawnFxAnchor.None
                )
            );
            akashic_form.AvailableMetamagic =
                Metamagic.Heighten | Metamagic.Quicken | Metamagic.Extend;
        ...
        static void createTelekineticStorm()
        {
            ...
            var effect = Helpers.CreateConditionalSaved(
                null,
                new GameAction[]
                {
                    Common.createContextActionApplyBuff(
            ...
            telekinetic_storm = Helpers.CreateAbility(
                "TelekineticStorm",
                "Telekinetic Storm",
                ...
                Common.createAbilitySpawnFx(
                    "5c60b61bfa134fa47a4628f2ae880e05",
                    orientation_anchor: AbilitySpawnFxAnchor.None,
                    position_anchor: AbilitySpawnFxAnchor.None
                ),
                Helpers.Create<SharedSpells.CannotBeShared>(),
            ...
            telekinetic_storm.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Maximize
                | Metamagic.Quicken
                | Metamagic.Heighten
        ...
        static void createDivideMind()
        {
            var buff = Helpers.CreateBuff(
                ...
                Common.createPrefabLink("c388856d0e8855f429a83ccba67944ba"),
                Helpers.Create<NewMechanics.MetamagicMechanics.MetamagicUpToSpellLevel>(m =>
                {
                    m.max_level = 5;
                    m.Metamagic = Metamagic.Quicken;
                    m.except_fullround_action = true;
                }),
            ...
            divide_mind = Helpers.CreateAbility(
                "DivindMindAbility",
                buff.Name,
                buff.Description,
                "",
            ...
            divide_mind.AvailableMetamagic =
                Metamagic.Quicken | Metamagic.Extend | Metamagic.Heighten;
        ...
        static void createPsychicSurgery()
        {
            ...
            psychic_surgery = Helpers.CreateAbility(
                "PsychicSurgeryAbility",
                "Psychic Surgery",
                ...
                Helpers.CreateRunActions(
                    heal_stat_damage,
                    Common.createContextActionDispelMagic(
                        SpellDescriptor.MindAffecting,
                        new SpellSchool[0],
                ...
                Helpers.CreateSpellComponent(SpellSchool.Enchantment),
                Common.createAbilitySpawnFx(
                    "319f507857aeb58499713b105df2bf29",
                    anchor: AbilitySpawnFxAnchor.SelectedTarget,
                    position_anchor: AbilitySpawnFxAnchor.None,
                    orientation_anchor: AbilitySpawnFxAnchor.None
                )
            ...
            psychic_surgery.AvailableMetamagic =
                Metamagic.Quicken | Metamagic.Reach | Metamagic.Heighten;
            psychic_surgery.MaterialComponent = library
                .Get<BlueprintAbility>("c66e86905f7606c4eaa5c774f0357b2b")
                .MaterialComponent; //stoneskin
        ...
        static void createOrbOfTheVoid()
        {
            ...
            var caster_dmg_done = Helpers.CreateBuff(
                "OrbOfTheVoidCasterDamageDoneBuff",
            ...
            var orb_fx_buff = library.CopyAndAdd<BlueprintBuff>(
                "1eb1c1aab1b319c43b06b40c4800f16c",
                "OrbOfTheVoidFxBuff",
                ""
            );
            ...
            var dmg = Helpers.CreateActionEnergyDrain(
                Helpers.CreateContextDiceValue(DiceType.Zero, 0, 1),
                Helpers.CreateContextDuration(1, DurationRate.Days),
                Kingmaker.RuleSystem.Rules.EnergyDrainType.Temporary,
                IgnoreCritical: true
            );
            var undead_buff = library.CopyAndAdd<BlueprintBuff>(
                "b2c17e0e1f08d6549b47e7f7cfe4986d",
                "OrbOfTheVoidUndeadBuff",
                ""
            );
            undead_buff.ReplaceComponent<TemporaryHitPointsFromAbilityValue>(t =>
            {
                t.Value = Helpers.CreateContextValue(AbilitySharedValue.Damage);
                t.RemoveWhenHitPointsEnd = true;
            });
            undead_buff.AddComponent(
                Helpers.CreateCalculateSharedValue(
                    Helpers.CreateContextDiceValue(DiceType.D4, 10, 0),
                    AbilitySharedValue.Damage
                )
            );
            undead_buff.Stacking = StackingType.Replace;
            var effect = Helpers.CreateConditional(
                Helpers.Create<UndeadMechanics.ContextConditionHasNegativeEnergyAffinity>(),
                Common.createContextActionApplyBuff(
                    undead_buff,
                    Helpers.CreateContextDuration(1, DurationRate.Hours),
                    is_from_spell: true
                ),
                Helpers.CreateActionSavingThrow(
                    SavingThrowType.Fortitude,
            ...
            effect = Helpers.CreateConditional(
                Common.createContextConditionCasterHasFact(caster_dmg_done),
                new GameAction[0],
                new GameAction[]
                {
                    effect,
            ...
            var caster_buff = Helpers.CreateBuff(
                "OrbOfTheVoidCasterBuff",
                "Orb of the Void",
            ...
            caster_buff.AddComponent(
                Helpers.CreateAddFactContextActions(
                    deactivated: Helpers.Create<NewMechanics.RemoveUniqueArea>(a =>
                        a.feature = caster_buff
                    )
                )
            );
            area.AddComponent(Helpers.Create<UniqueAreaEffect>(u => u.Feature = caster_buff));

            var spawn_area = Common.createContextActionSpawnAreaEffect(
                area,
                Helpers.CreateContextDuration(100)
            );

            var move_ability = Helpers.CreateAbility(
                "OrbOfTheVoidMoveAbility",
                "Orb of the Void",
            ...
            caster_buff.AddComponent(
                Helpers.Create<ReplaceAbilityParamsWithContext>(r => r.Ability = move_ability)
            );

            var apply_caster_buff = Common.createContextActionApplyBuffToCaster(
                caster_buff,
                Helpers.CreateContextDuration(Helpers.CreateContextValue(AbilityRankType.Default))
            );

            orb_of_the_void = Helpers.CreateAbility(
                "OrbOfTheVoidAbility",
                caster_buff.Name,
            ...
            orb_of_the_void.MaterialComponent = library
                .Get<BlueprintAbility>("7c5d556b9a5883048bf030e20daebe31")
                .MaterialComponent.CloneObject(); //diamond dust
            orb_of_the_void.MaterialComponent.Count = 2;
            orb_of_the_void.setMiscAbilityParametersRangedDirectional();
            orb_of_the_void.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Quicken
                | Metamagic.Reach
        ...
        static void createIronBody()
        {
            ...
            var buff = Helpers.CreateBuff(
                ...
                Common.createBuffDescriptorImmunity(
                    SpellDescriptor.Electricity
            ...
            iron_body = Helpers.CreateAbility(
                "IronBodyAbility",
                buff.Name,
                buff.Description,
                "",
        ...
        static void createPainStrike()
        {
            ...
            var dot = Helpers.CreateBuff(
                ...
                null,
                Helpers.CreateAddFactContextActions(
                    activated: apply_sickened,
                    newRound: Helpers.CreateActionDealDirectDamage(
                        Helpers.CreateContextDiceValue(
                            BalanceFixes.getDamageDie(DiceType.D6),
                            1,
                            0
                ...
                Helpers.CreateSpellDescriptor(
                    (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.Pain
                )
            );

            var apply_dot = Common.createContextActionApplyBuff(
                dot,
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilityRankType.Default),
                    DurationRate.Rounds
            ...
            pain_strike = Helpers.CreateAbility(
                "PainStrikeAbility",
                "Pain Strike",
                $"Pain strike racks the targeted creature with agony, inflicting 1d{BalanceFixes.getDamageDieString(DiceType.D6)} points of damage per round for 1 round per level (maximum 10 rounds). Additionally, the affected creature is sickened for the spell’s duration.",
                "",
            ...
            pain_strike.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Empower
                | Metamagic.Maximize
                | Metamagic.Quicken
            ...
            pain_strike_mass.SetNameDescription(
                "Pain Strike, Mass",
                "This spell works like pain strike, except as noted above.\n"
                    + pain_strike.Name
                    + ": "
                    + pain_strike.Description
            );
            pain_strike_mass.AddComponent(
                Helpers.CreateAbilityTargetsAround(15.Feet(), TargetType.Enemy)
            );
        ...
        static void createInflictPain()
        {
            var buff = Helpers.CreateBuff(
                ...
                Helpers.Create<BuffAllSkillsBonus>(b =>
                {
                    b.Value = -4;
            ...
            var apply_buff1 = Common.createContextActionApplyBuff(
                buff,
                Helpers.CreateContextDuration(1, DurationRate.Rounds),
                is_from_spell: true
            );
            inflict_pain = Helpers.CreateAbility(
                "InflictPainAbility",
                buff.Name,
                buff.Description,
                "",
            ...
            inflict_pain.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Quicken
                | Metamagic.Reach
                | Metamagic.Heighten
            ...
            inflict_pain_mass.SetNameDescription(
                "Inflict Pain, Mass",
                "This spell functions like inflict pain except as noted above.\n"
                    + inflict_pain.Name
                    + ": "
                    + inflict_pain.Description
            );
            inflict_pain_mass.AddComponent(
                Helpers.CreateAbilityTargetsAround(15.Feet(), TargetType.Enemy)
            );
        ...
        static void createSynesthesia()
        {
            var buff = Helpers.CreateBuff(
                ...
                Common.createAddCondition(
                    Kingmaker.UnitLogic.UnitCondition.SpellCastingIsDifficult
                ),
                Common.createAddCondition(Kingmaker.UnitLogic.UnitCondition.Slowed),
            ...
            synesthesia = Helpers.CreateAbility(
                "SynestesiaAbility",
                buff.Name,
                buff.Description,
                "",
            ...
            synesthesia.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Quicken
                | Metamagic.Reach
                | Metamagic.Heighten
            ...
            synesthesia_mass.SetNameDescription(
                "Synesthesia, Mass",
        ...
        {
            var check_intelligent = Common.createAbilityTargetHasFact(
                true,
                Common.construct,
                Common.vermin
            );
            ...
            var spawn_fx = Common.createContextActionSpawnFx(
                Common.createPrefabLink("2a37573c2eb79f04a85d3832f1195962")
            );
            var dmg1 = Helpers.CreateActionDealDirectDamage(
                Helpers.CreateContextDiceValue(
                    BalanceFixes.getDamageDie(DiceType.D6),
                    3,
                    Helpers.CreateContextValue(AbilityRankType.Default)
            ...
            var effect1 = Helpers.CreateActionSavingThrow(
                SavingThrowType.Fortitude,
                Helpers.CreateConditionalSaved(
                    new GameAction[] { dmg1, apply_sickened },
                    new GameAction[] { Helpers.Create<ContextActionKillTarget>() }
                )
            );
            Common.addConditionalDCIncrease(
                effect1,
                Helpers.CreateConditionsCheckerOr(
                    Helpers.Create<NewMechanics.ContextConditionCompareTargetHPPercent>(c =>
                    {
                        c.Value = 50;
                        c.Not = true;
                    })
            ...
            psychic_crush[0] = Helpers.CreateAbility(
                "PsychicCrush1Ability",
                "Psychic Crush I",
                ...
                Helpers.CreateRunActions(
                    SavingThrowType.Will,
                    Helpers.CreateConditionalSaved(
                        new GameAction[] { apply_sickened },
                        new GameAction[] { spawn_fx, effect1 }
                    )
                ),
                Helpers.CreateSpellComponent(SpellSchool.Necromancy),
                Helpers.CreateSpellDescriptor(SpellDescriptor.MindAffecting),
            ...
            psychic_crush[0].AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Maximize
                | Metamagic.Quicken
                | Metamagic.Reach
            ...
            var dmg2 = Helpers.CreateActionDealDirectDamage(
                Helpers.CreateContextDiceValue(
                    BalanceFixes.getDamageDie(DiceType.D6),
                    5,
                    Helpers.CreateContextValue(AbilityRankType.Default)
            ...
            var effect2 = Helpers.CreateActionSavingThrow(
                SavingThrowType.Fortitude,
                Helpers.CreateConditionalSaved(
                    new GameAction[] { dmg2, apply_sickened },
                    new GameAction[] { Helpers.Create<ContextActionKillTarget>() }
                )
            );
            Common.addConditionalDCIncrease(
            ...
            psychic_crush[1] = Helpers.CreateAbility(
                "PsychicCrush2Ability",
                "Psychic Crush II",
                $"This functions as psychic crush I, but on a successful Fortitude save, the target takes 5d{BalanceFixes.getDamageDieString(DiceType.D6)} points of damage + 1 point of damage per caster level. In addition, the target receives a +4 circumstance bonus on the Fortitude save only if it is at full hit points; otherwise, it gains a +2 bonus if it has more than half its total hit points remaining.\n"
                    + psychic_crush[0].Name
                    + ": "
                    + psychic_crush[0].Description,
                "",
                icon,
                AbilityType.Spell,
                UnitCommand.CommandType.Standard,
                ...
                Helpers.CreateRunActions(
                    ...
                    Helpers.CreateConditionalSaved(
                        new GameAction[] { apply_sickened },
                        new GameAction[] { spawn_fx, effect2 }
                    )
                ),
                Helpers.CreateSpellComponent(SpellSchool.Necromancy),
                Helpers.CreateSpellDescriptor(SpellDescriptor.MindAffecting),
            ...
            var dmg3 = Helpers.CreateActionDealDirectDamage(
                Helpers.CreateContextDiceValue(
                    BalanceFixes.getDamageDie(DiceType.D6),
                    7,
                    Helpers.CreateContextValue(AbilityRankType.Default)
            ...
            var effect3 = Helpers.CreateActionSavingThrow(
                SavingThrowType.Fortitude,
                Helpers.CreateConditionalSaved(
                    new GameAction[] { dmg3, apply_sickened },
                    new GameAction[] { Helpers.Create<ContextActionKillTarget>() }
                )
            );
            Common.addConditionalDCIncrease(
            ...
            psychic_crush[2] = Helpers.CreateAbility(
                "PsychicCrush3Ability",
                "Psychic Crush III",
                ...
                Helpers.CreateRunActions(
                    ...
                    Helpers.CreateConditionalSaved(
                        new GameAction[] { apply_sickened },
                        new GameAction[] { spawn_fx, effect3 }
                    )
                ),
                Helpers.CreateSpellComponent(SpellSchool.Necromancy),
                Helpers.CreateSpellDescriptor(SpellDescriptor.MindAffecting),
            ...
            var dmg4 = Helpers.CreateActionDealDirectDamage(
                Helpers.CreateContextDiceValue(
                    BalanceFixes.getDamageDie(DiceType.D6),
                    9,
                    Helpers.CreateContextValue(AbilityRankType.Default)
            ...
            var effect4_1 = Helpers.CreateActionSavingThrow(
                SavingThrowType.Fortitude,
                Helpers.CreateConditionalSaved(
                    new GameAction[] { dmg4, apply_sickened },
                    new GameAction[] { Helpers.Create<ContextActionKillTarget>() }
                )
            );
            var effect4 = Helpers.CreateConditional(
                Helpers.CreateConditionsCheckerOr(
                    Helpers.Create<NewMechanics.ContextConditionCompareTargetHPPercent>(c =>
                        c.Value = 50
                    )
            ...
            psychic_crush[3] = Helpers.CreateAbility(
                "PsychicCrush4Ability",
                "Psychic Crush IV",
                ...
                Helpers.CreateRunActions(
                    SavingThrowType.Will,
                    Helpers.CreateConditionalSaved(
                        new GameAction[] { apply_sickened, dmg4 },
                        new GameAction[] { spawn_fx, effect4 }
                    )
                ),
                Helpers.CreateSpellComponent(SpellSchool.Necromancy),
                Helpers.CreateSpellDescriptor(SpellDescriptor.MindAffecting),
            ...
            var dmg5 = Helpers.CreateActionDealDirectDamage(
                Helpers.CreateContextDiceValue(
                    BalanceFixes.getDamageDie(DiceType.D6),
                    11,
                    Helpers.CreateContextValue(AbilityRankType.Default)
            ...
            var effect5_1 = Helpers.CreateActionSavingThrow(
                SavingThrowType.Fortitude,
                Helpers.CreateConditionalSaved(
                    new GameAction[] { dmg5, apply_sickened },
                    new GameAction[] { Helpers.Create<ContextActionKillTarget>() }
                )
            );
            var effect5 = Helpers.CreateConditional(
                Helpers.CreateConditionsCheckerOr(
                    Helpers.Create<NewMechanics.ContextConditionCompareTargetHPPercent>(c =>
                        c.Value = 50
                    )
            ...
            var effect5_2 = Helpers.CreateActionSavingThrow(
                SavingThrowType.Will,
                Helpers.CreateConditionalSaved(
                    new GameAction[] { dmg5, apply_sickened },
            ...
            psychic_crush[4] = Helpers.CreateAbility(
                "PsychicCrush5Ability",
                "Psychic Crush V",
                $"This functions as psychic crush IV, but on a successful Fortitude or Will save, the target takes 11d{BalanceFixes.getDamageDieString(DiceType.D6)} points of damage + 1 point of damage per caster level. If it is at fewer than half its total hit points, the target takes a –2 penalty on the Will save to resist this spell.\n"
                    + psychic_crush[3].Name
                    + ": "
                    + psychic_crush[3].Description,
                "",
                icon,
                AbilityType.Spell,
                UnitCommand.CommandType.Standard,
            ...
            for (int i = 0; i < psychic_crush.Length; i++)
            {
                psychic_crush[i]
                    .AddComponent(
                        Helpers.Create<SpellbookMechanics.SpellUndercast>(s =>
                        {
        ...
        static void createBurstOfForce()
        {
            ...
            var effect = Helpers.CreateActionSavingThrow(
                ...
                Helpers.CreateConditionalSaved(null, Helpers.Create<ContextActionKnockdownTarget>())
            );

            burst_of_force = Helpers.CreateAbility(
                "BurstOfForceAbility",
                "Burst of Force",
                ...
                Helpers.CreateRunActions(
                    ...
                    Helpers.CreateConditional(
                        Common.createContextConditionIsCaster(),
                        new GameAction[0],
                        new GameAction[] { dmg, Helpers.CreateConditionalSaved(null, effect) }
                    )
                ),
                Helpers.CreateContextRankConfig(
                    max: 15,
                ...
                Common.createAbilitySpawnFxDestroyOnCast(
                    "859a6d74aedf5f349a470ab14afb47d3",
                    anchor: AbilitySpawnFxAnchor.SelectedTarget,
            ...
            burst_of_force.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Maximize
                | Metamagic.Quicken
                | Metamagic.Heighten
        ...
        static void createSynapseOverload()
        {
            ...
            var synapse_overload_touch = Helpers.CreateAbility(
                "SynapseOverloadAbility",
                "Synapse Overload",
            ...
            synapse_overload_touch.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Maximize
                | Metamagic.Quicken
                | Metamagic.Reach
        ...
        static void createBurstOfInsight()
        {
            ...
            var apply_after_buff = Common.createContextActionApplyBuff(
                after_buff,
                Helpers.CreateContextDuration(1),
                dispellable: false
            );
            ...
            string description =
                "You plumb the depths of your mind for insight, leaving you momentarily frazzled. For one round you gain a +8 enhancement bonus on Intelligence, Wisdom, or Charisma, but you are dazed for 1 round afterward.";
            var icon = Helpers.GetIcon("4cf3d0fae3239ec478f51e86f49161cb");
            foreach (var s in stats)
            {
                var buff = Helpers.CreateBuff(
                    s.ToString() + "BurstOfInsightBuff",
                ...
                var ability = Helpers.CreateAbility(
                    s.ToString() + "BurstOfInsightAbility",
                    buff.Name,
                    buff.Description,
                    "",
                    buff.Icon,
            ...
            burst_of_insight = Common.createVariantWrapper(
                "BurstOfInsightAbility",
                "",
                variants.ToArray()
            );
        ...
        static void createBurstOfAdrenaline()
        {
            ...
            var variants = new List<BlueprintAbility>();
            string description =
                "You draw upon your body’s inner reserves of strength, leaving you winded. For one round you gain a +8 enhancement bonus to Strength, Dexterity, or Constitution, but you are fatigued for 1 round afterward.";
            var icon = Helpers.GetIcon("3dccdf27a8209af478ac71cded18a271");
            foreach (var s in stats)
            {
                var buff = Helpers.CreateBuff(
                    s.ToString() + "BurstOfAdrenalineBuff",
                ...
                var ability = Helpers.CreateAbility(
                    s.ToString() + "BurstOfAdrenalineAbility",
                    buff.Name,
                    buff.Description,
                    "",
                    buff.Icon,
            ...
            burst_of_adrenaline = Common.createVariantWrapper(
                "BurstOfAdrenalineAbility",
                "",
                variants.ToArray()
            );
            burst_of_adrenaline.SetName("Burst of Adrenaline");
            burst_of_adrenaline.AddComponent(
                Helpers.CreateSpellComponent(SpellSchool.Transmutation)
            );
        ...
        static void createFireShuriken()
        {
            ...
            var one_projectile_spell_swift = library.CopyAndAdd(
                fire_bolt,
                "FieryShurikenSingleProjectileAbility",
                ""
            );
            one_projectile_spell_swift.SetNameDescription(
                "Fiery Shuriken (1 Projectile, Swift)",
                description
            );
            ...
            one_projectile_spell_swift.ReplaceComponent<AbilityResourceLogic>(a =>
            ...
            one_projectile_spell_swift.AddComponent(
                Helpers.CreateRunActions(
                    Helpers.CreateActionDealDamage(
                        DamageEnergyType.Fire,
                        Helpers.CreateContextDiceValue(BalanceFixes.getDamageDie(DiceType.D8), 1, 0)
                    )
                )
            );
            one_projectile_spell_swift.LocalizedDuration = Helpers.CreateString(
                "FireShurikenSingleProjectile.Duration",
                ""
            );
            one_projectile_spell_swift.AddComponent(
                Helpers.CreateSpellComponent(SpellSchool.Conjuration)
            );
            one_projectile_spell_swift.AvailableMetamagic =
                Metamagic.Reach
                | Metamagic.Empower
                | Metamagic.Maximize
                | (Metamagic)MetamagicFeats.MetamagicExtender.Elemental
            ...
            for (int i = 2; i <= 7; i++)
            {
                var ability = library.CopyAndAdd(
                    one_projectile_spell_swift,
                    $"FieryShuriken{i}ProjectilesAbility",
                    ""
                );
                ability.ActionType = UnitCommand.CommandType.Standard;
                ability.ReplaceComponent<AbilityResourceLogic>(a =>
                {
                    a.Amount = i;
                });
                ability.AddComponent(
                    Helpers.Create<NewMechanics.AbilityShowIfCasterHasResource>(a =>
                    {
                        a.resource = resource;
                        a.amount = i;
                    })
                );
                var projectile = one_projectile_spell_swift
                    .GetComponent<AbilityDeliverProjectile>()
                    .Projectiles[0];
                ability.ReplaceComponent<AbilityDeliverProjectile>(a =>
                {
                    a.Projectiles = Enumerable.Repeat(projectile, i).ToArray();
            ...
            var wrapper = Common.createVariantWrapper(
                "FireShurikenAbilityBase",
                "",
                abilities.ToArray()
            );
            ...
            var buff = Helpers.CreateBuff(
                ...
                Helpers.CreateAddFactContextActions(
                    newRound: Helpers.CreateConditional(
                        Helpers.Create<ResourceMechanics.ContextConditionTargetHasEnoughResource>(
            ...
            {
                buff.AddComponent(
                    Helpers.Create<ReplaceAbilityParamsWithContext>(r => r.Ability = a)
                );
            }
            buff.AddComponents(
                Helpers.Create<ShadowSpells.IgnoreShadowReality>(),
                Helpers.Create<ShadowSpells.ReplaceShadowContextForAbilities>(s =>
                    s.abilities = abilities.ToArray()
                )
            );
            ...
            var fiery_shuriken_one_projectile = library.CopyAndAdd(
                one_projectile_spell_swift,
                "FieryShurikenOneProjectileSpell",
                ""
            );
            ...
            fiery_shuriken_one_projectile.AvailableMetamagic =
                fiery_shuriken_one_projectile.AvailableMetamagic
                | Metamagic.Heighten
                | Metamagic.Extend
                | Metamagic.Quicken;
            ...
            var action_on_caster = Common.createContextActionOnContextCaster(
                apply_buff,
            ...
            fiery_shuriken_one_projectile.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(a.Actions.Actions.AddToArray(action_on_caster))
            );
            fiery_shuriken_one_projectile.AddComponents(
                Helpers.CreateContextRankConfig(
            ...
            fiery_shuriken_one_projectile.LocalizedDuration = Helpers.CreateString(
                fiery_shuriken_one_projectile.name + ".Duration",
                Helpers.roundsPerLevelDuration
            );
            var fiery_shuriken_all_projectiles = library.CopyAndAdd(
                one_projectile_spell_swift,
                "FieryShurikenAllProjectilesSpell",
                ""
            );
            ...
            fiery_shuriken_all_projectiles.AvailableMetamagic =
                fiery_shuriken_one_projectile.AvailableMetamagic
                | Metamagic.Heighten
                | Metamagic.Extend
                | Metamagic.Quicken
            ...
            fiery_shuriken_all_projectiles.AddComponent(
                Helpers.CreateContextRankConfig(
                    progression: ContextRankProgression.DelayedStartPlusDivStep,
                    startLevel: 1,
                    stepLevel: 2,
            ...
            fiery_shiriken = Common.createVariantWrapper(
                "FieryShurikenBaseSpell",
                "",
                fiery_shuriken_one_projectile,
                fiery_shuriken_all_projectiles
            );
        ...
        static void createFickleWinds()
        {
            ...
            var apply_buff = Common.createContextActionApplyBuff(
                ...
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilityRankType.Default),
                    Main.settings.balance_fixes ? DurationRate.Rounds : DurationRate.Minutes
                ),
                is_from_spell: true
            );
            fickle_winds = Helpers.CreateAbility(
                "FickleWindsAbility",
                buff.Name,
                buff.Description,
                "",
            ...
            fickle_winds.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Heighten | Metamagic.Quicken;
        ...
        static void createBarrowHaze()
        {
            ...
            var buff = Helpers.CreateBuff(
                ...
                icon,
                null,
                Helpers.Create<ConcealementMechanics.IgnoreCasterConcealemnt>(a =>
                {
                    a.CheckDistance = true;
                    a.DistanceGreater = 5.Feet();
                    a.Descriptor = ConcealmentDescriptor.Fog;
            ...
            barrow_haze = library.CopyAndAdd<BlueprintAbility>(
                "68a9e6d7256f1354289a39003a46d826",
                "BarrowHazeAbility",
                ""
            );
            ...
            barrow_haze.ReplaceComponent<AbilityAoERadius>(a =>
                Helpers.SetField(a, "m_Radius", 20.Feet())
            );
            barrow_haze.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(
                    Common.changeAction<ContextActionSpawnAreaEffect>(
                        a.Actions.Actions,
                        s =>
            ...
            barrow_haze.AvailableMetamagic =
                Metamagic.Heighten | Metamagic.Quicken | Metamagic.Reach | Metamagic.Extend;
        ...
        {
            var desecrate_buff = Helpers.CreateBuff(
                "DesecrateBuff",
                "Desecrate",
            ...
            var desecrate_undead_buff = Helpers.CreateBuff(
                "DesecrateUndeadBuff",
                desecrate_buff.Name,
            ...
            desecrate_area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                "c08bd33a377d5014a81be94e33ec8ce4",
                "DesecrateArea",
                ""
            );
            ...
            desecrate_area.ComponentsArray = new BlueprintComponent[]
            {
                Helpers.Create<AbilityAreaEffectBuff>(a =>
                {
                    a.Buff = desecrate_buff;
                    a.Condition = Helpers.CreateConditionsCheckerOr();
                }),
                Helpers.Create<AbilityAreaEffectBuff>(a =>
                {
                    a.Buff = desecrate_undead_buff;
                    a.Condition = Helpers.CreateConditionsCheckerOr(
                        Common.createContextConditionHasFact(Common.undead)
                    );
                }),
            ...
            desecrate = Helpers.CreateAbility(
                "DesecrateAbility",
                desecrate_buff.Name,
                desecrate_buff.Description,
                "",
        ...
        {
            var consecreate_buff = Helpers.CreateBuff(
                "ConsecrateBuff",
                "Consecrate",
            ...
            var consecreate_undead_buff = Helpers.CreateBuff(
                "ConsecrateUndeadBuff",
            ...
            consecrate_area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                "c08bd33a377d5014a81be94e33ec8ce4",
                "ConsecrateArea",
                ""
            );
            ...
            consecrate_area.ComponentsArray = new BlueprintComponent[]
            {
                Helpers.Create<AbilityAreaEffectBuff>(a =>
                {
                    a.Buff = consecreate_buff;
                    a.Condition = Helpers.CreateConditionsCheckerOr();
                }),
                Helpers.Create<AbilityAreaEffectBuff>(a =>
                {
                    a.Buff = consecreate_undead_buff;
                    a.Condition = Helpers.CreateConditionsCheckerOr(
                        Common.createContextConditionHasFact(Common.undead)
                    );
                }),
            ...
            consecrate = Helpers.CreateAbility(
                "ConsecrateAbility",
                consecreate_buff.Name,
                consecreate_buff.Description,
                "",
        ...
        {
            var skeleton = library.CopyAndAdd<BlueprintUnit>(
                "6c94133d39dea8544a591836c78eaaf3",
                "AnimatedSkeletonUnit",
                "aaf0f057ecff4fc0b8ad010be9fe4a97"
            );

            skeleton.Body = skeleton.Body.CloneObject();
            skeleton.Body.PrimaryHand = null;
            skeleton.Body.Armor = null;
            skeleton.Body.EmptyHandWeapon = library.Get<BlueprintItemWeapon>(
            ...
            skeleton.AddFacts = skeleton.AddFacts.AddToArray(
                library.Get<BlueprintFeature>("203992ef5b35c864390b4e4a1e200629"), //martial weapons
                ...
                library.Get<BlueprintFeature>("1b0f68188dcc435429fb87a022239681")
            ); //shield prof

            var exotic_weapon_prof = library.Get<BlueprintFeatureSelection>(
            ...
            var animate_dead = library.Get<BlueprintAbility>("4b76d32feb089ad4499c3a1ce8e1ac27");
            var after_spawn = (
                animate_dead.GetComponent<AbilityEffectRunAction>().Actions.Actions[0]
                as ContextActionSpawnMonster
            ).AfterSpawn;
            ...
            var animate_action = Helpers.Create<DeadTargetMechanics.ContextActionAnimateDead>(a =>
            {
                ...
                a.dex_bonus = 2;
                a.DurationValue = Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilityRankType.Default),
                    DurationRate.TenMinutes
                );
            ...
            animate_dead.ReplaceComponent<AbilityEffectRunAction>(
                Helpers.CreateRunActions(
                    Helpers.CreateConditional(
                        Helpers.Create<DeadTargetMechanics.ContextConditionCanBeAnimated>(),
                        animate_action
                    )
                )
            );
            animate_dead.LocalizedDuration = Helpers.CreateString(
                "AnimateDead.Description",
                Helpers.tenMinPerLevelDuration
            );
            animate_dead.setMiscAbilityParametersRangedDirectional();
            animate_dead.SetDescription(
                "This spell turns corpses into undead skeletons that obey your spoken commands.\n"
            ...
            animate_dead.AddComponent(
                Helpers.CreateAbilityTargetsAround(10.Feet(), TargetType.Any, includeDead: true)
            );
            animate_dead_lesser = Helpers.CreateAbility(
                "AniamteDeadLesserAbility",
                "Animate Dead, Lesser",
                "This spell functions as animate dead, except you can only create a single Small or Medium skeleton.\n"
                    + "Animate Dead: "
                    + animate_dead.Description,
                "",
                icon,
                AbilityType.Spell,
                UnitCommand.CommandType.Standard,
                ...
                Helpers.CreateContextRankConfig(),
                Helpers.Create<DeadTargetMechanics.AbilityTargetCanBeAnimated>(a =>
                    a.max_size = Size.Medium
                ),
                Helpers.CreateSpellDescriptor(SpellDescriptor.Evil),
                Helpers.CreateSpellComponent(SpellSchool.Necromancy),
            ...
            animate_dead.MaterialComponent = library
                .Get<BlueprintAbility>("7c5d556b9a5883048bf030e20daebe31")
                .MaterialComponent.CloneObject();
            animate_dead.MaterialComponent.Count = 4;
            animate_dead_lesser.MaterialComponent = library
                .Get<BlueprintAbility>("c66e86905f7606c4eaa5c774f0357b2b")
                .MaterialComponent.CloneObject();
            animate_dead_lesser.MaterialComponent.Count = 2;
            animate_dead_lesser.AvailableMetamagic =
                Metamagic.Heighten | Metamagic.Quicken | Metamagic.Extend;
            //fix jaethal ability
            var summon_undead = library.Get<BlueprintAbility>("4c1556984f24e5c4282c6fcda832b7b2");
            summon_undead.LocalizedDuration = animate_dead.LocalizedDuration;
            summon_undead.SetDescription(animate_dead.Description);
            summon_undead.ReplaceComponent<AbilityEffectRunAction>(
                animate_dead.GetComponent<AbilityEffectRunAction>()
            );
            summon_undead.AddComponent(animate_dead.GetComponent<AbilityTargetsAround>());
            var summon_undead_feature = library.Get<BlueprintFeature>(
                "f06f246950e76864fa545c13cb334ba5"
            );
            summon_undead_feature.SetDescription(
                "Jaethal now can cast animate dead spell three times per day."
            );
        }
        ...
        static void createIntellectFortress()
        {
            ...
            var buff = Common.createBuffAreaEffect(
                effect_buff,
                20.Feet(),
                Helpers.CreateConditionsCheckerOr()
            );
            buff.SetNameDescriptionIcon(
                "Intellect Fortress",
                effect_buff.Description,
                effect_buff.Icon
            );
            buff.SetBuffFlags(0);
            buff.GetComponent<AddAreaEffect>().AreaEffect.Fx = Common.createPrefabLink(
                "63f322580ec0e7c4c96fc62ecabad40f"
            ); //axiomatic aoe
            var apply_buff = Common.createContextActionApplyBuff(
                buff,
                Helpers.CreateContextDuration(2),
                is_from_spell: true
            );
            intellect_fortress = Helpers.CreateAbility(
                "IntellectFortressAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
            ...
            intellect_fortress.AvailableMetamagic =
                Metamagic.Heighten | (Metamagic)MetamagicFeats.MetamagicExtender.ExtraRoundDuration;
        ...
        static void createMentalBarrier()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                mental_barrier[i] = Helpers.CreateAbility(
                    $"MentalBarrier{i + 1}Ability",
                    buff.Name,
                    buff.Description,
                    "",
                    buff.Icon,
                    ...
                    Helpers.CreateSpellComponent(SpellSchool.Abjuration),
                    Common.createAbilitySpawnFx(
                        "6bebb42fd1a2ab9499d19f7a1dce3359",
                        anchor: AbilitySpawnFxAnchor.SelectedTarget
                    ) //shield of faith
                );
                mental_barrier[i].setMiscAbilityParametersSelfOnly();
                mental_barrier[i].AvailableMetamagic =
                    Metamagic.Heighten
                    | (Metamagic)MetamagicFeats.MetamagicExtender.ExtraRoundDuration;
        ...
        static void createThoughtShield()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                var buff = Helpers.CreateBuff(
                    ...
                    icon,
                    null,
                    Common.createSavingThrowBonusAgainstDescriptor(
                        4 + 2 * i,
                ...
                thought_shield[i] = Helpers.CreateAbility(
                    $"ThoughtShield{i + 1}Ability",
                    buff.Name,
                    buff.Description,
                    "",
                    buff.Icon,
                ...
                thought_shield[i].AvailableMetamagic =
                    Metamagic.Heighten
                    | (Metamagic)MetamagicFeats.MetamagicExtender.ExtraRoundDuration;
        ...
        static void createMindThrust()
        {
            ...
            var apply_fatigued = Common.createContextActionApplyBuff(
                fatigued,
                Helpers.CreateContextDuration(1)
            );
            var apply_exhausted = Common.createContextActionApplyBuff(
                exhausted,
                Helpers.CreateContextDuration(1)
            );
            var apply_stunned = Common.createContextActionApplyBuff(
                stunned,
                Helpers.CreateContextDuration(1)
            );

            mind_thrust[0] = Helpers.CreateAbility(
                "MindThrust1Ability",
                "Mind Thrust I",
                ...
                Helpers.CreateRunActions(
                    SavingThrowType.Will,
                    Helpers.CreateActionDealDirectDamage(
                        Helpers.CreateContextDiceValue(
                            BalanceFixes.getDamageDie(DiceType.D6),
                            Helpers.CreateContextValue(AbilityRankType.Default),
                            0
                ...
                Common.createAbilitySpawnFx(
                    "c388856d0e8855f429a83ccba67944ba",
                    anchor: AbilitySpawnFxAnchor.SelectedTarget
                ),
                Helpers.CreateSpellDescriptor(SpellDescriptor.MindAffecting),
                Helpers.CreateSpellComponent(SpellSchool.Divination),
            ...
            mind_thrust[0].AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Maximize
                | Metamagic.Quicken
                | Metamagic.Reach
            ...
            mind_thrust[1] = Helpers.CreateAbility(
                "MindThrust2Ability",
                "Mind Thrust II",
            ...
            mind_thrust[2] = Helpers.CreateAbility(
                "MindThrust3Ability",
                "Mind Thrust III",
            ...
            mind_thrust[3] = Helpers.CreateAbility(
                "MindThrust4Ability",
                "Mind Thrust IV",
            ...
            mind_thrust[4] = Helpers.CreateAbility(
                "MindThrust5Ability",
                "Mind Thrust V",
            ...
            mind_thrust[5] = Helpers.CreateAbility(
                "MindThrust6Ability",
                "Mind Thrust VI",
                ...
                Helpers.CreateRunActions(
                    ...
                    Helpers.CreateConditionalSaved(
                        new GameAction[] { apply_fatigued },
                        new GameAction[] { apply_stunned, apply_exhausted }
                    )
                ),
                Helpers.CreateContextRankConfig(
                    max: 20,
        ...
        static void createBloodyClaws()
        {
            ...
            var effect_buff = Helpers.CreateBuff(
                ...
                icon,
                null,
                Helpers.Create<BleedMechanics.BleedBuff>(b =>
                    b.dice_value = Helpers.CreateContextDiceValue(
                        DiceType.Zero,
                        0,
                        Helpers.CreateContextValue(AbilityRankType.Default)
                    )
            ...
            var apply_effect_buff = Common.createContextActionApplyBuff(
                effect_buff,
                Helpers.CreateContextDuration(),
                dispellable: false,
                is_permanent: true
            );
            var on_hit = Common.createAddInitiatorAttackWithWeaponTrigger(
                Helpers.CreateActionList(apply_effect_buff)
            );
            ...
            bloody_claws = Helpers.CreateAbility(
                "BloodyClawsAbility",
                buff.Name,
                buff.Description,
                "",
            ...
            bloody_claws.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Quicken | Metamagic.Heighten | Metamagic.Reach;
        ...
        static void createTouchOfBloodletting()
        {
            ...
            var buff = Helpers.CreateBuff(
                ...
                null,
                Helpers.Create<BleedMechanics.BleedBuff>(b =>
                    b.dice_value = Helpers.CreateContextDiceValue(DiceType.Zero, 0, 1)
                ),
                bleed1d6.GetComponent<SpellDescriptorComponent>(),
                bleed1d6.GetComponent<AddHealTrigger>()
            );
            ...
            var touch_of_blood_letting_touch = Helpers.CreateAbility(
                "TouchOfBloodlettingAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
            ...
            touch_of_blood_letting_touch.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Quicken
                | Metamagic.Heighten
                | Metamagic.Reach
            ...
            touch_of_blood_letting.AddComponents(
                Common.createAbilityTargetHasFact(true, Common.undead),
                Common.createAbilityTargetHasFact(true, Common.construct),
                Common.createAbilityTargetHasFact(true, Common.elemental),
                Helpers.Create<NewMechanics.AbilityTargetWounded>()
        ...
        static void createHaltUndead()
        {
            ...
            var buff = library.CopyAndAdd<BlueprintBuff>(
                "11cb2fe4fe9c44b448cfe1788ae1ab59",
                "HaltUndeadBuff",
                ""
            );
            buff.SetNameDescriptionIcon(
            ...
            buff.ReplaceComponent<SpellDescriptorComponent>(s =>
                s.Descriptor = SpellDescriptor.MovementImpairing
            );
            buff.AddComponent(
                Common.createIncomingDamageTrigger(Helpers.Create<ContextActionRemoveSelf>())
            );
            ...
            halt_undead = Helpers.CreateAbility(
                "HaltUndeadAbility",
                buff.Name,
                buff.Description,
                "",
            ...
            halt_undead.AvailableMetamagic =
                Metamagic.Heighten
                | Metamagic.Quicken
                | Metamagic.Reach
                | Metamagic.Extend
        ...
        static void createControlUndead()
        {
            ...
            control_undead = Helpers.CreateAbility(
                "ControlUndeadAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
                ...
                Common.createAbilityTargetHasFact(
                    true,
                    library.Get<BlueprintBuff>("8728e884eeaa8b047be04197ecf1a0e4")
                ),
                Common.createAbilitySpawnFx(
            ...
            control_undead.AvailableMetamagic =
                Metamagic.Heighten
                | Metamagic.Quicken
                | Metamagic.Reach
                | Metamagic.Extend
        ...
        static void createSleetStorm()
        {
            ...
            var buff = Helpers.CreateBuff(
                ...
                null,
                Common.createSpellImmunityToSpellDescriptor(
                    SpellDescriptor.Blindness | SpellDescriptor.SightBased
                ),
                Common.createAddCondition(Kingmaker.UnitLogic.UnitCondition.Slowed),
                ...
                Helpers.Create<ConcealementMechanics.AddOutgoingConcealment>(c =>
                {
                    c.Concealment = Concealment.Total;
                    c.Descriptor = ConcealmentDescriptor.Fog;
                })
            ...
            var can_not_move_buff = Helpers.CreateBuff(
                "SleetStormCanNotMoveBuff",
            ...
            var apply_can_not_move = Common.createContextActionApplyBuff(
                can_not_move_buff,
                Helpers.CreateContextDuration(1),
                dispellable: false,
                is_child: true
            ...
            var check_movement = Helpers.CreateConditional(
                ...
                Helpers.Create<SkillMechanics.ContextActionSkillCheckWithFailures>(c =>
                {
                    ...
                    c.Failure5 = Helpers.CreateActionList(
                        apply_can_not_move,
            ...
            area.ComponentsArray = new BlueprintComponent[]
            {
                ...
                Helpers.Create<AbilityAreaEffectBuff>(a =>
                {
                    a.Buff = buff;
                    a.Condition = Helpers.CreateConditionsCheckerOr(
                        Common.createContextConditionHasFact(immunity_to_wind, false)
                    );
                }),
                Helpers.Create<AbilityAreaEffectBuff>(a =>
                {
                    a.Buff = ranged_attacks_forbidden_buff;
                    a.Condition = Helpers.CreateConditionsCheckerOr();
                }),
            };
            ...
            sleet_storm = Helpers.CreateAbility(
                "SleetStormAbility",
                buff.Name,
                buff.Description,
                "",
            ...
            sleet_storm.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Heighten | Metamagic.Quicken;
            ...
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("c18a821ee662db0439fb873165da25be"),
                sleet_storm,
                4
            ); //instead of slowing mud for weather domain
        }
        ...
        static void createTemporalStasis()
        {
            ...
            var temporal_stasis_touch = Helpers.CreateAbility(
                "TemporalStasisAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
            ...
            temporal_stasis_touch.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Quicken
                | Metamagic.Reach
        ...
        static void createTimeStop()
        {
            ...
            var caster_buff = Helpers.CreateBuff("TimeStopCasterBuff", "", "", "", null, null);

            var apply_buff = Common.createContextActionApplyBuff(
                buff,
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilitySharedValue.Duration)
                )
            );
            var apply_caster_buff = Common.createContextActionApplyBuff(
                caster_buff,
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilitySharedValue.Duration)
                )
            ...
            time_stop = Helpers.CreateAbility(
                "TimeStopAbility",
                "Time Stop",
                ...
                Helpers.CreateRunActions(
                    apply_caster_buff,
                    Helpers.Create<NewMechanics.ApplyActionToAllUnits>(a =>
                        a.actions = Helpers.CreateActionList(apply_buff)
                    )
                ),
                Helpers.CreateCalculateSharedValue(
                    Helpers.CreateContextDiceValue(DiceType.D4, 1, 2),
                    sharedValue: AbilitySharedValue.Duration
                ),
                Helpers.CreateSpellComponent(SpellSchool.Transmutation)
            );
            time_stop.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Quicken
                | Metamagic.Empower
            ...
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("cc2d330bb0200e840aeb79140e770198"),
                time_stop,
                9
            );
        }
        ...
        static void createSandsOfTime()
        {
            ...
            var deal_damage = Helpers.CreateActionDealDamage(
            ...
            var action = Helpers.CreateConditional(
                Common.createContextConditionHasFacts(all: false, Common.undead, Common.construct),
                deal_damage,
                apply_buff
            );
            var sands_of_time_touch = Helpers.CreateAbility(
                "SandsOfTimeTouchAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
            ...
            sands_of_time_touch.AvailableMetamagic =
                Metamagic.Quicken
                | Metamagic.Heighten
                | Metamagic.Reach
                | Metamagic.Extend
        ...
        static void createThreefoldAspect()
        {
            ...
            var buff1 = Helpers.CreateBuff(
                "ThreeFoldAspect1Buff",
            ...
            var buff2 = Helpers.CreateBuff(
                "ThreeFoldAspect2Buff",
            ...
            var buff3 = Helpers.CreateBuff(
                "ThreeFoldAspect3Buff",
            ...
            for (int i = 0; i < buffs.Length; i++)
            {
                abilities[i] = Helpers.CreateActivatableAbility(
                    $"ThreeFoldAspect{i}ToggleAbility",
                    buffs[i].Name,
                    buffs[i].Description,
                    "",
                    icon,
                ...
                abilities[i].Group =
                    ActivatableAbilityGroupExtension.ThreefoldAspect.ToActivatableAbilityGroup();
            }
            ...
            threefold_aspect = Helpers.CreateAbility(
                "ThreeFoldAspectAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
            ...
            threefold_aspect.AvailableMetamagic =
                Metamagic.Heighten | Metamagic.Quicken | Metamagic.Extend;
        ...
        static BlueprintAbility createFlamingSphereLikeSpell(
            string prefix,
            string name,
            string description,
            UnityEngine.Sprite icon,
            PrefabLink prefab,
            string savingthrow_description,
        ...
        {
            return createFlamingSphereLikeSpell(
                prefix,
                name,
                description,
                icon,
        ...
        )
        {
            ...
            var dmg_save_action = Common.createContextActionSavingThrow(
                SavingThrowType.Reflex,
                Helpers.CreateActionList(Helpers.CreateConditionalSaved(new GameAction[0], effects))
            );
            if (extra_dc_increase_condition != null)
            {
                Common.addConditionalDCIncrease(
                    dmg_save_action,
                    extra_dc_increase_condition,
                    extra_dc_increase
                );
            }

            var dmg_action = Helpers.CreateActionList(
                Helpers.CreateConditional(
                    Common.createContextConditionCasterHasFact(caster_dmg_done),
                    new GameAction[0],
                    new GameAction[]
            ...
            caster_buff.AddComponents(
                Helpers.Create<ShadowSpells.IgnoreShadowReality>(),
                Helpers.Create<ShadowSpells.ReplaceShadowContextForAbilities>(a =>
                    a.abilities = new BlueprintAbility[] { move_ability }
                )
            );
            ...
            var spell = Helpers.CreateAbility(
                prefix + "Ability",
                caster_buff.Name,
                caster_buff.Description,
                "",
        ...
        static void createAggressiveThunderCloudGreater()
        {
            ...
            var fx = Common.createPrefabLink("cfacbb7d39eaf624382c58bad8ba2df1"); //will o wisp fx
            var stunned = library.CopyAndAdd<BlueprintBuff>(
                "09d39b38bb7c6014394b6daced9bacd3",
                "AggressiveThundercloudGreaterStunBuff",
                ""
            );
            stunned.AddComponent(Helpers.CreateSpellDescriptor(SpellDescriptor.Sonic));

            var stun_allowed = Helpers.CreateBuff(
                "AggressiveThundercloudGreaterStunAllowedBuff",
                "",
                "",
                "",
                null,
            ...
            var apply_stun = Common.createContextActionApplyBuff(
                stunned,
                Helpers.CreateContextDuration(1)
            );
            var stun_action = Helpers.CreateConditional(
                new Condition[] { Common.createContextConditionCasterHasFact(stun_allowed) },
                new GameAction[]
                {
                    Common.createContextActionSavingThrow(
                        SavingThrowType.Fortitude,
                        Helpers.CreateActionList(Helpers.CreateConditionalSaved(null, apply_stun))
                    ),
                    Common.createContextActionOnContextCaster(
                        Common.createContextActionRemoveBuff(stun_allowed)
                    ),
                }
            );
            var dmg = Helpers.CreateActionDealDamage(
            ...
            aggressive_thundercloud_greater = createFlamingSphereLikeSpell(
                "AggressiveThundercloudGreater",
                ...
                $"This spell functions as aggressive thundercloud, except it deals 6d{BalanceFixes.getDamageDieString(DiceType.D6)} points of electricity damage to any creature it strikes. The first creature damaged by the cloud is also stunned for 1 round (Fort negates); this is a sonic effect.\n"
                    ...
                    + aggressive_thundercloud.Description,
                icon,
                Common.createPrefabLink("cfacbb7d39eaf624382c58bad8ba2df1"), //will o wisp fx
                ...
                new BlueprintComponent[0],
                Helpers.CreateAddFactContextActions(
                    Common.createContextActionApplyChildBuff(stun_allowed)
                )
            );
        ...
        static void createAggressiveThunderCloud()
        {
            ...
            thunder_cloud_fx_buff = library.CopyAndAdd<BlueprintBuff>(
                "bedf9d0d6be45bb4eb197b83e2ad38ee",
                "AggressiveThundercloudFxBuff",
                ""
            );
            thunder_cloud_fx_buff.ComponentsArray = new BlueprintComponent[]
            {
                Helpers.Create<AddConcealment>(a =>
                {
                    a.Descriptor = ConcealmentDescriptor.Fog;
            ...
            aggressive_thundercloud = createFlamingSphereLikeSpell(
                "AggressiveThundercloud",
                "Aggressive Thundercloud",
        ...
        static void createScouringWinds()
        {
            ...
            var dmg_regular = Helpers.CreateActionDealDamage(
                PhysicalDamageForm.Piercing,
                Helpers.CreateContextDiceValue(BalanceFixes.getDamageDie(DiceType.D6), 3, 0),
                isAoE: true
            );
            var check_movement = Helpers.CreateConditional(
                new Condition[]
                {
                    Helpers.Create<CombatManeuverMechanics.ContextConditionTargetSizeLessOrEqual>(
                        c => c.target_size = Size.Medium
                    ),
                    Helpers.CreateConditionHasFact(immunity_to_wind, not: true),
                },
                Common.createContextActionSkillCheck(
                    StatType.Strength,
                    failure: Helpers.CreateActionList(apply_can_not_move),
                    custom_dc: 10
                )
            );
            var check_small = Helpers.CreateConditional(
                new Condition[]
                {
                    Helpers.Create<CombatManeuverMechanics.ContextConditionTargetSizeLessOrEqual>(
                        c => c.target_size = Size.Small
                    ),
                    Helpers.CreateConditionHasFact(immunity_to_wind, not: true),
                },
                Common.createContextActionSkillCheck(
            ...
            var move_ability = Helpers.CreateAbility(
                ...
                Helpers.CreateSpellDescriptor(
                    (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.Air
                        | (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.Earth
                ),
                Helpers.CreateSpellComponent(SpellSchool.Evocation)
            );
            ...
            caster_buff.AddComponents(
                Helpers.Create<ShadowSpells.IgnoreShadowReality>(),
                Helpers.Create<ShadowSpells.ReplaceShadowContextForAbilities>(r =>
                    r.abilities = new BlueprintAbility[] { move_ability }
                )
            );
            ...
            scouring_winds = Helpers.CreateAbility(
                "ScouringWindsAbility",
                buff.Name,
                buff.Description,
                "",
                icon,
            ...
            scouring_winds.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Maximize
            ...
            Common.replaceDomainSpell(
                ...
                scouring_winds,
                7
            ); //weather domain (instead of fire storm)
        }
        ...
        static void createWallOfFire()
        {
            ...
            var area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                "ac8737ccddaf2f948adf796b5e74eee7",
                "WallOfFireSpellAbilityArea",
                ""
            );
            ...
            wall_of_fire = library.CopyAndAdd<BlueprintAbility>(
                "77d255c06e4c6a745b807400793cf7b1",
                "WallOfFireSpellAbility",
                ""
            );
            wall_of_fire.SetNameDescriptionIcon(
                "Wall of Fire",
            ...
            wall_of_fire.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(spawn_area)
            );
            wall_of_fire.Type = AbilityType.Spell;
            wall_of_fire.Range = AbilityRange.Medium;
            wall_of_fire.SpellResistance = true;
            wall_of_fire.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Maximize
            ...
            wall_of_fire_fire_domain = SpellDuplicates.addDuplicateSpell(
                wall_of_fire,
                "FireDomain" + wall_of_fire.name
            );
            //replace 4th level spell in fire domain
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("881b2137a1779294c8956fe5b497cc35"),
                wall_of_fire_fire_domain,
                4
            );
        }
        ...
        static void createIncendiaryCloud()
        {
            ...
            var steam_cloud_area = library.Get<BlueprintAbilityAreaEffect>(
                "35a62ad81dd5ae3478956c61d6cd2d2e"
            );

            var area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                obscuring_mist_area.AssetGuid,
                "IncendiaryCloudAbilityArea",
                ""
            );
            area.AddComponent(
                Helpers.CreateAreaEffectRunAction(
                    round: Helpers.CreateActionSavingThrow(
                        SavingThrowType.Reflex,
                        Helpers.CreateActionDealDamage(
                            DamageEnergyType.Fire,
                            Helpers.CreateContextDiceValue(
            ...
            incendiary_cloud = Helpers.CreateAbility(
        ...
        static void createWallOfNausea()
        {
            ...
            var nauseted = library.CopyAndAdd<BlueprintBuff>(
                "956331dba5125ef48afe41875a00ca0e",
                "NausetedWithoutPoisonBuff",
                ""
            );
            nauseted.ReplaceComponent<SpellDescriptorComponent>(s =>
                s.Descriptor = SpellDescriptor.Nauseated
            );
            var apply_buff = Common.createContextActionApplyBuff(
                nauseted,
                Helpers.CreateContextDuration(1)
            );
            var knock_down = Common.createContextActionSkillCheck(
                StatType.SkillMobility,
                null,
                Helpers.CreateActionList(Helpers.Create<ContextActionKnockdownTarget>()),
                12
            );

            var action = Helpers.CreateConditionalSaved(
                null,
                new GameAction[] { apply_buff, knock_down }
            );
            var effect = Helpers.CreateConditional(
                Common.createContextConditionHasFacts(
                    false,
            ...
            area.AddComponent(
                Helpers.CreateSpellDescriptor(
                    SpellDescriptor.Nauseated | SpellDescriptor.MindAffecting
                )
            );
            area.SpellResistance = true;
            wall_of_nausea = Helpers.CreateAbility(
                "WallOfNauseaAbility",
                "Wall of Nausea",
        ...
        static void createWallOfBlindness()
        {
            ...
            area.SpellResistance = true;
            wall_of_blindness = Helpers.CreateAbility(
                "WallOfBlindnessAbility",
                "Wall of Blindness",
            ...
            wall_of_blindness.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Quicken
                | Metamagic.Reach
        ...
        static void createHypnoticPattern()
        {
            ...
            hypnotic_pattern = library.CopyAndAdd<BlueprintAbility>(
                "4b8265132f9c8174f87ce7fa6d0fe47b",
                "HypnoticPatternAbility",
                ""
            );

            hypnotic_pattern.SetNameDescription(
                "Hypnotic Pattern",
            ...
            hypnotic_pattern.ReplaceComponent<AbilitySpawnFx>(a =>
                a.PrefabLink = Common.createPrefabLink("bb95a6177968e3f499f39e7c90c59fee")
            ); //blinding aoe 10 feet
            hypnotic_pattern.ReplaceComponent<AbilityTargetsAround>(
                Helpers.CreateAbilityTargetsAround(10.Feet(), TargetType.Any)
            );
            hypnotic_pattern.ReplaceComponent<ContextCalculateSharedValue>(c =>
                c.Value = Helpers.CreateContextDiceValue(
                    DiceType.D4,
                    2,
                    Helpers.CreateContextValue(AbilityRankType.DamageDice)
                )
            );
            hypnotic_pattern.ReplaceComponent<ContextRankConfig>(
                Helpers.CreateContextRankConfig(min: 3, max: 32)
            );
            hypnotic_pattern.AddComponent(
                Helpers.CreateContextRankConfig(type: AbilityRankType.DamageDice, max: 10)
            );
            hypnotic_pattern.LocalizedDuration = Helpers.CreateString(
                "HypnoticPattern.Description",
                "3 rounds"
            );
        ...
        static void createFlyAndOverlandFlight()
        {
            ...
            var spawn_fx = library
                .Get<BlueprintAbility>("f3c0b267dd17a2a45a40805e31fe3cd1")
                .GetComponent<AbilitySpawnFx>();
            var buff = Helpers.CreateBuff(
                "FlyBuff",
                "",
                "",
            ...
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("d169dd2de3630b749a2363c028bb6e7b"),
                fly,
                3
            ); //travel

            var apply_buff10 = Common.createContextActionApplyBuff(
                buff,
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilityRankType.Default),
                    DurationRate.TenMinutes
            ...
            fly_mass = Helpers.CreateAbility(
                "FlyMassAbility",
                "Fly, Mass",
            ...
            var apply_buff_long = Common.createContextActionApplyBuff(
                buff,
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilityRankType.Default),
                    DurationRate.Hours
            ...
            overland_flight = Helpers.CreateAbility(
                "OverlandFlightAbility",
                "Overland Flight",
            ...
            overland_flight.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Heighten | Metamagic.Quicken;
        ...
        static void createWindWalk()
        {
            ...
            var buff = Helpers.CreateBuff(
                ...
                icon,
                null,
                Helpers.Create<TravelMap.OverrideGlobalMapTravelMultiplier>(o =>
                    o.travel_map_multiplier = 7
                )
            );
            ...
            wind_walk = Helpers.CreateAbility(
                "WindWalkAbility",
                buff.Name,
                buff.Description,
                "",
        ...
        static void createAirWalk()
        {
            ...
            var buff = Helpers.CreateBuff(
                ...
                Common.createBuffDescriptorImmunity(
                    Kingmaker.Blueprints.Classes.Spells.SpellDescriptor.Ground
                ),
                Common.createAddConditionImmunity(
                    Kingmaker.UnitLogic.UnitCondition.DifficultTerrain
                ),
            ...
            air_walk = Helpers.CreateAbility(
                "AirWalkAbility",
                "Air Walk",
            ...
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("750bfcd133cd52f42acbd4f7bc9cc365"),
                air_walk,
                4
            ); //air

            air_walk_communal = Helpers.CreateAbility(
                "AirWalkCommunalAbility",
                "Air Walk, Communal",
                "This spell functions like air walk, except that it effects all allies in 30 ft radius.\n"
                    + "Air Walk: "
                    + air_walk.Description,
                "",
                icon,
                AbilityType.Spell,
                UnitCommand.CommandType.Standard,
            ...
            air_walk_communal.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Heighten | Metamagic.Quicken;
        ...
        static void createMeteorSwarm()
        {
            ...
            area.ComponentsArray = new BlueprintComponent[]
            {
                Helpers.CreateAreaEffectRunAction(new GameAction[0]),
            };

            var firestorm = library.Get<BlueprintAbility>("e3d0dfe1c8527934294f241e0ae96a8d");

            var on_hit_buff = Helpers.CreateBuff("MeteorSwarmOnHitBuff", "", "", "", null, null);
            on_hit_buff.SetBuffFlags(BuffFlags.HiddenInUi);

            var damage = Helpers.CreateActionDealDamage(
                DamageEnergyType.Fire,
                Helpers.CreateContextDiceValue(BalanceFixes.getDamageDie(DiceType.D6), 24),
                true,
                true
            );
            var main_action = Common.createContextActionSavingThrow(
                SavingThrowType.Reflex,
            ...
            Common.addConditionalDCIncrease(
                main_action,
                Helpers.CreateConditionsCheckerOr(
                    Common.createContextConditionHasBuffFromCaster(on_hit_buff)
                ),
                4
            );

            var on_hit_actions = new GameAction[]
            {
                Helpers.CreateActionDealDamage(
                    PhysicalDamageForm.Bludgeoning,
                    Helpers.CreateContextDiceValue(BalanceFixes.getDamageDie(DiceType.D6), 2)
                ),
                Common.createContextActionApplyBuff(on_hit_buff, Helpers.CreateContextDuration(1)),
            };

            var ranged_touch_attack_action = NewMechanics.ContextActionRangedTouchAttack.Create(
                on_hit_actions
            );
            meteor_swarm = Helpers.CreateAbility(
                "MeteorSwarmAbility",
                "Meteor Swarm",
                ...
                Helpers.reflexHalfDamage,
                Helpers.CreateRunActions(
                    ranged_touch_attack_action,
                    main_action,
                    Common.createContextActionRemoveBuffFromCaster(on_hit_buff)
                ),
                firestorm.GetComponent<AbilitySpawnFx>(),
                Helpers.Create<AbilityEffectRunActionOnClickedTarget>(a =>
                    a.Action = Helpers.CreateActionList(spawn_area)
                ),
            ...
            meteor_swarm.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Maximize
                | Metamagic.Quicken
                | Metamagic.Heighten
        ...
        static void createPathOfGlory()
        {
            ...
            var area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                "b8a7c68b040695a40b3a87b9676f7b50",
                "PathOfGloryArea",
                ""
            ); //cave fangs trap
            area.ComponentsArray = new BlueprintComponent[]
            ...
            path_of_glory = Helpers.CreateAbility(
                "PathOfGloryAbility",
                "Path of Glory",
                ...
                "",
                Helpers.CreateRunActions(
                    Common.createContextActionSpawnAreaEffectMultiple(
                        area,
                        duration,
                        points.ToArray()
                    )
                ...
                Helpers.Create<AoeMechanics.AbilityRectangularAoeVisualizer>(ab =>
                {
                    ab.target_type = TargetType.Ally;
                    ab.length = 60.Feet();
                    ab.width = 5.Feet();
                })
            );
            path_of_glory.setMiscAbilityParametersRangedDirectional();
            path_of_glory.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Heighten | Metamagic.Reach | Metamagic.Quicken;
        ...
        static void createPathOfGloryGreater()
        {
            ...
            path_of_glory_greater = Helpers.CreateAbility(
                "PathOfGloryGreaterAbility",
            ...
            path_of_glory_greater.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Heighten | Metamagic.Reach | Metamagic.Quicken;
        ...
        static void createTidalSurge()
        {
            ...
            var deliver_projectile = library
                .Get<BlueprintAbility>("963da934d652bdc41900ed68f63ca1fa")
                .GetComponent<AbilityDeliverProjectile>(); //from water blast
            ...
            var knock_out = Helpers.CreateConditional(
                Helpers.Create<CombatManeuverMechanics.ContextConditionTargetSizeLessOrEqual>(c =>
                    c.target_size = Size.Medium
                ),
                Helpers.Create<ContextActionKnockdownTarget>()
            );
            var move = Helpers.Create<CombatManeuverMechanics.ContextActionForceMove>(c =>
                c.distance_dice = Helpers.CreateContextDiceValue(DiceType.D4, 5, 0)
            );

            tidal_surge = Helpers.CreateAbility(
                "TidalSurgeAbility",
                "Tidal Surge",
                ...
                deliver_projectile,
                Helpers.CreateSpellDescriptor(
                    (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.Water
                )
            );
            tidal_surge.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Maximize
                | Metamagic.Quicken
                | Metamagic.Heighten
        ...
        static void createStunningBarrierGreater()
        {
            ...
            var buff = library.CopyAndAdd<BlueprintBuff>(
                "705fec87d90607444a1ae629acfeb94e",
                "StunningBarrierGreaterBuff",
                ""
            );
            ...
            var after_discharge = Helpers.CreateConditional(
            ...
            buff.AddComponent(
                Helpers.CreateAddFactContextActions(
                    activated: Helpers.Create<ResourceMechanics.ContextRestoreResource>(c =>
                    {
                        c.Resource = resource;
            ...
            buff.AddComponent(
                Helpers.CreateContextRankConfig(type: AbilityRankType.DamageDice, max: 30)
            );
            ...
            stunning_barrier_greater = Helpers.CreateAbility(
            ...
            stunning_barrier_greater.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Quicken
                | (Metamagic)MetamagicFeats.MetamagicExtender.Persistent;
        ...
        static void createBladeLash()
        {
            ...
            var apply_buff = Common.createContextActionApplyBuffToCaster(
                buff,
                Helpers.CreateContextDuration(1)
            );
            var remove_buff = Common.createContextActionOnContextCaster(
                Common.createContextActionRemoveBuff(buff)
            );

            var maneuver = Helpers.Create<ContextActionCombatManeuver>(c =>
            {
                c.Type = Kingmaker.RuleSystem.Rules.CombatManeuver.Trip;
                c.OnSuccess = Helpers.CreateActionList();
            });

            blade_lash = Helpers.CreateAbility(
                "BladeLashAbility",
                "Blade Lash",
        ...
        static void createLongArm()
        {
            ...
            long_arm = Helpers.CreateAbility(
                "LongArmAbility",
                buff.Name,
                buff.Description,
                "",
        ...
        static void createResinousSkin()
        {
            ...
            var main_hand_buff = library.CopyAndAdd<BlueprintBuff>(
                "f7db19748af8b69469073485a65f37cf",
                "ResionousSKinMainHandBuff",
                ""
            );
            var off_hand_buff = library.CopyAndAdd<BlueprintBuff>(
                "afb1ea46a8c41e04eaab833b7b1b9321",
                "ResionousSKinOffHandBuff",
                ""
            );

            var break_free = Helpers.CreateAddFactContextActions(
                newRound: Common.createContextActionSkillCheck(
                    StatType.Strength,
            ...
            var apply_main_hand = Common.createContextActionApplyBuff(
                main_hand_buff,
                Helpers.CreateContextDuration(),
                is_child: true,
                is_permanent: true,
            ...
            var apply_off_hand = Common.createContextActionApplyBuff(
                off_hand_buff,
                Helpers.CreateContextDuration(),
                is_child: true,
                is_permanent: true,
            ...
            var apply_main_hand_saved = Common.createContextActionSavingThrow(
                SavingThrowType.Reflex,
                Helpers.CreateActionList(Helpers.CreateConditionalSaved(null, apply_main_hand))
            );
            var apply_off_hand_saved = Common.createContextActionSavingThrow(
                SavingThrowType.Reflex,
                Helpers.CreateActionList(Helpers.CreateConditionalSaved(null, apply_off_hand))
            );
            var buff = Helpers.CreateBuff(
                "ResinousSkinBuff",
                "Resinous Skin",
                ...
                Common.createContextManeuverDefenseBonus(
            ...
            resinous_skin = Helpers.CreateAbility(
                "ResinousSkinAbility",
                buff.Name,
                buff.Description,
                "",
            ...
            resinous_skin.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Heighten | Metamagic.Quicken;
        ...
        static void createSolidFogAndFixAcidFog()
        {
            ...
            solid_fog = library.CopyAndAdd<BlueprintAbility>(
                "68a9e6d7256f1354289a39003a46d826",
                "SolidFogAbility",
                ""
            );
            ...
            solid_fog.ReplaceComponent<AbilityAoERadius>(a =>
                Helpers.SetField(a, "m_Radius", 20.Feet())
            );
            solid_fog.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(
                    Common.changeAction<ContextActionSpawnAreaEffect>(
                        a.Actions.Actions,
                        s =>
        ...
        static void createAccursedGlare()
        {
            ...
            accursed_glare = library.CopyAndAdd<BlueprintAbility>(
                "ca1a4cd28737ae544a0a7e5415c79d9b",
                "AccursedGlareAbility",
                ""
            ); //touch of chaos as base
            accursed_glare.SetIcon(icon);
            accursed_glare.Type = AbilityType.Spell;
            accursed_glare.SetName("Accursed Glare");
            accursed_glare.LocalizedDuration = Helpers.CreateString(
                "AccursedGlareAbility.Duration",
                "1 day/level"
            );
            ...
            accursed_glare.Animation = Kingmaker
                .Visual
                .Animation
                .Kingmaker
                .Actions
                ...
                .CastAnimationStyle
                .Point;
            accursed_glare.AnimationStyle = Kingmaker
                .View
                .Animation
                .CastAnimationStyle
                .CastActionPoint;
            ...
            accursed_glare.LocalizedSavingThrow = Helpers.CreateString(
                "AccursedGlare.SavingThrow",
                Helpers.willNegates
            );

            var buff = library.CopyAndAdd<BlueprintBuff>(
                "96bbd279e0bed0f4fb208a1761f566b5",
                "AccursedGlareBuff",
                ""
            );
            ...
            var action = Common.createContextActionSavingThrow(
                SavingThrowType.Will,
                Helpers.CreateActionList(
                    Common.createContextSavedApplyBuff(
                        buff,
                        DurationRate.Days,
            ...
            accursed_glare.ReplaceComponent<AbilityEffectRunAction>(
                Helpers.CreateRunActions(action)
            );
            accursed_glare.AddComponent(Helpers.CreateContextRankConfig());
            accursed_glare.AddComponent(
                doom_spell.GetComponent<Kingmaker.UnitLogic.Abilities.Components.Base.AbilitySpawnFx>()
            );
            ...
            accursed_glare.AvailableMetamagic =
                Metamagic.Quicken
                | Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Reach
        ...
        static void createDazzlingBlade()
        {
            ...
            var release_action = Helpers.CreateConditionalSaved(
                Common.createContextActionApplyBuff(dazzled, Helpers.CreateContextDuration(1)),
                Common.createContextActionApplyBuff(blinded, Helpers.CreateContextDuration(1))
            );

            var release_ability = Helpers.CreateAbility(
                "DazzlingBladeReleaseAbility",
            ...
            var buff = Helpers.CreateBuff(
                ...
                Helpers.Create<NewMechanics.ContextCombatManeuverBonus>(c =>
                {
                    c.Type = Kingmaker.RuleSystem.Rules.CombatManeuver.Disarm;
                    c.Bonus = Helpers.CreateContextValue(AbilityRankType.Default);
                }),
                Helpers.Create<NewMechanics.SkillBonusInCombat>(s =>
                {
                    s.value = Helpers.CreateContextValue(AbilityRankType.Default);
                    s.skill = StatType.CheckBluff;
                    s.descriptor = ModifierDescriptor.Competence;
                }),
                Helpers.CreateContextRankConfig(
            ...
            dazzling_blade = Helpers.CreateAbility(
                "DazzlingBladeAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
            ...
            dazzling_blade.AvailableMetamagic =
                Metamagic.Heighten
                | Metamagic.Extend
                | Metamagic.Reach
                | (Metamagic)MetamagicFeats.MetamagicExtender.Persistent;
            release_ability.AvailableMetamagic = (Metamagic)
                MetamagicFeats.MetamagicExtender.Persistent;

            dazzling_blade_mass = Helpers.CreateAbility(
                "DazzlingBladeMassAbility",
                "Dazzling Blade, Mass",
            ...
            dazzling_blade_mass.AvailableMetamagic =
                Metamagic.Heighten
                | Metamagic.Extend
                | Metamagic.Reach
                | (Metamagic)MetamagicFeats.MetamagicExtender.Persistent;
        ...
        static void createMagicWeapon()
        {
            ...
            {
                var buff = Helpers.CreateBuff(
                    (oh ? "OffHand" : "") + "MagicWeaponBaseBuff",
                    "Magic Weapon",
                    ...
                    icon,
                    null,
                    Helpers.Create<NewMechanics.EnchantmentMechanics.BuffContextEnhancePrimaryHandWeaponUpToValue>(
                        b =>
                        {
                            b.value = 1;
                            b.in_off_hand = oh;
                ...
                var greater_buff = Helpers.CreateBuff(
                    (oh ? "OffHand" : "") + "MagicWeaponGreaterBuff",
                ...
                var apply_greater_buff = Common.createContextActionApplyBuff(
                    greater_buff,
                    Helpers.CreateContextDuration(
                        Helpers.CreateContextValue(AbilityRankType.StatBonus),
                        DurationRate.Hours
                ...
                var magic_weapon_v = Helpers.CreateAbility(
                    (oh ? "OffHand" : "MainHand") + "MagicWeaponBaseAbility",
                    ...
                    Helpers.CreateSpellComponent(SpellSchool.Transmutation),
                    Common.createAbilitySpawnFx(
                        "cf69c140c7d4d3c49a37e9202c5b835e",
                        anchor: AbilitySpawnFxAnchor.SelectedTarget
                    ), //bless weapon
                    Helpers.Create<NewMechanics.AbilitTargetManufacturedWeapon>(a =>
                        a.off_hand = oh
                ...
                magic_weapon_v.AvailableMetamagic =
                    Metamagic.Heighten | Metamagic.Quicken | Metamagic.Extend;

                var magic_weapon_greater_v = Helpers.CreateAbility(
                    (oh ? "OffHand" : "MainHand") + "MagicWeaponGreaterAbility",
            ...
            magic_weapon = Common.createVariantWrapper(
                "MagicWeaponBaseAbility",
                "",
                magic_weapon_variants.ToArray()
            );
            magic_weapon.AddComponent(Helpers.CreateSpellComponent(SpellSchool.Transmutation));
            magic_weapon_greater = Common.createVariantWrapper(
                "MagicWeaponGreaterAbility",
                "",
                greater_magic_weapon_variants.ToArray()
            );
            magic_weapon_greater.AddComponent(
                Helpers.CreateSpellComponent(SpellSchool.Transmutation)
            );
            ...
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("8d454cbb7f25070419a1c8eaf89b5be5"),
                magic_weapon,
                1
            );
        }
        ...
        {
            var flaming = library.Get<BlueprintWeaponEnchantment>(
                "30f90becaaac51f41bf56641966c4121"
            );
            var flaming_burst = library.Get<BlueprintWeaponEnchantment>(
                "3f032a3cd54e57649a0cdad0434bf221"
            );

            var buff_flaming_burst = Helpers.CreateBuff(
                "FlamesOfTheFaithfulFlamingBurstBuff",
                "",
                "",
                "",
                null,
            ...
            var conditional = Helpers.CreateConditional(
                Helpers.CreateConditionHasFact(judgment_watcher),
                Common.createContextActionApplyBuff(
                    buff_flaming_burst,
                    Helpers.CreateContextDuration(),
                    is_child: true,
            ...
            flames_of_the_faithful = Helpers.CreateAbility(
                "FlamesOfTheFaithful",
            ...
            flames_of_the_faithful.setMiscAbilityParametersSelfOnly(
                Kingmaker
                    .Visual
                    .Animation
                    .Kingmaker
            ...
            flames_of_the_faithful.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Quicken
                | (Metamagic)MetamagicFeats.MetamagicExtender.Rime
        ...
        static void createLendJudgement()
        {
            ...
            judgments.AddRange(
                library
                    .Get<BlueprintFeature>("981def910b98200499c0c8f85a78bde8")
                    .GetComponent<AddFacts>()
                    .Facts.Cast<BlueprintActivatableAbility>()
            ); //base
            //judgments.Add(library.Get<BlueprintActivatableAbility>("bfec9cee57e7a7d47a8641c5c9d43c41")); //resilency base
            judgments.Add(
                library.Get<BlueprintActivatableAbility>("d7e61eb9f0cec5e49bd1b0c428fa98e4")
            ); //smiting base
            judgments.Add(
                library.Get<BlueprintActivatableAbility>("2c448ab4135c7c741b6f0f223901f9fa")
            ); //smiting adamantite;
            judgments.Add(
                library.Get<BlueprintActivatableAbility>("72fe16312b4479145afc6cc6c87cd08f")
            ); //smiting alignment

            foreach (
                var comp in library
                    .Get<BlueprintFeature>("112314658d0848645b34555a41def2ff")
                    .GetComponents<AddFeatureOnAlignment>()
            )
            {
            ...
            foreach (var judgment in judgments)
            {
                ...
                var buff = Helpers.CreateBuff(
                    judgment_buff.name + "LendJudgmentBuff",
                    ...
                    judgment_buff
                        .ComponentsArray.Where(c => !(c as AddFactContextActions))
                        .ToArray()
                );

                var remove_condition = Helpers.CreateConditional(
                    Common.createContextConditionCasterHasFact(judgment_buff),
                    null,
                    Helpers.Create<ContextActionRemoveSelf>()
                );
                ...
                var ability = Helpers.CreateAbility(
                    judgment_buff.name + "LendJudgmentAbility",
                    buff.Name,
                    buff.Description,
                    "",
                    buff.Icon,
                    ...
                    HarmlessSaves.HarmlessSaves.will_harmless,
                    Helpers.CreateRunActions(apply_buff),
                    Helpers.Create<NewMechanics.AbilityShowIfCasterHasFact2>(a =>
                        a.UnitFact = judgment_buff
                    ),
                    Helpers.CreateSpellComponent(SpellSchool.Divination),
                    Helpers.CreateContextRankConfig(),
                    Helpers.Create<HarmlessSaves.HarmlessSpell>()
            ...
            lend_judgement = Common.createVariantWrapper(
                "LendJudgmentAbility",
                "",
                variants.ToArray()
            );
            lend_judgement.SetNameDescriptionIcon(
                "Lend Judgment",
            ...
            {
                var apply_greater = Common.createContextActionApplyBuff(
                    variant_buffs[i],
                    Helpers.CreateContextDuration(
                        Helpers.CreateContextValue(AbilityRankType.Default)
                    ),
                ...
                var apply_greater_condition = Helpers.CreateConditional(
                    Common.createContextConditionCasterHasFact(j_buffs[i]),
                    apply_greater,
                    null
                );
            ...
            greater_buff.AddComponent(
                Helpers.CreateAddFactContextActions(activated: actions.ToArray())
            );
            ...
            lend_judgement_greater = Helpers.CreateAbility(
                "LendJudgmentGreaterAbility",
                greater_buff.Name,
                greater_buff.Description,
                "",
                greater_buff.Icon,
            ...
            lend_judgement_greater.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Heighten | Metamagic.Quicken | Metamagic.Reach;
        ...
        static void createFieryRunes()
        {
            ...
            var allow_buff = Helpers.CreateBuff("FieryRunesAllowBuff", "", "", "", null, null);
            allow_buff.SetBuffFlags(BuffFlags.HiddenInUi);

            var activatable_ability = Helpers.CreateActivatableAbility(
                "FieryRunesDischargeActivatableAbility",
            ...
            var effect = Helpers.CreateConditional(
                Helpers.Create<NewMechanics.ContextConditionMainTargetHasFact>(c =>
                    c.Fact = allow_buff
                ),
                dmg
            );
            ...
            var buff = Helpers.CreateBuff(
                ...
                Common.createAddInitiatorAttackWithWeaponTrigger(
                    Helpers.CreateActionList(effect),
                    check_weapon_range_type: true,
                    wait_for_attack_to_resolve: true
                ),
            ...
            var remove = Helpers.CreateConditional(
                Helpers.Create<NewMechanics.ContextConditionMainTargetHasFact>(c =>
                    c.Fact = allow_buff
                ),
                Common.createContextActionRemoveBuff(buff)
            ...
            buff.AddComponent(
                Common.createAddInitiatorAttackWithWeaponTrigger(
                    Helpers.CreateActionList(remove),
                    check_weapon_range_type: true,
                    on_initiator: true,
                    wait_for_attack_to_resolve: true
                )
            ...
            fiery_runes = Helpers.CreateAbility(
                "FieryRunesAbility",
                buff.Name,
                buff.Description,
                "",
                ...
                Helpers.CreateRunActions(
                    Common.createContextActionApplyBuff(
                        buff,
                        Helpers.CreateContextDuration(
                            Helpers.CreateContextValueRank(AbilityRankType.Default),
                            DurationRate.Minutes
                        ),
                        is_from_spell: true
                    )
            ...
            fiery_runes.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Extend
                | Metamagic.Reach
                | Metamagic.Quicken
        ...
        static void createBladedDash()
        {
            ...
            dimension_door_free = library.CopyAndAdd<BlueprintAbility>(
                "a9b8be9b87865744382f7c64e599aeb2",
                "BladedDashTeleportAbility",
                ""
            );
            ...
            var buff = Helpers.CreateBuff(
                ...
                null,
                null,
                Helpers.Create<NewMechanics.AttackBonusMaxFromMultipleStats>(a =>
                {
                    a.stats = new StatType[] { StatType.Charisma, StatType.Intelligence };
                    a.descriptor = ModifierDescriptor.Circumstance;
                })
            );
            buff.SetBuffFlags(BuffFlags.HiddenInUi);
            bladed_dash = Helpers.CreateAbility(
                "BladedDashAbility",
                "Bladed Dash",
            ...
            bladed_dash_greater = Helpers.CreateAbility(
                "BladedDashAbilityGreater",
                "Bladed Dash, Greater",
                ...
                Helpers.CreateRunActions(
                    Helpers.CreateConditional(
                        ...
                        new GameAction[]
                        {
                            ...
                            Helpers.CreateConditional(
                                Helpers.Create<ContextConditionIsMainTarget>(),
                                Helpers.Create<ContextActionCastSpell>(c =>
                                    c.Spell = dimension_door_free
                                )
                            ),
                ...
                library
                    .Get<BlueprintAbility>("c3e84b5e4400f16459ae8f0585e8dc2b")
                    .GetComponent<AbilityDeliverProjectile>(), //air blast torrent
                Helpers.CreateSpellComponent(SpellSchool.Transmutation),
                Helpers.Create<AbilityCasterMainWeaponIsMelee>()
            );
        ...
        static void createRebuke()
        {
            ...
            var sonic_dmg1 = Helpers.CreateActionDealDamage(
            ...
            var holy_dmg1 = Helpers.CreateActionDealDamage(
            ...
            var effect1 = Helpers.CreateConditionalSaved(
                null,
                Common.createContextActionApplyBuff(staggered, Helpers.CreateContextDuration(1))
            );

            var sonic_dmg2 = Helpers.CreateActionDealDamage(
                DamageEnergyType.Sonic,
                Helpers.CreateContextDiceValue(
                    BalanceFixes.getDamageDie(DiceType.D6),
                    Helpers.CreateContextValue(AbilityRankType.DamageDice)
            ...
            var holy_dmg2 = Helpers.CreateActionDealDamage(
                DamageEnergyType.Divine,
                Helpers.CreateContextDiceValue(
                    BalanceFixes.getDamageDie(DiceType.D6),
                    Helpers.CreateContextValue(AbilityRankType.DamageDice)
            ...
            var effect2 = Helpers.CreateConditionalSaved(
                null,
                Common.createContextActionApplyBuff(
                    stunned,
                    Helpers.CreateContextDuration(0, DurationRate.Rounds, DiceType.D4, 1)
                )
            );

            var deities = library
                .Get<BlueprintFeatureSelection>("59e7a76987fe3b547b9cce045f4db3e4")
                .AllFeatures;

            var effect = Helpers.CreateConditional(
                Helpers.Create<NewMechanics.ContextConditionCasterAndTargetHasFactFromList>(c =>
                    c.facts = deities
                ),
            ...
            rebuke = Helpers.CreateAbility(
                ...
                Helpers.CreateRunActions(effect),
                Common.createAbilitySpawnFx(
                    "2483780330931b64f97cbb6bb7cbd352",
                    position_anchor: AbilitySpawnFxAnchor.None,
                    orientation_anchor: AbilitySpawnFxAnchor.None
                ),
                Helpers.Create<SharedSpells.CannotBeShared>(),
        ...
        static void createFleshwormInfestation()
        {
            ...
            var protection_from_evil = library.Get<BlueprintBuff>(
            ...
            var dmg = Helpers.CreateActionDealDamage(
                DamageEnergyType.Unholy,
                Helpers.CreateContextDiceValue(BalanceFixes.getDamageDie(DiceType.D6), 1, 0)
            );
            dmg.DamageType.Type = DamageType.Direct;

            var dex_dmg = Helpers.CreateActionDealDamage(
                StatType.Dexterity,
                Helpers.CreateContextDiceValue(DiceType.Zero, 0, 2)
            );

            var effect = Helpers.CreateConditionalSaved(
                new GameAction[]
                {
                    Common.createContextActionApplyBuff(sickened, Helpers.CreateContextDuration(1)),
                },
                new GameAction[]
                {
                    Common.createContextActionApplyBuff(
            ...
            var conditional = Helpers.CreateConditional(
                Common.createContextConditionHasFact(protection_from_evil),
                null,
                action
            );

            var buff = Helpers.CreateBuff(
                "FleshwormInfestationBuff",
                "",
                "",
                "",
                null,
            ...
            fleshworm_infestation.AddComponent(
                Common.createAbilityTargetHasFact(
                    inverted: true,
                    Common.undead,
                    Common.construct,
        ...
        static void createGhoulTouch()
        {
            ...
            var sickened = library.CopyAndAdd<BlueprintBuff>(
                "4e42460798665fd4cb9173ffa7ada323",
                "GhoulTouchSickened",
                ""
            );
            ...
            var action = Common.createContextActionSavingThrow(
                SavingThrowType.Fortitude,
                Helpers.CreateActionList(Helpers.CreateConditionalSaved(null, apply_buff))
            );
            ...
            area.ReplaceComponent<AbilityAreaEffectBuff>(
                Helpers.CreateAreaEffectRunAction(
                    unitEnter: effect,
                    round: effect,
                    unitExit: remove
            ...
            var aura_buff = Helpers.CreateBuff(
                "GhoulTouchAuraBuff",
                "",
                "",
                "",
            ...
            var buff = Helpers.CreateBuff(
                ...
                Helpers.CreateSpellDescriptor(
                    SpellDescriptor.Paralysis | SpellDescriptor.MovementImpairing
                ),
                Common.createAuraFeatureComponent(aura_buff)
            );
            var primary_effect = Common.createContextActionApplyBuff(
                buff,
                Helpers.CreateContextDuration(2, DurationRate.Rounds, DiceType.D6, 1)
            );
            ...
            var checkers = hold_person
                .GetComponents<AbilityTargetHasNoFactUnless>()
                .ToArray<BlueprintComponent>()
                .AddToArray(hold_person.GetComponents<AbilityTargetHasFact>())
                .AddToArray(hold_person.GetComponents<AbilityTargetHasNoFactUnless>());
        ...
        static void createForcefulStrike()
        {
            ...
            var bull_rush = Helpers.Create<ContextActionCombatManeuver>(c =>
            {
                c.Type = Kingmaker.RuleSystem.Rules.CombatManeuver.BullRush;
                c.IgnoreConcealment = true;
                c.OnSuccess = Helpers.CreateActionList();
            });

            var bull_rush_buff = Helpers.CreateBuff(
                "ForcefullStrikeBullRushBuff",
                "",
                "",
                "",
                null,
            ...
            var apply_bull_rush_buff = Common.createContextActionOnContextCaster(
                Common.createContextActionApplyBuff(
                    bull_rush_buff,
                    Helpers.CreateContextDuration(1),
                    is_child: true
            ...
            var effect = Common.createContextActionSavingThrow(
                SavingThrowType.Fortitude,
                Helpers.CreateActionList(dmg, Helpers.CreateConditionalSaved(null, bull_rush))
            );
            ...
            forceful_strike = Helpers.CreateAbility(
                "ForcefulStrikeAbility",
                "Forceful Strike",
            ...
            forceful_strike.AvailableMetamagic =
                Metamagic.Heighten
                | Metamagic.Empower
                | Metamagic.Maximize
                | (Metamagic)MetamagicFeats.MetamagicExtender.IntensifiedGeneral
        ...
        static void createSpite()
        {
            ...
            var spite_give_ability_buff = Helpers.CreateBuff(
                "SpiteGiveAbilityBuff",
                "",
                "",
                "",
                null,
            ...
            var action_remove_spite_use = Helpers.CreateActionList(
                Common.createContextActionRemoveBuff(spite_give_ability_buff)
            );
            var spite_store_buff = Helpers.CreateBuff(
                "SpiteBuff",
                "Spite",
                ...
                Helpers.Create<SpellManipulationMechanics.FactStoreSpell>(f =>
                {
                    f.actions_on_store = action_remove_spite_use;
                    f.always_hit = true;
                }),
                Helpers.CreateAddFactContextActions(
                    Common.createContextActionApplyBuff(
                        spite_give_ability_buff,
                        Helpers.CreateContextDuration(),
                        is_child: true,
                        is_permanent: true
                    )
            ...
            spite_store_buff.AddComponent(
                Helpers.Create<SpellManipulationMechanics.AddStoredSpellToCaption>(a =>
                    a.store_fact = spite_store_buff
                )
            );
            var release_action =
                Helpers.Create<SpellManipulationMechanics.ReleaseSpellStoredInSpecifiedBuff>(r =>
                    r.fact = spite_store_buff
                );

            var release_buff = Helpers.CreateBuff(
                "SpiteReleaseBuff",
                "",
                "",
                "",
                ...
                Common.createAddTargetAttackWithWeaponTrigger(
                    Helpers.CreateActionList(
                        Common.createContextActionRemoveBuff(spite_store_buff),
                        Helpers.Create<ContextActionRemoveSelf>()
                    ),
            ...
            spite_store_buff.AddComponent(
                Helpers.CreateAddFactContextActions(
                    deactivated: Common.createContextActionRemoveBuff(release_buff)
                )
            );

            var apply_release_buff = Common.createContextActionApplyBuff(
                release_buff,
                Helpers.CreateContextDuration(),
                dispellable: false,
                is_permanent: true
            ...
            Predicate<AbilityData> check_slot_predicate = delegate(AbilityData spell)
            {
                return spell.Spellbook != null
                    ...
                    && !SpellManipulationMechanics.FactStoreSpell.hasSpellStoredInFact(
                        spell.Caster,
                        spite_store_buff
                    );
            };
            ...
            {
                var spite_use = Helpers.CreateAbility(
                    $"SpiteStoreAbility{i}",
                    "Spite: Store",
            ...
            spite.MaterialComponent = library
                .Get<BlueprintAbility>("c66e86905f7606c4eaa5c774f0357b2b")
                .MaterialComponent; //same as for stoneskin
        ...
        static void createHowlingAgony()
        {
            ...
            howling_agony = Helpers.CreateAbility(
                "HowlingAgonyAbility",
                "Howling Agony",
            ...
            howling_agony.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Reach
                | Metamagic.Quicken
        ...
        static void createFreezingSphere()
        {
            ...
            var dmg_water = Helpers.CreateActionDealDamage(
                DamageEnergyType.Cold,
                Helpers.CreateContextDiceValue(
                    BalanceFixes.getDamageDie(DiceType.D8),
                    Helpers.CreateContextValue(AbilityRankType.Default)
            ...
            var apply_staggered = Common.createContextActionApplyBuff(
                stagger_buff,
                Helpers.CreateContextDuration(0, DurationRate.Rounds, DiceType.D4, 1)
            );
            var water_subtype = library.Get<BlueprintFeature>("bf7ee56ec9e43c14fa17727997e91993");
            var effect = Helpers.CreateConditional(
                Common.createContextConditionHasFact(water_subtype),
                new GameAction[] { dmg_water, apply_staggered },
                new GameAction[] { dmg }
            );

            var projectile = library.Get<BlueprintProjectile>("99be5f02870297b48b0342ba44156dc2");

            freezing_sphere = Helpers.CreateAbility(
                "FreezingSphereAbility",
                "Freezing Sphere",
            ...
            freezing_sphere.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Maximize
                | Metamagic.Quicken
                | Metamagic.Heighten
        ...
        static void createHoldMonsterMass()
        {
            ...
            hold_monster_mass = library.CopyAndAdd<BlueprintAbility>(
                "41e8a952da7a5c247b3ec1c2dbb73018",
                "HoldMonsterMassAbility",
                ""
            );
            ...
            hold_monster_mass.AddComponent(
                Helpers.CreateAbilityTargetsAround(15.Feet(), TargetType.Enemy)
            );

            hold_monster_mass.SetName("Hold Monster, Mass");
            hold_monster_mass.SetDescription(
            ...
            var action = Helpers.CreateConditional(
                Helpers.CreateConditionsCheckerAnd(
                    Common.createContextConditionHasFacts(false, checker_fact[0].CheckedFacts),
                    Common.createContextConditionCasterHasFact(
                        checker_fact[0].UnlessFact,
                        has: false
                    )
                ),
                null,
                Helpers.CreateConditional(
                    Common.createContextConditionHasFacts(false, does_not_work.CheckedFacts),
                    null,
                    hold_monster.GetComponent<AbilityEffectRunAction>().Actions.Actions[0]
                )
            );

            hold_monster_mass.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(action)
            );
            hold_monster_mass.setMiscAbilityParametersRangedDirectional();
        ...
        static void createIrresistibleDance()
        {
            ...
            var buff = Helpers.CreateBuff(
                ...
                Helpers.Create<ConfusionControl.ControlConfusionBuff>(a =>
                    a.allowed_states = new Kingmaker.UnitLogic.Parts.ConfusionState[]
                    {
                        Kingmaker.UnitLogic.Parts.ConfusionState.DoNothing,
                    }
                ),
                Helpers.Create<NewMechanics.RemoveShieldACBonus>(),
                Helpers.CreateAddFactContextActions(
                    newRound: Helpers.Create<ContextActionProvokeAttackOfOpportunity>()
                ),
                Helpers.CreateSpellDescriptor(SpellDescriptor.MindAffecting)
            );

            var effect_saved = Common.createContextActionApplyBuff(
                buff,
                Helpers.CreateContextDuration(1),
                is_from_spell: true
            );
            var effect = Common.createContextActionApplyBuff(
                buff,
            ...
            var ability = Helpers.CreateAbility(
                ...
                Helpers.CreateRunActions(
                    SavingThrowType.Will,
                    Helpers.CreateConditionalSaved(effect_saved, effect)
                )
            );
            var dominate_monster = library.Get<BlueprintAbility>(
        ...
        static void createParticulateForm()
        {
            ...
            var buff = Helpers.CreateBuff(
                ...
                icon,
                null,
                Common.createAddContextEffectFastHealing(
                    Helpers.CreateContextValue(AbilityRankType.StatBonus)
                ),
            ...
            var particualte_form_swift = Helpers.CreateAbility(
                "ParticulateFormSwiftAction",
                ...
                Helpers.CreateRunActions(
                    Common.createContextActionHealTarget(
                        Helpers.CreateContextDiceValue(BalanceFixes.getDamageDie(DiceType.D6), 5)
                    ),
                    Common.createContextActionRemoveBuff(buff)
                )
            );
            buff.AddComponent(Helpers.CreateAddFact(particualte_form_swift));
            particulate_form = Helpers.CreateAbility(
            ...
            particulate_form.AvailableMetamagic =
                Metamagic.Reach | Metamagic.Extend | Metamagic.Heighten | Metamagic.Quicken;
        ...
        static void createHoldPersonMass()
        {
            ...
            hold_person_mass = library.CopyAndAdd<BlueprintAbility>(
                "c7104f7526c4c524f91474614054547e",
                "HoldPersonMassAbility",
                ""
            );
            ...
            hold_person_mass.AddComponents(
                Helpers.CreateAbilityTargetsAround(15.Feet(), TargetType.Enemy)
            );

            hold_person_mass.SetName("Hold Person, Mass");
            hold_person_mass.SetDescription(
            ...
            hold_person_mass.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(action)
            );
            hold_person_mass.setMiscAbilityParametersRangedDirectional();
        ...
        static void createCurseMajor()
        {
            ...
            var cl_bonus = Helpers.CreateBuff(
                "BestowCurseCLBonusBuff",
                "",
                "",
                "",
                null,
            ...
            {
                var ability = library.CopyAndAdd<BlueprintAbility>(
                    v.StickyTouch.TouchDeliveryAbility,
                    v.StickyTouch.TouchDeliveryAbility.name + "Major",
                    ""
                );
                ...
                var remove_buff = Common.createContextActionOnContextCaster(
                    Common.createContextActionRemoveBuff(cl_bonus)
                );

                ability.ReplaceComponent<AbilityEffectRunAction>(a =>
                    a.Actions = Helpers.CreateActionList(
                        apply_buff.AddToArray(a.Actions.Actions).AddToArray(remove_buff)
                    )
                );
        ...
        static void createFluidForm()
        {
            ...
            fluid_form = Helpers.CreateAbility(
                "FluidFormAbility",
                buff.Name,
                buff.Description,
                "",
        ...
        static void createSuffocation()
        {
            ...
            {
                marker_buffs[i] = Helpers.CreateBuff(
                    $"SuffocationMarkerBuff{i + 1}Buff",
                    "",
                    "",
                    "",
                    null,
                ...
                apply_marker_buff[i] = Common.createContextActionApplyBuff(
                    marker_buffs[i],
                    Helpers.CreateContextDuration(),
                    true,
                    true,
            ...
            var new_round = Helpers.CreateConditional(
                Helpers.CreateConditionHasFact(marker_buffs[1]),
                Helpers.Create<ContextActionKillTarget>(),
                Helpers.CreateConditional(
                    Helpers.CreateConditionHasFact(marker_buffs[0]),
                    new GameAction[]
                    {
                        apply_marker_buff[1],
            ...
            var new_round_saved = Common.createContextActionSavingThrow(
                SavingThrowType.Fortitude,
                Helpers.CreateActionList(Helpers.CreateConditionalSaved(null, new_round))
            );
            var new_round_after = Helpers.CreateConditional(
                Helpers.Create<BuffConditionCheckRoundNumber>(b => b.RoundNumber = 0),
                null,
                new_round_saved
            );

            suffocation_buff = Helpers.CreateBuff(
                "SuffocationBuff",
                "",
                "",
                "",
                ...
                null,
                Helpers.CreateAddFactContextActions(
                    activated: apply_staggered,
                    newRound: new_round_after
                ),
                Helpers.CreateSpellDescriptor(SpellDescriptor.Death)
            );

            var fast_death = Common.createContextActionSavingThrow(
                SavingThrowType.Fortitude,
                Helpers.CreateActionList(
                    Helpers.CreateConditionalSaved(
                        null,
            ...
            fast_suffocation_buff = Helpers.CreateBuff(
                "FastSuffocationBuff",
                "",
                "",
                "",
                ...
                null,
                Helpers.CreateAddFactContextActions(
                    activated: Helpers.Create<NewMechanics.ReduceHpToValue>(r => r.value = 0),
                    newRound: Helpers.CreateConditional(
                        Helpers.Create<BuffConditionCheckRoundNumber>(b => b.RoundNumber = 0),
                        null,
                        fast_death
            ...
            var effect = Helpers.CreateConditionalSaved(
                ...
                Common.createContextActionApplyBuff(
                    suffocation_buff,
                    Helpers.CreateContextDuration(3, DurationRate.Rounds),
                    is_from_spell: true
                )
            );

            var effect_mass = Helpers.CreateConditionalSaved(
                Common.createContextActionApplyBuff(
                    staggered,
                    Helpers.CreateContextDuration(1, DurationRate.Rounds),
                    is_from_spell: true
            ...
            suffocation = Helpers.CreateAbility(
                "SuffocationAbility",
                "Suffocation",
            ...
            suffocation.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Quicken
                | Metamagic.Reach
                | Metamagic.Heighten
            ...
            mass_suffocation = Helpers.CreateAbility(
                "SuffocationMassAbility",
                "Suffocation, Mass",
            ...
            mass_suffocation.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Quicken
                | Metamagic.Reach
                | Metamagic.Heighten
        ...
        static void createFireSeeds()
        {
            ...
            for (int i = 1; i <= 10; i++)
            {
                var primary_damage = Helpers.CreateActionDealDamage(
                    DamageEnergyType.Fire,
                    Helpers.CreateContextDiceValue(BalanceFixes.getDamageDie(DiceType.D4), i)
                );
                var secondary_damage = Helpers.CreateActionDealDamage(
                    DamageEnergyType.Fire,
                    Helpers.CreateContextDiceValue(DiceType.Zero, 0, i)
                );

                var conditional = Helpers.CreateConditional(
                    Helpers.Create<ContextConditionIsMainTarget>(),
                    new GameAction[] { primary_damage, secondary_damage },
                    new GameAction[] { secondary_damage }
                );
                ...
                var ability = Helpers.CreateAbility(
                    ...
                    Helpers.Create<AbilityEffectMiss>(a =>
                    {
                        a.MissAction = Helpers.CreateActionList(secondary_damage);
                        a.UseTargetSelector = true;
                    }),
            ...
            fire_seeds = Helpers.CreateAbility(
                "FireSeedsCastAbility",
                buff.Name,
                buff.Description,
                "",
                icon,
            ...
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("c85c8791ee13d4c4ea10d93c97a19afc"),
                fire_seeds,
                6
            );
        }
        ...
        static void createIceBody()
        {
            ...
            var weapon = library.CopyAndAdd<BlueprintItemWeapon>(
                "f60c5a820b69fb243a4cce5d1d07d06e",
                "IceBodyFist",
                ""
            );
            var frost_enchantment = library.Get<BlueprintWeaponEnchantment>(
                "421e54078b7719d40915ce0672511d0b"
            );

            var enchantment = Common.createWeaponEnchantment(
                "IceBodyWeaponEcnchantment",
                "Ice Body",
                ...
                Common.weaponEnergyDamageDice(
                    DamageEnergyType.Cold,
                    new DiceFormula(1, DiceType.One)
                )
            );
            ...
            var buff = Helpers.CreateBuff(
                ...
                Helpers.CreateAddFact(
                    library.Get<BlueprintFeature>("5e4d22d5cb6869e499f5fdc82e2127ad")
                ), //cold subtype
            ...
            ice_body = Helpers.CreateAbility(
                "IceBodyAbility",
                buff.Name,
                buff.Description,
                "",
        ...
        static void createRigorMortis()
        {
            ...
            var effect = Common.createContextActionSavingThrow(
                SavingThrowType.Fortitude,
                Helpers.CreateActionList(dmg, Helpers.CreateConditionalSaved(null, apply_buff))
            );

            rigor_mortis = Helpers.CreateAbility(
                "RigorMortisAbility",
                buff.Name,
                buff.Description,
                "",
            ...
            rigor_mortis.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Maximize
        ...
        static void createFlashfire()
        {
            ...
            var saved_dmg = Common.createContextActionSavingThrow(
                SavingThrowType.Reflex,
                Helpers.CreateActionList(
                    Helpers.CreateConditionalSaved(
                        new GameAction[0],
            ...
            var area_run_action =
                Helpers.Create<NewMechanics.AbilityAreaEffectRunActionWithFirstRound>(a =>
                {
                    a.UnitEnter = Helpers.CreateActionList(saved_dmg);
                    a.Round = Helpers.CreateActionList(saved_dmg);
                });
            ...
            area.SpellResistance = true;
            flashfire = Helpers.CreateAbility(
                "FlashfireAbility",
                "Flashfire",
        ...
        static void createBlisteringInvective()
        {
            ...
            var burn1d6 = library.Get<BlueprintBuff>("e92ecaa76b5db674fa5b0aaff5b21bc9");
            var dazzling_display = library.Get<BlueprintAbility>(
                "5f3126d4120b2b244a95cb2ec23d69fb"
            );

            var demoralize = (
                dazzling_display.GetComponent<AbilityEffectRunAction>().Actions.Actions[0]
                as Demoralize
            );

            var dmg = Helpers.CreateActionDealDamage(
                DamageEnergyType.Fire,
                Helpers.CreateContextDiceValue(BalanceFixes.getDamageDie(DiceType.D10), 1, 0)
            );
            var apply_burn = Common.createContextActionApplyBuff(
                burn1d6,
                Helpers.CreateContextDuration(),
            ...
            var effect = Common.createContextActionSavingThrow(
                SavingThrowType.Reflex,
                Helpers.CreateActionList(dmg, Helpers.CreateConditionalSaved(null, apply_burn))
            );

            blistering_invective = Helpers.CreateAbility(
                "BlisteringInvectiveAbility",
                ...
                Helpers.Create<DemoralizeMechanics.ScopedDemoralizeActions>(a =>
            ...
            blistering_invective.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Heighten
                | Metamagic.Quicken
                | Metamagic.Maximize
        ...
        static void createStrickenHeart()
        {
            ...
            var dmg = Helpers.CreateActionDealDamage(
                ...
                Helpers.CreateContextDiceValue(BalanceFixes.getDamageDie(DiceType.D6), 2, 0)
            );

            var frigid_touch = library.Get<BlueprintAbility>("c83447189aabc72489164dfc246f3a36");
            var ability = Helpers.CreateAbility(
                "StrickenHeartAbility",
                "Stricken Heart",
                ...
                Helpers.savingThrowNone,
                Helpers.CreateRunActions(
                    new GameAction[] { dmg }.AddToArray(
                        frigid_touch.GetComponent<AbilityEffectRunAction>().Actions.Actions.Skip(1)
                    )
                ),
                Helpers.CreateDeliverTouch(),
                Helpers.CreateSpellComponent(SpellSchool.Necromancy),
        ...
        static void createRiverOfWind()
        {
            var dmg = Helpers.CreateActionDealDamage(
                PhysicalDamageForm.Bludgeoning,
                Helpers.CreateContextDiceValue(BalanceFixes.getDamageDie(DiceType.D6), 4),
                true,
                true
            );
            var dmg2 = Helpers.CreateActionDealDamage(
            ...
            var saved = Helpers.CreateConditionalSaved(
                null,
                Helpers.Create<ContextActionKnockdownTarget>()
            );
            var effect = Helpers.CreateConditional(
                Helpers.CreateConditionHasFact(immunity_to_wind),
                null,
                Common.createContextActionSavingThrow(
                    SavingThrowType.Fortitude,
                    Helpers.CreateActionList(dmg, saved)
                )
            );
            var effect2 = Helpers.CreateConditional(
                Helpers.CreateConditionHasFact(immunity_to_wind),
                null,
                Common.createContextActionSavingThrow(
                    SavingThrowType.Fortitude,
                    Helpers.CreateActionList(dmg2, saved)
                )
            );
            ...
            area.ComponentsArray = new BlueprintComponent[]
            {
                Helpers.Create<NewMechanics.AbilityAreaEffectRunActionWithFirstRound>(a =>
                {
                    a.FirstRound = Helpers.CreateActionList(effect, dmg2);
                    a.Round = Helpers.CreateActionList(effect2);
                }),
            };
            area.SpellResistance = true;
            river_of_wind = Helpers.CreateAbility(
                "RiverOfWindAbility",
                "River of Wind",
            ...
            river_of_wind.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Maximize
            ...
            foreach (var b in freedom_buffs)
            {
                ...
                buff.AddComponent(
                    Common.createSpellImmunityToSpellDescriptor(SpellDescriptor.MovementImpairing)
                );
            }
        ...
        static void createWindsOfVengeance()
        {
            ...
            var dmg = Helpers.CreateActionDealDamage(
                PhysicalDamageForm.Bludgeoning,
                Helpers.CreateContextDiceValue(BalanceFixes.getDamageDie(DiceType.D8), 5),
                false,
                true
            );
            var saved = Helpers.CreateConditionalSaved(
            ...
            var apply_cooldown_on_main_target =
                Helpers.Create<NewMechanics.ContextActionOnMainTarget>(c =>
                    c.Actions = Helpers.CreateActionList(apply_cooldown)
                );
            var action = Helpers.CreateConditional(
                new Condition[]
                {
                    Helpers.Create<NewMechanics.ContextConditionMainTargetHasFact>(c =>
                        c.Fact = cooldown_buff
                    ),
            ...
            var on_hit = Common.createAddTargetAttackWithWeaponTrigger(
                Helpers.CreateActionList(),
                Helpers.CreateActionList(action)
            );
            var buff = Helpers.CreateBuff(
                ...
                Common.createSpellImmunityToSpellDescriptor(
                    SpellDescriptor.BreathWeapon | SpellDescriptor.Poison | SpellDescriptor.Ground
                ),
                Helpers.CreateAddStatBonus(StatType.Speed, 30, ModifierDescriptor.UntypedStackable),
                Helpers.Create<NewMechanics.WeaponAttackAutoMiss>(w =>
                    w.attack_types = new AttackType[] { AttackType.Ranged, AttackType.RangedTouch }
                ),
                on_hit,
            ...
            winds_of_vengeance = Helpers.CreateAbility(
                "WindsOfVengeanceAbility",
                buff.Name,
                buff.Description,
                "",
                icon,
            ...
            winds_of_vengeance.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Maximize
                | Metamagic.Extend
                | Metamagic.Heighten
        ...
        static void createBurstOfRadiance()
        {
            ...
            burst_of_radiance.LocalizedSavingThrow = Helpers.CreateString(
                "BurstOfRadianceAbility.SavingThrow",
                "Reflex partial"
            );
            ...
            burst_of_radiance.AvailableMetamagic =
                ...
                | (Metamagic)MetamagicFeats.MetamagicExtender.Piercing
                | (Metamagic)MetamagicFeats.MetamagicExtender.Selective;
            burst_of_radiance.ReplaceComponent<SpellDescriptorComponent>(
                Helpers.CreateSpellDescriptor(
                    SpellDescriptor.Good | SpellDescriptor.Blindness | SpellDescriptor.SightBased
                )
            );
            ...
            var effect = Helpers.CreateConditionalSaved(
                Common.createContextActionApplyBuff(dazzled, duration, is_from_spell: true),
            ...
            var apply_damage = Helpers.CreateConditional(
                Helpers.CreateContextConditionAlignment(AlignmentComponent.Evil),
                damage
            );

            burst_of_radiance.ReplaceComponent<AbilityEffectRunAction>(
                Helpers.CreateRunActions(SavingThrowType.Reflex, effect, apply_damage)
            );
            burst_of_radiance.AddComponent(
                Helpers.CreateContextRankConfig(
                    max: 5,
                    feature: MetamagicFeats.intensified_metamagic
                )
        ...
        static void createObscuringMist()
        {
            ...
            var stinking_cloud_area = library.Get<BlueprintAbilityAreaEffect>(
                "aa2e0a0fe89693f4e9205fd52c5ba3e5"
            );
            var cloudkill_area = library.Get<BlueprintAbilityAreaEffect>(
                "6df1ac314d4e6e9418e34470b79f90d8"
            );
            var mind_fog_area = library.Get<BlueprintAbilityAreaEffect>(
                "fe5102d734382b74586f56980086e5e8"
            );
            ...
            obscuring_mist = library.CopyAndAdd<BlueprintAbility>(
                "68a9e6d7256f1354289a39003a46d826",
                "ObscuringMistAbility",
                ""
            );
            ...
            obscuring_mist.ReplaceComponent<AbilityAoERadius>(a =>
                Helpers.SetField(a, "m_Radius", 20.Feet())
            );
            obscuring_mist.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(
                    Common.changeAction<ContextActionSpawnAreaEffect>(
                        a.Actions.Actions,
                        s =>
            ...
            obscuring_mist.AvailableMetamagic =
                Metamagic.Heighten | Metamagic.Quicken | Metamagic.Reach | Metamagic.Extend;
            ...
            obscuring_mist.LocalizedSavingThrow = Helpers.CreateString(
                "ObscuringMist.SavingThrow",
                ""
            );
            ...
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("e63d9133cebf2cf4788e61432a939084"),
                obscuring_mist,
                1
            ); //water
        ...
        static void createRayOfExhaustion()
        {
            ...
            var exhausted_guard = Helpers.CreateConditional(
                Common.createContextConditionHasFact(exhausted, false),
                apply_exhausted
            );
            var fatigued_guard = Helpers.CreateConditional(
                Common.createContextConditionHasFact(fatigued),
                exhausted_guard,
                apply_fatigued
            );
            ...
            var effect = Helpers.CreateConditional(
                new Condition[]
                {
                    Common.createContextConditionHasFact(undead, false),
                    Common.createContextConditionHasFact(construct, false),
                    Common.createContextConditionHasFact(elemental, false),
                },
                conditional_saved
            );
            var deliver = library
                .Get<BlueprintAbility>("450af0402422b0b4980d9c2175869612")
                .GetComponent<AbilityDeliverProjectile>()
                .CreateCopy(); //ray of enfeeblement
            deliver.Projectiles = new BlueprintProjectile[]
            {
                library.Get<BlueprintProjectile>("8e38d2cfc358e124e93c792dea56ff9a"),
            }; //ray of exhaustion ?
            ray_of_exhaustion = Helpers.CreateAbility(
                "RayOfExhaustionAbility",
                "Ray of Exhaustion",
            ...
            ray_of_exhaustion.setMiscAbilityParametersSingleTargetRangedHarmful(
                works_on_allies: true
            );
            ray_of_exhaustion.SpellResistance = true;
            ray_of_exhaustion.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Quicken
                | Metamagic.Heighten
                | Metamagic.Reach
        ...
        {
            var bow_spirit_swift = Helpers.CreateAbility(
                "BowSpiritEffectAbility",
                "Bow Spirit",
            ...
            bow_spirit = Helpers.CreateAbility(
                "BowSpiritAbility",
                buff.Name,
                buff.Description,
                "",
                ...
                Helpers.CreateSpellComponent(SpellSchool.Conjuration),
                Common.createAbilitySpawnFx(
                    "0c07afb9ee854184cb5110891324e3ad",
                    position_anchor: AbilitySpawnFxAnchor.SelectedTarget
                ),
                Common.createAbilitTargetMainWeaponCheck(
                    WeaponCategory.Longbow,
                    WeaponCategory.Shortbow
                )
            );
            bow_spirit.setMiscAbilityParametersSelfOnly();
            bow_spirit.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Heighten | Metamagic.Quicken;
        ...
        {
            var fog_area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                "aa2e0a0fe89693f4e9205fd52c5ba3e5",
                "BurningEntanglementFogArea",
                ""
            );
            fog_area.Fx = Common.createPrefabLink("098a29fefbbc4564281afa5a6887cd2c");
            fog_area.Size = 40.Feet();
            GameAction no_action = null;
            fog_area.ComponentsArray = new BlueprintComponent[]
            {
                Helpers.CreateAreaEffectRunAction(no_action),
            };

            var area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                "bcb6329cefc66da41b011299a43cc681",
                "BurningEntanglementArea",
                ""
            ); //entangle
            ...
            var dmg = Helpers.CreateConditional(
                Helpers.CreateConditionHasFact(entnagle_buff),
                Helpers.CreateActionDealDamage(
                    DamageEnergyType.Fire,
                    Helpers.CreateContextDiceValue(BalanceFixes.getDamageDie(DiceType.D6), 4),
                    halfIfSaved: true
            ...
            area_run_actions.Round = Helpers.CreateActionList(
                area_run_actions.Round.Actions.AddToArray(save_action)
            );
            var concealement_buff = library.CopyAndAdd<BlueprintBuff>(
                "49786ccc94a5ee848a5637b4145b2092",
                "BurningEntanglementConcealementBuff",
                ""
            ); //chameleon stride
            ...
            area.AddComponent(
                Helpers.Create<AbilityAreaEffectBuff>(a =>
                {
                    a.Buff = concealement_buff;
                    a.Condition = Helpers.CreateConditionsCheckerOr();
                })
            );

            burning_entanglement = library.CopyAndAdd<BlueprintAbility>(
                "0fd00984a2c0e0a429cf1a911b4ec5ca",
                "BurningEntanglementAbility",
                ""
            );
            var spawn_area = Common.createContextActionSpawnAreaEffect(
                area,
            ...
            var spawn_fog = Common.createContextActionSpawnAreaEffectMultiple(
                fog_area,
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilityRankType.Default),
                    DurationRate.Rounds
            ...
            burning_entanglement.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(spawn_area, spawn_fog)
            );
            burning_entanglement.RemoveComponents<SpellListComponent>();
            burning_entanglement.AvailableMetamagic =
                burning_entanglement.AvailableMetamagic
                | Metamagic.Empower
                | Metamagic.Maximize
                | (Metamagic)MetamagicFeats.MetamagicExtender.Dazing
            ...
            burning_entanglement.SetNameDescriptionIcon(
            ...
            burning_entanglement.LocalizedDuration = Helpers.CreateString(
                "BurningEntanglementAbility.Duration",
                Helpers.roundsPerLevelDuration
            );
            concealement_buff.SetNameDescriptionIcon(
                burning_entanglement.Name,
                burning_entanglement.Description,
                burning_entanglement.Icon
            );
            concealement_buff.FxOnStart = Common.createPrefabLink(
                "ba8a4e16282d63a439434697ee656a3a"
            ); //fire theme buff
            burning_entanglement.ReplaceComponent<SpellComponent>(s =>
                s.School = SpellSchool.Evocation
            );
        ...
        static void createThirstingEntanglement()
        {
            ...
            var area_run_actions = area.GetComponent<AbilityAreaEffectRunAction>().CreateCopy();
            var buff = library.CopyAndAdd<BlueprintBuff>(
                "f7f6330726121cf4b90a6086b05d2e38",
                "ThirstinEntanglementBuff",
                ""
            );
            buff.SetIcon(icon);
            ...
            var con_damage = Helpers.CreateActionDealDamage(
                StatType.Constitution,
                Helpers.CreateContextDiceValue(DiceType.D2, 1, 0)
            );

            var break_free = Helpers.Create<ContextActionBreakFree>(c =>
            {
                c.Success = Helpers.CreateActionList(Helpers.Create<ContextActionRemoveSelf>());
            ...
            var save_action = Helpers.CreateActionSavingThrow(
                SavingThrowType.Reflex,
                Helpers.CreateConditionalSaved(null, apply_buff)
            );
            var remove_buff = Helpers.Create<ContextActionRemoveBuffSingleStack>(c =>
                c.TargetBuff = buff
            );
            var remove_difficult_terrain = Helpers.Create<ContextActionRemoveBuffSingleStack>(c =>
                c.TargetBuff = difficult_terrain
            );
            var apply_difficult_terrain = Common.createContextActionApplyBuff(
                difficult_terrain,
                Helpers.CreateContextDuration(),
                is_child: true,
                is_permanent: true
            );
            var area_run_action = Helpers.CreateAreaEffectRunAction(
                unitEnter: new GameAction[] { save_action, apply_difficult_terrain },
                unitExit: new GameAction[] { remove_buff, remove_difficult_terrain },
                round: new GameAction[]
                {
                    Helpers.CreateConditional(
                        Helpers.CreateConditionHasFact(buff),
                        null,
                        save_action
                    ),
                }
            ...
            thirsting_entanglement = library.CopyAndAdd<BlueprintAbility>(
                "0fd00984a2c0e0a429cf1a911b4ec5ca",
                "ThirstingEntanglementAbility",
                ""
            );

            thirsting_entanglement.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(spawn_area)
            );
            thirsting_entanglement.RemoveComponents<SpellListComponent>();
            thirsting_entanglement.AvailableMetamagic =
                thirsting_entanglement.AvailableMetamagic
                | Metamagic.Empower
                | Metamagic.Maximize
                | (Metamagic)MetamagicFeats.MetamagicExtender.Persistent;

            thirsting_entanglement.SetNameDescriptionIcon(buff.Name, buff.Description, buff.Icon);
        ...
        static void createArchonsTrumpet()
        {
            ...
            var apply_paralyzed = Common.createContextActionApplyBuff(
                paralyzed,
                Helpers.CreateContextDuration(0, DurationRate.Rounds, DiceType.D4, 1),
                is_from_spell: true
            );
            ...
            archons_trumpet = Helpers.CreateAbility(
                "ArchonsTrumpetAbility",
                "Archon’s Trumpet",
                ...
                Common.createAbilityDeliverProjectile(
                    ...
                    library.Get<BlueprintProjectile>("c7fd792125b79904881530dbc2ff83de"),
                    30.Feet(),
                    5.Feet()
                ),
                Helpers.CreateSpellDescriptor(
            ...
            archons_trumpet.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Maximize
                | Metamagic.Quicken
                | Metamagic.Heighten
        ...
        {
            var area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                "a70dc66c3059b7a4cb5b2a2e8ac37762",
                "AuraOfDoomArea",
                ""
            );

            aura_of_doom_effect_buff = library.CopyAndAdd<BlueprintBuff>(
                "25ec6cb6ab1845c48a95f9c20b034220",
                "AuraOfDoomShakenBuff",
                ""
            ); //shaken
            aura_of_doom_effect_buff.Stacking = StackingType.Stack;
            var apply_shaken = Common.createContextActionApplyBuff(
                aura_of_doom_effect_buff,
                Helpers.CreateContextDuration(),
                is_child: false,
                dispellable: false,
                is_permanent: true
            ...
            var effect = Common.createContextActionSavingThrow(
                SavingThrowType.Will,
                Helpers.CreateActionList(on_save_failed)
            );

            var conditional_effect = Helpers.CreateConditional(
                Helpers.Create<ContextConditionIsEnemy>(),
                effect
            );
            area.ReplaceComponent<AbilityAreaEffectRunAction>(a =>
            {
                ...
                a.UnitExit = Helpers.CreateActionList(
                    Helpers.CreateConditional(
                        Common.createContextConditionHasBuffFromCaster(aura_of_doom_effect_buff),
                        Helpers.Create<ContextActionRemoveBuffSingleStack>(c =>
                            c.TargetBuff = aura_of_doom_effect_buff
                        )
                    )
                );
            });
            ...
            var apply_aura = Common.createContextActionApplyBuff(
                buff,
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilityRankType.Default),
                    DurationRate.TenMinutes
            ...
            aura_of_doom = Helpers.CreateAbility(
                "AuraOfDoomAbility",
                buff.Name,
                buff.Description,
                "",
            ...
            aura_of_doom.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Quicken
                | (Metamagic)MetamagicFeats.MetamagicExtender.Persistent
        ...
        {
            var allowed_categories = new WeaponCategory[]
            {
                WeaponCategory.Claw,
                WeaponCategory.Bite,
                WeaponCategory.Gore,
            ...
            var buff = Helpers.CreateBuff(
                ...
                Helpers.Create<NewMechanics.ContextWeaponCategoryDamageBonus>(c =>
                {
                    c.Value = 2;
                    c.categories = allowed_categories;
                })
            );
            ...
            bone_fists = Helpers.CreateAbility(
                "BoneFistsAbility",
                buff.Name,
                buff.Description,
                "",
        ...
        static void createExplosionOfRot()
        {
            ...
            var normal_dmg = Helpers.CreateActionDealDamage(
                DamageEnergyType.Unholy,
                Helpers.CreateContextDiceValue(
                    BalanceFixes.getDamageDie(DiceType.D6),
                    Helpers.CreateContextValue(AbilityRankType.DamageDice)
            ...
            var plant_dmg = Helpers.CreateActionDealDamage(
                DamageEnergyType.Unholy,
                Helpers.CreateContextDiceValue(
                    BalanceFixes.getDamageDie(DiceType.D6),
                    Helpers.CreateContextValue(AbilityRankType.DamageDice),
            ...
            var effect = Helpers.CreateConditionalSaved(
                new GameAction[0],
                new GameAction[] { apply_staggered }
            );
            var action_savingthrow = Common.createContextActionSavingThrow(
                SavingThrowType.Reflex,
                Helpers.CreateActionList(effect, dmg)
            );
            Common.addConditionalDCIncrease(
                action_savingthrow,
                Helpers.CreateConditionsCheckerOr(is_plant),
                2
            );

            explosion_of_rot = Helpers.CreateAbility(
                "ExplosionOfRotAbility",
                "Explosion of Rot",
                ...
                Common.createAbilitySpawnFx(
                    "a65a25d577ea8564e81c0368f09bf585",
                    anchor: AbilitySpawnFxAnchor.ClickedTarget
                ),
                Helpers.CreateSpellComponent(SpellSchool.Necromancy),
                Helpers.CreateAbilityTargetsAround(10.Feet(), TargetType.Any),
        ...
        static void createEarthTremor()
        {
            ...
            var difficult_terrain = library.CopyAndAdd<BlueprintBuff>(
                "1914ccc0f3da5b1439f0b90d90d05811",
                "EarthTremorDifficultTerrainBuff",
                ""
            );
            var area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                "8b4ea698ae053c541beed4e050f32dc3",
                "EarthTremorArea",
                ""
            );
            ...
            var failure_prone_action = Helpers.CreateConditional(
                Helpers.Create<CombatManeuverMechanics.ContextConditionTargetSizeLessOrEqual>(c =>
                    c.target_size = Size.Medium
                ),
            ...
            var spawn_in_cone = Helpers.Create<NewMechanics.ContextActionSpawnAreaEffectMultiple>(
                c =>
                {
                    c.AreaEffect = area;
                    c.use_caster_as_origin = true;
                    c.points_around_target = new Vector2[]
                    {
                        new Vector2(5.Feet().Meters, 0.0f),
                        new Vector2(10.Feet().Meters, 5.Feet().Meters),
                        new Vector2(10.Feet().Meters, -5.Feet().Meters),
                    };
                    c.DurationValue = Helpers.CreateContextDuration(1, DurationRate.Hours);
                }
            );
            var earth_tremor_cone = Helpers.CreateAbility(
                "EarthTremorCone",
                ...
                Helpers.Create<AbilityEffectRunActionOnClickedTarget>(a =>
                    a.Action = Helpers.CreateActionList(spawn_in_cone)
                ),
                Helpers.CreateContextRankConfig(
                    max: 10,
                    feature: MetamagicFeats.intensified_metamagic
                ...
                Common.createAbilityDeliverProjectile(
                    AbilityProjectileType.Cone,
                    library.Get<BlueprintProjectile>("868f9126707bdc5428528dd492524d52"),
                    20.Feet(),
                    5.Feet()
                ) //sonic cone
            );

            earth_tremor_cone.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Maximize
                | Metamagic.Heighten
                | Metamagic.Quicken
            ...
            var earth_tremor_line = library.CopyAndAdd<BlueprintAbility>(
                earth_tremor_cone.AssetGuid,
                "EarthTremorLine",
                ""
            );
            ...
            var spawn_in_line = Helpers.Create<NewMechanics.ContextActionSpawnAreaEffectMultiple>(
                c =>
                {
                    c.AreaEffect = area;
                    c.use_caster_as_origin = true;
                    ...
                    {
                        new Vector2(5.Feet().Meters, 0.0f),
                        new Vector2(15.Feet().Meters, 0),
                        new Vector2(25.Feet().Meters, 0),
                    };
                    c.DurationValue = Helpers.CreateContextDuration(1, DurationRate.Hours);
                }
            );
            ...
            var earth_tremor_burst = library.CopyAndAdd<BlueprintAbility>(
                earth_tremor_cone.AssetGuid,
                "EarthTremorBurst",
                ""
            );
            earth_tremor_burst.SetName("Earth Tremor: 10-foot Spread");
            earth_tremor_burst.ReplaceComponent<AbilityDeliverProjectile>(
                Helpers.CreateAbilityTargetsAround(
                    10.Feet(),
                    TargetType.Any,
                    Helpers.CreateConditionsCheckerOr(
            ...
            var spawn_in_burst = Helpers.Create<NewMechanics.ContextActionSpawnAreaEffectMultiple>(
                c =>
                {
                    c.AreaEffect = area;
                    c.use_caster_as_origin = true;
                    ...
                    c.points_around_target = new Vector2[]
                    {
                        new Vector2(5.Feet().Meters, 5.Feet().Meters),
                        new Vector2(5.Feet().Meters, -5.Feet().Meters),
                        new Vector2(-5.Feet().Meters, 5.Feet().Meters),
                        new Vector2(-5.Feet().Meters, -5.Feet().Meters),
                    };
            ...
            earth_tremor = Common.createVariantWrapper(
                "EarthTremorAbility",
                "",
                earth_tremor_cone,
                earth_tremor_line,
        ...
        static void createFrostBite()
        {
            ...
            BlueprintWeaponEnchantment[] frost_bite_enchantments = new BlueprintWeaponEnchantment[
                11
            ];
            var cold_damage = Common.createEnergyDamageDescription(
                Kingmaker.Enums.Damage.DamageEnergyType.Cold
            );

            var frost_enchant = library.Get<BlueprintWeaponEnchantment>(
                "421e54078b7719d40915ce0672511d0b"
            );
            touch_slam_cold = library.CopyAndAdd<BlueprintWeaponType>(
                "f18cbcb39a1b35643a8d129b1ec4e716",
                "TouchSlamColdType",
                ""
            ); //slam
            ...
            Helpers.SetField(
                touch_slam_cold,
                "m_TypeNameText",
                Helpers.CreateString("TouchSlamColdName", "Touch")
            );
            Helpers.SetField(
                touch_slam_cold,
                "m_DefaultNameText",
            ...
            var weapon = library.CopyAndAdd<BlueprintItemWeapon>(
                "767e6932882a99c4b8ca95c88d823137",
                "FrostBiteWeapon",
                ""
            ); //sling
            ...
            Helpers.SetField(
                weapon,
                "m_DisplayNameText",
                Helpers.CreateString("FrostBiteWeaponName", "Frost Bite")
            );
            Helpers.SetField(weapon, "m_Icon", icon);
            Common.addEnchantment(weapon, WeaponEnchantments.summoned_weapon_enchant);
            ...
            {
                var frost_bite_enchant =
                    Helpers.Create<NewMechanics.EnchantmentMechanics.WeaponDamageChange>(w =>
                    {
                        w.bonus_damage = 1 + i;
                ...
                frost_bite_enchantments[i] = Common.createWeaponEnchantment(
                    $"FrostBite{i}Enchantment",
                    "Frostbite",
                    ...
                    frost_bite_enchant,
                    Common.createAddInitiatorAttackWithWeaponTrigger(
                        Helpers.CreateActionList(apply_fatigued)
                    )
                );
            }

            var empower_buff = Common.createBuffContextEnchantPrimaryHandWeaponIfHasMetamagic(
                Kingmaker.UnitLogic.Abilities.Metamagic.Empower,
                false,
                false,
                new BlueprintWeaponType[0],
                WeaponEnchantments.empower_enchant
            );

            var maximize_buff = Common.createBuffContextEnchantPrimaryHandWeaponIfHasMetamagic(
                Kingmaker.UnitLogic.Abilities.Metamagic.Maximize,
                false,
                false,
                new BlueprintWeaponType[0],
                WeaponEnchantments.maximize_enchant
            );
            /*
            ...
            */
            ...
            buff.Stacking = Kingmaker.UnitLogic.Buffs.Blueprints.StackingType.Replace;
            weapon.AddComponent(
                Helpers.Create<NewMechanics.EnchantmentMechanics.WeaponSourceBuff>(w =>
                    w.buff = buff
                )
            );

            var reduce_buff_duration = Helpers.Create<ContextActionReduceBuffDuration>(c =>
            {
                c.TargetBuff = buff;
            ...
            {
                e.AddComponent(
                    Helpers.Create<NewMechanics.EnchantmentMechanics.ActionOnAttackWithEnchantedWeapon>(
                        a =>
                        {
                            a.ActionsOnSelf = Helpers.CreateActionList(reduce_buff_duration);
                            a.only_on_hit = true;
                        }
                    )
                );
            ...
            var frost_bite_weapon = Helpers.CreateAbility(
                "FrostBiteWeaponAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
            ...
            var frost_bite_charge = Helpers.CreateAbility(
                "FrostBiteChargeAbility",
                "Frostbite",
                ...
                Helpers.CreateDeliverTouch(),
                library
                    .Get<BlueprintAbility>("c83447189aabc72489164dfc246f3a36")
                    .GetComponent<AbilitySpawnFx>() //from frigid touch
            );
            ...
            frost_bite_sticky.AddComponents(
                Helpers.Create<StickyTouchMechnics.AbilityEffectStickyTouchMultiple>(a =>
                    a.num_charges = Helpers.CreateContextValue(AbilityRankType.ProjectilesCount)
                ),
                Helpers.CreateContextRankConfig(type: AbilityRankType.ProjectilesCount)
            );

            frost_bite = Common.createVariantWrapper(
                "FrostBiteAbility",
                "",
                frost_bite_sticky,
                frost_bite_weapon
        ...
        static void createChillTouch()
        {
            ...
            BlueprintWeaponEnchantment[] chill_touch_echantments = new BlueprintWeaponEnchantment[
                10
            ];
            var negative_damage = Common.createEnergyDamageDescription(
                Kingmaker.Enums.Damage.DamageEnergyType.NegativeEnergy
            );

            var frost_enchant = library.Get<BlueprintWeaponEnchantment>(
                "421e54078b7719d40915ce0672511d0b"
            );
            touch_slam_negative = library.CopyAndAdd<BlueprintWeaponType>(
                "f18cbcb39a1b35643a8d129b1ec4e716",
                "TouchSlamNegativeType",
                ""
            ); //slam
            ...
            Helpers.SetField(
                touch_slam_negative,
                "m_TypeNameText",
                Helpers.CreateString("TouchSlamNegativeName", "Touch")
            );
            Helpers.SetField(
                touch_slam_negative,
                "m_DefaultNameText",
            ...
            Helpers.SetField(
                weapon,
                "m_DisplayNameText",
                Helpers.CreateString("ChillTouchWeaponName", "Chill Touch")
            );
            Helpers.SetField(weapon, "m_Icon", icon);
            Common.addEnchantment(weapon, WeaponEnchantments.summoned_weapon_enchant);

            var frightened = library.CopyAndAdd<BlueprintBuff>(
                "f08a7239aa961f34c8301518e71d4cdf",
                "ChillTouchUndeadFrightenedBuff",
                ""
            );
            ...
            {
                var on_living = Helpers.CreateConditionalSaved(
                    null,
                    Helpers.CreateActionDealDamage(
                        StatType.Strength,
                        Helpers.CreateContextDiceValue(DiceType.Zero, bonus: 1)
                    )
                );
                var on_undead = Helpers.CreateConditionalSaved(
                    null,
                    Common.createContextActionApplyBuff(
                        frightened,
                        Helpers.CreateContextDuration(i + 1, diceType: DiceType.D4, diceCount: 1),
                        is_from_spell: true
                    )
                );
                var effect = Helpers.CreateConditional(
                    Helpers.CreateConditionHasFact(undead),
                    Common.createContextActionSavingThrow(
                        SavingThrowType.Will,
                        Helpers.CreateActionList(on_undead)
                    ),
                    Common.createContextActionSavingThrow(
                        SavingThrowType.Fortitude,
                        Helpers.CreateActionList(on_living)
                    )
                );
                chill_touch_echantments[i] = Common.createWeaponEnchantment(
                    $"ChillTouch{i}Enchantment",
                    "Chill Touch",
            ...
            var chill_touch_weapon = Helpers.CreateAbility(
                "ChillTouchWeaponAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
            ...
            chill_touch_weapon.AvailableMetamagic =
                Kingmaker.UnitLogic.Abilities.Metamagic.Extend
                | Kingmaker.UnitLogic.Abilities.Metamagic.Heighten
                | Kingmaker.UnitLogic.Abilities.Metamagic.Empower
                | Kingmaker.UnitLogic.Abilities.Metamagic.Maximize
            ...
            var charge_on_living = Helpers.CreateConditionalSaved(
                null,
                Helpers.CreateActionDealDamage(
                    StatType.Strength,
                    Helpers.CreateContextDiceValue(DiceType.Zero, bonus: 1)
            ...
            var charge_on_undead = Helpers.CreateConditionalSaved(
                null,
                Common.createContextActionApplyBuff(
                    frightened,
                    Helpers.CreateContextDuration(
            ...
            var charge_effect = Helpers.CreateConditional(
                Helpers.CreateConditionHasFact(undead),
                new GameAction[]
                {
                    Common.createContextActionSavingThrow(
                        SavingThrowType.Will,
                        Helpers.CreateActionList(charge_on_undead)
                    ),
                },
                new GameAction[]
                {
                    Common.createContextActionSavingThrow(
                        SavingThrowType.Fortitude,
                        Helpers.CreateActionList(charge_on_living)
                    ),
                    Helpers.CreateActionDealDamage(
                        DamageEnergyType.NegativeEnergy,
                        Helpers.CreateContextDiceValue(DiceType.D6, 1, 0)
            ...
            var chill_touch_charge = Helpers.CreateAbility(
                "ChillTouchChargeAbility",
                "Chill Touch",
                ...
                library
                    .Get<BlueprintAbility>("cbecdd04ad2523c438123ef596fd2b9f")
                    .GetComponent<AbilitySpawnFx>(), //touch of fatigue fx
                Helpers.CreateContextRankConfig(max: 10)
            );
            ...
            chill_touch_sticky.AddComponents(
                Helpers.Create<StickyTouchMechnics.AbilityEffectStickyTouchMultiple>(a =>
                    a.num_charges = Helpers.CreateContextValue(AbilityRankType.ProjectilesCount)
                ),
                Helpers.CreateContextRankConfig(type: AbilityRankType.ProjectilesCount)
            ...
            chill_touch = Common.createVariantWrapper(
                "ChillTouchAbility",
                "",
                chill_touch_sticky,
                chill_touch_weapon
        ...
        static void createWinterGrasp()
        {
            ...
            var chill_buff = Helpers.CreateBuff(
                "WinterGraspChillBuff",
                "Winter's Grasp",
                ...
                Common.createContextSavingThrowBonusAgainstDescriptor(
                    -2,
                    ModifierDescriptor.UntypedStackable,
                    SpellDescriptor.Cold
                ),
            ...
            var area_effect = Helpers.CreateAreaEffectRunAction(
                round: new GameAction[]
                {
                    Helpers.CreateActionDealDamage(
                        DamageEnergyType.Cold,
                        Helpers.CreateContextDiceValue(BalanceFixes.getDamageDie(DiceType.D6), 1)
                    ),
                    Common.createContextActionApplyBuff(
                        chill_buff,
                        Helpers.CreateContextDuration(1),
            ...
            winter_grasp = Helpers.CreateAbility(
                "WinterGraspAbility",
                chill_buff.Name,
            ...
            winter_grasp.AvailableMetamagic =
                Metamagic.Extend
                | Metamagic.Empower
                | Metamagic.Maximize
                | Metamagic.Quicken
        ...
        static void createBloodMist()
        {
            ...
            var concleament_buff = library.CopyAndAdd<BlueprintBuff>(
                "dd3ad347240624d46a11a092b4dd4674",
                "BloodMistConcleamentBuff",
                ""
            );
            ...
            concleament_buff.ReplaceComponent<AddConcealment>(a =>
                a.Descriptor = ConcealmentDescriptor.Fog
            );
            concleament_buff.AddComponent(
                Common.createOutgoingConcelement(concleament_buff.GetComponent<AddConcealment>())
            );

            var undead = library.Get<BlueprintFeature>("734a29b693e9ec346ba2951b27987e33");
            var construct = library.Get<BlueprintFeature>("fd389783027d63343b4a5634bd81645f");
            var apply_attack = Helpers.CreateConditionalSaved(
                new GameAction[0],
                new GameAction[]
                {
                    Common.createContextActionApplyBuff(
                    ...
                    Helpers.CreateActionDealDamage(
                        StatType.Wisdom,
                        Helpers.CreateContextDiceValue(DiceType.D4, 1, 0)
                    ),
                }
            );
            var apply_buff = Helpers.CreateConditional(
                new Condition[]
                {
                    Helpers.CreateConditionHasFact(undead, not: true),
                    Helpers.CreateConditionHasFact(construct, not: true),
                },
                Common.createContextActionSavingThrow(
                    SavingThrowType.Fortitude,
                    Helpers.CreateActionList(apply_attack)
                )
            );
            var apply_concleament = Common.createContextActionApplyBuff(
                concleament_buff,
                Helpers.CreateContextDuration(),
                is_child: true,
                is_permanent: true
            ...
            var mist_action = Helpers.CreateAreaEffectRunAction(
                unitEnter: new GameAction[] { apply_buff },
                unitExit: new GameAction[]
                {
                    Helpers.Create<ContextActionRemoveBuffSingleStack>(r => r.TargetBuff = buff),
                }
            );

            area.ReplaceComponent<AbilityAreaEffectRunAction>(mist_action);

            blood_mist = library.CopyAndAdd<BlueprintAbility>(
                "68a9e6d7256f1354289a39003a46d826",
                "BloodMistAbility",
                ""
            );
            blood_mist.RemoveComponents<SpellListComponent>();
            blood_mist.ReplaceComponent<AbilityAoERadius>(a =>
                Helpers.SetField(a, "m_Radius", 30.Feet())
            );
            blood_mist.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(
                    Common.changeAction<ContextActionSpawnAreaEffect>(
                        a.Actions.Actions,
                        s => s.AreaEffect = area
        ...
        static void createSavageMaw()
        {
            ...
            var buff = library.CopyAndAdd<BlueprintBuff>(
                "a67b51a8074ae47438280be0a87b01b6",
                "SavageMawBuff",
                ""
            ); //animal fury
            var bleed1d4 = library.Get<BlueprintBuff>("5eb68bfe186d71a438d4f85579ce40c1");
            var apply_bleed = Common.createContextActionApplyBuff(
                bleed1d4,
                Helpers.CreateContextDuration(),
                is_permanent: true,
                dispellable: false
            ...
            buff.AddComponent(
                Common.createAddInitiatorAttackWithWeaponTriggerWithCategory(
                    Helpers.CreateActionList(apply_bleed),
                    critical_hit: true,
                    weapon_category: WeaponCategory.Bite
                )
            );

            var roar = library.CopyAndAdd<BlueprintAbility>(
                "5f3126d4120b2b244a95cb2ec23d69fb",
                "SavageMawRoarAbility",
                ""
            ); //dazzling display
            ...
            savage_maw = Helpers.CreateAbility(
                "SavageMawAbility",
                "Savage Maw",
                roar.Description,
                "",
            ...
            savage_maw.AvailableMetamagic =
                Metamagic.Extend | Metamagic.Heighten | Metamagic.Quicken;
            var remove_self = Common.createContextActionOnContextCaster(
                Common.createContextActionRemoveBuff(buff)
            );
            ...
            roar.AddComponent(
                Common.createAbilityExecuteActionOnCast(Helpers.CreateActionList(remove_self))
            );
        ...
        {
            var keen_edge_enchant = library.Get<BlueprintWeaponEnchantment>(
                "102a9c8c9b7a75e4fb5844e79deaf4c0"
            );

            var icon = library
                .Get<BlueprintActivatableAbility>("27d76f1afda08a64d897cc81201b5218")
                .Icon; //keen weapon bond

            var keen_edge1 = library.CopyAndAdd<BlueprintAbility>(
                "831e942864e924846a30d2e0678e438b",
                "KeenEdgePrimaryHandAbility",
                ""
            );

            keen_edge1.SetIcon(icon);
            keen_edge1.SetDescription(
            ...
            var action_old = (
                keen_edge1.GetComponent<AbilityEffectRunAction>().Actions.Actions[0]
                as ContextActionEnchantWornItem
            );

            var action = Common.createItemEnchantmentAction(
                keen_edge_enchant.name + "PrimaryHandKeenEdgeBuff",
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilityRankType.Default),
                    DurationRate.TenMinutes
                ),
            ...
            keen_edge1.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(action)
            );
            ...
            var action2 = Common.createItemEnchantmentAction(
                keen_edge_enchant.name + "SecondaryHandKeenEdgeBuff",
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilityRankType.Default),
                    DurationRate.TenMinutes
                ),
            ...
            keen_edge2.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(action2)
            );
            keen_edge2.AddComponent(
                Helpers.Create<NewMechanics.AbilitTargetManufacturedWeapon>(a =>
                {
                    a.off_hand = true;
                    a.works_on_summoned = true;
        ...
        static void createFlameArrow()
        {
            ...
            var dmg = Helpers.CreateActionDealDamage(
                DamageEnergyType.Fire,
                Helpers.CreateContextDiceValue(DiceType.D6, 1),
                IgnoreCritical: true
            );
            var buff = Helpers.CreateBuff(
                "FlameArrowBuff",
                ...
                Common.createAddInitiatorAttackWithWeaponTriggerWithCategory(
                    Helpers.CreateActionList(dmg),
                    wait_for_attack_to_resolve: true,
                    weapon_category: WeaponCategory.Longbow
                ),
                Common.createAddInitiatorAttackWithWeaponTriggerWithCategory(
                    Helpers.CreateActionList(dmg),
                    wait_for_attack_to_resolve: true,
                    weapon_category: WeaponCategory.Shortbow
                ),
                Common.createAddInitiatorAttackWithWeaponTriggerWithCategory(
                    Helpers.CreateActionList(dmg),
                    wait_for_attack_to_resolve: true,
                    weapon_category: WeaponCategory.LightCrossbow
                ),
                Common.createAddInitiatorAttackWithWeaponTriggerWithCategory(
                    Helpers.CreateActionList(dmg),
                    wait_for_attack_to_resolve: true,
                    weapon_category: WeaponCategory.HeavyCrossbow
                ),
                Common.createAddInitiatorAttackWithWeaponTriggerWithCategory(
                    Helpers.CreateActionList(dmg),
                    wait_for_attack_to_resolve: true,
                    weapon_category: WeaponCategory.LightRepeatingCrossbow
                ),
                Common.createAddInitiatorAttackWithWeaponTriggerWithCategory(
                    Helpers.CreateActionList(dmg),
                    wait_for_attack_to_resolve: true,
                    weapon_category: WeaponCategory.HeavyRepeatingCrossbow
                ),
                Common.createAddInitiatorAttackWithWeaponTriggerWithCategory(
                    Helpers.CreateActionList(dmg),
                    wait_for_attack_to_resolve: true,
                    weapon_category: WeaponCategory.HandCrossbow
                ),
                Common.createAddInitiatorAttackWithWeaponTriggerWithCategory(
                    Helpers.CreateActionList(dmg),
                    wait_for_attack_to_resolve: true,
                    weapon_category: WeaponCategory.Sling
                ),
                Common.createAddInitiatorAttackWithWeaponTriggerWithCategory(
                    Helpers.CreateActionList(dmg),
                    wait_for_attack_to_resolve: true,
                    weapon_category: WeaponCategory.Javelin
                ),
                Common.createAddInitiatorAttackWithWeaponTriggerWithCategory(
                    Helpers.CreateActionList(dmg),
                    wait_for_attack_to_resolve: true,
                    weapon_category: WeaponCategory.SlingStaff
                )
            );
            var apply_buff = Common.createContextActionApplyBuff(
                buff,
            ...
            flame_arrow = Helpers.CreateAbility(
                "FlameArrowAbility",
                buff.Name,
                buff.Description,
                "",
                ...
                Common.createAbilitySpawnFx(
                    "352469f228a3b1f4cb269c7ab0409b8e",
                    anchor: AbilitySpawnFxAnchor.SelectedTarget
                ), //CommonTransmutationBuff00
                Helpers.CreateSpellComponent(SpellSchool.Transmutation),
                Helpers.CreateContextRankConfig()
            );

            flame_arrow.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Extend
                | Metamagic.Heighten
                | Metamagic.Quicken
        ...
        {
            var improved_uncanny_dodge = library.Get<BlueprintFeature>(
                "485a18c05792521459c7d06c63128c79"
            );
            countless_eyes = library.CopyAndAdd<BlueprintAbility>(
                "c927a8b0cd3f5174f8c0b67cdbfde539",
                "CountlessEyesAbility",
                ""
            );
            countless_eyes.LocalizedSavingThrow = Helpers.CreateString(
                countless_eyes.name + ".LocalizedSavingThrow",
                HarmlessSaves.HarmlessSaves.will_harmless
            );
            countless_eyes.SetName("Countless Eyes");
            countless_eyes.SetDescription(
            ...
            countless_eyes.LocalizedDuration = Helpers.CreateString(
                "CountlessEyes.Duration",
                Helpers.hourPerLevelDuration
            );
            var buff = Helpers.CreateBuff(
                "NoFlankingBuff",
            ...
            countless_eyes.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(apply_buff)
            );
            countless_eyes.RemoveComponents<SpellListComponent>();
            countless_eyes.ReplaceComponent<SpellComponent>(s =>
                s.School = SpellSchool.Transmutation
            );
            countless_eyes.AvailableMetamagic =
                Metamagic.Heighten | Metamagic.Quicken | Metamagic.Reach | Metamagic.Extend;
        ...
        static void createRighteousVigor()
        {
            ...
            var freedom_of_movement = library.Get<BlueprintAbility>(
            ...
            var buff = Helpers.CreateBuff(
                ...
                Helpers.Create<NewMechanics.PersistentTemporaryHitPoints>(t =>
                {
                    t.Value = 0;
            ...
            var on_hit_actions = Helpers.CreateActionList(
                Common.createAddStackingStatBonusToModifierFromFact(
                    1,
                    StatType.AdditionalAttackBonus,
                    ModifierDescriptor.Morale,
                    buff,
                ...
                Common.createAddStackingStatBonusToModifierFromFact(
                    Helpers.CreateContextDiceValue(DiceType.D8, 1),
            ...
            var on_miss_actions = Helpers.CreateActionList(
                Common.createAddStackingStatBonusToModifierFromFact(
                    0,
                    StatType.AdditionalAttackBonus,
                    ModifierDescriptor.Morale,
            ...
            var on_miss = Helpers.Create<NewMechanics.AddInitiatorAttackRollMissTrigger>(a =>
            {
                a.Action = on_miss_actions;
                a.OnOwner = true;
            });

            buff.AddComponents(on_hit, on_miss);

            righteous_vigor = Helpers.CreateAbility(
                "RighteousVigorAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
            ...
            righteous_vigor.AvailableMetamagic =
                Metamagic.Empower
                | Metamagic.Extend
                | Metamagic.Quicken
                | Metamagic.Reach
        ...
        static void createForceSword()
        {
            ...
            var air_enchatment = library.Get<BlueprintWeaponEnchantment>(
                "1d64abd0002b98043b199c0e3109d3ee"
            );
            var force_damage = Common.createForceDamageDescription();

            var force_enchant = Common.createWeaponEnchantment(
                "ForceWeaponEnchantment",
                "Force",
                "This weapon deals force damage.",
                "",
                "",
                "",
                0,
            ...
            var weapon = library.CopyAndAdd<BlueprintItemWeapon>(
                "6fd0a849531617844b195f452661b2cd",
                "ForceSwordWeapon",
                ""
            ); //longsword
            ...
            Helpers.SetField(
                weapon,
                "m_DisplayNameText",
                Helpers.CreateString("ForceBladeName", "Force Sword")
            );
            Helpers.SetField(weapon, "m_Icon", icon);
            Common.addEnchantment(weapon, WeaponEnchantments.summoned_weapon_enchant);
            ...
            force_sword = library.CopyAndAdd<BlueprintAbility>(
                shillelagh.AssetGuid,
                "ForceSwordAbility",
                ""
            );
            ...
            force_sword.ActionType = Kingmaker
                .UnitLogic
                .Commands
                .Base
                .UnitCommand
            ...
            force_sword.ReplaceComponent<NewMechanics.AbilitTargetMainWeaponCheck>(
                Helpers.Create<NewMechanics.AbilityTargetPrimaryHandFree>()
            );
            force_sword.ReplaceComponent<SpellComponent>(
                Helpers.CreateSpellComponent(
            ...
            force_sword.ReplaceComponent<AbilityEffectRunAction>(
                Helpers.CreateRunActions(apply_buff)
            );
            force_sword.AvailableMetamagic =
                Metamagic.Heighten | Metamagic.Reach | Metamagic.Extend | Metamagic.Quicken;
        ...
        static void createBloodArmor()
        {
            ...
            {
                blood_armor_buffs[i] = Helpers.CreateBuff(
                    $"BloodArmor{i + 1}Buff",
                    "",
                    "",
                    "",
                    icon,
                    blood_fx,
                    Common.createBuffContextEnchantArmor(
                        1,
                        false,
                        true,
                        new BlueprintArmorEnchantment[]
                        {
                            ArmorEnchantments.temporary_armor_enchantments[i],
                        }
                    )
                );
            ...
            var conditional = Helpers.CreateConditional(
                Helpers.CreateConditionHasBuff(blood_armor_buffs[0]),
                new GameAction[]
                {
                    Common.createContextActionRemoveBuff(blood_armor_buffs[0]),
                    Common.createContextActionApplyBuff(
                        blood_armor_buffs[1],
                        Helpers.CreateContextDuration(),
                        is_from_spell: true,
            ...
            for (int i = 1; i < blood_armor_buffs.Length; i++)
            {
                ...
                {
                    if_true = new GameAction[]
                    {
                        Common.createContextActionRemoveBuff(blood_armor_buffs[i]),
                        Common.createContextActionApplyBuff(
                            blood_armor_buffs[i + 1],
                            Helpers.CreateContextDuration(),
                            is_from_spell: true,
                            is_child: true,
                            is_permanent: true,
                ...
                conditional = Helpers.CreateConditional(
                    Helpers.CreateConditionHasBuff(blood_armor_buffs[i]),
                    if_true,
            ...
            var on_dmg = Helpers.Create<NewMechanics.AddIncomingDamageTriggerOnAttacker>(a =>
            {
                ...
                a.physical_types = new PhysicalDamageForm[]
                {
                    PhysicalDamageForm.Piercing,
            ...
            var apply_buff = Common.createContextActionApplyBuff(
                buff,
                Helpers.CreateContextDuration(
                    bonus: Helpers.CreateContextValue(AbilityRankType.Default),
                    rate: DurationRate.Minutes
                ),
                is_from_spell: true
            );

            blood_armor = library.CopyAndAdd<BlueprintAbility>(
            ...
            blood_armor.setMiscAbilityParametersSelfOnly();
            blood_armor.LocalizedDuration = Helpers.CreateString(
                "BloodArmor.Duration",
                Helpers.minutesPerLevelDuration
            );
            ...
            blood_armor.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(apply_buff)
            );
        ...
        {
            poison_breath = library.CopyAndAdd<BlueprintAbility>(
                "d797007a142a6c0409a74b064065a15e",
                "PoisonBreathAbility",
                ""
            );
            poison_breath.SetName("Poison Breath");
            poison_breath.SetDescription(
            ...
            poison_breath.ActionType = Kingmaker
                .UnitLogic
                .Commands
                .Base
                .UnitCommand
                .CommandType
                .Standard;
            poison_breath.AvailableMetamagic =
                Metamagic.Heighten
                | Metamagic.Quicken
                | (Metamagic)MetamagicFeats.MetamagicExtender.Persistent
                | (Metamagic)MetamagicFeats.MetamagicExtender.Selective;
        ...
        static void createVineStrike()
        {
            ...
            var apply_entangle = Common.createContextActionApplyBuff(
                entangle_buff,
                Helpers.CreateContextDuration(1)
            );
            var apply_cooldown = Common.createContextActionApplyBuff(
            ...
            var save_action = Helpers.CreateConditionalSaved(
                new GameAction[] { apply_cooldown },
                new GameAction[] { apply_entangle, apply_cooldown }
            );
            var effect_action = Helpers.CreateConditional(
                Common.createContextConditionHasBuffFromCaster(cooldown_buff, not: true),
                Common.createContextActionSavingThrow(
                    SavingThrowType.Reflex,
                    Helpers.CreateActionList(save_action)
                )
            );
            var dmg = Helpers.CreateActionDealDamage(
                PhysicalDamageForm.Piercing,
            ...
            WeaponCategory[] categories = new WeaponCategory[]
            {
                WeaponCategory.UnarmedStrike,
                WeaponCategory.Claw,
                WeaponCategory.Bite,
            ...
            {
                var buff = Helpers.CreateBuff(
                    "VineStrike" + categories[i].ToString() + "Buff",
                ...
                var ability = Helpers.CreateAbility(
                    "VineStrike" + categories[i].ToString() + "Ability",
                    buff.Name,
                    buff.Description,
                    "",
                    buff.Icon,
        ...
        static void createSheetLightning()
        {
            ...
            var apply_dazed = Common.createContextActionApplyBuff(
                dazed,
                Helpers.CreateContextDuration(1)
            );
            var apply_dazzled = Common.createContextActionApplyBuff(
                dazzled,
                Helpers.CreateContextDuration(1)
            );
            var deal_damage = Helpers.CreateActionDealDamage(
            ...
            var context_saved = Common.createContextActionSavingThrow(
                SavingThrowType.Fortitude,
                Helpers.CreateActionList(save_result)
            );
            Common.addConditionalDCIncrease(
                context_saved,
                Helpers.CreateConditionsCheckerOr(
            ...
            sheet_lightning = Helpers.CreateAbility(
                "SheetLightningAbility",
                "Sheet Lightning",
                ...
                Helpers.CreateRunActions(
                    deal_damage,
                    Helpers.CreateConditional(
                        Common.createContextConditionHasFacts(false, undead, constructs),
                        null,
                        context_saved
                    )
                ),
                ...
                Helpers.CreateSpellComponent(SpellSchool.Evocation),
                Common.createAbilitySpawnFx(
                    "86e72b9ddeef0324d9d23c48594d6b7d",
                    AbilitySpawnFxAnchor.ClickedTarget
                ) //thunderstorm kineticist blast aoe
            );

            sheet_lightning.setMiscAbilityParametersRangedDirectional();
            sheet_lightning.SpellResistance = true;
            sheet_lightning.AvailableMetamagic =
                Metamagic.Heighten
                | Metamagic.Quicken
                | Metamagic.Extend
                | Metamagic.Reach
        ...
        {
            flurry_of_snowballs = library.CopyAndAdd<BlueprintAbility>(
                "e7c530f8137630f4d9d7ee1aa7b1edc0",
                "FlurryOfSnowballsAbility",
                ""
            );
            ...
            flurry_of_snowballs.SetDescription(
            ...
            flurry_of_snowballs.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(damage)
            );
            var cold_cone30 = library.Get<BlueprintProjectile>("72b45860bdfb81f4284aa005c04594dd");
            flurry_of_snowballs.ReplaceComponent<AbilityDeliverProjectile>(a =>
            {
                a.Projectiles = new BlueprintProjectile[] { cold_cone30 };
                a.Length = 30.Feet();
            });
            flurry_of_snowballs.AvailableMetamagic =
                Metamagic.Quicken
                | Metamagic.Empower
                | Metamagic.Reach
                | Metamagic.Heighten
                ...
                | (Metamagic)MetamagicFeats.MetamagicExtender.Elemental
                | (Metamagic)MetamagicFeats.MetamagicExtender.Selective;
            flurry_of_snowballs.ReplaceComponent<SpellDescriptorComponent>(s =>
                s.Descriptor =
                    s.Descriptor
                    | (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.Water
            );
        ...
        static void createIceSlick()
        {
            var difficult_terrain = library.CopyAndAdd<BlueprintBuff>(
                "1914ccc0f3da5b1439f0b90d90d05811",
                "IceSlickDifficultTerrainBuff",
                ""
            );
            var slick_area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                "eca936a9e235875498d1e74ff7c09ecd",
                "IceSlickArea",
                ""
            ); //spike stones
            ...
            var area_effect = Helpers.CreateAreaEffectRunAction( //unitEnter: Common.createContextActionApplyBuff(difficult_terrain, Helpers.CreateContextDuration(), is_permanent: true, dispellable: false),
                ...
                unitMove: Common.createContextActionSkillCheck(
                    StatType.SkillMobility,
                    failure: Helpers.CreateActionList(apply_prone),
                    custom_dc: 10
                )
            );
            ...
            ice_slick = Helpers.CreateAbility(
                "IceSlickAbility",
                "Ice Slick",
        ...
        static void createStrongJaw()
        {
            ...
            var buff = Helpers.CreateBuff(
                ...
                acid_maw.Icon,
                null,
                Helpers.Create<SizeMechanics.DoubleWeaponSize>(d =>
                    d.categories = new WeaponCategory[]
                    {
                        WeaponCategory.OtherNaturalWeapons,
                        WeaponCategory.Bite,
                        WeaponCategory.Claw,
            ...
            strong_jaw = Helpers.CreateAbility(
                "StrongJawAbility",
                buff.Name,
                buff.Description,
                "",
                ...
                Helpers.CreateSpellComponent(SpellSchool.Transmutation),
                Helpers.Create<HarmlessSaves.HarmlessSpell>(h =>
                    h.save_type = SavingThrowType.Fortitude
                )
            );
        ...
        static void createContingency()
        {
            ...
            var contingency_give_ability_buff = Helpers.CreateBuff(
                "ContingencyGiveAbilityBuff",
                "",
                "",
                "",
                null,
            ...
            var action_remove_contingency_use = Helpers.CreateActionList(
                Common.createContextActionRemoveBuff(contingency_give_ability_buff)
            );
            var contingency_store_buff = Helpers.CreateBuff(
                "ContingencyBuff",
                "Contingency",
                ...
                divination_buff.FxOnStart,
                Helpers.Create<SpellManipulationMechanics.FactStoreSpell>(f =>
                    f.actions_on_store = action_remove_contingency_use
                ),
                Helpers.CreateAddFactContextActions(
                    Common.createContextActionApplyBuff(
                        contingency_give_ability_buff,
                        Helpers.CreateContextDuration(),
                        is_child: true,
                        is_permanent: true
                    )
            ...
            contingency_store_buff.AddComponent(
                Helpers.Create<SpellManipulationMechanics.AddStoredSpellToCaption>(a =>
                    a.store_fact = contingency_store_buff
                )
            );
            var release_action =
                Helpers.Create<SpellManipulationMechanics.ReleaseSpellStoredInSpecifiedBuff>(r =>
                    r.fact = contingency_store_buff
                );
            var remove_buff = Common.createContextActionRemoveBuff(contingency_store_buff);

            var contingency_release = Helpers.CreateAbility(
                "ContingencyReleaseAbility",
                "Contingency: Release",
                ...
                Helpers.Create<SpellManipulationMechanics.AbilityCasterHasSpellStoredInFact>(a =>
                    a.store_fact = contingency_store_buff
                )
            );
            ...
            Predicate<AbilityData> check_slot_predicate = delegate(AbilityData spell)
            {
                return spell.Spellbook != null
                    ...
                    && !SpellManipulationMechanics.FactStoreSpell.hasSpellStoredInFact(
                        spell.Caster,
                        contingency_store_buff
                    );
            };

            for (int i = 0; i < max_variants; i++)
            {
                var contingency_use = Helpers.CreateAbility(
                    $"ContingencyStoreAbility{i}",
                    "Contingency: Store",
                    contingency_store_buff.Description,
                    "",
                    contingency_store_buff.Icon,
            ...
            contingency = Helpers.CreateAbility(
                "ContingencyAbility",
                "Contingency",
                contingency_store_buff.Description,
                "",
        ...
        static void createDelayedConsumption()
        {
            ...
            var delayed_consumption_give_ability_buff = Helpers.CreateBuff(
                "DelayedConsumptionGiveAbilityBuff",
                "",
                "",
                "",
                null,
            ...
            var action_remove_delayed_consumption_use = Helpers.CreateActionList(
                Common.createContextActionRemoveBuff(delayed_consumption_give_ability_buff)
            );
            var delayed_consumption_store_buff = Helpers.CreateBuff(
                "DelayedConsumptionBuff",
                "Delayed Consumption",
                ...
                divination_buff.FxOnStart,
                Helpers.Create<SpellManipulationMechanics.FactStoreSpell>(f =>
                    f.actions_on_store = action_remove_delayed_consumption_use
                ),
                Helpers.CreateAddFactContextActions(
                    Common.createContextActionApplyBuff(
                        delayed_consumption_give_ability_buff,
                        Helpers.CreateContextDuration(),
                        is_child: true,
                        is_permanent: true
                    )
            ...
            delayed_consumption_store_buff.AddComponent(
                Helpers.Create<SpellManipulationMechanics.AddStoredSpellToCaption>(a =>
                    a.store_fact = delayed_consumption_store_buff
                )
            );
            var release_action =
                Helpers.Create<SpellManipulationMechanics.ReleaseSpellStoredInSpecifiedBuff>(r =>
                    r.fact = delayed_consumption_store_buff
                );
            var remove_buff = Common.createContextActionRemoveBuff(delayed_consumption_store_buff);

            var delay_consumption_release = Helpers.CreateAbility(
                "DelayConsumptionReleaseAbility",
            ...
            delayed_consumption_store_buff.AddComponent(
                Helpers.CreateAddFact(delay_consumption_release)
            );
            ...
            Predicate<AbilityData> check_slot_predicate = delegate(AbilityData spell)
            {
                return spell.Spellbook != null
                    ...
                    && !SpellManipulationMechanics.FactStoreSpell.hasSpellStoredInFact(
                        spell.Caster,
                        delayed_consumption_store_buff
                    );
            };

            for (int i = 0; i < max_variants; i++)
            {
                var delay_consumption_use = Helpers.CreateAbility(
                    $"DelayConsumptionStoreAbility{i}",
                ...
                delayed_consumption_give_ability_buff.AddComponent(
                    Helpers.CreateAddFact(delay_consumption_use)
                );
            ...
            delayed_consumption = Helpers.CreateAbility(
                "DelayConsumptionAbility",
                "Delayed Consumption",
                delayed_consumption_store_buff.Description,
                "",
                delayed_consumption_store_buff.Icon,
        ...
        static void createFireShield()
        {
            ...
            var shield_of_dawn_buff = library.Get<BlueprintBuff>(
                "07abad76e7b688242b56749cd25f5d3d"
            );
            var shield_buff = library.Get<BlueprintBuff>("9c0fa9b438ada3f43864be8dd8b3e741");

            DamageEnergyType[] energy = new DamageEnergyType[]
            {
                DamageEnergyType.Fire,
                DamageEnergyType.Cold,
            };
            ...
            BlueprintBuff[] prototype_buffs = new BlueprintBuff[]
            {
                shield_of_dawn_buff,
                shield_buff,
            };
            ...
            {
                "The flames are warm to the touch. You take only half damage from cold-based attacks. If such an attack allows a Reflex save for half damage, you take no damage on a successful saving throw.",
            ...
            for (int i = 0; i < shields.Length; i++)
            {
                ...
                var dmg_component = shield_of_dawn_buff
                    .GetComponent<AddTargetAttackRollTrigger>()
                    .CreateCopy();
                ...
                var buff = Helpers.CreateBuff(
                    ...
                    Common.createEvasionAgainstDescriptor(
                        descriptors[i],
                        SavingThrowType.Fortitude
                    ),
                ...
                shields[i] = Helpers.CreateAbility(
                    $"FireShield{i + 1}Ability",
                    buff.Name,
                    buff.Description,
                    "",
                    buff.Icon,
            ...
            fire_shield = Helpers.CreateAbility(
                "FireShieldAbility",
                "Fire Shield",
            ...
            fire_shield.AvailableMetamagic =
                shield_of_dawn.AvailableMetamagic
                | (Metamagic)MetamagicFeats.MetamagicExtender.Rime
                | (Metamagic)MetamagicFeats.MetamagicExtender.Elemental
                | (Metamagic)MetamagicFeats.MetamagicExtender.Piercing;
            ...
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("881b2137a1779294c8956fe5b497cc35"),
                SpellDuplicates.addDuplicateSpell(fire_shield, "FireDomain" + fire_shield.name),
                5
            );
        ...
        static void createCommand()
        {
            ...
            {
                Common.dazed_non_stun,
                library.CopyAndAdd<BlueprintBuff>(
                    "bd9d11c630f645443b8a1061044d5cf0",
                    "ProneCommandBuff",
                    ""
                ), //prone
                library.CopyAndAdd<BlueprintBuff>(
                    "f08a7239aa961f34c8301518e71d4cdf",
                    "FrightenedCommandBuff",
                    ""
                ), //frightened
            };
            buffs[2]
                .ReplaceComponent<AddCondition>(
                    Common.createBuffStatusCondition(
            ...
            {
                b.ReplaceComponent<BuffStatusCondition>(s =>
                {
                    s.SaveEachRound = true;
                    s.SaveType = SavingThrowType.Will;
                });
            }
            ...
            var checker_fact = dominate_monster
                .GetComponents<AbilityTargetHasNoFactUnless>()
                .ToArray(); //vermin
            var does_not_work = dominate_monster.GetComponent<AbilityTargetHasFact>(); //construct, plant type

            command_greater = Helpers.CreateAbility(
                "CommandGreaterSpellAbility",
                "Command, Greater",
            ...
            command_greater.AvailableMetamagic =
                Metamagic.Heighten
                | Metamagic.Quicken
                | Metamagic.Reach
                | Metamagic.Extend
            ...
            for (int i = 0; i < buffs.Length; i++)
            {
                var variant_command = library.CopyAndAdd<BlueprintAbility>(
                    command.AssetGuid,
                    $"CommandSpell{i + 1}Ability",
                    ""
                );
                variant_command.SetDescription(descriptions[i]);
                variant_command.SetName($"Command ({names[i]})");

                var buff_action = Common.createContextSavedApplyBuff(
                    buffs[i],
                    Helpers.CreateContextDuration(
                        Helpers.CreateContextValue(AbilityRankType.Default),
                        DurationRate.Rounds
                ...
                var buff_save = Common.createContextActionSavingThrow(
                    SavingThrowType.Will,
                    Helpers.CreateActionList(buff_action)
                );
                ...
                variant_command.AddComponents(
                    dominate_monster.GetComponents<AbilityTargetHasNoFactUnless>()
                );
                commands.Add(variant_command);

                var variant_greater = library.CopyAndAdd<BlueprintAbility>(
                    command_greater.AssetGuid,
                    $"CommandGreateSpell{i + 1}Ability",
                    ""
                );
            ...
            //nobility domain fix
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("8480f2d1ca764774895ee6fd610a568e"),
                command_greater,
                5
            );
        }
        ...
        {
            var lesser_restoration = library.Get<BlueprintAbility>(
            ...
            var sancturay_logic = Helpers.Create<SanctuaryMechanics.Sanctuary>(c =>
            {
                ...
                c.offensive_action_effect = SanctuaryMechanics
                    .OffensiveActionEffect
                    .REMOVE_FROM_OWNER;
            });
            sanctuary_buff = library.CopyAndAdd<BlueprintBuff>(
            ...
            sanctuary = Helpers.CreateAbility(
                "SanctuaryAbility",
                "Sanctuary",
            ...
            sanctuary.AvailableMetamagic =
                Kingmaker.UnitLogic.Abilities.Metamagic.Extend
                | Kingmaker.UnitLogic.Abilities.Metamagic.Quicken
                | Kingmaker.UnitLogic.Abilities.Metamagic.Heighten
                | (Metamagic)MetamagicFeats.MetamagicExtender.Persistent;
            ...
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("b750650400d9d554b880dbf4c8347b24"),
                sanctuary,
                1
            );
        }

        internal static void createShillelagh()
        {
            var bless_weapon = library.Get<BlueprintAbility>("831e942864e924846a30d2e0678e438b");
            var enchant_dice =
                Helpers.Create<NewMechanics.EnchantmentMechanics.WeaponDamageChange>();
            ...
            var enchantment_size = Common.createWeaponEnchantment(
                "ShillelaghEnchantment",
                "Shillelagh",
            ...
            var enhantment1 = library.Get<BlueprintWeaponEnchantment>(
                "d704f90f54f813043a525f304f6c0050"
            );

            BlueprintWeaponType[] shillelagh_types = new BlueprintWeaponType[]
            {
                library.Get<BlueprintWeaponType>("26aa0672af2c7d84ba93bec37758c712"), // club
            ...
            shillelagh = Helpers.CreateAbility(
                "ShillelaghAbility",
                buff.Name,
                buff.Description,
                "",
                ...
                Common.createAbilitTargetMainWeaponCheck(
                    shillelagh_types[0].Category,
                    shillelagh_types[1].Category
                ),
                Helpers.Create<HarmlessSaves.HarmlessSpell>()
            );
            ...
            shillelagh.Animation = Kingmaker
                .Visual
                .Animation
                .Kingmaker
                .Actions
        ...
        static BlueprintAbility createFlameBladeVariant(
            string prefix,
            string display_name,
            string description,
            UnityEngine.Sprite icon,
        ...
        )
        {
            ...
            Helpers.SetField(
                weapon,
                "m_DisplayNameText",
                Helpers.CreateString(prefix + "Name", display_name)
            );
            Helpers.SetField(weapon, "m_Icon", icon);

            Common.addEnchantment(weapon, WeaponEnchantments.summoned_weapon_enchant);

            var weapon_off_hand = library.CopyAndAdd<BlueprintItemWeapon>(
                weapon,
                prefix + "WeaponOffHand",
                ""
            );
            for (int i = 0; i < flame_blade_enchantments.Length; i++)
            {
                var flame_blade_enchant =
                    Helpers.Create<NewMechanics.EnchantmentMechanics.WeaponDamageChange>(w =>
                    {
                        w.bonus_damage = i;
                        w.dice_formula = new DiceFormula(1, DiceType.D8);
                ...
                flame_blade_enchantments[i] = Common.createWeaponEnchantment(
                    prefix + $"{i}Enchantment",
                    display_name,
                    description,
                    "",
                    "",
            ...
            foreach (var oh in is_off_hand)
            {
                var empower_buff = Common.createBuffContextEnchantPrimaryHandWeaponIfHasMetamagic(
                    ...
                    false,
                    false,
                    new BlueprintWeaponType[] { scimitar_type },
                    WeaponEnchantments.empower_enchant
                );
                ...
                var fire_dmg = Common.createBuffContextEnchantPrimaryHandWeapon(
                    Helpers.CreateContextValue(AbilityRankType.DamageBonus),
                    false,
                    false,
                    new BlueprintWeaponType[] { scimitar_type },
                    flame_blade_enchantments
                );
                if (oh)
                {
                ...
                var buff = Helpers.CreateBuff(
                    ...
                    Helpers.Create<NewMechanics.EnchantmentMechanics.CreateWeapon>(c =>
                    {
                        c.weapon = oh ? weapon_off_hand : weapon;
                        c.create_in_offhand = oh;
                    }),
                    fire_dmg,
                    empower_buff,
                    maximize_buff,
                ...
                var flame_blade_v = library.CopyAndAdd<BlueprintAbility>(
                    shillelagh.AssetGuid,
                    (oh ? "OffHand" : "MainHand") + prefix + "Ability",
                    ""
                );
                ...
                flame_blade_v.ActionType = Kingmaker
                    .UnitLogic
                    .Commands
                    .Base
                    .UnitCommand
                ...
                if (oh)
                {
                    flame_blade_v.ReplaceComponent<NewMechanics.AbilitTargetMainWeaponCheck>(
                        Helpers.Create<NewMechanics.AbilityTargetSecondaryHandFree>()
                    );
                    weapon_off_hand.AddComponent(
                        Helpers.Create<NewMechanics.EnchantmentMechanics.WeaponSourceBuff>(w =>
                            w.buff = buff
                        )
                    );
                ...
                flame_blade_v.ReplaceComponent<SpellComponent>(
                    Helpers.CreateSpellComponent(
                        Kingmaker.Blueprints.Classes.Spells.SpellSchool.Evocation
                    )
                );
                ...
                flame_blade_v.ReplaceComponent<AbilityEffectRunAction>(
                    Helpers.CreateRunActions(apply_buff)
                );
                flame_blade_v.AvailableMetamagic =
                    Metamagic.Quicken
                    | Metamagic.Extend
                    | Metamagic.Heighten
                    | Metamagic.Empower
        ...
        {
            flame_blade_electric = createFlameBladeVariant(
                "FlameBladeElectric",
                ...
                DamageEnergyType.Electricity,
                SpellDescriptor.Electricity,
                library.Get<BlueprintWeaponEnchantment>("38f12574e91296f42b6a264542cb32a0")
            ); //kinetic blade electric
        }

        static void createFlameBlade()
        {
            flame_blade = createFlameBladeVariant(
                "FlameBlade",
                "Flame Blade",
                ...
                DamageEnergyType.Fire,
                SpellDescriptor.Fire,
                library.Get<BlueprintWeaponEnchantment>("ed7b5eb80e2a974499c3dd7aeca71f88")
            ); //kinetic blade fire
        ...
        static void createProduceFlame()
        {
            ...
            var flaming_enchatment = library.Get<BlueprintWeaponEnchantment>(
                "30f90becaaac51f41bf56641966c4121"
            );

            BlueprintWeaponEnchantment[] produce_flame_enchantments =
                new BlueprintWeaponEnchantment[11];
            var fire_damage = Common.createEnergyDamageDescription(
                Kingmaker.Enums.Damage.DamageEnergyType.Fire
            );

            var weapon_type = library.CopyAndAdd<BlueprintWeaponType>(
                "f807334ef058b7148a5d1582767c70ab",
                "ProduceFlameType",
                ""
            ); //sling
            ...
            Helpers.SetField(
                weapon_type,
                "m_TypeNameText",
                Helpers.CreateString("ProduceFlameTypeName", "Ray")
            );
            Helpers.SetField(
                weapon_type,
                "m_DefaultNameText",
            ...
            var weapon = library.CopyAndAdd<BlueprintItemWeapon>(
                "d30a1e8901890a04eaddaceb4abd7002",
                "ProduceFlameWeapon",
                ""
            ); //sling
            ...
            Helpers.SetField(
                weapon,
                "m_DisplayNameText",
                Helpers.CreateString("ProduceFlameWeaponName", "Produce Flame")
            );
            ...
            Helpers.SetField(
                weapon,
                "m_VisualParameters",
                Common.replaceProjectileInWeaponVisualParameters(weapon.VisualParameters, fire_ray)
            );
            Common.addEnchantment(weapon, WeaponEnchantments.summoned_weapon_enchant);

            for (int i = 0; i < produce_flame_enchantments.Length; i++)
            {
                var produce_flame_enchant =
                    Helpers.Create<NewMechanics.EnchantmentMechanics.WeaponDamageChange>(w =>
                    {
                        w.bonus_damage = 1 + i;
                ...
                produce_flame_enchantments[i] = Common.createWeaponEnchantment(
                    $"ProduceFlame{i}Enchantment",
                    "Produce Flame",
            ...
            */
            ...
            produce_flame = Helpers.CreateAbility(
                "ProduceFlameAbility",
                buff.Name,
                buff.Description,
                "",
            ...
            produce_flame.AvailableMetamagic =
                Kingmaker.UnitLogic.Abilities.Metamagic.Extend
                | Kingmaker.UnitLogic.Abilities.Metamagic.Heighten
                | Kingmaker.UnitLogic.Abilities.Metamagic.Empower
                | Kingmaker.UnitLogic.Abilities.Metamagic.Maximize
            ...
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("881b2137a1779294c8956fe5b497cc35"),
                SpellDuplicates.addDuplicateSpell(produce_flame, "FireDomain" + produce_flame.name),
                2
            );
        }
        ...
        {
            var performance_resource = library.Get<BlueprintAbilityResource>(
                "e190ba276831b5c4fa28737e5e49e6a6"
            );
            var inspire_competence = library.Get<BlueprintActivatableAbility>(
                "430ab3bb57f2cfc46b7b3a68afd4f74e"
            );
            var increase_group_size = Common.createIncreaseActivatableAbilityGroupSize(
                ActivatableAbilityGroup.BardicPerformance
            );
            var consume_additional_resource =
                Helpers.Create<NewMechanics.ConsumeResourceIfAbilitiesFromGroupActivated>(c =>
                {
                    c.group = ActivatableAbilityGroup.BardicPerformance;
                    c.num_abilities_activated = 2;
                    c.resource = performance_resource;
                });
            var deactivate_performance = Helpers.Create<NewMechanics.DeactivateAbilityFromGroup>(
                c =>
                {
                    c.group = ActivatableAbilityGroup.BardicPerformance;
            ...
            var buff = Helpers.CreateBuff(
                ...
                increase_group_size,
                Helpers.CreateAddFactContextActions(
                    newRound: consume_additional_resource,
                    deactivated: deactivate_performance
                )
            );
            var apply_buff = Common.createContextActionApplyBuff(
                buff,
        ...
        internal static void createDeadlyJuggernaut()
        {
            ...
            deadly_juggernaut = library.CopyAndAdd<BlueprintAbility>(
                "779179912e6c6fe458fa4cfb90d96e10",
                "DeadlyJuggernautAbility",
                ""
            );
            deadly_juggernaut.RemoveComponents<SpellListComponent>();
            deadly_juggernaut.ReplaceComponent<AbilitySpawnFx>(
                false_life.GetComponent<AbilitySpawnFx>()
            );
            deadly_juggernaut.ReplaceComponent<SpellComponent>(
                false_life.GetComponent<SpellComponent>()
            );

            deadly_juggernaut.SetIcon(sneak_attack.Icon);
            deadly_juggernaut.SetName("Deadly Juggernaut");
            deadly_juggernaut.SetDescription(
            ...
            {
                int bonus = i + 1;
                buffs[i] = Helpers.CreateBuff(
                    $"DeadlyJuggernaut{i + 1}Buff",
                    ...
                    Helpers.Create<WeaponAttackTypeDamageBonus>(w =>
                    {
                        w.AttackBonus = 1;
                        w.Value = bonus;
                        w.Descriptor = ModifierDescriptor.Luck;
                        w.Type = AttackTypeAttackBonus.WeaponRangeType.Melee;
                    }),
            ...
            var conditional = Helpers.CreateConditional(
                Helpers.CreateConditionHasBuff(buffs[0]),
                new GameAction[]
                {
                    Common.createContextActionApplyBuff(
                        buffs[1],
            ...
            for (int i = 1; i < buffs.Length; i++)
            {
                ...
                if (i < buffs.Length - 1)
                {
                    if_true = new GameAction[]
                    {
                        Common.createContextActionRemoveBuff(buffs[i]),
                        Common.createContextActionApplyBuff(
                            buffs[i + 1],
                            Helpers.CreateContextDuration(),
                            is_from_spell: true,
                ...
                conditional = Helpers.CreateConditional(
                    Helpers.CreateConditionHasBuff(buffs[i]),
                    if_true,
                    new GameAction[] { conditional }
                );
            }

            var on_kill = Common.createAddInitiatorAttackWithWeaponTrigger(
                Helpers.CreateActionList(conditional),
        ...
        internal static void createInvisibilityPurge()
        {
            var invisibility = library.Get<BlueprintBuff>("525f980cb29bc2240b93e953974cb325");
            var invisibility_greater = library.Get<BlueprintBuff>(
                "e6b35473a237a6045969253beb09777c"
            );
            var divination_area = library.Get<BlueprintAbilityAreaEffect>(
                "4ba26a4641c911d4487e3f7f11bcf801"
            );
            var area_effect =
                Helpers.Create<Kingmaker.UnitLogic.Abilities.Blueprints.BlueprintAbilityAreaEffect>();
            ...
            var remove_invisibility = new GameAction[]
            {
                Common.createContextActionRemoveBuff(invisibility),
                Common.createContextActionRemoveBuff(invisibility_greater),
            };

            area_effect.AddComponent(
                Helpers.CreateAreaEffectRunAction(
                    unitEnter: remove_invisibility,
                    round: remove_invisibility
                )
            );
            area_effect.Fx = divination_area.Fx;
            library.AddAsset(area_effect, "");

            var see_invisibility = library.Get<BlueprintAbility>(
                "30e5dc243f937fc4b95d2f8f4e1b7ff3"
            );
            var buff = Helpers.CreateBuff(
                "InvisibilityPurgeBuff",
                "Invisibility Purge",
            ...
            var apply_buff = Helpers.CreateApplyBuff(
                buff,
                Helpers.CreateContextDuration(
                    Helpers.CreateContextValue(AbilityRankType.Default),
                    DurationRate.Minutes
            ...
            invisibility_purge = Helpers.CreateAbility(
                "InvisibilityPurgeAbility",
                buff.Name,
                buff.Description,
                "",
                buff.Icon,
        ...
        public static BlueprintAbility createWish(
            string name_prefix,
            string display_name,
            string description,
            UnityEngine.Sprite icon,
            BlueprintSpellbook primary_spellbook,
            ...
            int primary_spellbook_level = 8,
            int secondary_spellbook_level = 7
        )
        {
            ...
            foreach (var spellbook in spellbooks)
            {
                ...
                int max_level =
                    spellbook == primary_spellbook
                        ? primary_spellbook_level
                        : secondary_spellbook_level;
                max_level = Math.Min(
                    max_level,
                    (int)spellbook.SpellList?.SpellsByLevel?.Length - 1
                );
                for (int i = 1; i <= max_level; i++)
                {
            ...
            List<BlueprintAbility>[] spells_per_level = new List<BlueprintAbility>[
                primary_spellbook_level
            ];
            ...
            var all_spells = spells_per_level
                .Aggregate(
            ...
            var wish = Helpers.CreateAbility(
                name_prefix + "Ability",
                display_name,
                description,
                "",
            ...
            var spells_to_process = all_spells
                .Where(s =>
                    !NewSpells.getShadowSpells().Contains(s)
                ...
                .ToArray();
            var variant_spells = Common.CreateAbilityVariantsReplace(
                wish,
                name_prefix,
                (s, v) =>
                {
        ...
        public static BlueprintAbility[] createWishSpellLevelVariants(
            string name_prefix,
            string display_name,
            string description,
            UnityEngine.Sprite icon,
        ...
        )
        {
            ...
            for (int i = 0; i < spells_per_level.Length; i++)
            {
                ...
                var wish_variant = Helpers.CreateAbility(
                    name_prefix + (i + 1).ToString() + "Ability",
                ...
                wish_variant.AddComponent(
                    Helpers.CreateAbilityVariants(wish_variant, variant_spells)
                );
                ...
                foreach (var s in variant_spells)
                {
                    wish_variant.AvailableMetamagic =
                        wish_variant.AvailableMetamagic | s.AvailableMetamagic;
                }
            }
        ...
        {
            ranged_attacks_forbidden_buff = Helpers.CreateBuff(
                "RangedAttacksForbiddenBuff",
            ...
            immunity_to_wind = Helpers.CreateFeature(
                "ImmunityToWindEffectsFeature",
                "",
                "",
                "",
                null,
                ...
                Helpers.Create<SpecificBuffImmunity>(s =>
                    s.Buff = library.Get<BlueprintBuff>("bb57c37bfb5982d4bbed8d0fea75e404")
                )
            );
        ...
        public static BlueprintAbility[] getShadowSpells()
        {
