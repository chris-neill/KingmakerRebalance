...
namespace CallOfTheWild
{
    ...
    {
        public static BlueprintFeatureSelection minor_magic;
        public static BlueprintFeatureSelection major_magic;
        public static BlueprintFeatureSelection feat;
        public static BlueprintFeature bleeding_attack;

        public static BlueprintFeature assasinate;
        public static BlueprintFeature swift_death;

        public static BlueprintFeature armored_marudeur;
        public static BlueprintFeature armored_swiftness;
        public static BlueprintFeature reaping_stalker;
        public static BlueprintFeature slippery_mind;
        ...
        public static void load()
        {
            ...
            if (test_mode)
            {
                var study_target = library.Get<BlueprintAbility>(
                    "b96d810ceb1708b4e895b695ddbb1813"
                );
        ...
        {
            slippery_mind = Helpers.CreateFeature(
                "SlipperyMindRogueTalentFeature",
                "Slippery Mind",
        ...
        static void fixSlayerTrapfindingScaling()
        {
            ...
            var archetype_list_feature = Helpers.CreateFeature(
                "SlayerTrapfindingArchetypeExtensionFeature",
                "",
                "",
                "",
                null,
            ...
            archetype_list_feature.AddComponent(
                Helpers.Create<ContextRankConfigArchetypeList>(c =>
                    c.archetypes = new BlueprintArchetype[]
                    {
                        Archetypes.NatureFang.archetype,
                        Archetypes.NatureFang.archetype,
                    }
                )
            );
            ...
            trapfinding.ReplaceComponent<ContextRankConfig>(c =>
            {
                Helpers.SetField(
                    c,
                    "m_BaseValueType",
                    ContextRankBaseValueTypeExtender.SummClassLevelWithArchetypes.ToContextRankBaseValueType()
                );
                ...
                Helpers.SetField(
                    ...
                    "m_Class",
                    Helpers
                        .GetField<BlueprintCharacterClass[]>(c, "m_Class")
                        .AddToArray(
                            Archetypes.NatureFang.archetype.GetParentClass(),
                            Archetypes.SanctifiedSlayer.archetype.GetParentClass()
                        )
                );
            });
        }

        static void fixStudiedTarget()
        {
            ...
            var swift_ability = library.Get<BlueprintAbility>("90fdfeb61368f15488031bee72ab7c18");
            var icon = LoadIcons.Image2Sprite.Create(@"AbilityIcons/StudyTarget.png");

            studied_ability.SetIcon(icon);
            studied_buff.SetIcon(icon);
            swift_ability.SetIcon(icon);
        }
        ...
        static void fixRogueSneakAttackTalents()
        {
            ...
            library
                .Get<BlueprintFeature>("1b92146b8a9830d4bb97ab694335fa7c")
                .AddComponent(
                    Helpers.PrerequisiteFeature(
                        library.Get<BlueprintFeature>("9b9eac6709e1c084cb18c3a366e0ec87")
                    )
                );

            var talent_ids = new string[]
            {
                "955ff81c596c1c3489406d03e81e6087", //focusing attack confused
            ...
            foreach (var id in talent_ids)
            {
                ...
                { //cl for dispelling strike
                    ...
                    buff.AddComponents(
                        feature.GetComponents<NewMechanics.ReplaceCasterLevelOfFactWithContextValue>()
                    );
                    buff.ReplaceComponent<NewMechanics.ReplaceCasterLevelOfFactWithContextValue>(
                        r => r.Feature = buff
                    );
                    ...
                    //add druid scaling
                    var archetype_list_feature = Helpers.CreateFeature(
                        "DispellingAttackArchetypeExtensionFeature",
                        "",
                        "",
                        "",
                        null,
                    ...
                    buff.ReplaceComponent<ContextRankConfig>(c =>
                    {
                        ...
                        Helpers.SetField(
                            ...
                            Helpers
                                .GetField<BlueprintCharacterClass[]>(c, "m_Class")
                                .AddToArray(Archetypes.NatureFang.archetype.GetParentClass())
                        );
                    });
                }

                var toggle = Helpers.CreateActivatableAbility(
                    feature.name + "ToggleAbility",
                    feature.Name,
                    feature.Description,
                    "",
                    feature.Icon,
                ...
                toggle.Group =
                    ActivatableAbilityGroupExtension.SneakAttack.ToActivatableAbilityGroup();
        ...
        {
            reaping_stalker = Helpers.CreateFeature(
                "ReapingStalkerSlayerTalentFeature",
                "Reaping Stalker",
                ...
                FeatureGroup.None,
                Helpers.Create<NewMechanics.WeaponCategorySizeChange>(w =>
                    w.category = WeaponCategory.Sickle
                ),
                Helpers.Create<NewMechanics.WeaponCategorySizeChange>(w =>
                    w.category = WeaponCategory.Scythe
                ),
                Helpers.Create<WeaponTypeCriticalEdgeIncrease>(w =>
                    w.WeaponType = library.Get<BlueprintWeaponType>(
                        "ec2da496c7936e14c9a28ce616a6b4cd"
                    )
                ), //sickle
                Helpers.Create<WeaponTypeCriticalEdgeIncrease>(w =>
                    w.WeaponType = library.Get<BlueprintWeaponType>(
                        "4eacfc7e152930a45a1a16217c35011c"
                    )
                ) //scythe
            );
        ...
        static void createArmoredMaraudeur()
        {
            ...
            var heavy_armor_proficiency = library.Get<BlueprintFeature>(
                "1b0f68188dcc435429fb87a022239681"
            );
            armored_marudeur = Helpers.CreateFeature(
                "ArmoredMaraudeurSlayerTalentFeature",
                "Armored Marauder",
                ...
                Helpers.Create<ArmorCheckPenaltyIncrease>(a =>
                {
                    ...
                    a.Category = ArmorProficiencyGroup.Heavy;
                }),
                ...
                Helpers.PrerequisiteFeature(
                    library.Get<BlueprintFeature>("46f4fb320f35704488ba3d513397789d")
                ) //medium armor prof
            );
        ...
        static void createArmoredSwiftness()
        {
            var druid = library.Get<BlueprintCharacterClass>("610d836f3a3a9ed42a4349b62f002e96");
            var slayer = library.Get<BlueprintCharacterClass>("c75e0971973957d4dbad24bc7957e4fb");
            armored_swiftness = Helpers.CreateFeature(
                "ArmoredSwiftnessSlayerTalentFeature",
                "Armored Swiftness",
                ...
                FeatureGroup.RogueTalent,
                Helpers.Create<NewMechanics.ContextMaxDexBonusIncrease>(a =>
                {
                    a.bonus = Helpers.CreateContextValue(AbilityRankType.Default);
                    a.category = new ArmorProficiencyGroup[] { ArmorProficiencyGroup.Heavy };
                }),
                Helpers.CreateContextRankConfig(
                    ContextRankBaseValueType.SummClassLevelWithArchetype,
                    archetype: Archetypes.NatureFang.archetype,
            ...
            var reduce_heavy_armor_speed_penalty = Helpers.CreateFeature(
                "ArmoredSwiftnessSpeedPenaltyRemovalFeature",
                "",
                "",
                "",
                null,
                ...
                Helpers.CreateAddMechanics(
                    AddMechanicsFeature.MechanicsFeatureType.ImmunToArmorSpeedPenalty
                )
            );
            reduce_heavy_armor_speed_penalty.HideInCharacterSheetAndLevelUp = true;
            armored_swiftness.AddComponent(
                Helpers.Create<WeaponTrainingMechanics.AddFeatureOnArmor>(a =>
                {
                    a.feature = reduce_heavy_armor_speed_penalty;
                    a.required_armor = new ArmorProficiencyGroup[] { ArmorProficiencyGroup.Heavy };
                })
            );
        ...
        {
            var druid = library.Get<BlueprintCharacterClass>("610d836f3a3a9ed42a4349b62f002e96");
            var slayer_class = library.Get<BlueprintCharacterClass>(
                "c75e0971973957d4dbad24bc7957e4fb"
            );
            var rogue_class = library.Get<BlueprintCharacterClass>(
                "299aa766dee3cbf4790da4efb8c72484"
            );

            var sneak_attack = library.Get<BlueprintFeature>("9b9eac6709e1c084cb18c3a366e0ec87");
            var assasinate_buff = Helpers.CreateBuff(
                "SlayerAssasinateBuff",
                "Assasinate Target",
            ...
            var assasinate_cooldown = Helpers.CreateBuff(
                "SlayerAssasinateCooldownBuff",
            ...
            var apply_cooldown = Helpers.CreateConditional(
                Common.createContextConditionHasBuffFromCaster(assasinate_cooldown),
                null,
            ...
            var apply_buff = Common.createContextActionApplyBuff(
                assasinate_buff,
                Helpers.CreateContextDuration(2, DurationRate.Rounds),
                dispellable: false
            );
            ...
            var ability = Helpers.CreateAbility(
                ...
                Common.createAbilityTargetHasNoFactUnlessBuffsFromCaster(
                    new BlueprintBuff[] { assasinate_cooldown, assasinate_buff }
                ),
            ...
            var attempt_assasinate = Helpers.CreateConditional(
                Helpers.CreateConditionsCheckerAnd(
                    Helpers.Create<ContextConditionIsFlatFooted>(),
                    Common.createContextConditionHasBuffFromCaster(assasinate_buff)
                ),
            ...
            assasinate = Helpers.CreateFeature(
                "AssasinateSlayerTalentFeature",
                ability.Name,
                ability.Description,
                "",
                ability.Icon,
                ...
                Helpers.Create<AddInitiatorAttackRollTrigger>(a =>
                {
                    ...
                    a.Action = Helpers.CreateActionList(
                        apply_cooldown,
                        Common.createContextActionRemoveBuffFromCaster(assasinate_buff)
                    );
                }),
                Common.createContextCalculateAbilityParamsBasedOnClassesWithArchetypes(
                    new BlueprintCharacterClass[] { slayer_class, rogue_class, druid },
            ...
            var swift_resource = Helpers.CreateAbilityResource(
                "SlayerSwiftDeathResource",
                "",
                "",
                "",
                null
            );
            swift_resource.SetIncreasedByLevelStartPlusDivStep(
                1,
                19,
                1,
                100,
                ...
                0,
                0.0f,
                new BlueprintCharacterClass[] { slayer_class }
            );

            var swift_ability = library.CopyAndAdd<BlueprintAbility>(
                ability,
                "SlayerSwiftDeathAbility",
                ""
            );
            ...
            swift_ability.SetNameDescription(
                "Swift Death",
        ...
        static void createBleedingAttack()
        {
            ...
            var effect_buff = Helpers.CreateBuff(
                ...
                Helpers.CreateContextRankConfig(
                    ...
                    customProperty: NewMechanics.SneakAttackDiceGetter.Blueprint.Value
                ),
            ...
            var medical_discoveries = library.Get<BlueprintFeatureSelection>(
                "67f499218a0e22944abab6fe1c9eaeee"
            );
            medical_discoveries.AllFeatures = medical_discoveries.AllFeatures.AddToArray(
                bleeding_attack
            );
        }
        ...
        {
            var combat_trick = library.Get<BlueprintFeatureSelection>(
                "c5158a6622d0b694a99efb1d0025d2c1"
            );
            combat_trick.AddComponent(Helpers.PrerequisiteNoFeature(combat_trick));

            feat = library.CopyAndAdd<BlueprintFeatureSelection>(
        ...
        public static void addToTalentSelection(
            BlueprintFeature f,
            bool advanced = false,
            bool for_investigator = false
        )
        {
        ...
        static void createMinorMagic()
        {
            ...
            minor_magic = Helpers.CreateFeatureSelection(
                "MinorMagicRogueTalent",
                "Minor Magic",
            ...
            {
                library.Get<BlueprintCharacterClass>("299aa766dee3cbf4790da4efb8c72484"), //rogue
                ...
                library.Get<BlueprintCharacterClass>("f1a70d9e1b0b41e49874e1fa9052a1ce"),
            }; //inquisitor for sanctified slayer
            ...
            foreach (var s in spells)
            {
                ...
                if (!s.HasVariants)
                {
                    var spell_like = Common.convertToSpellLike(
                        s,
                        "MinorMagic",
                        classes,
                        StatType.Intelligence,
                    ...
                    feature = Common.AbilityToFeatureMaybeReuseGuid(
                        spell_like,
                        false,
                        Helpers.MergeIds("fb026930ab7943da96f6e17b7c778f2b", s.AssetGuid)
                    );
                    feature.AddComponent(
                        Helpers.Create<BindAbilitiesToClass>(b =>
                        {
                            ...
                            b.Archetypes = new BlueprintArchetype[]
                            {
                                Archetypes.SanctifiedSlayer.archetype,
                                Archetypes.NatureFang.archetype,
                            };
                        })
                    );
                ...
                else
                {
                    ...
                    foreach (var v in s.Variants)
                    {
                        spell_likes.Add(
                            Common.convertToSpellLike(
                                ...
                                no_resource: true,
                                no_scaling: true,
                                guid: Helpers.MergeIds(
                                    "0e6a36ac029049c98a682f688e419f45",
                                    v.AssetGuid
                                )
                            )
                        );
                    ...
                    var wrapper = Common.createVariantWrapper(
                        "MinorMagic" + s.name,
                        Helpers.MergeIds("0e6a36ac029049c98a682f688e419f45", s.AssetGuid),
                        spell_likes.ToArray()
                    );
        ...
        static void createMajorMagic()
        {
            ...
            major_magic = Helpers.CreateFeatureSelection(
                "MajorMagicRogueTalent",
                "Major Magic",
            ...
            foreach (var s in spells)
            {
                var resource = Helpers.CreateAbilityResource(
                    "MajorMagic" + s.name + "Resource",
                    "",
                    "",
                    Helpers.MergeIds("27fea41a99cd46609f8ab2283d1afce0", s.AssetGuid),
                    null
                );
                ...
                if (!s.HasVariants)
                {
                    ...
                    spell_like.AddComponent(
                        Helpers.Create<NewMechanics.BindAbilitiesToClassFixedLevel>(b =>
                        {
                            b.Abilites = new BlueprintAbility[] { spell_like };
                            b.CharacterClass = classes[0];
                            b.AdditionalClasses = classes.Skip(1).ToArray();
                ...
                else
                {
                    ...
                    feature = Common.AbilityToFeatureMaybeReuseGuid(
                        wrapper,
                        false,
                        Helpers.MergeIds("3704cc05c1b64ea990ae6a2b97d35311", s.AssetGuid)
                    );
                    feature.AddComponent(
                        Helpers.Create<NewMechanics.BindAbilitiesToClassFixedLevel>(b =>
                        {
