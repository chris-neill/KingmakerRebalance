...
namespace CallOfTheWild
{
    public class DawnflowerAnchorite
    {
        ...
        public static BlueprintCharacterClass dawnflower_anchorite;
        public static BlueprintProgression dawnflower_anchorite_progression;

        public static BlueprintFeature channel_energy_domain_progression;
        public static BlueprintFeatureSelection credence;
        public static BlueprintFeature dervish_dance;
        public static BlueprintFeature divine_light;
        public static BlueprintFeature extra_invocations;
        public static BlueprintFeature solar_defense;
        public static BlueprintFeature solar_defense2;
        public static BlueprintFeature solar_weapons;

        public static BlueprintFeature solar_invocation,
            solar_invocation2,
            solar_invocation3;

        public static BlueprintFeature solar_invocation_move_action;
        public static BlueprintFeature solar_invocation_swift_action;
        public static BlueprintFeature bask_in_radiance;
        public static BlueprintFeature sunbeam;
        public static BlueprintFeature dawnflower_invocation;
        public static BlueprintFeatureSelection spellbook_selection;

        public static BlueprintAbilityResource solar_invocation_resource;

        internal static void createDawnflowerAnchoriteClass()
        {
            var ranger_class = ResourcesLibrary.TryGetBlueprint<BlueprintCharacterClass>(
            ...
            var savesPrestigeLow = library.Get<BlueprintStatProgression>(
                "dc5257e1100ad0d48b8f3b9798421c72"
            );
            var savesPrestigeHigh = library.Get<BlueprintStatProgression>(
                "1f309006cd2855e4e91a6c3707f3f700"
            );
            ...
            dawnflower_anchorite.LocalizedName = Helpers.CreateString(
                "DawnflowerAnchoriteClass.Name",
                "Dawnflower Anchorite"
            );
            dawnflower_anchorite.LocalizedDescription = Helpers.CreateString(
                "DawnflowerAnchoriteClass.Description",
            ...
            dawnflower_anchorite.ClassSkills = new StatType[]
            {
            ...
            dawnflower_anchorite.AddComponent(
                Common.createPrerequisiteAlignment(AlignmentMaskType.NeutralGood)
            );
            dawnflower_anchorite.AddComponent(
                Helpers.Create<PrerequisiteMechanics.PrerequsiteOrAlternative>(p =>
                {
                    ...
                    p.alternative_prerequsite = Helpers.PrerequisiteStatValue(
                        StatType.SkillLoreReligion,
                        5
                    );
                })
            ...
            dawnflower_anchorite.AddComponent(
                Common.createPrerequisiteCasterTypeSpellLevel(true, 1, true)
            );
            dawnflower_anchorite.AddComponent(
                Helpers.Create<SpellbookMechanics.PrerequisiteDivineCasterTypeSpellLevel>(p =>
                {
            ...
            dawnflower_anchorite.AddComponent(
                Helpers.Create<SpellbookMechanics.PrerequisitePsychicCasterTypeSpellLevel>(p =>
                {
                    p.RequiredSpellLevel = 1;
                    p.Group = Prerequisite.GroupType.Any;
                })
        ...
        static void createDawnflowerAnchoriteProgression()
        {
            ...
            dawnflower_anchorite_progression = Helpers.CreateProgression(
                "DawnfloweAnchoriteProgression",
            ...
            dawnflower_anchorite_progression.LevelEntries = new LevelEntry[]
            {
                Helpers.LevelEntry(1, channel_energy_domain_progression, solar_invocation),
                ...
                Helpers.LevelEntry(
                    10,
                    credence,
                    dawnflower_invocation,
                    solar_invocation_swift_action
                ),
            };

            dawnflower_anchorite_progression.UIDeterminatorsGroup = new BlueprintFeatureBase[]
            {
                channel_energy_domain_progression,
            };
            dawnflower_anchorite_progression.UIGroups = new UIGroup[]
            {
                Helpers.CreateUIGroup(
                    solar_invocation,
                    solar_invocation_move_action,
                    solar_invocation_swift_action
                ),
        ...
        {
            var sunbeam_resource = Helpers.CreateAbilityResource(
                "DawnflowerAnchoriteSunbeamResource",
                "",
                "",
                "",
                null
            );
            sunbeam_resource.SetIncreasedByLevelStartPlusDivStep(
                1,
                10,
                1,
                100,
                ...
                0,
                0.0f,
                getDawnflowerAcnchoriteArray()
            );

            var sunbeam_ability = library.CopyAndAdd<BlueprintAbility>(
                "1fca0ba2fdfe2994a8c8bc1f0f2fc5b1",
                "DawnflowerAnchoriteSunbeam",
                ""
            );
            ...
            sunbeam.SetDescription(
                "At 7th level, a Dawnflower anchorite gains the ability to cast sunbeam once per day as a spell-like ability. His caster level is equal to his Hit Dice, and the save DC is Charisma-based. At 10th level, the Dawnflower anchorite can use this ability twice per day."
            );
        }

        static void createSpellbookSelection()
        {
            spellbook_selection = Helpers.CreateFeatureSelection(
                "DawnflowerAnchoriteSpellbookSelection",
            ...
            Common.addSpellbooksToSpellSelection2(
                "DawnflowerAnchorite",
                1,
                spellbook_selection,
                alchemist: false
        ...
        static void createCredence()
        {
            ...
            dervish_dance.SetDescription(
                "The Dawnflower anchorite gains Dervish Dance as a bonus feat."
            );
            dervish_dance.AddComponent(Helpers.PrerequisiteNoFeature(NewFeats.dervish_dance));

            extra_invocations = Helpers.CreateFeature(
                "ExtraInvocationsFeature",
                "Extra Invocations",
                ...
                {
                    i.Resource = solar_invocation_resource;
                ...
                Helpers.CreateContextRankConfig(
                    ...
                    classes: getDawnflowerAcnchoriteArray(),
            ...
            credence = Helpers.CreateFeatureSelection(
                "CredenceFeatureSelection",
                "Credence",
            ...
            credence.AllFeatures = new BlueprintFeature[]
            {
                dervish_dance,
                divine_light,
                extra_invocations,
        ...
        static void createChannelEnergyDomainProgression()
        {
            ...
            var domain_selection = library.Get<BlueprintFeatureSelection>(
                "48525e5da45c9c243a343fc6545dbdb9"
            );
            var cleric_secondary_domain_selection = library.Get<BlueprintFeatureSelection>(
                "43281c3d7fe18cc4d91928395837cd1e"
            );
            var druid_domain_selection = library.Get<BlueprintFeatureSelection>(
                "5edfe84c93823d04f8c40ca2b4e0f039"
            );
            var blight_druid_domain_selection = library.Get<BlueprintFeatureSelection>(
                "096fc02f6cc817a43991c4b437e12b8e"
            );
            var cleric = library.Get<BlueprintCharacterClass>("67819271767a9dd4fbfd4ae700befea0");
            ClassToProgression.addClassToDomains(
            ...
            ClassToProgression.addClassToDomains(
                ...
                new BlueprintArchetype[0],
                ClassToProgression.DomainSpellsType.NoSpells,
                cleric_secondary_domain_selection,
                cleric
            );
            ClassToProgression.addClassToDomains(
                dawnflower_anchorite,
            ...
            {
                ClassToProgression.addClassToProgression(
                    dawnflower_anchorite,
                    new BlueprintArchetype[0],
                    ClassToProgression.DomainSpellsType.NoSpells,
                    p,
            ...
            var domain_animal_companion_progression = library.Get<BlueprintProgression>(
                "125af359f8bc9a145968b5d8fd8159b8"
            );
            domain_animal_companion_progression.Classes =
                domain_animal_companion_progression.Classes.RemoveFromArray(dawnflower_anchorite);
            var druid_animal_domain_selection = library.Get<BlueprintProgression>(
                "a75ad4936e099c54881cf553e2110703"
            );
            ...
            channel_energy_domain_progression = Helpers.CreateFeature(
                "DawnflowerAnchoriteChannelDomainProgressionFeature",
                "Focused",
            ...
            var animal_companion_rank = library.Get<BlueprintFeature>(
                "1670990255e4fe948a863bafd5dbda5d"
            );
            for (int i = 1; i <= 10; i++)
            {
                channel_energy_domain_progression.AddComponent(
                    Helpers.CreateAddFeatureOnClassLevelIfHasFact(
                        animal_companion_rank,
                        i,
                        getDawnflowerAcnchoriteArray(),
                        animal_companion_rank
                    )
        ...
        {
            solar_invocation_resource = Helpers.CreateAbilityResource(
                "SolarInvocationResource",
                "",
                "",
                "",
                null
            ...
            bask_in_radiance = Helpers.CreateFeature(
                "BaskInRadianceFeature",
                "Bask in Radiance",
            ...
            var effect_buff = Helpers.CreateBuff(
                ...
                icon,
                null,
                Helpers.Create<NewMechanics.AttackBonusAgainstAlignment>(a =>
                {
                    a.value = Helpers.CreateContextValue(AbilityRankType.Default);
                    a.descriptor = ModifierDescriptor.Competence;
                    a.alignment = AlignmentComponent.Evil;
                }),
                Helpers.Create<NewMechanics.SpellsDCBonusAgainstAlignment>(a =>
                {
                    a.value = Helpers.CreateContextValue(AbilityRankType.StatBonus);
                    a.descriptor = ModifierDescriptor.UntypedStackable;
                    a.alignment = AlignmentComponent.Evil;
                }),
                Helpers.Create<NewMechanics.DamageBonusAgainstAlignment>(a =>
                {
                    a.value = Helpers.CreateContextValue(AbilityRankType.Default);
                    a.descriptor = ModifierDescriptor.Competence;
                    a.alignment = AlignmentComponent.Evil;
            ...
            var defense_effect_buff = Helpers.CreateBuff(
                "SolarDefenseEffectBuff",
                "Solar Defense",
                ...
                null,
                Helpers.Create<NewMechanics.ArmorClassBonusAgainstAlignment>(a =>
                {
                    a.value = Helpers.CreateContextValue(AbilityRankType.Default);
                    a.descriptor = ModifierDescriptor.Dodge;
                    a.alignment = AlignmentComponent.Evil;
                }),
                Helpers.Create<NewMechanics.ContextSavingThrowBonusAgainstAlignment>(a =>
                {
                    a.value = Helpers.CreateContextValue(AbilityRankType.Default);
                    a.descriptor = ModifierDescriptor.Sacred;
                    a.alignment = AlignmentComponent.Evil;
                    a.save_type = SavingThrowType.Reflex;
                })
            );

            solar_defense = Helpers.CreateFeature(
                "SolarDefenseFeature",
                "Solar Defense I",
            ...
            solar_defense2 = Helpers.CreateFeature(
                "SolarDefense2Feature",
                "Solar Defense II",
                defense_effect_buff.Description,
                "",
                defense_effect_buff.Icon,
            ...
            var solar_weapons_buff = Helpers.CreateBuff(
                "SolarWeaponsEffectBuff",
                "Solar Weapons",
                ...
                Common.createBuffContextEnchantPrimaryHandWeapon(
                    ...
                    false,
                    true,
                    new BlueprintWeaponEnchantment[] { flaming }
                )
            );

            solar_weapons = Helpers.CreateFeature(
                "SolarWeaponsFeature",
            ...
            var apply_solar_defense = Common.createContextActionApplyBuff(
                defense_effect_buff,
            ...
            var apply_solar_weapons = Common.createContextActionApplyBuff(
                solar_weapons_buff,
                Helpers.CreateContextDuration(),
                false,
                true,
            ...
            Common.addContextActionApplyBuffOnConditionToActivatedAbilityBuffNoRemove(
                effect_buff,
                Helpers.CreateConditional(
                    Common.createContextConditionCasterHasFact(solar_weapons),
                    apply_solar_weapons
                )
            );
            Common.addContextActionApplyBuffOnConditionToActivatedAbilityBuffNoRemove(
                effect_buff,
                Helpers.CreateConditional(
                    Common.createContextConditionCasterHasFact(solar_defense),
                    Helpers.CreateConditional(
            ...
            var toggle = Common.createToggleAreaEffect(
                ...
                Helpers.CreateConditionsCheckerOr(
                    ...
                    Helpers.Create<NewMechanics.ContextConditionIsAllyAndCasterHasFact>(c =>
                        c.fact = bask_in_radiance
                    )
                ),
            ...
            toggle.AddComponents(
                solar_invocation_resource.CreateActivatableResourceLogic(ResourceSpendType.NewRound)
            );
            toggle.DeactivateIfCombatEnded = true;
            toggle.DeactivateIfOwnerDisabled = true;
            toggle.Buff.SetBuffFlags(BuffFlags.HiddenInUi);
            toggle.Group =
                ActivatableAbilityGroupExtension.SolarInvocation.ToActivatableAbilityGroup();
            ...
            solar_invocation.AddComponents(
            ...
            var dawnflower_invocation_buff = Helpers.CreateBuff(
                "DawnflowerInvocationBuff",
            ...
            var dawnflower_invocation_resource = Helpers.CreateAbilityResource(
                "DawnflowerInvocationResource",
                "",
                "",
                "",
                null
            ...
            var dawnflower_invocation_ability = Helpers.CreateAbility(
                "DawnflowerInvocationAbility",
            ...
            dawnflower_invocation.AddComponent(
                dawnflower_invocation_resource.CreateAddAbilityResource()
            );

            toggle.AddComponent(
                Common.createActivatableAbilityRestrictionHasFact(
                    dawnflower_invocation_buff,
                    not: true
                )
            );
            var config = Helpers.CreateContextRankConfig(
            ...
            var config2 = Helpers.CreateContextRankConfig(
                ContextRankBaseValueType.FeatureList,
                type: AbilityRankType.StatBonus,
            ...
            solar_invocation_move_action = Helpers.CreateFeature(
                "SolarInvocationMoveActionFeature",
                ...
                FeatureGroup.None,
                Helpers.Create<ActivatableAbilityActionTypeModierMechanics.ModifyActivatableAbilityGroupActionType>(
                    m =>
                    {
                        m.group =
                            ActivatableAbilityGroupExtension.SolarInvocation.ToActivatableAbilityGroup();
            ...
            solar_invocation_swift_action = library.CopyAndAdd(
                solar_invocation_move_action,
                "SolarInvocationSwiftActionFeature",
                ""
            );
            solar_invocation_swift_action.SetName("Solar Invocation: Swift Action");
            solar_invocation_swift_action.ReplaceComponent<ActivatableAbilityActionTypeModierMechanics.ModifyActivatableAbilityGroupActionType>(
                m => m.action = CommandType.Swift
            );

            divine_light = Helpers.CreateFeature(
                "DivineLightFeature",
                "Divine Light",
                ...
                FeatureGroup.None,
                Helpers.Create<IncreaseResourceAmount>(i =>
                {
                    i.Resource = solar_invocation_resource;
                    i.Value = 2;
                })
            ...
            toggle.AddComponent(
                Helpers.Create<NewMechanics.OutdoorsUnlessHasFact>(o => o.fact = divine_light)
            );
        }
    }
}
