...
namespace CallOfTheWild
{
    public class Rebalance
    {
        ...
        public static BlueprintBuff[] aid_another_buffs = new BlueprintBuff[2];
        public static ContextRankConfig aid_another_config;
        public static BlueprintAbility aid_another;
        public static BlueprintAbility aid_self_free;
        public static BlueprintBuff quarry_cooldown_buff;
        public static BlueprintBuff shatter_defenses_target_buff;

        public static BlueprintFeature flawless_mind;

        internal static void createAidAnother()
        {
            var remove_fear = library.Get<BlueprintAbility>("55a037e514c0ee14a8e3ed14b47061de");
            var remove_self_action = Helpers.CreateActionList(
                Helpers.Create<ContextActionRemoveSelf>()
            );

            aid_another_config = Helpers.CreateContextRankConfig(
                ContextRankBaseValueType.FeatureList,
                progression: ContextRankProgression.BonusValue,
                featureList: new BlueprintFeature[0],
                stepLevel: 2
            );
            aid_another_buffs[0] = Helpers.CreateBuff(
            ...
            aid_another_buffs[1] = Helpers.CreateBuff(
            ...
            BlueprintAbility[] aid_another_abilities = new BlueprintAbility[
                aid_another_buffs.Length
            ];
            BlueprintAbility[] aid_self_abilities = new BlueprintAbility[aid_another_buffs.Length];
            var cooldown = Helpers.CreateBuff(
                "AlliedCloakAidAnotherCooldownBuff",
            ...
            for (int i = 0; i < aid_another_buffs.Length; i++)
            {
                ...
                aid_another_abilities[i] = Helpers.CreateAbility(
                    $"WarpriestCommunityBlessingAidAnother{i + 1}Ability",
                    ...
                    Helpers.CreateRunActions(
                        Common.createContextActionRemoveBuffFromCaster(aid_another_buffs[i]),
                        apply_buff
                    )
                );
                aid_another_abilities[i]
                    .setMiscAbilityParametersTouchFriendly(works_on_self: false);

                aid_self_abilities[i] = Helpers.CreateAbility(
                    $"AlliedCloak{i + 1}Ability",
            ...
            var wrapper = Common.createVariantWrapper(
                "AidAnotherAbilityBase",
                "",
                aid_another_abilities
            );
            ...
            var basic_feat_progression = library.Get<BlueprintProgression>(
                "5b72dd2ca2cb73b49903806ee8986325"
            );
            basic_feat_progression.LevelEntries[0].Features.Add(feature);
            aid_another = wrapper;

            aid_self_free = Common.createVariantWrapper(
                "AidSelfFreeAbilityBase",
                "",
                aid_self_abilities
            );
        ...
        internal static void removeDescriptionsFromMonkACFeatures()
        {
        ...
        internal static void fixKiExtraAttackAction()
        {
            ...
            var scaled_fist_ki_extra_attack = library.Get<BlueprintAbility>(
                "ca948bb4ce1a2014fbf4d8d44b553074"
            );
            scaled_fist_ki_extra_attack.ActionType = UnitCommand.CommandType.Swift;
        }

        internal static void fixShatterDefenses()
        {
            //fix shatter defenses to start working only after first successful hit
            var shatter_defenses = library.Get<BlueprintFeature>(
                "61a17ccbbb3d79445b0926347ec07577"
            );
            shatter_defenses_target_buff = Helpers.CreateBuff(
                "ShatterDefensesTatgetBuff",
                shatter_defenses.Name,
                shatter_defenses.Description,
                "843741b85d8249b9acdcffb042015f06",
                shatter_defenses.Icon,
                null,
                Helpers.Create<NewRoundTrigger>(n =>
                    n.NewRoundActions = Helpers.CreateActionList(
            ...
            var shatter_defenses_target_cooldown_buff = Helpers.CreateBuff(
                "ShatterDefensesTargetCooldownBuff",
                shatter_defenses.Name,
                shatter_defenses.Description,
            ...
            var on_hit = Helpers.CreateConditional(
                Common.createContextConditionHasBuffFromCaster(
                    shatter_defenses_target_cooldown_buff,
                    not: true
                ),
                new GameAction[]
                {
            ...
            shatter_defenses.AddComponent(
                Common.createAddInitiatorAttackWithWeaponTrigger(
                    Helpers.CreateActionList(on_hit),
                    wait_for_attack_to_resolve: true
                )
            );
        ...
        internal static void addMonkFlawlessMind()
        {
            flawless_mind = Helpers.CreateFeature(
                "MonkFlawlessMindFeature",
                "Flawless Mind",
                ...
                Helpers.Create<NewMechanics.ModifyD20WithActions>(m =>
                {
                    ...
                    m.TakeBest = true;
                    m.m_SavingThrowType = NewMechanics
                        .ModifyD20WithActions
                        .InnerSavingThrowType
                        .Will;
                })
            );
            var monk = library.Get<BlueprintCharacterClass>("e8f21e5b58e0569468e420ebea456124");
            monk.Progression.LevelEntries.FirstOrDefault(l => l.Level == 19)
                .Features.Add(flawless_mind);
        }

        internal static void fixRangerQuarryCooldown()
        {
            var cooldown_buff = Helpers.CreateBuff(
                "RapidQuarryCooldownBuff",
                "Quarry Cooldown",
            ...
            var apply_cooldown = Helpers.CreateConditional(
                Common.createContextConditionCasterHasFact(improved_quarry),
                Common.createContextActionApplyBuff(
                    cooldown_buff,
                    Helpers.CreateContextDuration(1, DurationRate.TenMinutes),
                    dispellable: false
                ),
                Common.createContextActionApplyBuff(
                    cooldown_buff,
            ...
            ability.AddComponent(
                Common.createAbilityExecuteActionOnCast(
                    Helpers.CreateActionList(
                        Common.createContextActionOnContextCaster(apply_cooldown)
                    )
                )
            );
            ...
            improved_quarry.SetDescription(
                improved_quarry.Description
        ...
        {
            var dark_elementalist = library.Get<BlueprintArchetype>(
                "f12f18ae8842425489d29f302e69134c"
            );
            dark_elementalist.AddComponent(
                Common.createPrerequisiteAlignment(
                    Kingmaker.UnitLogic.Alignments.AlignmentMaskType.Evil
                )
            );

            var dragon_disciple = library.Get<BlueprintCharacterClass>(
                "72051275b1dbb2d42ba9118237794f7c"
            );

            var empyreal_sorcerer = library.Get<BlueprintArchetype>(
                "aa00d945f7cf6c34c909a29a25f2df38"
            );
            var sylvan_sorcerer = library.Get<BlueprintArchetype>(
                "711d5024ecc75f346b9cda609c3a1f83"
            );
            var sage_sorcerer = library.Get<BlueprintArchetype>("00b990c8be2117e45ae6514ee4ef561c");
            empyreal_sorcerer.AddComponent(
                Helpers.Create<PrerequisiteMechanics.PrerequisiteNoClassLevelVisible>(p =>
                    p.CharacterClass = dragon_disciple
                )
            );
            sylvan_sorcerer.AddComponent(
                Helpers.Create<PrerequisiteMechanics.PrerequisiteNoClassLevelVisible>(p =>
                    p.CharacterClass = dragon_disciple
                )
            );
            sage_sorcerer.AddComponent(
                Helpers.Create<PrerequisiteMechanics.PrerequisiteNoClassLevelVisible>(p =>
                    p.CharacterClass = dragon_disciple
                )
            );
        ...
        internal static void addFatigueBuffRestrictionsToRage()
        {
            ...
            var rage_ability = library.Get<BlueprintActivatableAbility>(
                "df6a2cce8e3a9bd4592fb1968b83f730"
            );

            rage_ability.AddComponents(
                Helpers.Create<RestrictionHasFact>(r =>
                {
                    r.Feature = BlueprintRoot.Instance.SystemMechanics.FatigueBuff;
                    r.Not = true;
                }),
                Helpers.Create<RestrictionHasFact>(r =>
                {
                    r.Feature = BlueprintRoot.Instance.SystemMechanics.ExhaustedBuff;
                    r.Not = true;
                })
            );
        }
        ...
        internal static void removePowerOfWyrmsBuffImmunity()
        {
            ...
            var powers = library
                ...
                .Where(f => f.name.Contains("PowerOfWyrms"))
                .ToArray();

            var elemental_descriptors =
            ...
            {
                p.RemoveComponents<BuffDescriptorImmunity>(s =>
                    (s.Descriptor & elemental_descriptors) > 0
                );
            }
        }
        ...
        internal static void fixSpellDescriptors()
        {
            //fiery body
            library
                .Get<BlueprintAbility>("08ccad78cac525040919d51963f9ac39")
                .GetComponent<SpellDescriptorComponent>()
                .Descriptor = SpellDescriptor.Fire;
            //fire belly
            Common.addSpellDescriptor(
                library.Get<BlueprintAbility>("b065231094a21d14dbf1c3832f776871"),
                SpellDescriptor.Fire
            );
            library
                .Get<BlueprintAbility>("08ccad78cac525040919d51963f9ac39")
            ...
            library
                .Get<BlueprintAbility>("4ac47ddb9fa1eaf43a1b6809980cfbd2")
                .AddComponent(Helpers.CreateSpellDescriptor(SpellDescriptor.Force));
            library
                .Get<BlueprintAbility>("0a2f7c6aa81bc6548ac7780d8b70bcbc")
                .AddComponent(Helpers.CreateSpellDescriptor(SpellDescriptor.Force));
            library
                .Get<BlueprintAbility>("740d943e42b60f64a8de74926ba6ddf7")
                .ReplaceComponent<SpellDescriptorComponent>(s =>
                    s.Descriptor = s.Descriptor | SpellDescriptor.Compulsion
                );
            //descriptor to boggard terrifying croak
            Common.addSpellDescriptor(
                library.Get<BlueprintAbility>("d7ab3a110325b174e90ae6c7b4e96bb9"),
            ...
            var tsunami_area = library.Get<BlueprintAbilityAreaEffect>(
                "800daf41c11463742ad24efd71ab1916"
            );
            Common.addSpellDescriptor(
                tsunami_area,
                (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.Water
            ...
            var original = Harmony12.AccessTools.Method(
                typeof(UIUtilityTexts),
                "GetSpellDescriptor"
            );
            var patch = Harmony12.AccessTools.Method(
                typeof(AdditionalSpellDescriptors.UIUtilityTexts_GetSpellDescriptor_Patch),
                "Postfix"
            );
            ...
            sirocco.ReplaceComponent<SpellDescriptorComponent>(s =>
                s.Descriptor =
                    s.Descriptor
                    | (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.Air
            );
            var sirocco_area = library.Get<BlueprintAbilityAreaEffect>(
                "b21bc337e2beaa74b8823570cd45d6dd"
            );
            sirocco_area.ReplaceComponent<SpellDescriptorComponent>(s =>
                s.Descriptor =
                    s.Descriptor
                    | (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.Air
            );
            ...
            earth_spells = earth_spells.AddToArray(
                library.Get<BlueprintAbility>("bacba2ff48d498b46b86384053945e83").Variants
            );
            ...
            var heroic_invocation = library.Get<BlueprintAbility>(
            ...
            Common.addSpellDescriptor(
                rage,
                SpellDescriptor.Compulsion | SpellDescriptor.MindAffecting | SpellDescriptor.Emotion
            );
            Common.addSpellDescriptor(
                bless,
                SpellDescriptor.Compulsion | SpellDescriptor.MindAffecting | SpellDescriptor.Emotion
            ...
            var heroism_greater_buff = library.Get<BlueprintBuff>(
                "b8da3ec045ec04845a126948e1f4fc1a"
            );
            var heroic_invocation_buff = library.Get<BlueprintBuff>(
                "fd8fb2c1d622556468a04bea949eb7da"
            );
            ...
            var inspire_courage_effect_buff = library.Get<BlueprintBuff>(
                "6d6d9e06b76f5204a8b7856c78607d5d"
            );
            var inspire_greatness_effect_buff = library.Get<BlueprintBuff>(
                "ec38c2e60d738584983415cb8a4f508d"
            );
            var inspire_heroics_effect_buff = library.Get<BlueprintBuff>(
                "31e1f369cf0e4904887c96e4ef97a9cb"
            );
            var aid_buff = library.Get<BlueprintBuff>("319b4679f25779e4e9d04360381254e1");
            var inspiring_recovery_buff = library.Get<BlueprintBuff>(
                "87cd09cdcde2856489a8dd44a55030dc"
            );
            ...
            var burst_of_glory_buff = library.Get<BlueprintBuff>(
                "81005a24695910f4cb9b7c8ab4d932e1"
            );
            ...
            Common.addSpellDescriptor(
                heroism_greater_buff,
                SpellDescriptor.Compulsion | SpellDescriptor.MindAffecting
            );
            Common.addSpellDescriptor(
                heroic_invocation_buff,
                SpellDescriptor.Compulsion | SpellDescriptor.MindAffecting
            );
            Common.addSpellDescriptor(
                good_hope_buff,
            ...
            Common.addSpellDescriptor(
                inspire_courage_effect_buff,
                SpellDescriptor.MindAffecting | SpellDescriptor.Emotion
            );
            Common.addSpellDescriptor(
                inspire_heroics_effect_buff,
                SpellDescriptor.MindAffecting | SpellDescriptor.Emotion
            );
            Common.addSpellDescriptor(
                inspire_greatness_effect_buff,
                SpellDescriptor.MindAffecting | SpellDescriptor.Emotion
            );
            Common.addSpellDescriptor(
                aid_buff,
            ...
            var compulsion_immunity_buff = library.Get<BlueprintBuff>(
                "868a0ad22d7fa4d4480deb50a9dca681"
            );
            compulsion_immunity_buff.GetComponent<BuffDescriptorImmunity>().IgnoreFeature =
                compulsion_immunity_buff;
            compulsion_immunity_buff
                .GetComponent<SpellImmunityToSpellDescriptor>()
                .CasterIgnoreImmunityFact = compulsion_immunity_buff;
            ...
            Common.addSpellDescriptor(
                castigate,
                (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.LanguageDependent
            );
            Common.addSpellDescriptor(
                castigate_mass,
                (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.LanguageDependent
            ...
            var inspiring_command = library.Get<BlueprintAbility>(
                "2972215a5367ae44b8ddfe435a127a6e"
            );
            var inspiring_command_buff = library.Get<BlueprintBuff>(
                "a78a13e8b6fbae1459faad20eb3ecc72"
            );
            Common.addSpellDescriptor(
                inspiring_command,
                (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.LanguageDependent
        ...
        internal static void fixFeyStalkerSummonBuff()
        {
            ...
            var feystalker_master = library.Get<BlueprintFeature>(
                "02357ba2802b8654bb3e824bae68f5c0"
            );
        ...
        {
            var physical_ehancment_feature = library.Get<BlueprintFeature>(
                "93919f8ce64dc5a4cbf058a486a44a1b"
            );
            ...
            foreach (var f in physical_ehancment_feature.GetComponent<AddFacts>().Facts)
            {
                ...
                buff.ComponentsArray = new BlueprintComponent[]
                {
                    ...
                    Helpers.CreateContextRankConfig(
                        ...
                        classes: new BlueprintCharacterClass[] { wizard },
                        stepLevel: 5
                    ),
                };
            }
        ...
        internal static void fixAnimalCompanion()
        {
            ...
            var natural_armor = ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                "0d20d88abb7c33a47902bd99019f2ed1"
            );
            ...
            var stat_bonuses = ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                "0c80276018694f24fbaf59ec7b841f2b"
            );
            ...
            stat_bonuses.SetDescription(
                "Animal companions receive +1 bonus to their Strength and Dexterity."
            );
            //remove enchanced attacks
            var enchanced_attacks_feature = ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                "71d6955fe81a9a34b97390fef1104362"
            );
            enchanced_attacks_feature.HideInCharacterSheetAndLevelUp = true;
            var enchanced_attack_bonus =
                enchanced_attacks_feature.GetComponent<AllAttacksEnhancement>();
            enchanced_attack_bonus.Bonus = 0;
            var enchanced_attack_saves_bonus =
                enchanced_attacks_feature.GetComponent<BuffAllSavesBonus>();
            enchanced_attack_saves_bonus.Value = 0;

            //fix progression
            var animal_companion_progression = ResourcesLibrary.TryGetBlueprint<BlueprintArchetype>(
                "9f8a232fbe435a9458bf64c3024d7bee"
            );
            ...
            var animals = library.Get<BlueprintFeatureSelection>(
                "571f8434d98560c43935e132df65fe76"
            ); //druid animal companion selection
            ...
            //fix base ac
            Dictionary<BlueprintFeature, int> animal_armor_map = new Dictionary<
                BlueprintFeature,
                int
            >()
            {
            ...
            foreach (var kv in animal_armor_map)
            {
                ...
                unit.AddFacts = unit
                    .AddFacts.Where(a => !Common.natural_armor.Values.Contains(a))
                    .ToArray();
            ...
            var small_feature = Helpers.CreateFeature(
                "AnimalCompanionSmallSizeFeature",
                "",
                "",
            ...
            upgrade_feature.AddComponents(
                Helpers.CreateAddStatBonus(StatType.Strength, 4, ModifierDescriptor.None),
        ...
        internal static void fixLegendaryProportionsAC()
        {
            ...
            {
                "3fca5d38053677044a7ffd9a872d3a0a", //animal growth
        ...
        {
            BlueprintArchetype[] inquisitor_archetypes = new BlueprintArchetype[2]
            {
                ResourcesLibrary.TryGetBlueprint<BlueprintArchetype>(
                    "46eb929c8b6d7164188eb4d9bcd0a012"
                ), //sacred huntsmaster
                ResourcesLibrary.TryGetBlueprint<BlueprintArchetype>(
                    "cdaabf4b146c9ba42ab7d05abe3b48c4"
                ), //monster tactician
            };
            Kingmaker.Blueprints.Classes.LevelEntry remove_entry =
                new Kingmaker.Blueprints.Classes.LevelEntry();
            remove_entry.Level = 19;
            remove_entry.Features.Add(
                ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                    "ee50875819478774b8968701893b52f5"
                )
            ); //judgement additional use
            foreach (var inquisitor_archetype in inquisitor_archetypes)
            {
                inquisitor_archetype.RemoveFeatures =
                    inquisitor_archetype.RemoveFeatures.AddToArray(remove_entry);
            }
        }
        ...
        internal static void fixSerpentineBloodlineSerpentfriend()
        {
            ...
            serpentfriend.SetNameDescription("Serpentfriend", "You gain a viper familiar.");
            var viper_familiar = library.Get<BlueprintFeature>("3c0b706c526e0654b8af90ded235a089");
            serpentfriend.ComponentsArray = new BlueprintComponent[]
            {
                Helpers.CreateAddFact(viper_familiar),
            };
        }

        internal static void fixNecklaceOfDoubleCorses()
        {
        ...
        internal static void fixSkillPoints()
        {
            ...
            class_skill_map.Add(
                new KeyValuePair<string, int>("0937bec61c0dabc468428f496580c721", 2)
            ); //alchemist
            class_skill_map.Add(
                new KeyValuePair<string, int>("9c935a076d4fe4d4999fd48d853e3cf3", 2)
            ); //arcane trickster
            class_skill_map.Add(
                new KeyValuePair<string, int>("f7d7eb166b3dd594fb330d085df41853", 2)
            ); //barbarian
            class_skill_map.Add(
                new KeyValuePair<string, int>("772c83a25e2268e448e841dcd548235f", 3)
            ); //bard
            class_skill_map.Add(
                new KeyValuePair<string, int>("67819271767a9dd4fbfd4ae700befea0", 1)
            ); //cleric
            class_skill_map.Add(
                new KeyValuePair<string, int>("72051275b1dbb2d42ba9118237794f7c", 1)
            ); //dragon disciple
            class_skill_map.Add(
                new KeyValuePair<string, int>("610d836f3a3a9ed42a4349b62f002e96", 2)
            ); //druid
            class_skill_map.Add(
                new KeyValuePair<string, int>("4e0ea99612ae87a499c7fb0588e31828", 2)
            ); //duelist
            class_skill_map.Add(
                new KeyValuePair<string, int>("de52b73972f0ed74c87f8f6a8e20b542", 1)
            ); //eldrich knight
            class_skill_map.Add(
                new KeyValuePair<string, int>("f5b8c63b141b2f44cbb8c2d7579c34f5", 1)
            ); //eldrich scion
            class_skill_map.Add(
                new KeyValuePair<string, int>("48ac8db94d5de7645906c7d0ad3bcfbd", 1)
            ); //fighter
            class_skill_map.Add(
                new KeyValuePair<string, int>("f1a70d9e1b0b41e49874e1fa9052a1ce", 3)
            ); //inquisitor
            class_skill_map.Add(
                new KeyValuePair<string, int>("42a455d9ec1ad924d889272429eb8391", 2)
            ); //kineticist
            class_skill_map.Add(
                new KeyValuePair<string, int>("45a4607686d96a1498891b3286121780", 1)
            ); //magus
            class_skill_map.Add(
                new KeyValuePair<string, int>("e8f21e5b58e0569468e420ebea456124", 2)
            ); //monk
            class_skill_map.Add(
                new KeyValuePair<string, int>("0920ea7e4fd7a404282e3d8b0ac41838", 1)
            ); //mystic theurge
            class_skill_map.Add(
                new KeyValuePair<string, int>("bfa11238e7ae3544bbeb4d0b92e897ec", 1)
            ); //paladin
            class_skill_map.Add(
                new KeyValuePair<string, int>("cda0615668a6df14eb36ba19ee881af6", 3)
            ); //ranger
            class_skill_map.Add(
                new KeyValuePair<string, int>("299aa766dee3cbf4790da4efb8c72484", 4)
            ); //rogue
            class_skill_map.Add(
                new KeyValuePair<string, int>("b3a505fb61437dc4097f43c3f8f9a4cf", 1)
            ); //sorcerer
            class_skill_map.Add(
                new KeyValuePair<string, int>("d5917881586ff1d4d96d5b7cebda9464", 1)
            ); //stalwart defender
            class_skill_map.Add(
                new KeyValuePair<string, int>("90e4d7da3ccd1a8478411e07e91d5750", 2)
            ); //aldori swordlord
            class_skill_map.Add(
                new KeyValuePair<string, int>("ba34257984f4c41408ce1dc2004e342e", 1)
            ); //wizard
            class_skill_map.Add(
                new KeyValuePair<string, int>("c75e0971973957d4dbad24bc7957e4fb", 2)
            ); //slayer
            class_skill_map.Add(
                new KeyValuePair<string, int>("90e4d7da3ccd1a8478411e07e91d5750", 2)
            ); //swordlord
            class_skill_map.Add(
                new KeyValuePair<string, int>("4cd1757a0eea7694ba5c933729a53920", 3)
            ); //animal
            foreach (var class_skill in class_skill_map)
            {
                var current_class = ResourcesLibrary.TryGetBlueprint<BlueprintCharacterClass>(
                    class_skill.Key
                );
            ...
            var skilled_half_orc = library.Get<BlueprintFeature>(
                "4e8fe10f42f314e4fa7c7918bcfadbd5"
            );
            skilled_human.ReplaceComponent<AddSkillPoint>(
                Helpers.Create<NewMechanics.AddSkillPointOnEvenLevels>()
            );
            skilled_human.SetDescription(
                "Humans gain an additional skill rank at every even level."
            );

            skilled_half_orc.ReplaceComponent<AddSkillPoint>(
                Helpers.Create<NewMechanics.AddSkillPointOnEvenLevels>()
            );
            skilled_half_orc.SetDescription(
                "Half-orcs gain an additional skill rank at every even level."
            );
        }

        internal static void fixArchetypeKineticistGatherPowerWithShield()
        {
            var base_kineticist_feature = library.Get<BlueprintFeature>(
                "57e3577a0eb53294e9d7cc649d5239a3"
            );
            var buff = base_kineticist_feature
                .GetComponent<AddKineticistPart>()
                .CanGatherPowerWithShieldBuff;

            var features = new BlueprintFeature[]
            {
                library.Get<BlueprintFeature>("42c5a9a8661db2f47aedf87fb8b27aaf"), //dark elementalist
        ...
        internal static void clericAndDruidOfErastilGetShortbowProficiency()
        {
            ...
            var shortbow_proficiency = library.Get<BlueprintFeature>(
                "e8096942d950c8843857c2545f8dc18f"
            );
            var cleric_class = ResourcesLibrary.TryGetBlueprint<BlueprintCharacterClass>(
                "67819271767a9dd4fbfd4ae700befea0"
            );
            var druid_class = ResourcesLibrary.TryGetBlueprint<BlueprintCharacterClass>(
                "610d836f3a3a9ed42a4349b62f002e96"
            );
            erastil.AddComponent(
                Helpers.CreateAddFeatureOnClassLevel(
                    shortbow_proficiency,
                    1,
                    new BlueprintCharacterClass[] { druid_class, cleric_class }
                )
            );
            erastil.SetDescription(
                erastil.Description
                    + "\nClerics and druids of Erastil are proficient with the shortbow."
            );
        }

        internal static void fixFlameWardenSpells()
        {
            var flamewarden = library.Get<BlueprintArchetype>("300917c3479d27d47b4b4b52b1762e8d");

            var spellbook = library.CopyAndAdd<BlueprintSpellbook>(
                "762858a4a28eaaf43aa00f50441d7027",
                "FlameWardenSpellbook",
                ""
            );
            spellbook.Name = Helpers.CreateString("Flamewarden.Spellbook", flamewarden.Name);
            var druid_spelllist = library.Get<BlueprintSpellList>(
                "bad8638d40639d04fa2f80a1cac67d6b"
            );
            var ranger_spell_list = flamewarden.GetParentClass().Spellbook.SpellList;
            spellbook.SpellList = Common.combineSpellLists(
                "FlameWardenSpellList",
                (spell, spelllist, lvl) =>
                {
                    return lvl != 0
                        && (
                            ...
                            || (
                                !ranger_spell_list.Contains(spell)
                                && lvl <= 4
                                && spell.SpellDescriptor.Intersects(SpellDescriptor.Fire)
                            )
                        );
                },
                flamewarden.GetParentClass().Spellbook.SpellList,
                druid_spelllist
            );

            flamewarden.ReplaceSpellbook = spellbook;

            var flame_warden_spellcasting1 = library.Get<BlueprintFeature>(
                "2cb57c0d74d143f4da1ef6704012b0f4"
            );
            var flame_warden_spellcasting2 = library.Get<BlueprintFeature>(
                "275d72a20f615b54eb89460cd3aa8e1b"
            );
            var flame_warden_spellcasting3 = library.Get<BlueprintFeature>(
                "0dc70999341cdd644be0b972dd83900b"
            );
            var flame_warden_spellcasting4 = library.Get<BlueprintFeature>(
                "891441bcd187d4d43abc46d3202e07a0"
            );

            flamewarden.AddFeatures = Common.removeEntries(
                flamewarden.AddFeatures,
                f =>
                    f == flame_warden_spellcasting2
                    || f == flame_warden_spellcasting3
                    || f == flame_warden_spellcasting4
            );
            flame_warden_spellcasting1.SetDescription(
            ...
            {
                Helpers.CreateAddKnownSpell(
                    library.Get<BlueprintAbility>("d8f88028204bc2041be9d9d51f58e6a5"),
                    flamewarden.GetParentClass(),
                    1
                ),
                Helpers.CreateAddKnownSpell(
                    library.Get<BlueprintAbility>("7b30211b83d55194db872b6c9c0d9cc1"),
                    flamewarden.GetParentClass(),
                    3
                ),
                Helpers.CreateAddKnownSpell(
                    library.Get<BlueprintAbility>("b3a203742191449458d2544b3f442194"),
                    flamewarden.GetParentClass(),
                    4
                ),
            };
            ...
            Common.addMTDivineSpellbookProgression(
                flamewarden.GetParentClass(),
                spellbook,
                "MysticTheurgeFlamewardenProgression",
        ...
        {
            BlueprintFeature[] metamagics = library
                .GetAllBlueprints()
                .OfType<BlueprintFeature>()
                .Where(b =>
                    b.Groups.Contains(FeatureGroup.WizardFeat)
                    && (b.GetComponent<AddMetamagicFeat>() != null)
                    && b.AssetGuid != "2f5d1e705c7967546b72ad8218ccf99c"
                )
                .ToArray();

            var resource = library.Get<BlueprintAbilityResource>(
                "42fd5b455f986f94293b15b13f38d6a5"
            );
            var feature = Helpers.CreateFeature(
                "UniversalistMetamagicFeature",
                "Metamagic Mastery",
            ...
            var universalist_progression = library.Get<BlueprintProgression>(
                "0933849149cfc9244ac05d6a5b57fd80"
            );
            universalist_progression.LevelEntries = universalist_progression
                .LevelEntries.Where(le => le.Level < 8)
                .ToArray();
            universalist_progression.LevelEntries =
                universalist_progression.LevelEntries.AddToArray(Helpers.LevelEntry(8, feature));
            foreach (var mf in metamagics)
            {
                ...
                toggle.Group =
                    ActivatableAbilityGroupExtension.MetamagicMastery.ToActivatableAbilityGroup();
                var add_toggle = Common.ActivatableAbilityToFeature(toggle);
                var level = 2 * (cost - 1) + 8;

                mf.AddComponent(
                    Common.createAddFeatureIfHasFactAndNotHasFact(feature, add_toggle, add_toggle)
                );
                feature.AddComponent(
                    Common.createAddFeatureIfHasFactAndNotHasFact(mf, add_toggle, add_toggle)
                );
            }
            universalist_progression.SetDescription(
        ...
        {
            //Valerie
            var valerie_companion = ResourcesLibrary.TryGetBlueprint<BlueprintUnit>(
                "54be53f0b35bf3c4592a97ae335fe765"
            );
            valerie_companion.Strength = 16;
            valerie_companion.Dexterity = 13;
            valerie_companion.Constitution = 14;
            valerie_companion.Intelligence = 10;
            valerie_companion.Wisdom = 10;
            valerie_companion.Charisma = 15;
            valerie_companion.Body.Armor =
                ResourcesLibrary.TryGetBlueprint<Kingmaker.Blueprints.Items.Armors.BlueprintItemArmor>(
                    "559b0b6f194656c428c403a000ceee78"
                ); //full plate
            valerie_companion.Body.PrimaryHand =
                ResourcesLibrary.TryGetBlueprint<Kingmaker.Blueprints.Items.Weapons.BlueprintItemWeapon>(
                    "571c56d11dafbb04094cbaae659974b5"
                ); //longsword
            valerie_companion.Body.SecondaryHand =
                ResourcesLibrary.TryGetBlueprint<Kingmaker.Blueprints.Items.Shields.BlueprintItemShield>(
                    "f4cef3ba1a15b0f4fa7fd66b602ff32b"
                ); //shield
            var valerie_feature = ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                "912444657701e2d4ab2634c3d1e130ad"
            );
            var valerie_class_level = valerie_feature.GetComponent<AddClassLevels>();
            valerie_class_level.Archetypes = new BlueprintArchetype[]
            {
                library.Get<BlueprintArchetype>("d9e8055bbc5c43de9d8b2643006ef468"),
            };
            valerie_class_level.RaceStat = Kingmaker.EntitySystem.Stats.StatType.Constitution;

            valerie_class_level.Selections[0].Features[0] = library.Get<BlueprintFeature>(
                "ac57069b6bf8c904086171683992a92a"
            ); //shield focus
            valerie_class_level.Selections[1].Features[0] = library.Get<BlueprintFeature>(
                "121811173a614534e8720d7550aae253"
            ); //shield bash

            //change amiri stats
            var amiri_companion = ResourcesLibrary.TryGetBlueprint<BlueprintUnit>(
                "b3f29faef0a82b941af04f08ceb47fa2"
            );
            amiri_companion.Strength = 16;
            ...
            var amiri1_feature = ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                "df943986ee329e84a94360f2398ae6e6"
            );
            var amiri_class_level = amiri1_feature.GetComponent<AddClassLevels>();
            amiri_class_level.Archetypes = new BlueprintArchetype[]
            {
                library.Get<BlueprintArchetype>("a2ccb759dc6f1f94d9aae8061509bf87"),
            };
            amiri_class_level.RaceStat = Kingmaker.EntitySystem.Stats.StatType.Strength;
            amiri_class_level.Skills = new StatType[]
            {
            ...
            amiri_class_level.Selections[0].Features[1] = library.Get<BlueprintFeature>(
                "9972f33f977fc724c838e59641b2fca5"
            ); //power attack

            //harrim
            var harrim_companion = ResourcesLibrary.TryGetBlueprint<BlueprintUnit>(
                "aab03d0ab5262da498b32daa6a99b507"
            );
            harrim_companion.Strength = 14;
            ...
            linzi_class_levels.Selections[1].Features[0] = library.Get<BlueprintFeature>(
                "0da0c194d6e1d43419eb8d990b28e0ab"
            ); //point blank shot instead of extra performance

            //change octavia
            var octavia_feature = ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                "200151a5a5c78a4439d0f6e9fb26620a"
            );
            var octavia_acl = octavia_feature.GetComponent<AddClassLevels>();
            octavia_acl.Archetypes = new BlueprintArchetype[]
            {
                Arcanist.exploiter_wizard_archetype,
            };
            Common.addFeatureSelectionToAcl(
                octavia_acl,
                Arcanist.arcane_exploits_wizard,
                Arcanist.potent_magic
            );
            octavia_acl.SelectSpells[1] = library.Get<BlueprintAbility>(
                "95851f6e85fe87d4190675db0419d112"
            ); //grease
            octavia_acl.MemorizeSpells[0] = library.Get<BlueprintAbility>(
                "4ac47ddb9fa1eaf43a1b6809980cfbd2"
            ); //magic missile
            octavia_acl.MemorizeSpells[2] = library.Get<BlueprintAbility>(
                "4ac47ddb9fa1eaf43a1b6809980cfbd2"
            ); //magic missile
            octavia_acl.Selections[6].ParamSpellSchool = SpellSchool.Evocation;
            octavia_acl.Selections = octavia_acl
                .Selections.Where((_, index) => index != 2 && index != 4)
                .ToArray();

            //change regongar and fix his portrait
            var reg_portrait = library
                .Get<BlueprintPortrait>("6e7302bb773adf04299dbe8832562d50")
                .BackupPortrait = null;
            var regognar_companion = ResourcesLibrary.TryGetBlueprint<BlueprintUnit>(
                "b090918d7e9010a45b96465de7a104c3"
            );
            var regognar_levels = ResourcesLibrary
                .TryGetBlueprint<BlueprintFeature>("12ee53c9e546719408db257f489ec366")
                .GetComponent<AddClassLevels>();
            //fix claws selection
            regognar_levels.Selections = regognar_levels.Selections.AddToArray(
                new SelectionEntry()
                {
                    Selection = library.Get<BlueprintFeatureSelection>(
                        "5294b338c6084396abbe63faab09049c"
                    ),
                ...
                new SelectionEntry()
                {
                    ...
                    Features = new BlueprintFeature[]
                    {
                        library.Get<BlueprintFeature>("61aeb92c176193e48b0c9c50294ab290"),
                    }, //lizard
                }
            );

            //fix tratucio
            var tartucio_feature = library.Get<BlueprintFeature>(
                "a94fdc7ac4e70954aa05a5ff34b8e6bf"
            );
            var tartucio_levels = tartucio_feature.GetComponent<AddClassLevels>();
            tartucio_levels.Selections = tartucio_levels.Selections.AddToArray(
                new SelectionEntry()
                {
                    Selection = library.Get<BlueprintFeatureSelection>(
                        "7c150d6a5f5b4ffd8eb710c79888d273"
                    ),
                    Features = new BlueprintFeature[] { BloodlinesFix.bloodline_familiar },
                },
                new SelectionEntry()
            ...
            //change kallike
            var kalikke_feature = ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                "385e8d69b89992844b0992caf666a5fd"
            );
            var kalikke_acl = kalikke_feature.GetComponent<AddClassLevels>();
            kalikke_acl.Levels = 1;

            //change kanerah
            var kanerah_feature = ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                "ccb52e235941e0442be0cb0ee5570f07"
            );
        ...
        internal static void fixCompanions()
        {
            ...
            valerie_companion.Wisdom = 10;
            valerie_companion.Charisma = 15;
            var valerie1_feature = ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                "912444657701e2d4ab2634c3d1e130ad"
            );
            ...
            valerie_class_level.Selections[0].Features[1] = library.Get<BlueprintFeature>(
                "4c44724ffa8844f4d9bedb5bb27d144a"
            ); //combat expertise
            valerie_class_level.Skills = new StatType[]
            {
                StatType.SkillPersuasion,
            ...
            valerie1_feature.GetComponent<AddFacts>().Facts = valerie1_feature
            ...
            var tristian_companion = ResourcesLibrary.TryGetBlueprint<BlueprintUnit>(
            ...
            tristian_level.Selections[2].Features[0] =
                ResourcesLibrary.TryGetBlueprint<BlueprintProgression>(
                    "c85c8791ee13d4c4ea10d93c97a19afc"
                ); //sun as primary
            tristian_level.Selections[3].Features[0] = Subdomains.restoration_domain_secondary;
            tristian_level.Selections[4].Features[1] =
                ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                    "797f25d709f559546b29e7bcb181cc74"
                ); //improved initiative
            tristian_level.Selections[4].Features[0] =
                ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
            ...
            tristian_level.Skills = new StatType[]
            {
                StatType.SkillLoreReligion,
            ...
            harrim_companion.Body.PrimaryHandAlternative1 =
                ResourcesLibrary.TryGetBlueprint<Kingmaker.Blueprints.Items.Weapons.BlueprintItemWeapon>(
                    "7f7c8e1e4fdd99e438b30ed9622e9e3f"
                ); //heavy flail

            var harrim_feature = ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                "8910febae2a7b9f4ba5eca4dde1e9649"
            );
            harrim_feature.GetComponent<AddFacts>().Facts = harrim_feature
                .GetComponent<AddFacts>()
                .Facts.Skip(1)
                .ToArray();
            ...
            harrim_class_level.Archetypes = new BlueprintArchetype[]
            {
                Warpriest.sacred_fist_archetype,
            };
            harrim_class_level.Skills = new StatType[]
            {
                StatType.SkillLoreReligion,
                StatType.SkillPerception,
                StatType.SkillPersuasion,
            ...
            harrim_class_level.Selections[0].Features = new BlueprintFeature[]
            {
                library.Get<BlueprintParametrizedFeature>("1e1f627d26ad36f43bbd26cc2bf8ac7e"), //wf
            ...
            harrim_class_level.Selections[2].Features = new BlueprintFeature[]
            {
                Warpriest.warpriest_spontaneous_heal,
            };
            harrim_class_level.Selections[3].Selection = Warpriest.warpriest_blessings;
            harrim_class_level.Selections[3].Features = new BlueprintFeature[]
            {
                Warpriest.blessings_map["Chaos"],
                Warpriest.blessings_map["Destruction"],
            };
            harrim_class_level.Selections[4].Selection = Warpriest.fighter_feat;
            harrim_class_level.Selections[4].Features = new BlueprintFeature[]
            {
                NewFeats.weapon_of_the_chosen,
                NewFeats.improved_weapon_of_the_chosen,
                NewFeats.greater_weapon_of_the_chosen,
            ...
            harrim_class_level.Selections[5].Features = new BlueprintFeature[]
            {
                library.Get<BlueprintParametrizedFeature>("1e1f627d26ad36f43bbd26cc2bf8ac7e"),
            }; //wf
            harrim_class_level.Selections[6].ParametrizedFeature =
                library.Get<BlueprintParametrizedFeature>("1e1f627d26ad36f43bbd26cc2bf8ac7e"); //wf
            harrim_class_level.Selections[6].ParamWeaponCategory = WeaponCategory.UnarmedStrike;
            harrim_class_level.Selections[7].ParametrizedFeature =
                library.Get<BlueprintParametrizedFeature>("31470b17e8446ae4ea0dacd6c5817d86"); //ws
            ...
            harrim_class_level.Selections[8].Selection = library.Get<BlueprintFeatureSelection>(
                "76d4885a395976547a13c5d6bf95b482"
            ); //af
            harrim_class_level.Selections[8].Features = new BlueprintFeature[]
            {
                library.Get<BlueprintFeature>("c27e6d2b0d33d42439f512c6d9a6a601"),
            }; //heavy
            harrim_class_level.Selections[9].ParametrizedFeature =
                library.Get<BlueprintParametrizedFeature>("09c9e82965fb4334b984a1e9df3bd088"); //gwf
            ...
            //change linzi
            var linzi_companion = ResourcesLibrary.TryGetBlueprint<BlueprintUnit>(
            ...
            var linzi_feature = library.Get<BlueprintFeature>("920cb420385dbb34681b620b6c1b59e9");
            var linzi_class_levels = linzi_feature.GetComponent<AddClassLevels>();
            linzi_class_levels.Skills = new StatType[]
            {
                StatType.SkillPersuasion,
                StatType.SkillKnowledgeWorld,
            ...
            {
                linzi_class_levels.Selections[1].Features[0] = library.Get<BlueprintFeature>(
                    "8f3d1e6b4be006f4d896081f2f889665"
                ); //precise shot
            }
            //change octavia
            var octavia_companion = ResourcesLibrary.TryGetBlueprint<BlueprintUnit>(
            ...
            octavia_acl.Skills = new StatType[]
            {
                StatType.SkillKnowledgeArcana,
                StatType.SkillKnowledgeWorld,
                StatType.SkillUseMagicDevice,
            ...
            octavia_acl.Selections[4].Features[0] = library.Get<BlueprintFeature>(
                "97dff21a036e80948b07097ad3df2b30"
            ); // hare familiar
            octavia_acl.Selections[5].Features[0] = library.Get<BlueprintFeature>(
                "f43ffc8e3f8ad8a43be2d44ad6e27914"
            ); //umd
            octavia_companion.Dexterity = 14;
            octavia_companion.Charisma = 14;
            octavia_companion.Strength = 10;
            octavia_acl.Selections[0].Features[0] = library.Get<BlueprintFeature>(
                "797f25d709f559546b29e7bcb181cc74"
            ); //improved initiative
            ...
            Action<UnitDescriptor> fix_action = delegate(UnitDescriptor u)
            {
                ...
                var dex_toggle = library.Get<BlueprintActivatableAbility>(
                    "3553bda4d6dfe6344ad89b25f7be939a"
                );
            ...
            regognar_levels.Selections[1].Selection =
                Bloodrager.eldritch_scion_bloodrager_bloodlines;
            regognar_levels.Selections[1].Features[0] = library.Get<BlueprintProgression>(
                "2f5c69372bb5494da0b67acc66c0b54a"
            ); //draconic blue
            regognar_levels.Selections = regognar_levels.Selections.AddToArray(
                new SelectionEntry()
                {
                    Selection = library.Get<BlueprintFeatureSelection>(
                        "f121a082924144cb92023d202902763b"
                    ),
                    Features = new BlueprintFeature[] { BloodlinesFix.bloodline_familiar },
                },
                new SelectionEntry()
            ...
            //change ekun
            var ekun_companion = ResourcesLibrary.TryGetBlueprint<BlueprintUnit>(
            ...
            var ekun_feature = ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                "0bc6dc9b6648a744899752508addae8c"
            );
            ...
            //change jubilost
            var jubilost_companion = ResourcesLibrary.TryGetBlueprint<BlueprintUnit>(
            ...
            var jubilost_feature = ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                "c9618e3c61e65114b994f3fabcae1d97"
            );
            var jubilost_acl = jubilost_feature.GetComponent<AddClassLevels>();
            if (Main.settings.balance_fixes)
            {
                jubilost_acl.Selections[0].Features[0] = library.Get<BlueprintFeature>(
                    "8f3d1e6b4be006f4d896081f2f889665"
                ); //precise shot
            }
            jubilost_acl.Levels = 1;
            jubilost_acl.Archetypes = jubilost_acl.Archetypes.AddToArray(
                Archetypes.Preservationist.archetype
            );
            jubilost_acl.Skills = new StatType[]
            {
                StatType.SkillKnowledgeWorld,
                StatType.SkillPersuasion,
                StatType.SkillThievery,
            ...
            //change nok-nok
            var noknok_companion = ResourcesLibrary.TryGetBlueprint<BlueprintUnit>(
                "f9417988783876044b76f918f8636455"
            );
            ...
            noknok_companion.GetComponent<AddClassLevels>().Skills = new StatType[]
            {
                StatType.SkillMobility,
                StatType.SkillThievery,
                StatType.SkillPerception,
            ...
            var jaethal_feature_list = library.Get<BlueprintFeature>(
                "34280596dd550074ca55bd15285451b3"
            );
            var jaethal_selections = jaethal_feature_list.GetComponent<AddClassLevels>();
            jaethal_selections.Skills = new StatType[]
            {
                StatType.SkillPerception,
                StatType.SkillPersuasion,
                StatType.SkillMobility,
            ...
            jaethal_selections.Selections[1].Features[0] = library.Get<BlueprintFeature>(
                "0da0c194d6e1d43419eb8d990b28e0ab"
            ); //point blank shot
            if (Main.settings.balance_fixes)
            {
            ...
            jaethal_unit.Body.PrimaryHandAlternative1 = library.Get<BlueprintItemWeapon>(
                "7998cd1409fe1194583b64180df4f216"
            ); //composite longbow

            var varn_companion = ResourcesLibrary.TryGetBlueprint<BlueprintUnit>(
                "e83a03d50fedd35449042ce73f1b6908"
            );
            var varn_feature = ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                "2babd2d4687b5ee428966322eccfe4b6"
            );
            ...
            varn_class_levels.Skills = new StatType[]
            {
                StatType.SkillMobility,
                StatType.SkillThievery,
                StatType.SkillPerception,
            ...
            var cephales_companion = ResourcesLibrary.TryGetBlueprint<BlueprintUnit>(
                "77c5eb949dffb9f45abcc7a78a2d281f"
            );
            var cephales_feature = ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                "d152b07305353474ba15d750015d99ee"
            );
            ...
            cephales_class_levels.Selections[0].Features[0] = library.Get<BlueprintFeature>(
                "797f25d709f559546b29e7bcb181cc74"
            ); //improved initiative
            cephales_class_levels.Selections[0].Features[1] =
                library.Get<BlueprintParametrizedFeature>("16fa59cc9a72a6043b566b49184f53fe"); //spell focus (necromancy)
            cephales_class_levels.Selections = cephales_class_levels.Selections.AddToArray(
                new SelectionEntry()
                {
                    Selection = library.Get<BlueprintFeatureSelection>(
                        "5294b338c6084396abbe63faab09049c"
                    ...
                    ParametrizedFeature = library.Get<BlueprintParametrizedFeature>(
                        "16fa59cc9a72a6043b566b49184f53fe"
                    ),
            ...
            cephales_class_levels.Selections[0].Features[3] =
                library.Get<BlueprintParametrizedFeature>("5b04b45b228461c43bad768eb0f7c7bf");
            cephales_class_levels.Selections[0].Features[4] = library.Get<BlueprintFeature>(
            ...
            var kalikke_acl = kalikke_feature.GetComponent<AddClassLevels>();
            kalikke_acl.Levels = 1;
            kalikke_acl.Selections[0].Features[0] = library.Get<BlueprintFeature>(
                "90e54424d682d104ab36436bd527af09"
            ); //weapon finesse
            kalikke_acl.Selections[4].Features = kalikke_acl
                .Selections[4]
                .Features.Reverse()
                .ToArray(); //give cold blast instead of water at level 1
            kalikke_acl.Skills = new StatType[]
            {
                StatType.SkillPerception,
                StatType.SkillMobility,
                StatType.SkillStealth,
            ...
            var water_blast_action = library.Get<BlueprintAiCastSpell>(
                "2c24f6bb1a757864d8aaa4b41466d3dc"
            );
            water_blast_action.Ability = library.Get<BlueprintAbility>(
                "7980e876b0749fc47ac49b9552e259c1"
            );
            water_blast_action.Variant = library.Get<BlueprintAbility>(
                "f6d32ecd20ebacb4e964e2ece1c70826"
            );

            var elemental_focus = library.Get<BlueprintFeatureSelection>(
                "bb24cc01319528849b09a3ae8eec0b31"
            );
            var kanerah_feature = ResourcesLibrary.TryGetBlueprint<BlueprintFeature>(
                "ccb52e235941e0442be0cb0ee5570f07"
            );
            ...
            kanerah_acl.Selections[12].Features[0] = library.Get<BlueprintFeature>(
                "c82bc8134f3a6e24994b8ef70fb4014a"
            ); //tiefling standard
            Common.addFeatureSelectionToAcl(
                kanerah_acl,
                elemental_focus,
                elemental_focus.AllFeatures.Last()
            ); //fire
            kanerah_acl.Selections[4].Features = kalikke_acl
                .Selections[4]
                .Features.Reverse()
                .ToArray();
            kanerah_acl.Skills = new StatType[]
            {
                StatType.SkillStealth,
                StatType.SkillMobility,
                StatType.SkillUseMagicDevice,
            ...
            tartucio_levels.SelectSpells[1] = library.Get<BlueprintAbility>(
        ...
        internal static void fixMissingSlamProficiency()
        {
            ...
            var skill_use_ability = library.Get<BlueprintFeature>(
                "e4c33ff99d638744686112e2a5f49856"
            );
            skill_use_ability.AddComponent(
                Common.createAddWeaponProficiencies(WeaponCategory.OtherNaturalWeapons)
            );
        ...
        internal static void fixWebSchool()
        {
            ...
            library
                .Get<BlueprintSpellList>("ac551db78c1baa34eb8edca088be13cb")
                .SpellsByLevel[2]
                .Spells.Add(web); //add to lust
            library
                .Get<BlueprintSpellList>("17c0bfe5b7c8ac3449da655cdcaed4e7")
                .SpellsByLevel[2]
                .Spells.Remove(web); //remove from wrath

            library
                .Get<BlueprintSpellList>("69a6eba12bc77ea4191f573d63c9df12")
                .SpellsByLevel[2]
                .Spells.Add(web); //add to conjuration
            library
                .Get<BlueprintSpellList>("becbcfeca9624b6469319209c2a6b7f1")
                .SpellsByLevel[2]
                .Spells.Remove(web); //remove from conjuration
        }
        ...
        internal static void fixSpellRemoveFearBuff()
        {
            ...
            var fearless_defensive_stance_buff = library.Get<BlueprintBuff>(
                "993a5300cc84fde4bb4df441bf92d701"
            );
            fearless_defensive_stance_buff.AddComponent(
                Helpers.CreateAddFactContextActions(
                    activated: Common.createContextActionRemoveBuffsByDescriptor(
                        SpellDescriptor.Shaken | SpellDescriptor.Fear
                    )
                )
            );
            fearless_rage_buff.AddComponent(
                Helpers.CreateAddFactContextActions(
                    activated: Common.createContextActionRemoveBuffsByDescriptor(
                        SpellDescriptor.Shaken | SpellDescriptor.Fear
                    )
            ...
            buff.AddComponent(
                Helpers.CreateAddFactContextActions(
                    activated: Common.createContextActionApplyBuff(
                        fearless_rage_buff,
                        Helpers.CreateContextDuration(),
                        duration_seconds: 1
                    )
        ...
        {
            //fix smiting buffs
            library.Get<BlueprintActivatableAbility>("72fe16312b4479145afc6cc6c87cd08f").Buff =
                library.Get<BlueprintBuff>("481b03bc6cbc5af448b1f6cb70d88859"); //alignment
            library.Get<BlueprintActivatableAbility>("2c448ab4135c7c741b6f0f223901f9fa").Buff =
                library.Get<BlueprintBuff>("2e3f01df36b508b4e9186bab7a337dfa"); //adamantite
        }
        ...
        internal static void fixDomains()
        {
            ...
            var inquisitor_class = ResourcesLibrary.TryGetBlueprint<BlueprintCharacterClass>(
                "f1a70d9e1b0b41e49874e1fa9052a1ce"
            );
            var druid_class = ResourcesLibrary.TryGetBlueprint<BlueprintCharacterClass>(
                "610d836f3a3a9ed42a4349b62f002e96"
            );
            var domain_classes_and_druid = new BlueprintCharacterClass[]
            {
                cleric_class,
                inquisitor_class,
                druid_class,
            ...
            library
                .Get<BlueprintAbility>("f166325c271dd29449ba9f98d11542d9")
                .ReplaceComponent<ContextRankConfig>(c =>
                    Helpers.SetField(c, "m_Class", domain_classes_and_druid)
                );

            //fix luck domain
            var luck_domain_greater_resource = library.Get<BlueprintAbilityResource>(
                "b209ca75fbea5144c9d73ecb29055a08"
            );
            var luck_domain_greater_ability = library.Get<BlueprintAbility>(
                "0e0668a703fbfcf499d9aa9d918b71ea"
            );

            if (luck_domain_greater_ability.GetComponent<AbilityResourceLogic>() == null)
            {
                luck_domain_greater_ability.AddComponent(
                    luck_domain_greater_resource.CreateResourceLogic()
                );
            }
            ...
            var madness_greater_resource = library.Get<BlueprintAbilityResource>(
                "3289ee86c57f6134d81770865c315e8b"
            );
            var madness_domain_buff = library.Get<BlueprintBuff>(
                "73192f96dd97b634cb794ae42f92c2ff"
            );
            var madness_area = library.Get<BlueprintAbilityAreaEffect>(
                "19ee79b1da25ea049ba4fea92c2a4025"
            );
            var madness_greater_feature = library.Get<BlueprintFeature>(
                "9acc8ab2f313d0e49bb01e030c868e3f"
            );

            madness_greater_resource.SetIncreasedByLevel(
                0,
                1,
                new BlueprintCharacterClass[] { cleric_class, inquisitor_class }
            );
            madness_area.AddComponent(
            ...
            var toggle = Common.buffToToggle(
                ...
                UnitCommand.CommandType.Standard,
                false,
                madness_greater_resource.CreateActivatableResourceLogic(
                    ActivatableAbilityResourceLogic.ResourceSpendType.NewRound
                )
            );
        ...
        {
            var jaethal_immortality = library.Get<BlueprintFeature>(
                "1ed5fac73a4dc054d8411f24cf09d703"
            );
            jaethal_immortality.AddComponents(
                ...
                Helpers.CreateAddFact(
                    library.Get<BlueprintFeature>("a9ac84c6f48b491438f91bb237bc9212")
                ) //channel resistance
            );
        }
        ...
        internal static void fixDispellingStrikeCL()
        {
            ...
            var dispelling_attack = library.Get<BlueprintFeature>(
                "1b92146b8a9830d4bb97ab694335fa7c"
            );
            ...
            dispelling_attack.ReplaceComponent<ContextSetAbilityParams>(
                Helpers.Create<NewMechanics.ReplaceCasterLevelOfFactWithContextValue>(r =>
                {
        ...
        {
            var rage = ResourcesLibrary.TryGetBlueprint<BlueprintBuff>(
                "da8ce41ac3cd74742b80984ccc3c9613"
            );
            var components =
                rage.GetComponents<Kingmaker.UnitLogic.FactLogic.AddContextStatBonus>();
        ...
        {
            var magic_vestement_armor_buff = Main.library.Get<BlueprintBuff>(
                "9e265139cf6c07c4fb8298cb8b646de9"
            );
            var armor_enchant =
                Helpers.Create<NewMechanics.EnchantmentMechanics.BuffContextEnchantArmor>();
            ...
            library
                .Get<BlueprintAbility>("956309af83352714aa7ee89fb4ecf201")
                .AddComponent(Helpers.Create<NewMechanics.AbilitTargetHasArmor>());
        }

        static void fixMagicVestmentShield()
        {
            var magic_vestement_shield_buff = Main.library.Get<BlueprintBuff>(
                "2e8446f820936a44f951b50d70a82b16"
            );
            var shield_enchant =
                Helpers.Create<NewMechanics.EnchantmentMechanics.BuffContextEnchantShield>();
            ...
            magic_vestement_shield_buff.ComponentsArray = new BlueprintComponent[]
            {
                shield_enchant,
                Helpers.CreateContextRankConfig(
                    baseValueType: ContextRankBaseValueType.CasterLevel,
            ...
            library
                .Get<BlueprintAbility>("adcda176d1756eb45bd5ec9592073b09")
                .AddComponent(Helpers.Create<NewMechanics.AbilitTargetHasShield>());
        }
        ...
        internal static void fixDragonDiscipleBonusFeat()
        {
            ...
            var dd_feat_selection = Main.library.Get<BlueprintFeatureSelection>(
                "f4b011d090e8ae543b1441bd594c7bf7"
            );
            dd_feat_subselection = Main.library.CopyAndAdd<BlueprintFeatureSelection>(
                "f4b011d090e8ae543b1441bd594c7bf7",
                "DragonDiscipleDraconicFeatSubselection",
                ""
            );
            ...
            dd_feat_subselection.SetDescription(
            ...
            var dragon_disciple_progression = Main.library.Get<BlueprintProgression>(
                "69fc2bad2eb331346a6c777423e0d0f7"
            );
        ...
        internal static void fixNaturalACStacking()
        {
            ...
            ResourcesLibrary
                .TryGetBlueprint<BlueprintFeature>("aa4f9fd22a07ddb49982500deaed88f9")
                .GetComponent<AddStatBonus>()
                .Descriptor = ModifierDescriptor.Racial;
        }

        internal static void fixInspiredFerocity()
        {
            var reckless_stance_switch = Main.library.Get<BlueprintBuff>(
                "c52e4fdad5df5d047b7ab077a9907937"
            );
            var inspire_ferocity_rage_buff = Main.library.Get<BlueprintBuff>(
                "9a8a16f5734eec7439c5c77000316742"
            );
            var inspire_ferocity_switch_buff = Main.library.Get<BlueprintBuff>(
                "4b3fb3c9473a00f4fa526f4bd3fc8b7a"
            );
            var c = reckless_stance_switch.GetComponent<AddFactContextActions>();
            c.Deactivated.Actions = c.Deactivated.Actions.AddToArray(
                Common.createContextActionRemoveBuff(inspire_ferocity_rage_buff)
            ); //remove inspired ferocity when reckless stance is deactivated
            var condition_on = (Conditional)c.Activated.Actions[0];
            var apply_ferocity = Common.createContextActionApplyBuff(
                inspire_ferocity_rage_buff,
                Helpers.CreateContextDuration(),
                is_child: true,
                is_permanent: true
            );
            condition_on.IfTrue.Actions = condition_on.IfTrue.Actions.AddToArray(
                Helpers.CreateConditional(
                    Common.createContextConditionCasterHasFact(inspire_ferocity_switch_buff),
                    apply_ferocity,
                    null
                )
            );
        ...
        internal static void fixLethalStance()
        {
        ...
        internal static void fixItemBondForSpontnaeousCasters()
        {
            var item_bond_spontaneous = library.CopyAndAdd<BlueprintAbility>(
                "e5dcf71e02e08fc448d9745653845df1",
                "ItemBondSpontaneousAbility",
                ""
            );
            item_bond_spontaneous.ReplaceComponent<AbilityRestoreSpellSlot>(
                Helpers.Create<AbilityRestoreSpontaneousSpell>(a => a.SpellLevel = 10)
            );

            var item_bond_feature = library.Get<BlueprintFeature>(
        ...
        internal static void fixTrapfinding()
        {
            var trapfinding_rogue = library.Get<BlueprintFeature>(
                "dbb6b3bffe6db3547b31c3711653838e"
            );
            var trapfinding_slayer = library.Get<BlueprintFeature>(
                "e3c12938c2f93544da89824fbe0933a5"
            );

            trapfinding_rogue.AddComponent(
                Helpers.CreateAddContextStatBonus(StatType.SkillThievery, ModifierDescriptor.None)
            );
            trapfinding_slayer.AddComponent(
                Helpers.CreateAddContextStatBonus(StatType.SkillThievery, ModifierDescriptor.None)
            );
            trapfinding_rogue.SetDescription(
                "A rogue adds 1/2 her level on Perception and Trickery checks."
            );
        }

        internal static void fixAnimalSizeChange()
        {
            //to make it compatible with size increasing efects
            string[] large_upgrades = new string[]
            {
                "abda5a76b8a5901478495ffdc5450c9e", //bear
            ...
            string[] medium_upgrades = new string[]
            {
                "beb608c45bb2aef42802e2afdf018a32", //monitor
            ...
            foreach (var id in large_upgrades)
            {
                ...
                feature.ReplaceComponent<ChangeUnitSize>(
                    Helpers.Create<SizeMechanics.PermanentSizeOverride>(p => p.size = Size.Large)
                );
            }
        ...
        internal static void condenseMonkUnarmedDamage()
        {
            ...
            var fists = new BlueprintFeature[]
            {
                fist1d8,
                fist1d10,
                fist2d6,
            ...
            fist1d6.ComponentsArray = new BlueprintComponent[]
            {
                ...
                Helpers.CreateContextRankConfig(
                    ...
                    progression: ContextRankProgression.DivStep,
                    stepLevel: 4,
                    classes: new BlueprintCharacterClass[]
                    {
                        library.Get<BlueprintCharacterClass>("e8f21e5b58e0569468e420ebea456124"),
                    }
                ),
            };
            fist1d6.ReapplyOnLevelUp = true;
            var monk_progresssion = library.Get<BlueprintProgression>(
                "8a91753b978e3b34b9425419179aafd6"
            );
            monk_progresssion.LevelEntries = Common.removeEntries(
                monk_progresssion.LevelEntries,
                f => fists.Contains(f),
                keep_empty_entries: true
            );
            ...
            hammerblow.ReplaceComponent(
                double_damage,
                Helpers.Create<NewMechanics.DoubleDamageDiceOnAttack>(d =>
                {
        ...
        internal static void fixTeamworkFeats()
        {
            ...
            var allied_spell_caster = library.Get<BlueprintFeature>(
                "9093ceeefe9b84746a5993d619d7c86f"
            );
            allied_spell_caster.GetComponent<AlliedSpellcaster>().Radius = fix_range;
            allied_spell_caster.AddComponent(
                Helpers.Create<TeamworkMechanics.AlliedSpellcasterSameSpellBonus>(a =>
                {
                    a.Radius = fix_range;
                    a.AlliedSpellcasterFact = allied_spell_caster;
                })
            );
            allied_spell_caster.SetDescription(
            ...
            var coordinated_maneuvers = library.Get<BlueprintFeature>(
                "b186cea78dce3a04aacff0a81786008c"
            );
            coordinated_maneuvers.GetComponent<CoordinatedManeuvers>().Radius = fix_range;
        }

        internal static void fixSpellRanges()
        {
            library.Get<BlueprintAbility>("b24583190f36a8442b212e45226c54fc").Range =
                AbilityRange.Medium; //change range of wail of banshee to medium since by the time you can cast it will be 25 + 17/2 * 5 = 65
            library.Get<BlueprintAbility>("ba48abb52b142164eba309fd09898856").Range =
                AbilityRange.Medium; //change range of polar midnight to medium since by the time you can cast it will be 25 + 17/2 * 5 = 65
        }

        internal static void fixEcclesitheurge()
        {
            var cleric_class = library.Get<BlueprintCharacterClass>(
                "67819271767a9dd4fbfd4ae700befea0"
            );
            ...
            long_blessing.ReplaceComponent<ContextRankConfig>(
                Helpers.CreateContextRankConfig(
                    baseValueType: ContextRankBaseValueType.ClassLevel,
                    progression: ContextRankProgression.StartPlusDivStep,
                    classes: new BlueprintCharacterClass[] { cleric_class },
                    stepLevel: 2,
                    startLevel: 3
                )
            );
        ...
        internal static void fixSenseiMysticAdvice()
        {
            ...
            var mystic_powers_mass = library.Get<BlueprintFeature>(
                "a316044187ec61344ba33535f42f6a4d"
            );
            ...
            var mystic_wisdom_mass = library.Get<BlueprintFeature>(
                "1c02ec3a153954b459becc0d40d3cf60"
            );
            var abilities = mystic_wisdom
                .GetComponent<AddFacts>()
                .Facts.Cast<BlueprintAbility>()
                .ToArray();
            abilities = abilities.AddToArray(
                mystic_wisdom_mass.GetComponent<AddFacts>().Facts.Cast<BlueprintAbility>()
            );
            ...
            foreach (var ab in abilities)
            {
                ...
                ab.ReplaceComponent<AbilityEffectRunAction>(a =>
                    a.Actions.Actions = Common.changeAction<ContextActionApplyBuff>(
                        a.Actions.Actions,
            ...
            mystic_powers.SetDescription(
                "At 6th level, a sensei may use his advice ability by paying 1 extra ki pool point, when spending points from his ki pool to activate a class ability (using the normal actions required for each) in order to have that ability affect one ally within 30 feet rather than the sensei himself.\nAt 10th level, a sensei may pay 2 extra ki pool points to affect all allies within 30 feet rather than himself (spending points from his ki pool only once, not once for each target)."
            );
        ...
        internal static void fixSenseiBuffs()
        {
            ...
            var diamond_body_feature = library.Get<BlueprintFeature>(
                "a8819b70975701b4e874b2f9862aac24"
            );
            var diamond_soul_feature = library.Get<BlueprintFeature>(
                "01182bcee8cb41640b7fa1b1ad772421"
            );

            diamond_soul_buff.ComponentsArray = diamond_soul_feature
                .ComponentsArray.Where(c => !(c is Prerequisite))
                .ToArray();
            diamond_body_buff.ComponentsArray = diamond_body_feature
                .ComponentsArray.Where(c => !(c is Prerequisite))
                .ToArray();
            ...
            mystic_powers.RemoveComponents<AddFeatureIfHasFact>(a =>
                (a.CheckedFact as BlueprintFeature) == ki_pool
            );
            mystic_powers_mass.RemoveComponents<AddFeatureIfHasFact>(a =>
                (a.CheckedFact as BlueprintFeature) == ki_pool
            );
        }

        internal static void fixKiPoolExtraAttacks()
        {
            //remove extra attack from anyone who does not get flurry of blows
            var ki_pool = library.Get<BlueprintFeature>("e9590244effb4be4f830b1e3fffced13");
            var scaled_fist_ki_pool = library.Get<BlueprintFeature>(
                "ae98ab7bda409ef4bb39149a212d6732"
            );
            ...
            foreach (var kp in ki_pools)
            {
                ...
                if (kp == ki_pool)
                {
                    ki_pool.AddComponent(
                        Common.createAddFeatureIfHasFact(Archetypes.ZenArcher.flurry1, c.Facts[0])
                    );
                }
                kp.ReplaceComponent(
                    c,
                    Common.createAddFeatureIfHasFact(flurry_of_blows, c.Facts[0])
                );
            }
        }

        internal static void fixMonkStyleStrikes()
        {
            ...
            var monk_class = library.Get<BlueprintCharacterClass>(
                "e8f21e5b58e0569468e420ebea456124"
            );
            var style_strike = library.Get<BlueprintFeatureSelection>(
                "7bc6a93f6e48eff49be5b0cde83c9450"
            );
            var extra_style_strike_feature = Helpers.CreateFeature(
                "MonkExtraStyleStrikeFeature15",
                "",
                "",
                "823c059bd3754bfca2d06bd3409827e1",
                null,
                FeatureGroup.None,
                Common.createIncreaseActivatableAbilityGroupSize(
            ...
            {
                style_strike.AddComponent(
                    Helpers.CreateAddFeatureOnClassLevel(
                        extra_style_strike_feature,
                        15,
                        new BlueprintCharacterClass[] { monk_class }
                    )
                );
            }
            ...
            sensei.RemoveFeatures = sensei.RemoveFeatures.AddToArray(
                Helpers.LevelEntry(5, style_strike),
        ...
        internal static void fixIncreasedDamageReduction()
        {
            var drs = new BlueprintFeature[]
            {
                library.Get<BlueprintFeature>("cffb5cddefab30140ac133699d52a8f8"), //barbarian
            ...
            var increased_dr_stalwart = library.Get<BlueprintFeature>(
                "d10496e92d0799a40bb3930b8f4fda0d"
            );

            foreach (var dr in drs)
            {
                var context_rank_config = dr.GetComponent<ContextRankConfig>();
                var feature_list = Helpers
                    .GetField<BlueprintFeature[]>(context_rank_config, "m_FeatureList")
                    .ToList();
            ...
            var dr_buff = Helpers.CreateBuff(
                "BarbarianRageIncreasedDrBuff",
                "",
                "",
                "",
                null,
                null,
                Common.createContextPhysicalDR(
            ...
            var barbarian_rage_buff = library.Get<BlueprintBuff>(
                "da8ce41ac3cd74742b80984ccc3c9613"
            );
            Common.addContextActionApplyBuffOnFactsToActivatedAbilityBuffNoRemove(
                barbarian_rage_buff,
                dr_buff,
                increased_dr
            );

            var dr_buff_stalwart = Helpers.CreateBuff(
                "StalwartDefenderIncreasedDrBuff",
                "",
                "",
                "",
                null,
            ...
            increased_dr_stalwart.SetDescription(
                "The stalwart defender's damage reduction from this class increases by 2/—. This increase is always active while the stalwart defender is in a defensive stance. He can select this power up to two times. Its effects stack. The stalwart defender must be at least 6th level before selecting this defensive power."
            );
            dr_buff_stalwart.ReplaceComponent<ContextRankConfig>(
                Helpers.CreateContextRankConfig(
                    baseValueType: ContextRankBaseValueType.FeatureListRanks,
                    featureList: new BlueprintFeature[]
                    {
                        increased_dr_stalwart,
                        increased_dr_stalwart,
                    }
                )
            );

            var defensive_stance_buff = library.Get<BlueprintBuff>(
                "3dccdf27a8209af478ac71cded18a271"
            );
            Common.addContextActionApplyBuffOnFactsToActivatedAbilityBuffNoRemove(
                defensive_stance_buff,
                dr_buff_stalwart,
                increased_dr_stalwart
            );
        ...
        internal static void fixChannelEnergyHeal()
        {
            ...
            {
                var new_actions = Common.changeAction<ContextActionHealTarget>(
                    h.GetComponent<AbilityEffectRunAction>().Actions.Actions,
                    c =>
                ...
                h.ReplaceComponent<AbilityEffectRunAction>(c =>
                    c.Actions = Helpers.CreateActionList(new_actions)
                );
            }
        }
        ...
        {
            BlueprintAbility[] vital_strikes = new BlueprintAbility[]
            {
                library.Get<BlueprintAbility>("efc60c91b8e64f244b95c66b270dbd7c"),
        ...
        {
            var archaeologist_luck = library.Get<BlueprintActivatableAbility>(
                "12dc796147c42e04487fcad3aaa40cea"
            );
            archaeologist_luck.Group = ActivatableAbilityGroup.BardicPerformance;
            Helpers.SetField(
                archaeologist_luck,
                "m_ActivateWithUnitCommand",
        ...
        {
            var improved_favored_terrain = library.CopyAndAdd<BlueprintFeatureSelection>(
                "a6ea422d7308c0d428a541562faedefd",
                "ImprovedFavoredTerrain",
                ""
            );
            ...
            var ranger_progression = library.Get<BlueprintProgression>(
            ...
            ranger_progression.UIGroups = ranger_progression.UIGroups.AddToArray(
                Helpers.CreateUIGroup(
                    improved_favored_terrain,
                    improved_favored_terrain,
                    improved_favored_terrain
                )
            );
        ...
        {
            var familiar = library.Get<BlueprintFeatureSelection>(
                "363cab72f77c47745bf3a8807074d183"
            );

            foreach (var f in familiar.AllFeatures)
            {
                f.AddComponent(
                    Helpers.Create<PrerequisiteMechanics.PrerequisiteNoFeatures>(p =>
                        p.Features = familiar.AllFeatures.RemoveFromArray(f)
                    )
                );
            }
        }
        ...
        internal static void fixSacredmasterHunterTactics()
        {
            ...
            var sh_teamwork_share = library.Get<BlueprintFeature>(
                "e1f437048db80164792155102375b62c"
            );
            var share_old = sh_teamwork_share.GetComponent<ShareFeaturesWithCompanion>();
            var share_new = Helpers.Create<CompanionMechanics.ShareFeaturesWithCompanion2>(s =>
                s.Features = share_old.Features
            );
        ...
        internal static void refixBardicPerformanceOverlap()
        {
            ...
            var abilities = library
                .GetAllBlueprints()
                .OfType<BlueprintActivatableAbility>()
                .Where(a => a.Group == ActivatableAbilityGroup.BardicPerformance);
        ...
        class ActivatableAbilityy__OnTurnOn__Patch
        {
            static void Postfix(ActivatableAbility __instance)
            {
                ...
                var activated_performances = __instance.Owner.ActivatableAbilities.Enumerable.Where(
                    a =>
                        __instance.Owner.Buffs.HasFact(a.Blueprint.Buff)
                        && !a.IsOn
        ...
        internal static void fixElementalMovementWater()
        {
            ...
            feature_water.ReplaceComponent<AbilityTargetHasCondition>(
                Helpers.Create<AddCondition>(c =>
                    c.Condition = Kingmaker.UnitLogic.UnitCondition.ImmuneToCombatManeuvers
                )
            );
            ...
            feature_air.SetDescription(
                "At 15th level, you are able to fly. Yoy get immunity to difficult terrain and ground-based effects as well as +3 melee dodge AC bonus against non-flying creatures."
            );
        }
        ...
        internal static void fixDelayPoison()
        {
            ...
            delay_poison_buff.AddComponent(
                Helpers.Create<BuffMechanics.SuppressBuffsCorrect>(s =>
                    s.Descriptor = SpellDescriptor.Poison
                )
            );
            ...
            var poisons = library
                .GetAllBlueprints()
                .OfType<BlueprintFeature>()
                .Where(f => f.name.Contains("PoisonFeature"))
                .ToArray();
            ...
            foreach (var p in poisons)
            {
                ...
                attack_trigger.Action.Actions = Common.changeAction<ContextActionApplyBuff>(
                    attack_trigger.Action.Actions,
                    a => a.Permanent = true
                );
            }
        }
        ...
        internal static void fixElementalWallsToAvoidDealingDamageTwiceOnTheFirstRound()
        {
            ...
            {
                library.Get<BlueprintAbilityAreaEffect>("ac8737ccddaf2f948adf796b5e74eee7"),
            ...
            foreach (var area in areas)
            {
                ...
                var new_run_action =
                    ...
                    {
                        a.UnitEnter = old_run_action.UnitEnter;
                        a.FirstRound = old_run_action.Round;
                        a.Round = old_run_action.Round;
                    });
        ...
        internal static void fixDazzlingDisplay()
        {
            ...
            var weapon_focus = library.Get<BlueprintParametrizedFeature>(
                "1e1f627d26ad36f43bbd26cc2bf8ac7e"
            );
            var dazzling_display = library.Get<BlueprintAbility>(
                "5f3126d4120b2b244a95cb2ec23d69fb"
            );
            dazzling_display.AddComponent(
                Helpers.Create<NewMechanics.AbilityCasterEquippedWeaponCheckHasParametrizedFeature>(
                    a =>
                    {
                        a.feature = weapon_focus;
                        a.allow_kinetic_blast = true;
                    }
                )
            );
        }
        ...
        {
            var empyreal_resource = library.Get<BlueprintAbilityResource>(
                "f9af9354fb8a79649a6e512569387dc5"
            );
            ...
            string[] cleric_channel_ids = new string[]
            {
                "f5fc9a1a2a3c1a946a31b320d1dd31b2",
                "279447a6bf2d3544d93a0a39c3b8e91d",
                "9be3aa47a13d5654cbcb8dbd40c325f2",
                "89df18039ef22174b81052e2e419c728",
            };

            string[] paladin_channel_ids = new string[]
            {
                "6670f0f21a1d7f04db2b8b115e8e6abf",
                "0c0cf7fcb356d2448b7d57f2c4db3c0c",
                "4937473d1cfd7774a979b625fb833b47",
                "cc17243b2185f814aa909ac6b6599eaa",
            };

            string[] empyreal_channel_ids = new string[]
            {
                "574cf074e8b65e84d9b69a8c6f1af27b",
                "e1536ee240c5d4141bf9f9485a665128",
            };

            foreach (var id in cleric_channel_ids)
            {
                var channel = library.Get<BlueprintAbility>(id);
                channel.AddComponent(
                    Common.createContextCalculateAbilityParamsBasedOnClasses(
                        new BlueprintCharacterClass[] { cleric },
                        StatType.Charisma
                    )
                );
            }
            ...
            foreach (var id in empyreal_channel_ids)
            {
                ...
                channel.AddComponent(
                    Common.createContextCalculateAbilityParamsBasedOnClasses(
                        new BlueprintCharacterClass[] { sorcerer },
                        StatType.Charisma
                    )
                );
            }
        ...
        {
            var cave_fangs_stalagmites_ability = library.Get<BlueprintAbility>(
                "8ec73d388f0875640af8df799f7f16b5"
            );
            var cave_fangs_stalactites_ability = library.Get<BlueprintAbility>(
                "039681ca00c74f24eb302f340f8c6be7"
            );

            var cave_fangs_stalagmites_area = library.Get<BlueprintAbilityAreaEffect>(
                "104bb16f7c3717f44859d0aea97251ce"
            );
            var cave_fangs_stalactites_area = library.Get<BlueprintAbilityAreaEffect>(
                "b8a7c68b040695a40b3a87b9676f7b50"
            );

            var cave_fangs_stalagmites_area2 = library.Get<BlueprintAbilityAreaEffect>(
                "8b4ea698ae053c541beed4e050f32dc3"
            );
            var cave_fangs_stalactites_area2 = library.Get<BlueprintAbilityAreaEffect>(
                "34fc4df95571a2a4f81460cce0c2ea93"
            );

            var dummy_area = library.CopyAndAdd<BlueprintAbilityAreaEffect>(
                cave_fangs_stalagmites_area.AssetGuid,
                "CaveFangsNoCastArea",
                ""
            );
            dummy_area.Fx = new Kingmaker.ResourceLinks.PrefabLink();
            dummy_area.ComponentsArray = new BlueprintComponent[]
            {
            ...
            cave_fangs_stalagmites_ability.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(
                    a.Actions.Actions.AddToArray(dummy_spawn_action)
                )
            );
            cave_fangs_stalactites_ability.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(
                    a.Actions.Actions.AddToArray(dummy_spawn_action)
                )
            );

            cave_fangs_stalagmites_ability.AddComponent(
                Helpers.Create<NewMechanics.AbilityTargetPointDoesNotContainAreaEffect>(a =>
                    a.area_effect = cave_fangs_stalagmites_area
                )
            );
            cave_fangs_stalagmites_ability.AddComponent(
                Helpers.Create<NewMechanics.AbilityTargetPointDoesNotContainAreaEffect>(a =>
                    a.area_effect = dummy_area
                )
            );

            cave_fangs_stalactites_ability.AddComponent(
                Helpers.Create<NewMechanics.AbilityTargetPointDoesNotContainAreaEffect>(a =>
                    a.area_effect = cave_fangs_stalactites_area
                )
            );
            cave_fangs_stalactites_ability.AddComponent(
                Helpers.Create<NewMechanics.AbilityTargetPointDoesNotContainAreaEffect>(a =>
        ...
        internal static void fixAnimalCompanionFeats()
        {
            ...
            var animal_companion_selection = library.Get<BlueprintFeatureSelection>(
                "571f8434d98560c43935e132df65fe76"
            );
            ...
            foreach (var f in animal_companion_selection.AllFeatures)
            {
                ...
                u.GetComponent<AddClassLevels>().Selections[0].Features = feats.RemoveFromArray(
                    weapon_focus
                );
            }
        }
        ...
        {
            BlueprintWeaponType[] flails = new BlueprintWeaponType[]
            {
                library.Get<BlueprintWeaponType>("bf1e53f7442ed0c43bf52d3abe55e16a"),
        ...
        {
            Common.replaceSpellFromListWithDuplicate(
                library.Get<BlueprintSpellList>("eba577470b8ee8443bb4552433451990"),
                5,
                "WeatherDomain"
            ); //ice storm
            Common.replaceSpellFromListWithDuplicate(
            ...
            Common.replaceSpellFromListWithDuplicate(
                library.Get<BlueprintSpellList>("35e15cd1b353e2d47b507c445d2f8c6f"),
                5,
                "WaterDomain"
            ); //ice storm
            Common.replaceSpellFromListWithDuplicate(
                library.Get<BlueprintSpellList>("df3bc5bda7deb9d46b0f177db3bb7876"),
                6,
                "EarthDomain"
            ); //stoneskin

            Common.replaceSpellFromListWithDuplicate(
                library.Get<BlueprintSpellList>("81bff1165d9468a44b2f815f7c26a373"),
                6,
                "EvilDomain"
            ); //create undead
            //lvl 4 death domain spell should be death ward
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("710d8c959e7036448b473ffa613cdeba"),
                library.Get<BlueprintAbility>("0413915f355a38146bc6ad40cdf27b3f"),
                4
            );
            ...
            Common.replaceDomainSpell(
                library.Get<BlueprintProgression>("243ab3e7a86d30243bdfe79c83e6adb4"),
                library.Get<BlueprintAbility>("36c8971e91f1745418cc3ffdfac17b74"),
                6
            );
        }
        ...
        {
            var stalwart_defender = library.Get<BlueprintCharacterClass>(
                "d5917881586ff1d4d96d5b7cebda9464"
            );
            var progression = library.Get<BlueprintProgression>("e93eabf4f9b48914c9d880dd41c06385");

            //ad armor proficiency prerequisites
            var light_armor_proficiency = library.Get<BlueprintFeature>(
                "6d3728d4e9c9898458fe5e9532951132"
            );
            var medium_armor_proficiency = library.Get<BlueprintFeature>(
            ...
            var proficiency = library.CopyAndAdd<BlueprintFeature>(
                "a23591cc77086494ba20880f87e73970",
                "StalwartDefenderProficiency",
                ""
            ); //from fighter
            proficiency.SetNameDescription(
                "Stalwart Defender Proficiencies",
            ...
            {
                if (
                    unit.Progression.GetClassLevel(stalwart_defender) >= 1
                    && !unit.Progression.Features.HasFact(proficiency)
                )
                {
            ...
            var internal_fortitude = library.Get<BlueprintFeature>(
                "727fcc6ef87e568479ab9dc3a8a5dc6c"
            );
            internal_fortitude.ComponentsArray = new BlueprintComponent[0];
            var internal_fortitude_buff = library.CopyAndAdd<BlueprintBuff>(
                "21ff8159995fe194b81d89b1c83f33a3",
                "StalwartDefenderInternalFortitudeBuff",
                ""
            ); //from rage
        ...
        internal static void fixAlchemistFastBombs()
        {
            ...
            var fast_bombs_ability =
                fast_bombs.GetComponent<AddFacts>().Facts[0] as BlueprintActivatableAbility;
            var fast_bombs_buff = fast_bombs_ability.Buff;

            var bombs = fast_bombs_buff.GetComponent<FastBombs>().Abilities;

            var new_buff = Helpers.CreateBuff(
                "FastBombs2Buff",
                ...
                fast_bombs.Icon,
                null,
                Helpers.Create<TurnActionMechanics.IterativeAttacksWithAbilities>(i =>
                    i.abilities = bombs
                )
            );

            var new_ability = Helpers.CreateAbility(
                "FastBombs2Ability",
                new_buff.Name,
            ...
            fast_bombs_ability.AddComponent(
                Helpers.Create<RestrictionHasFact>(r =>
                {
                    r.Feature = new_buff;
                    r.Not = true;
        ...
        internal static void fixArchonsAuraToEffectOnlyEnemiesAndDescription()
        {
            var area = ResourcesLibrary.TryGetBlueprint<BlueprintAbilityAreaEffect>(
                "a70dc66c3059b7a4cb5b2a2e8ac37762"
            );

            var run_actions = area.GetComponent<AbilityAreaEffectRunAction>();

            Common.changeAction<Conditional>(
                run_actions.UnitEnter.Actions,
                a =>
                {
                    if (
                        a.ConditionsChecker.Conditions.Length == 2
                        && (a.ConditionsChecker.Conditions[1] is ContextConditionIsAlly)
                    )
                    {
                        a.ConditionsChecker.Conditions[1] =
                            Helpers.Create<ContextConditionIsEnemy>();
                    }
                }
            );
            var archons_aura = library
                .Get<BlueprintAbility>("e67efd8c84f69d24ab472c9f546fff7e")
                .LocalizedSavingThrow = Helpers.willNegates;
        }

        public static void removeSoloTacticsFromSH()
        {
            var solo_tactics = library.Get<BlueprintFeature>("5602845cd22683840a6f28ec46331051");
            var sacred_huntsmaster = library.Get<BlueprintArchetype>(
                "46eb929c8b6d7164188eb4d9bcd0a012"
            );
            ...
            sacred_huntsmaster.RemoveFeatures = sacred_huntsmaster.RemoveFeatures.AddToArray(
                Helpers.LevelEntry(3, solo_tactics)
            );
        }

        internal static void fixDruidDomainUi()
        {
            var druid_domains = library
                .Get<BlueprintFeatureSelection>("096fc02f6cc817a43991c4b437e12b8e")
                .AllFeatures;
            ...
            foreach (var druid_domain in druid_domains)
            {
                ...
                var cleric_domain =
                    library.GetAllBlueprints().Where(a => a.name == cleric_name).First()
                    as BlueprintProgression;

                (druid_domain as BlueprintProgression).UIGroups = cleric_domain.UIGroups;
            }
        }

        internal static void fixBleed()
        {
            ...
            bleed1d4.AddComponent(
                Helpers.Create<BleedMechanics.BleedBuff>(b =>
                    b.dice_value = Helpers.CreateContextDiceValue(DiceType.D4, 1, 0)
                )
            );
            bleed1d6.RemoveComponents<AddFactContextActions>();
            bleed1d6.AddComponent(
                Helpers.Create<BleedMechanics.BleedBuff>(b =>
                    b.dice_value = Helpers.CreateContextDiceValue(DiceType.D6, 1, 0)
                )
            );
            bleed1d6e.RemoveComponents<AddFactContextActions>();
            bleed1d6e.AddComponent(
                Helpers.Create<BleedMechanics.BleedBuff>(b =>
                    b.dice_value = Helpers.CreateContextDiceValue(DiceType.D6, 1, 0)
                )
            );
            bleed2d6.RemoveComponents<AddFactContextActions>();
            bleed2d6.AddComponent(
                Helpers.Create<BleedMechanics.BleedBuff>(b =>
                    b.dice_value = Helpers.CreateContextDiceValue(DiceType.D6, 2, 0)
                )
            );
        }

        internal static void fixRangerAnimalCompanion()
        {
            var selection = library.Get<BlueprintFeatureSelection>(
                "ee63330662126374e8785cc901941ac7"
            );
            var share_fe_bonus = library.Get<BlueprintFeature>("cd7b831693c0f3947b019321c0510915");
            share_fe_bonus.AddComponent(
                Helpers.Create<CompanionMechanics.FavoredTerrainBonusFromMaster>()
            );
            ...
            var hunters_bond = library.Get<BlueprintFeatureSelection>(
                "b705c5184a96a84428eeb35ae2517a14"
            );
            hunters_bond.SetDescription(
        ...
        internal static void fixRangerMasterHunter()
        {
            var master_hunter_cooldown_buff = library.Get<BlueprintBuff>(
                "077f4430a10d3504b9078ab717334972"
            );
            ...
            var effect = Helpers.CreateActionSavingThrow(
                ...
                Helpers.CreateConditionalSaved(null, Helpers.Create<ContextActionKillTarget>())
            );
        ...
        internal static void fixEaglesoul()
        {
        ...
        internal static void fixGrease()
        {
            var grease_spell = library.Get<BlueprintAbility>("95851f6e85fe87d4190675db0419d112");
            var grease_area = library.Get<BlueprintAbilityAreaEffect>(
            ...
            grease_buff.ComponentsArray = new BlueprintComponent[]
            {
                Helpers.CreateSpellDescriptor(
                    SpellDescriptor.Ground | SpellDescriptor.MovementImpairing
                ),
                Common.createAddCondition(UnitCondition.DifficultTerrain),
            };

            var fall = Helpers.CreateActionSavingThrow(
                SavingThrowType.Reflex,
                Helpers.CreateConditionalSaved(null, Helpers.Create<ContextActionKnockdownTarget>())
            );
            grease_spell.GetComponent<AbilityEffectRunAction>().Actions = Helpers.CreateActionList(
                fall
            );
            ...
            var area_effect = Helpers.Create<NewMechanics.AbilityAreaEffectRunActionWithFirstRound>(
                a =>
                {
                    a.UnitMove = Helpers.CreateActionList(
        ...
        {
            Common.ignore_spell_combat_penalty = Helpers.CreateFeature(
                "IgnoreSpellCombatPenaltyFeature",
                "",
                "",
                "",
                null,
            ...
            var spellcombat_penalty_buff = library.Get<BlueprintBuff>(
                "7b4cf64d3a49e3d45b1dbd2385f4eb6d"
            );
            spellcombat_penalty_buff.RemoveComponents<AttackTypeAttackBonus>();

            var cmp = Helpers.CreateAddContextStatBonus(
                StatType.AdditionalAttackBonus,
                ModifierDescriptor.UntypedStackable
            );
            spellcombat_penalty_buff.AddComponents(
                cmp,
                Helpers.CreateContextRankConfig(
                    ContextRankBaseValueType.FeatureList,
                    ...
                    featureList: new BlueprintFeature[]
                    {
                        Common.ignore_spell_combat_penalty,
                        Common.ignore_spell_combat_penalty,
                    }
                )
            );
            BladeTutor.RuleCalculateAttackBonusWithoutTarget_OnTrigger_Patch.facts.Add(
                spellcombat_penalty_buff
            );
        }

        internal static void addMissingImmunities()
        {
            Common.plant_arcana_language_hidden = Helpers.CreateFeature(
                "BypassPlantLanguageDependentImmunity",
                "",
                "",
                "",
                null,
            ...
            var language_dependent = (SpellDescriptor)
                AdditionalSpellDescriptors.ExtraSpellDescriptor.LanguageDependent;
            Common.vermin.AddComponents(
                Helpers.Create<BuffDescriptorImmunity>(b =>
                {
                    b.Descriptor = language_dependent;
                    b.IgnoreFeature = serpentine_arcana;
                }),
                Helpers.Create<SpellImmunityToSpellDescriptor>(b =>
                {
                    b.Descriptor = language_dependent;
                    b.CasterIgnoreImmunityFact = serpentine_arcana;
                })
            );
            Common.plant.AddComponents(
                Helpers.Create<BuffDescriptorImmunity>(b =>
                {
                    b.Descriptor = language_dependent;
                    b.IgnoreFeature = Common.plant_arcana_language_hidden;
                }),
                Helpers.Create<SpellImmunityToSpellDescriptor>(b =>
                {
                    b.Descriptor = language_dependent;
                    b.CasterIgnoreImmunityFact = Common.plant_arcana_language_hidden;
                })
            );
            Common.animal.AddComponents(
                Helpers.Create<BuffDescriptorImmunity>(b =>
                {
                    b.Descriptor = language_dependent;
                    b.IgnoreFeature = serpentine_arcana;
            ...
            Common.magical_beast.AddComponents(
                Helpers.Create<BuffDescriptorImmunity>(b =>
                {
                    b.Descriptor = language_dependent;
                    b.IgnoreFeature = serpentine_arcana;
            ...
            well_versed.ReplaceComponent<SavingThrowBonusAgainstDescriptor>(s =>
                s.SpellDescriptor = s.SpellDescriptor.Value | language_dependent
            );

            Common.construct.AddComponents(
                Helpers.Create<BuffDescriptorImmunity>(b =>
                {
                    b.Descriptor = (SpellDescriptor)
                        AdditionalSpellDescriptors.ExtraSpellDescriptor.Pain;
                }),
                Helpers.Create<SpellImmunityToSpellDescriptor>(b =>
                {
                    b.Descriptor = (SpellDescriptor)
        ...
        internal static void fixUndeadImmunity()
        {
            Common.undead_arcana_hidden = Helpers.CreateFeature(
                "BypassUndeadImmunity",
                "",
                "",
                "",
                null,
            ...
            SpellDescriptor always_immune =
                ...
                | SpellDescriptor.VilderavnBleed
                | SpellDescriptor.Death
                | SpellDescriptor.Stun
                | (SpellDescriptor)AdditionalSpellDescriptors.ExtraSpellDescriptor.Pain;

            undead_immunity.AddComponent(
                Helpers.Create<BuffDescriptorImmunity>(b =>
                {
                    b.Descriptor = always_immune;
                })
            );
            undead_immunity.AddComponent(
                Helpers.Create<BuffDescriptorImmunity>(b =>
                {
                    b.Descriptor = SpellDescriptor.MindAffecting;
                    b.IgnoreFeature = Common.undead_arcana_hidden;
                })
            );
            undead_immunity.AddComponent(
                Helpers.Create<SpellImmunityToSpellDescriptor>(b =>
            ...
            undead_immunity.AddComponent(
                ...
                {
                    b.Descriptor = SpellDescriptor.MindAffecting;
                    b.CasterIgnoreImmunityFact = Common.undead_arcana_hidden;
                })
            );
            ...
            foreach (var a in abilities)
            {
                a.RemoveComponents<AbilityTargetHasNoFactUnless>(u =>
                    u.UnlessFact == undead_arcana
                );
                ...
                foreach (var ea in extracted_actions)
                {
                    ...
                    {
                        var cond_to_remove = ea
                            .ConditionsChecker.Conditions.OfType<ContextConditionCasterHasFact>()
                            .Where(ccc => ccc.Fact == undead_arcana)
                            .ToArray();
                        foreach (var ctr in cond_to_remove)
                        {
                            ea.ConditionsChecker.Conditions =
                                ea.ConditionsChecker.Conditions.RemoveFromArray(ctr);
                        }
                    }
                }
            }
            ...
            var baleful_polymorph = library.Get<BlueprintAbility>(
                "3105d6e9febdc3f41a08d2b7dda1fe74"
            );
            baleful_polymorph.ReplaceComponent<AbilityTargetHasFact>(a =>
                a.CheckedFacts = a.CheckedFacts.AddToArray(Common.undead)
            );
        }

        internal static void fixWidomCognatogen()
        {
            var wis_cognatogen = library.Get<BlueprintAbility>("84a9092b8430a1344a3c8b002cc68e7f");
            wis_cognatogen.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions.Actions = Common.changeAction<ContextActionApplyBuff>(
                    a.Actions.Actions,
                    b =>
                        b.DurationValue.BonusValue = Helpers.CreateContextValue(
        ...
        internal static void addMobilityToMonkBonusFeats()
        {
        ...
        internal static void fixSylvanSorcererAnimalCompanion()
        {
            ...
            var sylvan_animal_companion = library.Get<BlueprintFeatureSelection>(
                "a540d7dfe1e2a174a94198aba037274c"
            );
            sylvan_animal_companion.SetDescription(
                "At 1st level, you gain an animal companion. Your effective druid level for this ability is equal to your sorcerer level – 3 (minimum 1st).\n"
                    + sylvan_animal_companion.Description
            );
        }

        internal static void fixPhysicalDrBypassToApplyToAllPhysicalDamage()
        {
        ...
        internal static void fixElementalArcana()
        {
            ...
            foreach (var b in buffs)
            {
                ...
                b.ReplaceComponent(
                    c,
                    Helpers.Create<NewMechanics.MetamagicMechanics.ChangeSpellElementalDamage>(s =>
                        s.Element = c.Element
                    )
                );
            }
        ...
        internal static void fixTandemTripPrerequisite()
        {
        ...
        internal static void fixAuraOfJustice()
        {
            ...
            old_actions.Actions = Common.addMatchingAction<ContextActionApplyBuff>(
                old_actions.Actions,
                Common.createContextActionApplyBuff(
                    smite_buff,
        ...
        internal static void fixDruidWoodlandStride()
        {
            var woodland_stride = library.Get<BlueprintFeature>("11f4072ea766a5840a46e6660894527d");
            var druid_progression = library.Get<BlueprintProgression>(
                "01006f2ac8866764fb7af135e73be81c"
            );
        ...
        internal static void fixGrappleSpells()
        {
            ...
            foreach (var b in buffs)
            {
                ...
                var new_actions = Common.replaceActions<ContextActionBreakFree>(
                    new_round_actions.Actions,
                    a =>
                        Helpers.Create<CombatManeuverMechanics.ContextActionBreakFreeFromSpellGrapple>(
                            c =>
                            {
                                c.Failure = a.Failure;
                                c.Success = a.Success;
        ...
        internal static void nerfSmilodonRake()
        {
            var units = library
                ...
                .Where(c => c.name.Contains("Smilodon") || c.name.Contains("Dweomercat"));
            var buffs = library
                .GetAllBlueprints()
                .OfType<BlueprintBuff>()
                .Where(c => c.name.Contains("Smilodon"));
            ...
            foreach (var u in units)
            {
                ...
                u.Body.AdditionalSecondaryLimbs = u
                    .Body.AdditionalLimbs.Skip(num_limbs - 2)
                    .ToArray();
            ...
            foreach (var b in buffs)
            {
                ...
                polymorph.SecondaryAdditionalLimbs = polymorph
                    .AdditionalLimbs.Skip(num_limbs - 2)
                    .ToArray();
        ...
        internal static void fixFeatsRequirements()
        {
            ...
            manyshot.AddComponent(
                Helpers.PrerequisiteFeature(
                    library.Get<BlueprintFeature>("0da0c194d6e1d43419eb8d990b28e0ab")
                )
            ); //point blank shot
        }
        ...
        internal static void fixPenetratingStrike()
        {
            ...
            foreach (var ps_id in guids)
            {
                ...
                if (c != null)
                {
                    feature.ReplaceComponent(
                        c,
                        Helpers.Create<NewMechanics.PenetratingStrike>(p =>
                            p.value = c.ReductionReduction
                        )
                    );
                }
            }
        ...
        internal static void fixFlameDancer()
        {
            ...
            var toggle = Common.convertPerformance(
            ...
            {
                fact.SetDescription(
                    "At 6th level, a fire dancer’s performance can bend flames away from others. Any ally within 30 feet of the bard who can hear or see the bardic performance gains resist fire 20 as long as the performance is maintained. At 11th level, this resistance increases to 30."
                );
            }

            var progression = flamedancer.GetParentClass().Progression;
            progression.UIGroups = progression.UIGroups.AddToArray(
                Helpers.CreateUIGroup(
                    library.Get<BlueprintFeature>("3c10a0069e7f110499d2e810f4861a6e"),
                    feature
                )
        ...
        public static void fixBlindingRay()
        {
            ...
            blinding_ray.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions.Actions = Common.changeAction<ContextActionApplyBuff>(
                    a.Actions.Actions,
                    c =>
                    {
            ...
            blinding_ray.SetDescription(
                "As a standard action, you can fire a shimmering ray at any foe within 30 feet as a ranged touch attack. The ray causes creatures to be blinded for 1 round. Creatures with more Hit Dice than your wizard level are dazzled for 1 round instead. You can use this ability a number of times per day equal to 3 + your Intelligence modifier."
            );
        }

        internal static void fixTactician()
        {
            var tactical_leader_tactician = library.Get<BlueprintFeature>(
                "93e78cad499b1b54c859a970cbe4f585"
            );
            var tactical_leader = library.Get<BlueprintArchetype>(
                "639b74fd2f48d474e965c596b1649095"
            );
            var teamwork_feats = library
                .Get<BlueprintBuff>("a603a90d24a636c41910b3868f434447")
                .GetComponent<AddFactsFromCaster>()
                .Facts.Cast<BlueprintFeature>()
                .ToArray();
            ...
            {
                var choice_buff = Helpers.CreateBuff(
                    tw.name + "ShareBuff",
                    "Tactician: " + tw.Name,
                ...
                toggle.Group =
                    ActivatableAbilityGroupExtension.TacticianTeamworkFeatShare.ToActivatableAbilityGroup();
                toggle.WeightInGroup = 1;

                var feature = Common.ActivatableAbilityToFeature(
                    toggle,
                    true,
                    Helpers.MergeIds("c9ca89f32d3b4e1b8add1bae23c73f4b", tw.AssetGuid)
                );
                tw.AddComponent(
                    Common.createAddFeatureIfHasFact(tactical_leader_tactician, feature)
                );
                buff.GetComponent<TeamworkMechanics.AddFactsFromCasterIfHasBuffs>().facts.Add(tw);
                buff.GetComponent<TeamworkMechanics.AddFactsFromCasterIfHasBuffs>()
                    .prerequsites.Add(choice_buff);
            }
            ...
            ability.ReplaceComponent<ContextRankConfig>(c =>
                Helpers.SetField(c, "m_StartLevel", -4)
            );

            var extra_tactician = Helpers.CreateFeature(
                "TacticalLeaderExtraTactician",
                "",
                "",
                "",
                null,
            ...
            tactical_leader_tactician.AddComponent(
                Helpers.CreateAddFeatureOnClassLevel(
                    extra_tactician,
                    18,
                    new BlueprintCharacterClass[] { tactical_leader.GetParentClass() },
                    new BlueprintArchetype[] { tactical_leader }
                )
            );
            tactical_leader_tactician.SetNameDescription(ability);
        }

        internal static void restrictAnimalCompanions()
        {
            var empty_companion = library.Get<BlueprintFeature>("472091361cf118049a2b4339c4ea836a");
            empty_companion.Ranks = 10;
            var animal_companion_selection = library.Get<BlueprintFeatureSelection>(
                "90406c575576aee40a34917a1b429254"
            );
    ...
    class ModifiableValue_IsPermanent
    {
        static void Postfix(ModifiableValue.Modifier __instance, ref bool __result)
        {
            ...
            __result =
                __result
                || __instance.ModDescriptor == ModifierDescriptor.Inherent
                || __instance.ModDescriptor == ModifierDescriptor.Feat;
        }
    }
    ...
    [Harmony12.HarmonyPatch(
        ...
        "GetAction",
        typeof(UnitAnimationSpecialAttackType)
    )]
    class UnitAnimationManager_GetAction
    {
        static UnitAnimationSpecialAttackType[] attacks_to_try =
            new UnitAnimationSpecialAttackType[]
            {
                UnitAnimationSpecialAttackType.Slam,
        ...
        static void Postfix(
            ...
            UnitAnimationSpecialAttackType type,
            ref UnitAnimationAction __result
        )
        {
            if (__result != null)
            {
            ...
            {
                __result = (UnitAnimationAction)
                    __instance
                        .ActionSet.OfType<UnitAnimationActionSpecialAttack>()
                        .FirstOrDefault<UnitAnimationActionSpecialAttack>(
                            (Func<UnitAnimationActionSpecialAttack, bool>)(a => a.AttackType == att)
                        );
                if (__result != null)
                {
                    return;
    ...
    class RaiseBABt_OnTurnOn
    {
        ...
        {
            int num =
                __instance.TargetValue.Calculate(__instance.Fact.MaybeContext)
                - __instance.Owner.Stats.BaseAttackBonus.ModifiedValue;
            if (num <= 0)
                return false;
            Traverse
                .Create(__instance)
                .Field("m_Modifier")
                .SetValue(
                    __instance.Owner.Stats.BaseAttackBonus.AddModifier(
                        num,
                        (GameLogicComponent)__instance,
    ...
    {
        static IEnumerable<Harmony12.CodeInstruction> Transpiler(
            IEnumerable<Harmony12.CodeInstruction> instructions
        )
        {
            ...
            {
                if (
                    (codes[i].opcode == System.Reflection.Emit.OpCodes.Ldc_I4_1)
                    && codes[i + 1].opcode == System.Reflection.Emit.OpCodes.Call
                    && codes[i + 1].operand.ToString().Contains("IsCriticalConfirmed")
                )
                {
            ...
            codes.Insert(
                set_is_critical_confirmed + 1,
                new CodeInstruction(
                    System.Reflection.Emit.OpCodes.Call,
                    new Action<RuleAttackRoll>(setIsCriticalConfirmed).Method
                )
            );
            codes.Insert(
                set_is_critical_confirmed + 1,
        ...
        static void setIsCriticalConfirmed(RuleAttackRoll rule)
        {
            ...
            if (
                !rule.AutoCriticalConfirmation
                && !rule.AutoHit
                && rule.CriticalConfirmationRoll == 1
            )
            {
                result = false;
            }
