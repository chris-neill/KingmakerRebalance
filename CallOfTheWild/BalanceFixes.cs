...
namespace CallOfTheWild
{
    internal class BalanceFixes
    {
        ...
        static DiceType[] dices = new DiceType[]
        {
            DiceType.D3,
            DiceType.D4,
            DiceType.D6,
        ...
        static Dictionary<DiceType, DiceType> dices_shift = new Dictionary<DiceType, DiceType>
        {
            { DiceType.D3, DiceType.D4 },
        ...
        static Dictionary<BlueprintFeature, HashSet<DiceType>> processed_facts =
            new Dictionary<BlueprintFeature, HashSet<DiceType>>();
        static HashSet<BlueprintAbilityAreaEffect> processed_areas =
            new HashSet<BlueprintAbilityAreaEffect>();
        static Dictionary<BlueprintAbility, HashSet<DiceType>> processed_abilities =
            new Dictionary<BlueprintAbility, HashSet<DiceType>>();
        static HashSet<BlueprintBuff> processed_buffs = new HashSet<BlueprintBuff>();
        static HashSet<string> black_list;

        internal static void load(params string[] guids_black_list)
        {
        ...
        static void fixCallLightningAndLightningStorm()
        {
            ...
            var buff_cooldown = Helpers.CreateBuff(
                "CallLightningCooldownBuff",
            ...
            var call_lightning_ability = library.Get<BlueprintAbility>(
                "0bd54216d38852947930320f6269a9d7"
            );

            call_lightning_ability.ActionType = Kingmaker
                .UnitLogic
                .Commands
                .Base
                .UnitCommand
            ...
            var call_lightning_storm = library.Get<BlueprintAbility>(
                "d5a36a7ee8177be4f848b953d1c53c84"
            );
            var call_lightning_storm_ability = library.Get<BlueprintAbility>(
                "cad052ef098f9f247ab73ae4c37ac687"
            );

            call_lightning_storm_ability.ActionType = Kingmaker
                .UnitLogic
                .Commands
                .Base
                .UnitCommand
                .CommandType
                .Move;
            call_lightning_storm.SetDescription(
                "This spell functions like call lightning, except that each bolt deals 5d6 points of electricity damage at long range, and you may call a maximum of 15 bolts.\n"
                    + call_lightning.Name
                    + ": "
                    + call_lightning.Description
            );

            var apply_cooldown = Common.createContextActionApplyBuffToCaster(
                buff_cooldown,
                Helpers.CreateContextDuration(),
                dispellable: false,
                duration_seconds: 6
            );
            var precast = Common.createAbilityExecuteActionOnCast(
                Helpers.CreateActionList(apply_cooldown)
            );

            call_lightning.AddComponent(precast);
            call_lightning_storm.AddComponent(precast);
            call_lightning_ability.AddComponents(
                precast,
                Common.createAbilityCasterHasNoFacts(buff_cooldown)
            );
            call_lightning_storm_ability.AddComponents(
                precast,
                Common.createAbilityCasterHasNoFacts(buff_cooldown)
            );
        }
        ...
        static void fixSpells()
        {
            ...
            righteous_might.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(
                    Common.changeAction<ContextActionApplyBuff>(
                        a.Actions.Actions,
                        c => c.DurationValue.Rate = DurationRate.Minutes
                    )
                )
            );
            righteous_might.LocalizedDuration = Helpers.CreateString(
                "RighteousMightMinutes.Duration",
                Helpers.minutesPerLevelDuration
            );
            righteous_might.SetDescription(
                righteous_might.Description.Replace("+2 enhancement", "+2")
            );
        ...
        static void fixCleave()
        {
            ...
            var cleaving_finish_greater = library.Get<BlueprintFeature>(
                "ffa1b373190af4f4db7a5501904a1983"
            );
            ...
            cleaving_finish.SetDescription(
        ...
        static void fixVitalStrike()
        {
            ...
            var improved_vital_strike = library.Get<BlueprintFeature>(
                "52913092cd018da47845f36e6fbe240f"
            );
            var greater_vital_strike = library.Get<BlueprintFeature>(
                "e2d1fa11f6b095e4fb2fd1dcf5e36eb3"
            );
            var vital_strike_ability = library.Get<BlueprintAbility>(
            ...
            {
                s.AllFeatures = s
                    .AllFeatures.RemoveFromArray(improved_vital_strike)
                    .RemoveFromArray(greater_vital_strike);
                s.Features = s
                    .Features.RemoveFromArray(improved_vital_strike)
                    .RemoveFromArray(greater_vital_strike);
            }

            vital_strike.SetDescription(
        ...
        static void fixTwf()
        {
            ...
            var twf_basic_mechanics = library.Get<BlueprintFeature>(
                "6948b379c0562714d9f6d58ccbfa8faa"
            );
            twf_basic_mechanics.ReplaceComponent<TwoWeaponFightingAttacks>(
                Helpers.Create<IterativeTwoWeaponFightingAttacks>()
            );
            var itwf = library.Get<BlueprintFeature>("9af88f3ed8a017b45a6837eab7437629");
            itwf.SetDescription(
                "You get a second attack with your off-hand weapon, albeit at a –5 penalty. When your base attack bonus reaches +11, you can make a third off-hand weapon attack at -10 penalty."
            );

            //fix
            var ranger_shield_style10 = library.Get<BlueprintFeatureSelection>(
                "b2e73b554839a314a8c716dbf33fcfc3"
            );
            var shield_focus_greater = library.Get<BlueprintFeature>(
                "afd05ca5363036c44817c071189b67e1"
            );
            if (!ranger_shield_style10.AllFeatures.Contains(shield_focus_greater))
            {
                ranger_shield_style10.AllFeatures = ranger_shield_style10.AllFeatures.AddToArray(
                    shield_focus_greater
                );
                ranger_shield_style10.Features = ranger_shield_style10.Features.AddToArray(
                    shield_focus_greater
                );
            }
        ...
        static void fixMonkAc()
        {
            ...
            monk_ac_unlock.SetDescription(
                "When unarmored and unencumbered, the monk adds his Wisdom bonus (if any, up to his monk level) to his AC and CMD. In addition, a monk gains a + 1 bonus to AC and CMD at 4th level. This bonus increases by 1 for every four monk levels thereafter, up to a maximum of + 5 at 20th level.\nThese bonuses to AC apply even against touch attacks or when the monk is flat - footed. He loses these bonuses when he is immobilized or helpless, when he wears any armor, when he carries a shield, or when he carries a medium or heavy load."
            );
            var monk_ac = library.Get<BlueprintFeature>("e241bdfd6333b9843a7bfd674d607ac4");
            var monk_ac_property = NewMechanics.ContextValueWithLimitProperty.createProperty(
                "MonkAcProperty",
                "b8ba561529dc4143b014994ea3f234fe",
            ...
            foreach (var c in monk_ac.GetComponents<ContextRankConfig>().ToArray())
            {
                ...
                {
                    var new_c = Helpers.CreateContextRankConfig(
                        ContextRankBaseValueType.CustomProperty,
                        customProperty: monk_ac_property,
                        type: c.Type
                    );
            ...
            var scaled_fist_ac_unlock = library.Get<BlueprintFeature>(
                "2a8922e28b3eba54fa7a244f7b05bd9e"
            );
            scaled_fist_ac_unlock.SetDescription(
                "When unarmored and unencumbered, the monk adds his Charisma bonus (if any, up to his monk level) to his AC and CMD. In addition, a monk gains a +1 bonus to AC and CMD at 4th level. This bonus increases by 1 for every four monk levels thereafter, up to a maximum of +5 at 20th level.\nThese bonuses to AC apply even against touch attacks or when the monk is flat-footed. He loses these bonuses when he is immobilized or helpless, when he wears any armor, when he carries a shield, or when he carries a medium or heavy load."
            );
            var scaled_fist_ac = library.Get<BlueprintFeature>("3929bfd1beeeed243970c9fc0cf333f8");
            var sf_ac_property = NewMechanics.ContextValueWithLimitProperty.createProperty(
                "ScaledFistAcProperty",
                "d58a65251b2c4ce9829ae82ca896861d",
                Helpers.CreateContextRankConfig(
                    ContextRankBaseValueType.StatBonus,
        ...
        static void fixPaladinSaves()
        {
            ...
            var paladin_saves_property = NewMechanics.ContextValueWithLimitProperty.createProperty(
                "DivineGraceSavesProperty",
                "97e5940097ed4f2f989d531bda77df2f",
                Helpers.CreateContextRankConfig(
                    ContextRankBaseValueType.StatBonus,
                    stat: Kingmaker.EntitySystem.Stats.StatType.Charisma,
                    min: 0,
            ...
            divine_grace.AddComponents(
                ...
                Helpers.CreateContextRankConfig(
                    ContextRankBaseValueType.CustomProperty,
                    customProperty: paladin_saves_property
                )
            );
            divine_grace.SetDescription(
                "At 2nd level, a paladin gains a bonus equal to her Charisma bonus (if any, up to her paladin level) on all saving throws."
            );
        }
        ...
        static void fixSorcererBloodlineArcana()
        {
            ...
            var eldritch_scion = library.Get<BlueprintArchetype>(
                "d078b2ef073f2814c9e338a789d97b73"
            );
            ...
            var bloodline_classes = new BlueprintCharacterClass[]
            {
                library.Get<BlueprintCharacterClass>("b3a505fb61437dc4097f43c3f8f9a4cf"), //sorcerer
                library.Get<BlueprintCharacterClass>("45a4607686d96a1498891b3286121780"),
            }; //magus
            ...
            var arance_bloodline_arcana = library.Get<BlueprintFeature>(
                "e8e4f56618dd8b04490aa6a0b75ac24f"
            );
            arance_bloodline_arcana.ComponentsArray = new BlueprintComponent[]
            {
                Helpers.Create<ArcaneBloodlineArcanaOnSpecificClass>(a =>
                {
                    a.classes = bloodline_classes;
                }),
            };

            //reduce DC bonuses from fey and infernal bloodline to 1 and make them work only on sorcerer spells
            var arcanas = new BlueprintFeature[]
            {
                library.Get<BlueprintFeature>("67f151cdb9f0c9d4092ccfd5a9ccc6c9"),
            ...
            var school_power_selection = library.Get<BlueprintFeatureSelection>(
                "3524a71d57d99bb4b835ad20582cf613"
            );
            var school_power_feature = library.Get<BlueprintParametrizedFeature>(
                "8891303b67eb273428f1691864b08cf8"
            );
            school_power_feature.GetComponent<SpellFocusParametrized>().BonusDC = 1;
            school_power_selection.SetDescription(
                school_power_selection.Description.Replace("2", "1")
            );
            school_power_feature.SetDescription(school_power_feature.Description.Replace("2", "1"));
        }

        internal static void fixFeats()
        {
        ...
        static void manualFixes()
        {
            ...
            { //fix serenity
                ...
                serenity_buff.ReplaceComponent<AddInitiatorAttackRollTrigger>(a =>
                    a.Action = Helpers.CreateActionList(
                        processActions(
                            a.Action.Actions,
                            new ContextCalculateSharedValue[0],
                            processed_local
                        )
                    )
                );
                ...
                foreach (var p in processed_local)
                {
                    ...
                    serenity.SetDescription(
                        serenity.Description.Replace(
                            "d" + old_dice.ToString(),
                            "dxxx" + new_dice.ToString()
                        )
                    );
                }
            ...
            //fix phoenix_blast
            {
                var area = library.Get<BlueprintAbilityAreaEffect>(
                    "f6d511dda2d97b84783df21af423c878"
                );
        ...
        public static DiceType getDamageDie(DiceType dice)
        {
        ...
        public static string getDamageDieString(DiceType dice)
        {
        ...
        static void fixLowerLevelBlasts()
        {
            ...
            //fix evocation
            {
                var evocation_progression = library.Get<BlueprintProgression>(
                    "f8019b7724d72a241a97157bc37f1c3b"
                );
                var evocation_base = library.Get<BlueprintFeature>(
                    "c46512b796216b64899f26301241e4e6"
                );
                var force_missile_feature = library.Get<BlueprintFeature>(
                    "f9501f0df27af5446b705b5da255469a"
                );
                var force_missile_ability = library.Get<BlueprintAbility>(
                    "3d55cc710cc497843bb51788057cd93f"
                );

                var actions = force_missile_ability
                    .GetComponent<AbilityEffectRunAction>()
                    .Actions.Actions;
                actions = Common.changeAction<ContextActionDealDamage>(
                    actions,
                    a =>
                    {
                        a.Value = Helpers.CreateContextDiceValue(
                            getDamageDie(DiceType.D4),
                            Helpers.CreateContextValue(Kingmaker.Enums.AbilityRankType.Default),
                            0
                        );
                    }
                );
                force_missile_ability.ReplaceComponent<AbilityEffectRunAction>(a =>
                    a.Actions = Helpers.CreateActionList(actions)
                );
                force_missile_ability.AddComponent(
                    Helpers.CreateContextRankConfig(
                        ContextRankBaseValueType.ClassLevel,
            ...
            //fix transmutation
            {
                var transmutation_progression = library.Get<BlueprintProgression>(
                    "b6a604dab356ac34788abf4ad79449ec"
                );
                var transmutation_base = library.Get<BlueprintFeature>(
                    "c459c8200e666ef4c990873d3e501b91"
                );
                var telekinetic_fist_feature = library.Get<BlueprintFeature>(
                    "e015d05ca18b5c24183cd062486fd46b"
                );
                var telekinetic_fist_ability = library.Get<BlueprintAbility>(
                    "810992c76efdde84db707a0444cf9a1c"
                );

                var actions = telekinetic_fist_ability
                    .GetComponent<AbilityEffectRunAction>()
                    .Actions.Actions;
                actions = Common.changeAction<ContextActionDealDamage>(
                    actions,
                ...
                telekinetic_fist_ability.ReplaceComponent<AbilityEffectRunAction>(a =>
                    a.Actions = Helpers.CreateActionList(actions)
                );
                telekinetic_fist_ability.RemoveComponents<ContextRankConfig>();
                telekinetic_fist_ability.AddComponent(
                    Helpers.CreateContextRankConfig(
                        ContextRankBaseValueType.ClassLevel,
                        classes: new BlueprintCharacterClass[] { wizard },
                        progression: ContextRankProgression.OnePlusDiv2
                ...
                telekinetic_fist_ability.SetDescription(
                ...
                transmutation_base.SetDescription(
            ...
            //fix conjuration
            {
                var conjuration_progression = library.Get<BlueprintProgression>(
                    "567801abe990faf4080df566fadcd038"
                );
                var conjuration_base = library.Get<BlueprintFeature>(
                    "cee0f7edbd874a042952ee150f878b84"
                );
                var acid_dart_feature = library.Get<BlueprintFeature>(
                    "b4b575d14c3bab6489aafa17ac2c909e"
                );
                var acid_dart_ability = library.Get<BlueprintAbility>(
                    "697291ff99d3fbb448be5b60b5f2a30c"
                );

                var actions = acid_dart_ability
                    .GetComponent<AbilityEffectRunAction>()
                    .Actions.Actions;
                actions = Common.changeAction<ContextActionDealDamage>(
                    actions,
                ...
                acid_dart_ability.ReplaceComponent<AbilityEffectRunAction>(a =>
                    a.Actions = Helpers.CreateActionList(actions)
                );
                acid_dart_ability.RemoveComponents<ContextRankConfig>();
                acid_dart_ability.AddComponent(
                    Helpers.CreateContextRankConfig(
                        ContextRankBaseValueType.ClassLevel,
                        classes: new BlueprintCharacterClass[] { wizard },
                        progression: ContextRankProgression.OnePlusDiv2
                ...
                acid_dart_ability.SetDescription(
                ...
                conjuration_base.SetDescription(
            ...
            fixDomainAbility(
                ...
                library.Get<BlueprintProgression>("2bd6aa3c4979fd045bbbda8da586d3fb"),
                library.Get<BlueprintProgression>("562567d7c244fae43ac61df3d55547ca"),
                library.Get<BlueprintFeature>("42cc125d570c5334c89c6499b55fc0a3"),
                library.Get<BlueprintAbility>("4ecdf240d81533f47a5279f5075296b9"),
                getDamageDie(DiceType.D6)
            );
            ...
            fixDomainAbility(
                ...
                library.Get<BlueprintProgression>("f05fb4f417465f94fb1b4d6c48ea42cf"),
                library.Get<BlueprintProgression>("e48425d6fdafdba449beec54fe158339"),
                library.Get<BlueprintFeature>("4c21ad24f55f64d4fb722f40720d9ab0"),
                library.Get<BlueprintAbility>("5e1db2ef80ff361448549beeb7785791"),
                DiceType.D8
            );
            ...
            fixDomainAbility(
                ...
                library.Get<BlueprintProgression>("d7169e8978d9e9d418398eab946c49e5"),
                library.Get<BlueprintProgression>("3aef017b78329db4fa53fe8560069886"),
                library.Get<BlueprintFeature>("39b0c7db785560041b436b558c9df2bb"),
                library.Get<BlueprintAbility>("b3494639791901e4db3eda6117ad878f"),
                getDamageDie(DiceType.D6)
            );

            //fix earth domain
            fixDomainAbility(
                library.Get<BlueprintProgression>("08bbcbfe5eb84604481f384c517ac800"),
                library.Get<BlueprintProgression>("4132a011b835a36479d6bc19a1b962e6"),
                library.Get<BlueprintProgression>("a3217dc55003b914aa296da7ada029bc"),
                library.Get<BlueprintFeature>("828d82a0e8c5a944bbdb6b12f802ff02"),
                library.Get<BlueprintAbility>("3ff40918d33219942929f0dbfe5d1dee"),
                getDamageDie(DiceType.D6)
            );
            ...
            fixDomainAbility(
                ...
                library.Get<BlueprintProgression>("d124d29c7c96fc345943dd17e24990e8"),
                library.Get<BlueprintProgression>("4a3516fdc4cda764ebd1279b22d10205"),
                library.Get<BlueprintFeature>("1c37869ee06ca33459f16f23f4969e7d"),
                library.Get<BlueprintAbility>("f166325c271dd29449ba9f98d11542d9"),
                getDamageDie(DiceType.D6)
            );
            ...
            //fix healing doamin
            fixDomainAbility(
                library.Get<BlueprintProgression>("b0a26ee984b6b6945b884467aa2f1baa"),
                library.Get<BlueprintProgression>("599fb0d60358c354d8c5c4304a73e19a"),
                library.Get<BlueprintProgression>("599fb0d60358c354d8c5c4304a73e19a"),
                library.Get<BlueprintFeature>("303cf1c933f343c4d91212f8f4953e3c"),
                library.Get<BlueprintAbility>("18f734e40dd7966438ab32086c3574e1"),
                getDamageDie(DiceType.D4),
                AbilityRankType.DamageBonus
            );

            //do not fix community domain, it is already powerful (just description)
            var community_domain_progressions = new BlueprintProgression[]
            {
                library.Get<BlueprintProgression>("b8bbe42616d61ac419971b7910d79fc8"),
                library.Get<BlueprintProgression>("3a397e27682edfd409cb73ff12de7c51"),
            };
            foreach (var cdp in community_domain_progressions)
            {
                cdp.SetDescription(
                    cdp.Description.Replace($"d6", $"d{getDamageDieString(DiceType.D6)}")
                );
            }

            //fix darkness greater ability description
            var darkness_domain_progressions = new BlueprintProgression[]
            {
            ...
            {
                ddp.SetDescription(
                    ddp.Description.Replace("d10", $"d{getDamageDieString(DiceType.D10)}")
                );
                ddp.SetDescription(
                    ddp.Description.Replace("d8", $"d{getDamageDieString(DiceType.D8)}")
                );
            }

            //fix runes
            {
                var base_ability = library.Get<BlueprintAbility>(
                    "56ad05dedfd9df84996f62108125eed5"
                );
                base_ability.SetDescription(
                    base_ability.Description.Replace(
                        "+ 1 point for every two levels you possess in the class that gave you access to this domain",
                        $"plus 1d{getDamageDieString(DiceType.D6)} points of damage per two levels of the class that gave you access to this domain beyond first"
                    )
                );
                ...
                foreach (var v in base_ability.Variants)
                {
                    ...
                    var area = (
                        v.GetComponent<AbilityEffectRunAction>().Actions.Actions[0]
                        as ContextActionSpawnAreaEffect
                    ).AreaEffect;
                    area.ReplaceComponent<AbilityAreaEffectRunAction>(a =>
                        a.UnitEnter.Actions = Common.changeAction<ContextActionDealDamage>(
                            a.UnitEnter.Actions,
                            ca =>
                                ca.Value = Helpers.CreateContextDiceValue(
                                    getDamageDie(DiceType.D6),
                ...
                foreach (var v in base_ability.Variants)
                {
                    ...
                    {
                        v.AddComponent(
                            Helpers.Create<NewMechanics.AbilityTargetPointDoesNotContainAreaEffect>(
                                atp => atp.area_effect = a
                            )
                        );
                    }
                }

                var base_feature = library.Get<BlueprintFeature>(
                    "b74c64a0152c7ee46b13ecdd72dda6f3"
                );
                ...
                base_feature.SetDescription(
                    base_feature.Description.Replace(
                        "+ 1 point for every two levels you possess in the class that gave you access to this domain",
                        $"plus 1d{getDamageDieString(DiceType.D6)} points of damage per two levels of the class that gave you access to this domain beyond first"
                    )
                );
            ...
            //sorcerer - heavenly fire (celestial)
            {
                ...
                actions = Common.changeAction<ContextActionDealDamage>(
                    ...
                    a =>
                    {
                        a.Value = Helpers.CreateContextDiceValue(
                            getDamageDie(DiceType.D4),
                            Helpers.CreateContextValue(base_config.Type),
                            0
                        );
                    }
                );
                actions = Common.changeAction<ContextActionHealTarget>(
                    actions,
                    a =>
                    {
                        a.Value = Helpers.CreateContextDiceValue(
                ...
                ability.ReplaceComponent(
                    base_config,
                    Helpers.CreateContextRankConfig(
                        ContextRankBaseValueType.SummClassLevelWithArchetype,
                        classes: Helpers.GetField<BlueprintCharacterClass[]>(
                            base_config,
                            "m_Class"
                        ),
                ...
                foreach (var feature in features)
                {
                    ...
                    ability.ReplaceComponent(
                        ...
                        Helpers.CreateContextRankConfig(
                            ...
                            archetype: Helpers.GetField<BlueprintArchetype>(
                                base_config,
                                "Archetype"
                            ),
                            type: base_config.Type,
                    ...
                    ability.SetDescription(
                        ability.Description.Replace(
                            "+ 1 for every two sorcerer levels you possess",
                            $"+ 1d{getDamageDieString(DiceType.D6)} for every two sorcerer levels you possess beyond first"
                        )
                    );
                    feature.SetDescription(ability.Description);
                }
        ...
        static void fixDomainAbility(
            ...
            DiceType dice,
            AbilityRankType rank = AbilityRankType.Default
        )
        {
            var domain_classes = new BlueprintCharacterClass[]
            {
                library.Get<BlueprintCharacterClass>("67819271767a9dd4fbfd4ae700befea0"), //cleric
            ...
            actions = Common.changeAction<ContextActionDealDamage>(
                ...
                a =>
                {
                    a.Value = Helpers.CreateContextDiceValue(
                        dice,
                        Helpers.CreateContextValue(rank),
                        0
                    );
                }
            );
            ...
            base_ability.ReplaceComponent<AbilityEffectRunAction>(a =>
                a.Actions = Helpers.CreateActionList(actions)
            );
            ...
            base_ability.SetDescription(
                base_ability.Description.Replace(
                    "+ 1 point for every two levels you possess in the class that gave you access to this domain",
                    $"plus 1d{(int)dice} points of damage per two levels of the class that gave you access to this domain beyond first"
                )
            );
            base_feature.SetDescription(
                base_feature.Description.Replace(
        ...
        static void manualTextFixes()
        {
            ...
            var channel_energy_selection = library.Get<BlueprintFeatureSelection>(
                "d332c1748445e8f4f9e92763123e31bd"
            );
            channel_energy_selection.SetDescription(
                replaceString(channel_energy_selection.Description, DiceType.D6)
            );

            var dragon_form1 = library.Get<BlueprintAbility>("f767399367df54645ac620ef7b2062bb");
            var dragon_form1_feature = library.Get<BlueprintFeature>(
                "b10c54491148de84b858763588664a8a"
            );
            dragon_form1.SetDescription(
                dragon_form1.Description.Replace("6d8", $"1d{getDamageDieString(DiceType.D8)}")
            );
            dragon_form1_feature.SetDescription(
                dragon_form1_feature.Description.Replace(
                    "6d8",
                    $"6d{getDamageDieString(DiceType.D8)}"
                )
            );

            var dragon_form2 = library.Get<BlueprintAbility>("666556ded3a32f34885e8c318c3a0ced");
            var dragon_form2_feature = library.Get<BlueprintFeature>(
                "5b13008bdc18a0c4db321ae9f04ba77f"
            );
            dragon_form2.SetDescription(
                dragon_form2.Description.Replace("8d8", $"8d{getDamageDieString(DiceType.D8)}")
            );
            dragon_form2_feature.SetDescription(
                dragon_form2_feature.Description.Replace(
                    "8d8",
                    $"8d{getDamageDieString(DiceType.D8)}"
                )
            );

            var dragon_form3 = library.Get<BlueprintAbility>("1cdc4ad4c208246419b98a35539eafa6");
            var dragon_form3_feature = library.Get<BlueprintFeature>(
                "a5e3c6ee70f04c6489fd0bac3582db74"
            );
            dragon_form3.SetDescription(
                dragon_form3.Description.Replace("12d8", $"12d{getDamageDieString(DiceType.D8)}")
            );
            dragon_form3_feature.SetDescription(
                dragon_form3_feature.Description.Replace(
                    "12d8",
                    $"12d{getDamageDieString(DiceType.D8)}"
                )
            );

            var kinetic_blast_feature = library.Get<BlueprintFeature>(
                "93efbde2764b5504e98e6824cab3d27c"
            );
            kinetic_blast_feature.SetDescription(
                replaceString(kinetic_blast_feature.Description, DiceType.D6)
            );

            var kinetic_blast_progression = library.Get<BlueprintProgression>(
                "30a5b8cf728bd4a4d8d90fc4953e322e"
            );
            kinetic_blast_progression.SetDescription(
                replaceString(kinetic_blast_progression.Description, DiceType.D6)
            );

            var kinetic_diadem_lesser = library.Get<BlueprintItemEquipmentHead>(
                "2c46e4062d47c5243922e60eb5ab3df1"
            );
            var kinetic_diadem = library.Get<BlueprintItemEquipmentHead>(
                "cd6b1dda38c5b614cb428969770bb08d"
            );
            ...
            kinetic_diadem_lesser.SetDescription(
                replaceString(kinetic_diadem_lesser.Description, DiceType.D6)
            );
            ...
            firebelly.SetDescription(
                firebelly.Description.Replace("1d4", $"1d{getDamageDieString(DiceType.D4)}")
            );
            firebelly_buff.SetDescription(
                firebelly_buff.Description.Replace("1d4", $"1d{getDamageDieString(DiceType.D4)}")
            );

            var arcane_bomber_bomb_selection = library.Get<BlueprintFeatureSelection>(
                "0c7a9899e27cae6449ee1fb3049f128d"
            );
            arcane_bomber_bomb_selection.SetDescription(
                replaceString(arcane_bomber_bomb_selection.Description, DiceType.D6)
            );

            var cave_fangs = library.Get<BlueprintAbility>("bacba2ff48d498b46b86384053945e83");
            var cave_fangs_abilities = new BlueprintAbility[] { cave_fangs }.AddToArray(
                cave_fangs.Variants
            );
            ...
            var firebrand_ability = library.Get<BlueprintAbility>(
                "98734a2665c18cd4db71878b0532024a"
            );
            var firebrand_bonus_spell = library.Get<BlueprintFeature>(
                "f10e60b5fa889e44585e4e48d0256a42"
            );
            firebrand_buff.SetDescription(replaceString(firebrand_buff.Description, DiceType.D6));
            firebrand_ability.SetDescription(
                replaceString(firebrand_ability.Description, DiceType.D6)
            );
            firebrand_bonus_spell.SetDescription(
                replaceString(firebrand_bonus_spell.Description, DiceType.D6)
            );

            //scaled fist draconic heritage
            var sf_draconic_heritage = library.Get<BlueprintFeatureSelection>(
                "f9042eed12dac2745a2eb7a9a936906b"
            );
            sf_draconic_heritage.SetDescription(
                replaceString(sf_draconic_heritage.Description, DiceType.D6)
            );

            //acerbic ring
            var acerbic_ring = library.Get<BlueprintItemEquipmentRing>(
                "1f34a6b309907a44681c689709976bff"
            );
            ...
            acid_splash.SetDescription(
                acid_splash.Description.Replace("3", getDamageDieString(DiceType.D3))
            );

            //fix changed dexterity damage description
            var polar_midnight = library.Get<BlueprintAbility>("ba48abb52b142164eba309fd09898856");
            polar_midnight.SetDescription(
                polar_midnight.Description.Replace($"1d{getDamageDieString(DiceType.D6)}", "1d6")
            );
        }
        ...
        static void processFeature(BlueprintFeature f, HashSet<DiceType> processed)
        {
            ...
            foreach (var p in processed_local)
            {
                ...
                var new_dice = (int)dices_shift[p];
                f.SetDescription(
                    f.Description.Replace("d" + old_dice.ToString(), "dxxx" + new_dice.ToString())
                );
            }
        ...
        static void fixSpellDamageArea(BlueprintAbilityAreaEffect area, HashSet<DiceType> processed)
        {
            ...
            var run_actions_array = new GameAction[][]
            {
                area.GetComponent<AbilityAreaEffectRunAction>()?.Round?.Actions,
                area.GetComponent<AbilityAreaEffectRunAction>()?.UnitEnter?.Actions,
                area.GetComponent<AbilityAreaEffectRunAction>()?.UnitExit?.Actions,
                area.GetComponent<AbilityAreaEffectRunAction>()?.UnitMove?.Actions,
            };
            for (int i = 0; i < run_actions_array.Length; i++)
            {
                ...
                var new_actions = processActions(
                    run_actions,
                    area.GetComponents<ContextCalculateSharedValue>().ToArray(),
                    processed_local
                );
        ...
        static void fixSpellDamageAbilities()
        {
            ...
            var abilities_wit_variants = library
                .GetAllBlueprints()
                .OfType<BlueprintAbility>()
                .Where(a => a.HasVariants);
        ...
        static void fixSpellDamageAbility(BlueprintAbility ability, HashSet<DiceType> processed)
        {
            ...
            var clicked_actions = ability
                .GetComponent<AbilityEffectRunActionOnClickedTarget>()
                ?.Action?.Actions;
            ...
            if (run_actions != null)
            {
                run_actions = processActions(
                    run_actions,
                    ability.GetComponents<ContextCalculateSharedValue>().ToArray(),
                    processed_local
                );
            }
            if (clicked_actions != null)
            {
                clicked_actions = processActions(
                    clicked_actions,
                    ability.GetComponents<ContextCalculateSharedValue>().ToArray(),
                    processed_local
                );
            ...
            ability.MaybeReplaceComponent<AbilityEffectRunAction>(ra =>
                ra.Actions = Helpers.CreateActionList(run_actions)
            );
            ability.MaybeReplaceComponent<AbilityEffectRunActionOnClickedTarget>(ra =>
                ra.Action = Helpers.CreateActionList(clicked_actions)
            );
        ...
        static void fixSpellDamageBuff(BlueprintBuff buff, HashSet<DiceType> processed)
        {
            ...
            if (
                buff.GetComponent<AddFactContextActions>() == null
                && buff.GetComponent<AddFallProneTrigger>() == null
                && buff.GetComponent<AddOffensiveActionTrigger>() == null
            )
            {
                return;
            }
            ...
            var run_actions_array = new GameAction[][]
            {
                buff.GetComponent<AddFactContextActions>()?.Activated?.Actions,
            ...
            for (int i = 0; i < run_actions_array.Length; i++)
            {
                ...
                var new_actions = processActions(
                    run_actions,
                    buff.GetComponents<ContextCalculateSharedValue>().ToArray(),
                    processed_local
                );
                run_actions_array[i] = new_actions;
            }
        ...
        static GameAction[] processActions(
            GameAction[] run_actions,
            ContextCalculateSharedValue[] shared_values,
            HashSet<DiceType> processed
        )
        {
            if (run_actions == null)
            {
            ...
            var new_actions = Common.changeAction<ContextActionDealDamage>(
                run_actions,
                c =>
                {
                    ...
                    {
                        var sh2 = shared_values2
                            .Where(cc => cc.ValueType == c.Value.BonusValue.ValueShared)
                            .FirstOrDefault();
                        if (sh2 != null)
                        {
                    ...
                    {
                        if (
                            v.DiceCountValue == null
                            || (v.DiceCountValue.Value == 0 && v.DiceCountValue.IsValueSimple)
                        )
                        {
                            continue;
                        }
            ...
            new_actions = Common.changeAction<ContextActionHealTarget>(
                new_actions,
                c =>
                {
                    if (
                        c.Value.DiceCountValue == null
                        || (
                            c.Value.DiceCountValue.Value == 0
                            && c.Value.DiceCountValue.IsValueSimple
                        )
                    )
                    {
                        return;
            ...
            new_actions = Common.changeAction<ContextActionSpawnAreaEffect>(
                new_actions,
                c =>
                {
    ...
    public class DraconicBloodlineArcanaClassSpells
            ...
            IInitiatorRulebookSubscriber
    {
        ...
        public void OnEventAboutToTrigger(RuleCalculateDamage evt)
        {
            ...
            if (
                (Object)context?.SourceAbility == (Object)null
    ...
    public class IterativeTwoWeaponFightingAttacks
    ...
    public class ArcaneBloodlineArcanaOnSpecificClass
        : RuleInitiatorLogicComponent<RuleCalculateAbilityParams>
    {
        ...
        public override void OnEventAboutToTrigger(RuleCalculateAbilityParams evt)
        {
            ...
            if (
                ((object)abilityData != null ? abilityData.MetamagicData : (MetamagicData)null)
                    == null
                || !evt.AbilityData.MetamagicData.NotEmpty
                || evt.AbilityData.HasMetamagic(Metamagic.Heighten)
            )
                return;
            evt.AddBonusDC(1);
        }
